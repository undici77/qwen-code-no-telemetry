...
```bash
curl -fsSL https://raw.githubusercontent.com/undici77/qwen-code-no-telemetry/v0.21.14-no-telemetry/install.sh \
    | bash -s v0.21.14-no-telemetry
```
...
```powershell
iwr https://raw.githubusercontent.com/undici77/qwen-code-no-telemetry/v0.21.14-no-telemetry/install.ps1 -OutFile install.ps1
