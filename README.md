...
> [original README at v0.19.5](https://github.com/QwenLM/qwen-code/blob/v0.19.5/README.md).
...
For full documentation on features, configuration, and usage, please refer to the [original README at v0.19.5](https://github.com/QwenLM/qwen-code/blob/v0.19.5/README.md).
