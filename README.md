...
> [original README at v0.23.4](https://github.com/QwenLM/qwen-code/blob/v0.23.4/README.md).
...
```bash
curl -fsSL https://raw.githubusercontent.com/undici77/qwen-code-no-telemetry/v0.23.4-no-telemetry/install.sh \
    | bash -s v0.23.4-no-telemetry
```
...
```powershell
iwr https://raw.githubusercontent.com/undici77/qwen-code-no-telemetry/v0.23.4-no-telemetry/install.ps1 -OutFile install.ps1
.\install.ps1 v0.23.4-no-telemetry
```
