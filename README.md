...
> [original README at v0.16.0](https://github.com/QwenLM/qwen-code/blob/v0.16.0/README.md).
...
```bash
curl -fsSL https://raw.githubusercontent.com/undici77/qwen-code-no-telemetry/v0.16.0-no-telemetry/install.sh \
    | bash -s v0.16.0-no-telemetry
```
