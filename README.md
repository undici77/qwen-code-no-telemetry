...
> [original README at v0.21.15](https://github.com/QwenLM/qwen-code/blob/v0.21.15/README.md).
...
```bash
curl -fsSL https://raw.githubusercontent.com/undici77/qwen-code-no-telemetry/v0.21.15-no-telemetry/install.sh \
    | bash -s v0.21.15-no-telemetry
```
...
```powershell
iwr https://raw.githubusercontent.com/undici77/qwen-code-no-telemetry/v0.21.15-no-telemetry/install.ps1 -OutFile install.ps1
.\install.ps1 v0.21.15-no-telemetry
```
...
For full documentation on features, configuration, and usage, please refer to the [original README at v0.21.15](https://github.com/QwenLM/qwen-code/blob/v0.21.15/README.md).
