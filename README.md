...
> [original README at v0.24.2](https://github.com/QwenLM/qwen-code/blob/v0.24.2/README.md).
...
```bash
curl -fsSL https://raw.githubusercontent.com/undici77/qwen-code-no-telemetry/v0.24.2-no-telemetry/install.sh \
    | bash -s v0.24.2-no-telemetry
```
...
```powershell
iwr https://raw.githubusercontent.com/undici77/qwen-code-no-telemetry/v0.24.2-no-telemetry/install.ps1 -OutFile install.ps1
.\install.ps1 v0.24.2-no-telemetry
```
