...
> [original README at v0.21.11](https://github.com/QwenLM/qwen-code/blob/v0.21.11/README.md).
...
```powershell
iwr https://raw.githubusercontent.com/undici77/qwen-code-no-telemetry/v0.21.11-no-telemetry/install.ps1 -OutFile install.ps1
...
For full documentation on features, configuration, and usage, please refer to the [original README at v0.21.11](https://github.com/QwenLM/qwen-code/blob/v0.21.11/README.md).
