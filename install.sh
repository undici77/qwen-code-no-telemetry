...
#
# Examples:
#   bash install.sh v0.21.9-no-telemetry
#   bash install.sh v0.21.9-no-telemetry --source github
...
usage() {
    ...
    echo ""
    echo "Examples:"
    echo "  bash install.sh v0.21.9-no-telemetry"
    echo "  bash install.sh v0.21.9-no-telemetry --source github"
    echo ""
    exit 1
}
