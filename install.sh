...
#
# Examples:
#   bash install.sh v0.14.3-no-telemetry
#   bash install.sh v0.14.3-no-telemetry --source github
...
usage() {
    ...
    echo ""
    echo "Examples:"
    echo "  bash install.sh v0.14.3-no-telemetry"
    echo "  bash install.sh v0.14.3-no-telemetry --source github"
    echo ""
    exit 1
}
