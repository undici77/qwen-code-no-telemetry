...
#
# Examples:
#   bash install.sh v0.14.0-no-telemetry
#   bash install.sh v0.14.0-no-telemetry --source github
...
usage() {
    ...
    echo ""
    echo "Examples:"
    echo "  bash install.sh v0.14.0-no-telemetry"
    echo "  bash install.sh v0.14.0-no-telemetry --source github"
    echo ""
    exit 1
}
