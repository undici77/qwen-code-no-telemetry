...
const globalWithDom = globalThis;
...
if (typeof globalWithDom.Range !== 'undefined') {
    const rangePrototype = globalWithDom.Range.prototype;
...
if (typeof navigator !== 'undefined' && !navigator.mediaDevices) {
    Object.defineProperty(navigator, 'mediaDevices', {
        configurable: true,
        value: {
            getUserMedia: vi.fn(() => Promise.reject(new Error('getUserMedia is not mocked for this test'))),
        },
    });
}
