...
const MicIcon = () =>
  _jsxs('svg', {
    ...
    children: [
      ...
      _jsx('path', {
        d: 'M17 11a5 5 0 0 1-10 0H5a7 7 0 0 0 6 6.92V21h2v-3.08A7 7 0 0 0 19 11h-2Z',
      }),
    ],
  });
const StopIcon = () =>
...
export function VoiceButton({
  ...
  if (isRecording) {
    control = _jsxs('button', {
      ...
      title: label,
      children: [
        _jsx('span', { className: styles.recDot, 'aria-hidden': 'true' }),
        _jsx('span', {
          className: styles.wave,
          'aria-hidden': 'true',
          children: levels.map((lvl, i) =>
            _jsx(
              'span',
              {
    ...
    control = _jsxs('span', {
      ...
      'aria-label': label,
      children: [
        _jsx('span', { className: styles.spinner, 'aria-hidden': 'true' }),
        _jsx('span', { className: styles.time, children: '\u2026' }),
      ],
    });
  } else {
