...
export declare function resolveVoiceWorkspaceTarget({
  capabilities,
  intendedCwd,
  sessionId,
  workspaces,
}: ResolveVoiceWorkspaceTargetOptions): VoiceWorkspaceTarget | undefined;
export declare function supportsVoiceCapture(
  target: VoiceWorkspaceTarget | undefined,
  features: readonly string[],
): boolean;
export declare function supportsVoiceModelSettings(
  target: VoiceWorkspaceTarget | undefined,
  features: readonly string[],
): boolean;
export declare function loadVoiceStatus(
  client: DaemonClient,
  target: VoiceWorkspaceTarget,
): Promise<DaemonWorkspaceVoiceStatus>;
export declare function loadVoiceProviders(
  client: DaemonClient,
  target: VoiceWorkspaceTarget,
): Promise<DaemonWorkspaceProvidersStatus>;
export declare function loadVoiceSettings(
  client: DaemonClient,
  target: VoiceWorkspaceTarget,
): Promise<DaemonWorkspaceSettingsStatus>;
export declare function setVoiceModelSetting(
  client: DaemonClient,
  target: VoiceWorkspaceTarget,
