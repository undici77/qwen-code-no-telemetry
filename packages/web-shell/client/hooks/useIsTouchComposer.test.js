...
import { TOUCH_COMPOSER_QUERY, isCoarsePointerDevice, useIsTouchComposer, } from './useIsTouchComposer';
...
function installMatchMedia(matchesByQuery) {
    const listeners = [];
...
//# sourceMappingURL=useIsTouchComposer.test.js.map