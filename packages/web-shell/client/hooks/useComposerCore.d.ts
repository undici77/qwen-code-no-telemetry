...
export declare function buildComposerPrompt(
  text: string,
...
export declare function buildComposerPromptWithInlineTagPlacements(
  text: string,
  topTags: readonly WebShellComposerTag[],
  inlineTags: readonly InlineTagPlacement[],
): string;
export declare function replaceInlineTagPlacements(
  text: string,
  inlineTags: readonly InlineTagPlacement[],
): string;
...
export declare function getInlineComposerTags(
  view: EditorView,
): WebShellComposerTag[];
...
export declare function getFollowupCompletion(
  text: string,
...
export declare function useComposerCore(
