...
export declare function useNewSessionSuggestion({ enabled, messages, sessionId, contextUsageRatio, isRunning, dialogOpen, hasAttachments, generateContent, }: UseNewSessionSuggestionOptions): UseNewSessionSuggestionReturn;
export {};
