 ...
 */
import { type DaemonSessionActions, type DaemonStreamingState } from '@qwen-code/webui/daemon-react-sdk';
import type { DaemonInputAnnotation, DaemonTranscriptStore } from '@qwen-code/sdk/daemon';
...
export interface UseQueuedPromptsResult {
    ...
    queuedTexts: string[];
    enqueuePrompt: (text: string, images?: PromptImage[], onComplete?: () => void, inputAnnotations?: DaemonInputAnnotation[], onAdmitted?: () => void) => boolean;
...
export declare function useQueuedPrompts({ connected, writeBlocked, sessionId, workspaceCwd, clientId, canMutateMidTurn, canQueryMidTurn, streamingState, sessionActions, store, editorRef, reportError, t, }: UseQueuedPromptsArgs): UseQueuedPromptsResult;
export {};
