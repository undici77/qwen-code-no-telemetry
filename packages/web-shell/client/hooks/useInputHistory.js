...
export function getPromptHistoryStorageKey(workspaceCwd) {
    return workspaceCwd
...
function loadHistory(storageKey, fallbackStorageKey) {
...
export function pushInputHistoryEntry(storageKey, text, fallbackStorageKey) {
...
export function useInputHistory(storageKey = DEFAULT_STORAGE_KEY, fallbackStorageKey) {
    ...
    const push = useCallback((text) => {
        ...
        if (h[h.length - 1] === text) {
            if (fallbackStorageKeyRef.current &&
