...
function Harness({
  ...
  return _jsx('div', {
    ...
    ...composer.imageTransferHandlers,
    children: _jsx('div', { ref: composer.containerRef }),
  });
}
  ...
  const render = () => {
    root.render(
      _jsx(WebShellPortalRootContext.Provider, {
        value: currentPortalRoot,
        children: _jsx(I18nProvider, {
          language: 'en',
          children: _jsx(Harness, {
...
describe('useComposerCore tags', () => {
  ...
  it('restores shell history as raw command text without parsing tags', async () => {
    ...
    const parseUserMessageContent = vi.fn((content) =>
      content === command
        ? [
            { type: 'text', text: 'echo ' },
            {
