...
export type DaemonMessageToolCallStatus = 'pending' | 'in_progress' | 'completed' | 'failed';
export type DaemonMessageToolKind = 'read' | 'edit' | 'delete' | 'move' | 'search' | 'execute' | 'think' | 'fetch' | 'switch_mode' | 'other';
...
export type DaemonMessage = DaemonUserMessage | DaemonAssistantMessage | DaemonThinkingMessage | DaemonToolGroupMessage | DaemonPlanMessage | DaemonSystemMessage | DaemonUserShellMessage | DaemonBtwMessage | DaemonInsightProgressMessage | DaemonInsightReadyMessage | DaemonInsightErrorMessage;
