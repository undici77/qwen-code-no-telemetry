...
export function hasActiveAgents(agents) {
    return agents.some((agent) => isActiveToolStatus(agent.status));
}
export function isTaskExecutionRaw(raw) {
    return getRecord(raw)?.['type'] === 'task_execution';
}
export function isSubAgentToolCall(tool) {
...
export function isBackgroundSubAgentToolCall(tool) {
...
//# sourceMappingURL=toolClassification.js.map