...
import type { ChartRendererRegistry, MarkdownChartLabelOverrides } from '@datafe-open/markdown-chart';
 ...
 */
export type CodeBlockRenderer = (info: WebShellCodeBlockRenderInfo) => ReactNode | null | undefined;
...
export interface WebShellMarkdownCustomization {
    transformMarkdown?: (markdown: string, context: MarkdownRenderContext) => string;
    /**
...
export type ToolHeaderKind = 'agent' | 'ask' | 'edit' | 'fetch' | 'read' | 'shell' | 'todo' | 'write' | 'other';
...
export type ToolHeaderExtraRenderer = (info: ToolHeaderExtraRenderInfo) => ReactNode;
...
export type WebShellEnvironmentPanelItem = 'environment' | 'subagents' | 'backgroundTasks';
...
export type UserMessageContentRenderer = (info: UserMessageContentRenderInfo) => ReactNode;
...
export type AssistantTurnFooterRenderer = (info: WebShellAssistantTurnFooterRenderInfo) => ReactNode | null | undefined;
export type WebShellBuiltinComposerTagKind = 'extension' | 'mcp' | 'file' | 'skill';
export type WebShellComposerTagKind = WebShellBuiltinComposerTagKind | (string & {});
 ...
 */
export type ComposerTagRenderer = (info: WebShellComposerTagRenderInfo) => ReactNode | null | undefined;
export type ComposerTagClickHandler = (info: WebShellComposerTagRenderInfo) => void;
...
export type UserMessageContentParser = (content: string) => readonly WebShellUserMessagePart[] | undefined | null;
...
export type WebShellBuiltinAtProviderId = 'files' | 'extensions' | 'mcp-resources';
export type WebShellBuiltinAtProvidersConfig = boolean | readonly WebShellBuiltinAtProviderId[] | {
    enabled?: boolean;
...
export type WebShellAtItemRenderer = (info: WebShellAtItemRenderInfo) => ReactNode | null | undefined;
...
export type WebShellComposerToolbarStartRenderInfo = WebShellComposerToolbarRenderInfo;
export type WebShellComposerToolbarRightRenderInfo = WebShellComposerToolbarRenderInfo;
export type ComposerToolbarStartRenderer = ComponentType<WebShellComposerToolbarStartRenderInfo>;
export type ComposerToolbarEndRenderer = ComponentType<WebShellComposerToolbarRenderInfo>;
export type ComposerToolbarRightRenderer = ComponentType<WebShellComposerToolbarRightRenderInfo>;
export type ComposerHeaderRenderer = ComponentType<WebShellComposerToolbarRenderInfo>;
export type ComposerFooterRenderer = ComponentType<WebShellComposerToolbarRenderInfo>;
...
export type WebShellTaskInfo = WebShellAgentTask | WebShellShellTask | WebShellMonitorTask;
 ...
 */
export type LoadingPhrasesResolver = (language: string) => readonly string[] | undefined | null;
...
export declare const WebShellCustomizationProvider: import("react").Provider<WebShellCustomization>;
export declare function useWebShellCustomization(): WebShellCustomization;
export {};
