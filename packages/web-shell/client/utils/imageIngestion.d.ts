...
export type ImageIngestionRejectionReason = 'unsupported' | 'unavailable' | 'too-large' | 'read-failed';
...
export declare function extractImageTransfer(dataTransfer: DataTransfer, source: 'paste' | 'drop'): ExtractedImageTransfer;
export declare function readImageTransfer(transfer: ExtractedImageTransfer, lifecycle?: ReaderLifecycle): Promise<ImageIngestionBatchResult>;
export {};
