...
import { appendOrDeferLocalUserMessage, isCommandPrompt, } from './localCommandQueue';
describe('appendOrDeferLocalUserMessage', () => {
    it('appends and returns false when no turn is streaming', () => {
        const append = vi.fn();
        const enqueue = vi.fn();
        const deferred = appendOrDeferLocalUserMessage(false, '/context', undefined, {
            append,
        });
    ...
    it('suppresses local commands and returns true while a turn is streaming', () => {
        const append = vi.fn();
        const enqueue = vi.fn();
        const deferred = appendOrDeferLocalUserMessage(true, '/context', undefined, {
            append,
        });
...
//# sourceMappingURL=localCommandQueue.test.js.map