...
export declare function shouldDisableComposerInput({ catchingUp, pendingApproval, isPreparingPrompt, }: {
    catchingUp: boolean;
    pendingApproval: boolean;
    isPreparingPrompt: boolean;
}): boolean;
export declare function getComposerPlaceholderState({ catchingUp, isPreparingPrompt, isStreaming, }: {
    catchingUp: boolean;
    isPreparingPrompt: boolean;
    isStreaming: boolean;
...
export declare function shouldBlockComposerSubmit({ connectionStatus, hasSession, restartSseOnPrompt, }: {
