export const COPY_MESSAGES = {
    ...
    INLINE_LATEX_MISSING: 'No matching inline LaTeX expression found in the last AI output.',
...
function getLastAssistantOutput(messages) {
...
export async function copyFromLastAssistantMessage(messages, args, writeText = defaultClipboardWriter) {
    ...
    try {
        ...
        if (selectedLatexBlock === null) {
            ...
            return {
                status: 'info',
                message: wantsInline || args.trim().toLowerCase().startsWith('inline-latex')
