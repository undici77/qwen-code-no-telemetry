...
import { formatContextTokens, formatContextUsageDetail, } from './formatTokenCount';
...
describe('formatContextUsageDetail', () => {
    it('formats used/total with k/M units and one decimal', () => {
        expect(formatContextUsageDetail(53_600, 1_000_000)).toBe('53.6k / 1.0M tokens (5.4%)');
        expect(formatContextUsageDetail(338_108, 1_000_000)).toBe('338.1k / 1.0M tokens (33.8%)');
        expect(formatContextUsageDetail(512, 2000)).toBe('512 / 2.0k tokens (25.6%)');
    });
...
//# sourceMappingURL=formatTokenCount.test.js.map