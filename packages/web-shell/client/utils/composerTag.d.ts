...
export declare function parseUserMessageContentSafely(
  content: string,
  parser: UserMessageContentParser | undefined,
  warning: string,
  options?: ParseUserMessageContentOptions,
): readonly WebShellUserMessagePart[] | null;
export declare function getComposerTagSerialized(
  tag: WebShellComposerTag,
): string;
export declare function getComposerTagIconUrl(
  kind: WebShellComposerTagKind | undefined,
  customIconUrls?: WebShellComposerTagIconMap,
): string | undefined;
export declare function isBuiltinComposerTagIconUrl(
  iconUrl: string | undefined,
): boolean;
export declare function createInputAnnotationsFromComposerTags(
  content: string,
  tags: readonly WebShellComposerTag[],
): DaemonInputAnnotation[];
export declare function splitComposerTagContentByAnnotations(
  content: string,
  inputAnnotations?: readonly DaemonInputAnnotation[],
): ComposerTagContentSegment[];
export declare function getComposerTagViewModel(
  tag: WebShellComposerTag,
