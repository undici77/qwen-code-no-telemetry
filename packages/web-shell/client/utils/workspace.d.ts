 ...
 */
import type { DaemonCapabilities, DaemonSessionSummary, DaemonWorkspaceCapability } from '@qwen-code/sdk/daemon';
/**
...
export declare function workspaceLabel(workspace: Pick<DaemonWorkspaceCapability, 'cwd' | 'displayName'>): string;
export declare function workspaceLabelForCwd(cwd: string, workspaces: readonly Pick<DaemonWorkspaceCapability, 'cwd' | 'displayName'>[] | undefined): string;
/**
