...
import type { DaemonTranscriptBlock, DaemonSessionMonitorTaskStatus, DaemonSessionTaskStatus, DaemonWorkspaceCapability } from '@qwen-code/sdk/daemon';
...
import { type WebShellSidebarBranding, type WebShellSidebarFooterOptions, type WebShellSidebarLockedWorkspace, type WebShellSidebarPrimaryNavOptions, type WebShellSidebarSessionActionsOptions } from './components/sidebar/WebShellSidebar';
...
export type WebShellSlashCommandHandler = (command: WebShellSlashCommand) => boolean | void;
...
export declare function getTaskActivityKey(messages: readonly Message[]): string;
export declare function mergeMonitorTaskSnapshot(current: DaemonSessionMonitorTaskStatus, next: DaemonSessionMonitorTaskStatus): DaemonSessionMonitorTaskStatus;
