...
import { type DaemonCapabilities, type DaemonChannelsSnapshot, type DaemonChannelPairingRequest, type DaemonChannelTypeCatalog, type DaemonEvent, type DaemonSessionArtifact, type DaemonSessionGroup, type DaemonSessionState, type DaemonSessionSummary, type DaemonWorkspaceExtensionsStatus, type DaemonGitHubPullRequestList, type DaemonWorkspaceGitStatus, type DaemonWorkspaceProvidersStatus, type DaemonWorkspaceSettingsStatus, type DaemonWorkspaceSkillsStatus, type DaemonWorkspaceVoiceStatus, type ExtensionActiveOperations, type ExtensionUpdateCheckResponse } from '@qwen-code/sdk/daemon';
...
type ScenarioOverrides = Partial<Omit<WebShellDaemonScenario, 'capabilities' | 'providers' | 'skills' | 'settings' | 'voice' | 'extensions' | 'extensionOperations' | 'extensionUpdateCheck' | 'channelTypes' | 'channels' | 'pairingRequests' | 'pairingApprovals' | 'pairingGroupApprovals' | 'sessions' | 'sessionGroups' | 'state'>> & {
