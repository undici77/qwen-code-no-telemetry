...
export declare function gotoEmptyMobileWelcomeHarness(page: Page, options?: EmptyMobileWelcomeHarnessOptions): Promise<void>;
export declare function expectEmptyMobileWelcomeChromeVisible(page: Page, options?: EmptyMobileComposerLayoutOptions): Promise<void>;
export declare function emptyMobileComposerLayout(page: Page, options?: EmptyMobileComposerLayoutOptions): Promise<EmptyMobileComposerLayout>;
export declare function expectEmptyMobileComposerAnchored(layout: EmptyMobileComposerLayout, options?: EmptyMobileComposerLayoutOptions): void;
