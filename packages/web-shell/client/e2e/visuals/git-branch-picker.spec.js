...
import { assistantTextEvent, createWebShellDaemonScenario, turnCompleteEvent, userTextEvent, } from '../utils/mockDaemon';
import { captureScreenshot, gotoSession, installScenario, resolveBaseURL, VISUAL_VIEWPORT, } from './harness';
test.use({ viewport: { ...VISUAL_VIEWPORT } });
test('branch picker, commit dialog, create PR form', async ({ page, }, testInfo) => {
    const scenario = createWebShellDaemonScenario({
        ...
        events: [
            ...
            assistantTextEvent('Done! I added the branch picker with search, checkout, and commit support.', { id: 2 }),
    ...
    const createPrBtn = page
        .locator('button:has-text("Create Pull Request"), button:has-text("Create PR")')
        .first();
...
//# sourceMappingURL=git-branch-picker.spec.js.map