...
const sessionProps = emptyMobileWelcome
    ? {
        ...
        renderWelcomeHeader: () => (_jsx("div", { "data-e2e-mobile-welcome-header": true, children: "Welcome header" })),
        ...(includeWelcomeFooter
            ? {
                renderWelcomeFooter: () => (_jsx("div", { "data-e2e-mobile-welcome-footer": true, children: "Welcome footer" })),
            }
            : {}),
        ...(includeCustomFooter
            ? {
                renderFooter: () => _jsx("div", { "data-e2e-custom-footer": true, children: "Custom footer" }),
                bottomStatusItems: [
    ...
    : { sessionId };
ReactDOM.createRoot(document.getElementById('root')).render(_jsx(React.StrictMode, { children: _jsx(WebShellWithProviders, { baseUrl: window.location.origin, sidebar: false, composerInput: { tags, tagPlacement: 'top' }, composerInputVersion: 1, renderComposerTagTooltip: ({ tag }) => `Details for ${tag.value}`, ...sessionProps }) }));
