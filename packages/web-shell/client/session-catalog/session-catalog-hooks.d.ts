...
export declare function useSessionCatalogQuery(
  client: DaemonClient,
  query: SessionCatalogQuery | undefined,
  options?: SessionCatalogHookOptions,
): any;
export declare function useSessionCatalogQueries(
  client: DaemonClient,
  queries: readonly SessionCatalogQuery[],
  options?: SessionCatalogHookOptions,
): readonly SessionCatalogSnapshot[];
export declare function useSessionCatalogPolling(
  client: DaemonClient,
  query: SessionCatalogQuery | undefined,
...
export declare function useWebShellSessions(
  options?: WebShellSessionsOptions,
): {
  data: any;
  sessions: any;
  loading: any;
