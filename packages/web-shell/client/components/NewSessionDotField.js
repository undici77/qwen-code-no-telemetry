...
export function NewSessionDotField() {
        ...
        const draw = () => {
            ...
            if (settled) {
                for (const dot of dots) {
                    if (Math.abs(dot.x - dot.anchorX) > 0.01 ||
    ...
    return (_jsx("div", { ref: rootRef, className: styles.root, "data-web-shell-new-session-dot-field": true, "aria-hidden": "true", children: _jsx("canvas", { ref: canvasRef }) }));
}
//# sourceMappingURL=NewSessionDotField.js.map