...
export function GitBranchChipContent({
  ...
  return _jsxs(_Fragment, {
    children: [
      _jsxs('span', {
        className: styles.gitBranchIconWrap,
        children: [
          _jsx('span', {
            className: styles.gitBranchIcon,
            children: worktree
      ...
      _jsx('span', { className: styles.gitBranchText, children: branch }),
      !compact &&
        _jsxs('span', {
          className: styles.gitBranchIndicators,
          'aria-hidden': 'true',
          children: [
            s.operation &&
              _jsx('span', {
                className: styles.gitBranchOperation,
                children: t(`git.operation.${s.operation}`),
              }),
            s.conflicted > 0 &&
              _jsxs('span', {
                className: styles.gitBranchConflicted,
                children: [_jsx(TriangleAlertIcon, {}), s.conflicted],
              }),
            s.dirty && _jsx('span', { className: styles.gitBranchDirtyDot }),
            s.ahead > 0 &&
              _jsxs('span', {
                className: styles.gitBranchAheadBehind,
                children: ['\u2191', s.ahead],
              }),
            s.behind > 0 &&
              _jsxs('span', {
            ...
            s.stashCount > 0 &&
              _jsxs('span', {
                className: styles.gitBranchStash,
...
export function GitBranchIndicator({
  ...
  const chipInner = _jsx(GitBranchChipContent, {
    branch: branch,
    status: status,
    compact: compact,
    worktree: worktree,
    ...
    children: _jsxs(Tooltip, {
      children: [
        ...
        _jsx(TooltipContent, {
          side: 'top',
          children: _jsxs('div', {
            className: styles.gitBranchTooltip,
            children: [
              _jsx('div', {
                className: styles.gitBranchTooltipTitle,
                children: s.detached
                  ? `${t('git.detached')} (${branch})`
                  : branch,
              }),
              phrases.length > 0
                ? phrases.map((phrase) =>
