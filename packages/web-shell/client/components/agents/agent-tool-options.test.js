...
import { canAddSelection, selectBuiltInTools, selectDiscoverableMcpServerNames, } from './agent-tool-options';
...
describe('selectBuiltInTools', () => {
    it('excludes disabled and MCP tools from a mixed workspace response', () => {
        ...
        expect(selectBuiltInTools(tools, {
            code: [
                {
                    name: 'legacy_mcp_name',
...
describe('selectDiscoverableMcpServerNames', () => {
    it('loads tools only from connected, enabled servers', () => {
        expect(selectDiscoverableMcpServerNames([
            {
                name: 'connected',
                disabled: false,
                status: 'ok',
...
//# sourceMappingURL=agent-tool-options.test.js.map