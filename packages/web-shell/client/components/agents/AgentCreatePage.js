      ...
      _jsxs('div', {
        ...
        children: [
          _jsx('h1', {
            ...
            children: agent ? t('agent.edit') : t('agent.create'),
          }),
          _jsxs(Button, {
            type: 'button',
            variant: 'outline',
            ...
            children: [
              _jsx(SparklesIcon, { 'data-icon': 'inline-start' }),
      ...
      _jsxs(Tabs, {
        ...
        children: [
                      ...
                      children: [
                        ...
                        _jsxs(SelectContent, {
                          children: [
                            _jsx(SelectItem, {
                              value: 'workspace',
                              children: t('agent.create.project.cli'),
                            }),
                            _jsx(SelectItem, {
                              value: 'global',
                              children: t('agent.create.user.cli'),
                            }),
                          ],
                        }),
                      ],
                ...
                _jsxs(Field, {
                  children: [
                    ...
                    _jsx(FieldDescription, {
                      children: t('agent.create.nameHelp'),
                    }),
                  ],
                }),
                _jsxs(Field, {
                  ...
                  children: [
                    _jsx(FieldLabel, {
                      ...
                      children: t('agent.create.description'),
                    }),
                    _jsx(Textarea, {
                ...
                _jsxs(Field, {
                  children: [
                    _jsx(FieldLabel, {
                      ...
                      children: t('agent.create.approvalMode'),
                    }),
                    _jsxs(Select, {
                      value: approvalMode,
                      ...
                      children: [
                        _jsx(SelectTrigger, {
                          ...
                          className: 'w-full',
                          children: _jsx(SelectValue, {
                            children: approvalModeLabel(approvalMode, t),
                          }),
                        }),
                        _jsx(SelectContent, {
                          children: selectableApprovalModes.map((value) =>
                            _jsx(
                              SelectItem,
                              {
                                value: value,
                                disabled: value === 'bubble',
                                children: approvalModeLabel(value, t),
                              },
                              value,
                            ),
                          ),
                    ...
                    _jsx(FieldDescription, {
                      children: approvalModeDescription(approvalMode, t),
                    }),
                  ],
                }),
                _jsxs(Field, {
                  children: [
                    _jsx(FieldLabel, {
                      ...
                      children: t('agent.create.maxTurns'),
                    }),
                    _jsx(Input, {
                      id: 'agent-max-turns',
                      type: 'number',
                    ...
                    _jsx(FieldDescription, {
                      children: t('agent.create.maxTurnsHelp'),
                    }),
                  ],
                }),
                _jsxs(Field, {
          ...
          _jsx(TabsContent, {
            ...
            children: _jsxs(Field, {
              children: [
                ...
                _jsx(FieldDescription, {
                  children: t('agent.create.promptHelp'),
                }),
              ],
            }),
          }),
          _jsx(TabsContent, {
            ...
            children: _jsxs(FieldGroup, {
              children: [
                _jsxs(Field, {
                  children: [
                    _jsx(FieldLabel, { children: t('agent.create.tools') }),
                    _jsx(FieldDescription, {
                      children: t('agent.create.toolsSelectHelp'),
                    }),
                    _jsx(ToolPicker, {
                    ...
                    catalogLoading || mcpToolsLoading
                      ? _jsx(LoadingRow, {
                          label: t('agent.create.tools.initializing'),
                        })
                      : null,
                    catalogError || mcpToolsError
                      ? _jsx('div', {
                          ...
                          children: catalogError || mcpToolsError,
                        })
                      : null,
                  ],
                }),
                _jsxs(Field, {
                  children: [
                    _jsx(FieldLabel, {
                      children: t('agent.create.disallowedTools'),
                    }),
                    _jsx(ToolPicker, {
          ...
          _jsx(TabsContent, {
            ...
            children: _jsxs(Field, {
              children: [
                _jsx(FieldLabel, { children: t('agent.create.mcpServers') }),
                _jsx(McpServerPicker, {
                ...
                settingsResource.loading
                  ? _jsx(LoadingRow, { label: t('common.loading') })
                  : settingsResource.error
                    ? _jsx(ErrorRow, { error: settingsResource.error })
                    : null,
              ],
            }),
          }),
          _jsx(TabsContent, {
            ...
            children: _jsxs(Field, {
              children: [
                _jsx(FieldLabel, { htmlFor: 'agent-hooks', children: 'Hooks' }),
                _jsx(Textarea, {
                  id: 'agent-hooks',
                  value: hooks,
                  ...
                  rows: 10,
                  className:
                    'min-h-64 max-h-[60vh] overflow-y-auto font-mono text-xs',
                }),
                _jsx(FieldDescription, {
                  children: t('agent.create.jsonObjectHelp'),
                }),
              ],
            }),
          }),
      ...
      _jsxs('div', {
        ...
        children: [
          ...
          _jsxs(Button, {
            ...
            children: [
              busy ? _jsx(Spinner, { 'data-icon': 'inline-start' }) : null,
        ...
        children: _jsxs(DialogContent, {
          ...
          children: [
            _jsxs(DialogHeader, {
              children: [
                _jsx(DialogTitle, {
                  children: t('agent.create.modelGenerate'),
                }),
                _jsx(DialogDescription, {
                  children: t('agent.create.modelGenerate.description'),
                }),
              ],
            }),
            generationError
            ...
            _jsxs(FieldGroup, {
              children: [
                _jsxs(Field, {
                  children: [
                    _jsx(FieldLabel, {
                      htmlFor: 'agent-generation-requirements',
                      children: t('agent.create.describeAgent'),
                    }),
                    _jsx(Textarea, {
                    ...
                    _jsx(FieldDescription, {
                      children: t('agent.create.qwenHint'),
                    }),
                  ],
                }),
                _jsxs(Field, {
                  children: [
                    _jsx(GenerationFieldLabel, {
            ...
            _jsxs(DialogFooter, {
              children: [
                ...
                _jsx(Button, {
                  ...
                  children: t('agent.create.useGenerated'),
                }),
              ],
            }),
          ],
...
function GenerationFieldLabel({
  ...
  return _jsxs('div', {
    ...
    children: [
      _jsx(FieldLabel, { htmlFor: htmlFor, children: label }),
      active
        ? _jsxs(_Fragment, {
            children: [
              _jsxs('span', {
            ...
            children: [
              ...
              _jsxs(SelectContent, {
                children: [
                  _jsx(SelectItem, {
                    value: 'builtin',
                    children: t('agent.create.tools.builtin'),
                  }),
                  _jsx(SelectItem, {
                    value: 'mcp',
                    children: t('agent.create.tools.mcp'),
                  }),
                ],
              }),
            ],
            ...
            ? _jsxs(Select, {
                ...
                children: [
                  _jsx(SelectTrigger, {
                    ...
                    children: _jsx(SelectValue, {
                      placeholder: t('agent.create.tools.selectServer'),
                    }),
                  }),
                  _jsx(SelectContent, {
                    children: availableMcpServers.map((server) =>
                      _jsxs(
                        SelectItem,
                        {
                          value: server.name,
        ...
        children:
          availableTools.length > 0
                  ...
                  children: availableTools.map((tool) => {
                    const displayName =
                      kind === 'builtin'
                        ...
                        : tool.serverToolName || tool.name;
                    return _jsxs(
                      'label',
                      {
                        className:
                          'flex cursor-pointer items-start gap-3 px-3 py-2.5 hover:bg-accent/30',
                        children: [
                          _jsx(Checkbox, {
            ...
            : _jsx('div', {
                ...
                children: t('agent.create.tools.empty'),
              }),
      }),
      selection.size > 0
        ? _jsx('div', {
            className: 'flex flex-wrap gap-2',
            children: [...selection].map((name) =>
              _jsxs(
                'span',
                {
                  className:
                    'inline-flex max-w-full items-center gap-1 rounded-md bg-muted px-2 py-1 text-sm',
                  title: name,
                  children: [
                    _jsx('span', {
                      className: 'truncate',
                      children: selectedLabels.get(name) || name,
                    }),
                    _jsx('button', {
                      type: 'button',
                      className:
                      ...
                      onClick: () =>
                        onSelectionChange(
                          toggleSelection(selection, name, false),
                        ),
        ...
        : _jsx('div', {
            ...
            children: t('agent.create.tools.noneSelected'),
          }),
    ],
  });
}
    ...
    children:
      servers.length > 0
        ? _jsx('div', {
            ...
            children: servers.map((server) =>
              _jsxs(
                ...
                {
                  className:
                    'flex cursor-pointer items-center gap-3 px-3 py-2.5 hover:bg-accent/30',
                  children: [
                    _jsx(Checkbox, {
                      ...
                      ? _jsx(Badge, {
                          ...
                          className:
                            server.mcpStatus === 'connected'
                              ...
                              : undefined,
                          children: t(`mcp.status.${server.mcpStatus}`),
                        })
                      : null,
                  ],
                },
        ...
        : _jsx('div', {
            ...
            children: t('agent.create.mcpServers.empty'),
          }),
  });
}
