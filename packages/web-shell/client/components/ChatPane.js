...
const PANE_TOOLBAR_ACTIONS = ['approvalMode', 'model', 'voice'];
const EMPTY_VOICE_WORKSPACE_REVISIONS = {};
function OptionalMonitorDetailsProvider({ enabled, onOpen, children }) {
  return enabled
    ? _jsx(MonitorDetailsProvider, { onOpen: onOpen, children: children })
    : children;
}
/**
...
export function ChatPane({
  ...
  const catalogStreamingSessionIdRef = useRef(
    streamingState !== 'idle' ? connection.sessionId : undefined,
  );
  const catalogStreamingWorkspaceCwdRef = useRef(
  ...
  const handleSubmit = useCallback(
    (text, images, commitAccepted, metadata) => {
    ...
    children: [
          ...
          children: [
            workspaceLabel &&
              _jsxs('span', {
                ...
                'aria-label': t('workspace.paneLabel', {
                  name: workspaceLabel,
                }),
                'data-web-shell-pane-workspace': true,
                children: [
                  _jsx('span', {
                    className: styles.workspaceTagDot,
                    'aria-hidden': 'true',
                  }),
                  _jsx('span', {
                    className: styles.workspaceTagText,
      ...
      connection.error &&
        _jsx('div', {
          ...
          role: 'alert',
          children: _jsxs('span', {
            className: styles.connectionErrorText,
            children: [
              t('splitView.paneConnectionError'),
              ': ',
              connection.error,
            ],
          }),
      ...
      _jsx('div', {
        ...
        children: _jsx(OptionalMonitorDetailsProvider, {
          enabled: monitorDetailsSupported,
          onOpen: openMonitorDetails,
          children: _jsx(SubagentDetailsProvider, {
            ...
            children: _jsx(MessageList, {
              ...
              onReloadTranscript: transcriptReloadSupported
                ? reloadTranscript
                : undefined,
              isResponding: isResponding,
              workspaceCwd: connection.workspaceCwd || '',
              hideSessionTimeline: true,
              turnFileChanges: visibleTurnOutputKinds.has('file')
                ? fileChangesByTurn
                : undefined,
              turnArtifacts: visibleTurnOutputKinds.has('artifact')
                ? artifactsByTurn
                : undefined,
              turnScheduledTasks: visibleTurnOutputKinds.has('scheduled_task')
                ? scheduledTasksByTurn
                : undefined,
              onTurnOutputOpen: handleRightPanelOpen,
              onImagePreview: handleImagePreview,
              onError: reportError,
              generateContent: connection.capabilities?.features.includes(
                'session_generation',
              )
        ...
        children: [
          ...
          unknownPromptAdmission &&
            _jsxs('div', {
              ...
              children: [
                _jsx('span', { children: t('queue.admissionUnknown') }),
                unknownPromptAdmission.payloadAvailable &&
                  _jsxs('span', {
                    className: styles.admissionUnknownActions,
                    children: [
                      _jsx('button', {
                        type: 'button',
                        onClick: continueEditingUnknownPrompt,
                        children: t('queue.continueEditing'),
                      }),
                      _jsx('button', {
                        type: 'button',
                        onClick: discardUnknownPromptPayload,
                        children: t('queue.discardUnknown'),
                      }),
                    ],
                  }),
              ],
