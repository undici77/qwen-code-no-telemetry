...
import { filterToolbarDropdownItems, getToolbarExpansionBudget, getToolbarItemVisibility, getToolbarItemVisibilityWithHysteresis, resolveToolbarModelLabel, } from './toolbarDropdown';
describe('toolbarDropdown', () => {
    ...
    it('keeps pending items collapsed without consuming width', () => {
        ...
        expect(getToolbarItemVisibility({
            availableWidth: 64,
            items: [
                { id: 'mode', expansionWidth: 64 },
                {
    ...
    it('reserves toolbar render-prop widths before expanding built-in items', () => {
        ...
        expect(getToolbarExpansionBudget({
            ...base,
