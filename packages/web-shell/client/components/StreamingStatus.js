...
export function StreamingStatus({ startedAt, showPhrase = true }) {
  ...
  return _jsxs('div', {
    ...
    children: [
      _jsx('span', { className: styles.spinner, children: spinnerChar }),
      showPhrase &&
        loadingPhrase &&
        _jsx('span', { className: styles.label, children: loadingPhrase }),
      _jsxs('span', {
        className: styles.meta,
        children: ['(', timeStr, tokenStr, ' \u00B7 ', t('stream.cancel'), ')'],
      }),
    ],
  });
}
