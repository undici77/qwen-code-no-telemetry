...
function taskStatusIcon(status) {
  if (status === 'completed') return _jsx(CircleCheckIcon, {});
  if (status === 'running') {
    return _jsx(LoaderCircleIcon, { className: styles.statusRunning });
  }
  if (status === 'failed') return _jsx(CircleXIcon, {});
  if (status === 'cancelled') return _jsx(CircleStopIcon, {});
  return null;
}
...
export function EnvironmentPanel({
  ...
  const agents = agentTasks ?? tasks.filter((task) => task.kind === 'agent');
  ...
  return _jsxs('aside', {
    ...
    children: [
        ...
        _jsxs('section', {
          ...
          children: [
            _jsxs('button', {
              ...
              children: [
                _jsx('span', { children: t('environment.title') }),
                !environmentExpanded && _jsx(ChevronRightIcon, {}),
              ],
            }),
            environmentExpanded &&
              _jsxs('div', {
                ...
                children: [
                  _jsxs('button', {
                    ...
                    children: [
                      _jsx(FileDiffIcon, {}),
                      _jsx('span', { children: t('environment.changes') }),
                      _jsx('span', {
                  ...
                  _jsxs('div', {
                    ...
                    children: [
                      ...
                      _jsx('span', { children: t('environment.workspace') }),
                      _jsx('span', {
                        className: styles.value,
                        children:
        ...
        _jsxs('section', {
          ...
          children: [
            _jsxs('button', {
              ...
              children: [
                _jsx('span', { children: t('environment.agents') }),
                !agentsExpanded && _jsx(ChevronRightIcon, {}),
              ],
            }),
            agentsExpanded &&
              _jsx('ul', {
                className: styles.tasks,
                children: agents.map((task, index) =>
                  _jsx(
                    'li',
                    {
                      children: _jsxs('button', {
                            ...
                            children: [
                              !isForkAgent(task) &&
                                _jsx('span', {
                                  ...
                                  style: {
                                    backgroundColor: agentColorValue(
                                      task.color,
                                    ),
                                  },
                                  'aria-hidden': 'true',
      ...
      items.includes('backgroundTasks') &&
        ...
        _jsxs('section', {
          ...
          children: [
            _jsxs('button', {
              ...
              children: [
                _jsx('span', { children: t('tasks.title') }),
                !tasksExpanded && _jsx(ChevronRightIcon, {}),
              ],
            }),
            tasksExpanded &&
              _jsx('ul', {
                className: styles.tasks,
                children: backgroundTasks.map((task) =>
                  _jsx(
                    'li',
                    {
                      children: _jsxs('button', {
