        ...
        children: [
            ...
            ? _jsxs('button', {
                ...
                children: [
                  _jsx('span', {
                    ...
                    style: { '--todo-progress': String(progress) },
                    'aria-hidden': 'true',
                  }),
                  _jsxs('span', {
          ...
          statusItems.map((item, index) =>
            _jsxs(
              'span',
              {
                className: styles.statusSegmentWrap,
                children: [
                  (total > 0 || index > 0) &&
                    _jsx('span', {
                  ...
                  _jsx('span', {
                    ...
                    children:
                      todo.status === 'in_progress'
                        ? _jsx('span', { className: styles.loadingIcon })
