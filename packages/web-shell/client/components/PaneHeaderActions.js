...
export function PaneHeaderActions({ children, trailing }) {
  ...
  useLayoutEffect(() => {
    ...
    const update = () => {
      ...
      const workspaceTag = header.querySelector(
    ...
    children: [
      hasHostActions &&
        _jsx('div', {
          ...
          children: actionElements.map((element, index) =>
            _jsx(
              'span',
              {
              ...
              element.key ?? `pane-header-action-${index}`,
            ),
          ),
        }),
      hasHostActions &&
        ...
        _jsxs(DropdownMenu, {
          children: [
            ...
            _jsx(DropdownMenuContent, {
              ...
              children: _jsx('div', {
                className: styles.headerOverflowPanel,
                children: actionElements.map((element, index) => {
                  ...
                  return _jsx(
                    ...
                    element.key ?? `pane-header-menu-${index}`,
                  );
                }),
              }),
            }),
