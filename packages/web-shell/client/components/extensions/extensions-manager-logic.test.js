...
function extension(name, displayName, description) {
    return {
        kind: 'extension',
        id: name,
        name,
...
describe('extensions manager logic', () => {
    ...
    it('keeps a selected extension only while it remains installed', () => {
        expect(preserveSelectedExtensionName('gsd-core', extensions)).toBe('gsd-core');
...
//# sourceMappingURL=extensions-manager-logic.test.js.map