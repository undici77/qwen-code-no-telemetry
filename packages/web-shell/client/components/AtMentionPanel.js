...
export function AtMentionPanel({
  ...
  return createPortal(
    _jsx('div', {
      className: styles.atPortalLayer,
      style: themeVars,
      children: _jsxs('div', {
        ref: panelRef,
        ...
        children: [
          menu.level === 'items' &&
            _jsxs('div', {
              className: styles.atPanelHeaderWrap,
              children: [
                _jsxs('div', {
                  className: styles.atPanelHeader,
                  children: [
                    _jsx('button', {
                      type: 'button',
                ...
                _jsx('input', {
                  ...
                  onKeyDown: (event) => {
                    ...
                    if (event.key === 'Escape') {
                      ...
                      if (rows.length === 0) return;
                      onSelect(
                        Math.min(rows.length - 1, menu.selectedIndex + 1),
                      );
                    }
                  },
                }),
                        ...
                        children: menu.tabs.map((tab) => {
                          ...
                          return _jsx(
                            'button',
                            {
                              ...
                              className: `${styles.atTab} ${selected ? styles.atTabActive : ''}`,
                              title: tabText,
                              onClick: (event) => {
                                event.preventDefault();
                                event.stopPropagation();
                  ...
                  : rows.map((row, index) => {
                      ...
                      return _jsxs(
                        'button',
                        {
                          ...
                          role: 'option',
                          'aria-selected': selected,
                          className: `${styles.atItem} ${selected ? styles.atItemActive : ''} ${row.description ? '' : styles.atItemSingleLine}`,
                          style: {
                          ...
                          children: [
                            customItem ??
                              _jsxs(_Fragment, {
                                children: [
                                  _jsxs('span', {
                                    className: styles.atItemMain,
                                    children: [
                                      _jsxs('span', {
                                        className: styles.atItemLeading,
                                        children: [
                                          'item' in row &&
                                          row.item.kind === 'upload'
                                            ? _jsx(UploadIcon, {
                                                className:
                                                  styles.atItemUploadIcon,
                                                'aria-hidden': 'true',
                                              })
                                            : 'icon' in row &&
                                              safeIcon &&
                                              (row.iconMode === 'image'
                                                ...
                                                : _jsx('span', {
                                                    className: `${styles.atItemIcon} ${row.iconSpin ? styles.atItemIconSpin : ''}`,
                                                    style: {
                                                      ...cssUrlVar(
                                                        '--at-item-icon-url',
                                                        safeIcon,
                            ...
                            row.trailing &&
                              _jsx('span', {
                                className: styles.atItemTrailing,
                                'aria-hidden': 'true',
