 ...
 */
import type { DaemonSessionGroupPresetColor, DaemonSessionSummary, DaemonStatusReportSession } from '@qwen-code/sdk/daemon';
 ...
 */
export declare function deriveSessionCards(sessions: DaemonSessionSummary[], statusSessions: DaemonStatusReportSession[], currentSessionId: string | undefined, primaryCwd?: string): SessionCard[];
/**
 ...
 */
export declare function SessionOverviewPanel({ onOpenSession, onOpenSplit, includeOtherWorkspaces, workspaceCwd, }: {
