...
vi.mock('./SpecularComposerEffect', () => ({
  SpecularComposerEffect: () =>
    _jsx('span', {
      'data-web-shell-composer-specular': true,
      'aria-hidden': 'true',
    }),
}));
const mounted = [];
...
describe('ChatEditor Session Workflow mode rename', () => {
  it('renames only the plan entry in the mode dropdown while enabled', () => {
    ...
    act(() => {
      container.querySelector('[data-web-shell-mode-button]')?.click();
    });
...
describe('ChatEditor toolbar popovers', () => {
      ...
      renderChatEditor({
        ...
        customization: {
          renderComposerToolbarStart: () =>
            _jsx('span', {
              'data-test-toolbar-start': true,
              children: 'start',
            }),
          renderComposerToolbarEnd: () =>
            _jsx('span', { 'data-test-toolbar-end': true, children: 'end' }),
          renderComposerToolbarRight: () =>
            _jsx('span', {
              'data-test-toolbar-right': true,
              children: 'right',
            }),
        },
      });
  ...
  it('opens a searchable model popover and selects the filtered model', () => {
    ...
    act(() => {
      container.querySelector('[data-web-shell-model-button]')?.click();
    });
    ...
    const options = Array.from(
      document.querySelectorAll('[data-web-shell-toolbar-popover] button'),
    );
