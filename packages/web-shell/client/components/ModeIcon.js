...
export function ModeIcon({ mode }) {
    ...
    if (iconUrl) {
        return (_jsx("span", { className: styles.icon, style: cssUrlVar('--mode-icon-url', iconUrl), "aria-hidden": "true" }));
    }
    return (_jsx("svg", { viewBox: "0 0 24 24", "aria-hidden": "true", children: _jsx("path", { d: "M6 18c.7-2.7 2.2-4 4.5-4H12M7 6h10M7 10h7M17.5 14.5l2 2-2 2", fill: "none", stroke: "currentColor", strokeWidth: "1.8", strokeLinecap: "round", strokeLinejoin: "round" }) }));
}
