 ...
 */
export function MessageTimestamp({ timestamp, children, chatMode = false, toolGroupSpacing = false, copyText, copyTitle = 'Copy', }) {
    ...
    const copyButton = copyText ? (_jsx("button", { type: "button", className: styles.copyButton, title: copyTitle, "aria-label": copyTitle, onClick: handleCopy, children: copied ? _jsx(CheckIcon, {}) : _jsx(CopyIcon, {}) })) : null;
    ...
    if (timestamp === undefined) {
        return (_jsxs("div", { className: rowClassName, children: [children, copyButton] }));
    }
    return (_jsxs("div", { className: rowClassName, children: [children, chatMode ? (_jsxs("span", { className: styles.chatActions, children: [_jsx("span", { className: styles.chatTip, "aria-hidden": "true", children: formatTimestamp(timestamp) }), copyButton] })) : (_jsx("span", { className: styles.tip, "aria-hidden": "true", children: formatTimestamp(timestamp) }))] }));
}
function CopyIcon() {
