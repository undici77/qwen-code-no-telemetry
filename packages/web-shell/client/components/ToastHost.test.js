...
const mounted = [];
function renderToastHost(props, portalRoot = null) {
    const container = document.createElement('div');
    document.body.appendChild(container);
    const containers = [container];
    if (portalRoot)
        containers.push(portalRoot);
    ...
    act(() => {
        root.render(_jsx(I18nProvider, { language: "en", children: _jsx(WebShellPortalRootContext.Provider, { value: portalRoot, children: _jsx(ToastHost, { toasts: toasts, onDismiss: () => { }, elevated: props.elevated }) }) }));
    });
    return container;
}
afterEach(() => {
...
describe('ToastHost elevation', () => {
    ...
    it('keeps the auto-dismiss countdown across an elevation remount', () => {
        ...
        const render = (elevated) => act(() => {
            root.render(_jsx(I18nProvider, { language: "en", children: _jsx(WebShellPortalRootContext.Provider, { value: portalRoot, children: _jsx(ToastHost, { toasts: [toast], onDismiss: onDismiss, elevated: elevated }) }) }));
        });
        try {
            render(false);
            act(() => {
...
//# sourceMappingURL=ToastHost.test.js.map