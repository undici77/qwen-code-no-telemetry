 ...
 */
export declare const COLLAPSED_SESSION_SECTIONS_STORAGE_KEY =
  'qwen-code-web-shell-collapsed-session-groups';
export declare function isPrimaryCollapsedSectionId(id: string): boolean;
export declare function workspaceGroupSectionId(
  workspaceId: string,
  groupId: string,
): string;
export declare function workspaceUngroupedSectionId(
  workspaceId: string,
): string;
export declare function isWorkspaceCollapsedSectionId(
  workspaceId: string,
  id: string,
): boolean;
export declare function readCollapsedSessionSectionIds(): Set<string>;
export declare function writeCollapsedSessionSectionIds(
 ...
 */
export declare function replaceOwnedCollapsedSessionSectionIds(
  ownedIds: ReadonlySet<string>,
  isOwned: (id: string) => boolean,
): void;
export declare function readWorkspaceCollapsedGroupIds(
  workspaceId: string,
): Set<string>;
export declare function writeWorkspaceCollapsedGroupIds(
  workspaceId: string,
