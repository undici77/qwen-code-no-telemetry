...
const DEFAULT_SESSION_ACTION_ITEMS = [
  'details',
  'rename',
  'group',
  'export',
...
export function WebShellSidebar({
  ...
  const [exportingSessionIds, setExportingSessionIds] = useState(
    () => new Set(),
  );
  ...
  const [lastValidCustomGroupColor, setLastValidCustomGroupColor] = useState(
  ...
  const secondaryPinnedQueries = useMemo(
    () =>
  ...
  const secondaryArchivedQueries = useMemo(
    () =>
      secondaryWorkspaceCwds.map((workspaceCwd) => ({
        routeKind: 'qualified',
        workspaceCwd,
  ...
  const getSessionWorkspaceCwd = useCallback(
    (session) => resolveSessionWorkspaceScope(session).cwd,
    [resolveSessionWorkspaceScope],
  );
  const isMutableSessionScope = useCallback(
    (scope) => scope.kind === 'primary' || scope.kind === 'locked',
    [],
  );
  ...
  const isActiveSessionReadOnly = useCallback(
    (session) => !isMutableSessionScope(resolveSessionWorkspaceScope(session)),
  ...
  const isCurrentSession = useCallback(
    (session) => currentSessionIdentity === getIdentityForSession(session),
  ...
  const canDeleteSession = useCallback(
    (session) => !isCurrentSession(session) && canShowDeleteSession(session),
  ...
  useEffect(() => {
    ...
    const handlePointerDown = (event) => {
      if (groupMenuRef.current?.contains(event.target)) return;
      setGroupMenu(null);
    };
  ...
  useEffect(() => {
    ...
    const animationFrame = window.requestAnimationFrame(() => {
      const items = Array.from(
        groupMenuRef.current?.querySelectorAll('button:not(:disabled)') ?? [],
      );
      const selected =
  ...
  const setSessionExporting = useCallback(
    (sessionId, exporting, workspaceCwd) => {
      const identity = getSessionIdentity(
        sessionId,
        workspaceCwd || primaryWorkspaceCwd,
      );
  ...
  const groupColorChoices = colorOptions.length > 0 ? colorOptions : ['blue'];
                        ...
                        children: [
                          _jsx(DropdownMenuTrigger, {
                            ...
                            children: _jsx('button', {
                              ...
                              children: _jsx(EllipsisVerticalIcon, {}),
                            }),
                          }),
                          ...
                          children: [
                            attentionLabel &&
                              _jsx('span', {
                                className: cx(
                                  ...
                                  needsUserInput &&
                                    styles.sessionAttentionUserInput,
                                ),
                            ...
                            readOnly &&
                              ...
                              _jsx('div', {
                                ...
                                onClick: (event) => event.stopPropagation(),
                                onKeyDown: (event) => event.stopPropagation(),
                                children: inlineActionItems.has('archive')
                                  ? _jsx('button', {
                                      className: styles.sessionActionButton,
                                      type: 'button',
                                  ...
                                  : _jsxs(DropdownMenu, {
                                      children: [
                                        ...
                                        _jsx(DropdownMenuContent, {
                                          ...
                                          onCloseAutoFocus: (event) => {
                                            if (
                                              !sessionMenuPointerDismissRef.current
                                            )
                                              return;
                                            sessionMenuPointerDismissRef.current = false;
                                            event.preventDefault();
                                          ...
                                          children: _jsx(DropdownMenuGroup, {
                                            children: _jsxs(DropdownMenuItem, {
                                              ...
                                              title: isCurrent
                                                ? t(
                                                    'sidebar.archiveCurrentDisabled',
                                                  )
                                                : undefined,
                                              onSelect: () =>
  ...
  const body = useMemo(() => {
    ...
    if (loading && sessionsPage === undefined) {
      return _jsx('div', {
        ...
        children: t('sidebar.loadingSessions'),
      });
    }
    ...
    if (
      ...
      return _jsx('div', {
        className: styles.notice,
        children: t('sidebar.searchEmpty'),
      });
    }
  ...
  const archivedSection = useMemo(() => {
    ...
    const header = _jsxs('button', {
      ...
      children: [
        _jsx('span', {
          ...
          style: { flex: '0 1 auto' },
          children: t('sidebar.archivedTitle'),
        }),
        _jsx('span', {
          className: styles.archivedChevron,
          'aria-hidden': 'true',
          children: archivedExpanded
        ...
        archivedExpanded &&
          ...
          _jsx('span', {
            className: styles.archivedCount,
    ...
    if (effectiveArchivedLoading && allArchivedSessions.length === 0) {
      ...
      content = _jsx('div', {
        className: styles.notice,
        children: t('sidebar.archivedEmpty'),
      });
    } else {
    ...
    return _jsxs('div', {
      ...
      children: [
        header,
        _jsx('div', { className: styles.archivedList, children: content }),
      ],
    });
  }, [
    archivedExpanded,
          ...
          _jsxs('div', {
            ...
            children: [
              _jsxs('button', {
                ...
                children: [
                  _jsx('span', { className: styles.groupMenuEmptyDot }),
                  _jsx('span', {
                    className: styles.groupMenuName,
                    children: t('sidebar.groupUngrouped'),
                  }),
                  groupMenuUngroupedSelected &&
                    _jsx('span', {
                      className: styles.groupMenuCheck,
                      children: '\u2713',
                    }),
                ],
              }),
                ...
                return _jsxs(
                  'button',
                  {
                    ...
                    children: [
                      ...
                      _jsx('span', {
                        className: styles.groupMenuName,
                        children: t(`sidebar.groupColor.${color}`),
                      }),
                      selected &&
                        _jsx('span', {
                          className: styles.groupMenuCheck,
              ...
              _jsx('div', { className: styles.groupMenuSeparator }),
              _jsxs('button', {
                ...
                children: [
                  _jsx('span', {
                    className: styles.groupMenuIcon,
                    children: _jsx(IconNewChat, {}),
                  }),
                  _jsx('span', {
                    className: styles.groupMenuName,
                    children: t('sidebar.groupCreate'),
                  }),
                ],
              }),
            ],
            ...
            children: _jsxs('div', {
              ...
              children: [
                _jsx('p', {
                  ...
                  children: t('sidebar.deleteConfirmDescription', {
          ...
          _jsx(DialogShell, {
            ...
            children: _jsxs('div', {
              ...
              children: [
                _jsx('p', {
                  className: styles.confirmDescription,
                  children: workspaceRemovalActivity
                ...
                workspaceRemovalActivity &&
                  _jsxs('ul', {
                    className: styles.workspaceRemovalActivityList,
                    children: [
                      _jsx('li', {
                        children: t('sidebar.removeWorkspaceSessions', {
                          count: workspaceRemovalActivity.sessions,
                        }),
                      }),
                      _jsx('li', {
                        children: t('sidebar.removeWorkspacePrompts', {
                          count: workspaceRemovalActivity.activePrompts,
                        }),
                      }),
                      _jsx('li', {
                        children: t('sidebar.removeWorkspaceStarts', {
                          count: workspaceRemovalActivity.pendingSessionStarts,
                        }),
                      }),
                      _jsx('li', {
                        children: t('sidebar.removeWorkspaceConnections', {
                          count: workspaceRemovalActivity.acpConnections,
                        }),
                      }),
                      _jsx('li', {
                        children: t('sidebar.removeWorkspaceMemoryTasks', {
                          count: workspaceRemovalActivity.memoryTasks,
                        }),
                      }),
                      _jsx('li', {
                        children: t('sidebar.removeWorkspaceWorkers', {
                          count: workspaceRemovalActivity.channelWorkers,
                        }),
                      }),
                      _jsx('li', {
                        children: t('sidebar.removeWorkspaceVoiceSessions', {
                ...
                workspaceRemovalActivity &&
                  ...
                  _jsx('p', {
                    className: styles.confirmDescription,
                    children: t('sidebar.removeWorkspaceCurrentSession'),
                  }),
                workspaceRemovalRemoteInProgress &&
                  _jsx('p', {
                    className: styles.confirmDescription,
                    children: t('sidebar.removeWorkspaceInProgress'),
                  }),
                _jsxs('div', {
                  className: styles.confirmActions,
                  children: [
                ...
                _jsxs(FieldGroup, {
                  children: [
                    _jsxs(Field, {
                      children: [
                        _jsx(FieldLabel, {
                          htmlFor: 'session-group-name',
                          children: t('sidebar.groupNamePrompt'),
                        }),
                        _jsx(Input, {
                    ...
                    _jsxs(Field, {
                      children: [
                        _jsx(FieldLabel, {
                          htmlFor: 'session-group-color',
                          children: t('sidebar.groupColor'),
                        }),
                        _jsxs(Select, {
                          value: customGroupColor
                            ? CUSTOM_GROUP_COLOR_OPTION
                            : groupColor,
                          onValueChange: (value) => {
                            setGroupColor(
                            ...
                            _jsx(SelectContent, {
                              children: _jsxs(SelectGroup, {
                                children: [
                                  ...
                                  _jsx(SelectItem, {
                                    value: CUSTOM_GROUP_COLOR_OPTION,
                                    children: t('sidebar.groupColor.custom'),
                                  }),
                                ],
                              }),
                            }),
                    ...
                    customGroupColor &&
                      _jsxs(Field, {
                        children: [
                          _jsx(FieldLabel, {
                            htmlFor: 'session-group-hex-color',
                            children: t('sidebar.groupColor.hex'),
                          }),
                          _jsxs('div', {
                            className: styles.groupCustomColorRow,
                            children: [
                              _jsx(Input, {
                          ...
                          normalizedGroupColor === undefined &&
                            _jsx('span', {
                              className: styles.groupColorError,
                              role: 'alert',
                              children: t('sidebar.groupColor.invalid'),
                            }),
                        ],
                      }),
                  ],
          ...
          _jsx(DialogShell, {
            ...
            children: _jsxs('div', {
              ...
              children: [
                _jsx('p', {
                  className: styles.confirmDescription,
                  children: t('sidebar.groupDeleteConfirm', {
                ...
                _jsxs('div', {
                  ...
                  children: [
                    ...
                    _jsx('button', {
                      ...
                      children: t('sidebar.groupDelete'),
                    }),
                  ],
                }),
              ],
              ...
              _jsxs('button', {
                ...
                children: [
                  _jsx('span', {
                    ...
                    children: _jsx(SquarePenIcon, {
                      size: 16,
                      strokeWidth: 1.2,
                    }),
                  }),
                  !collapsed &&
                    _jsx('span', { children: t('sidebar.newTask') }),
                ],
              }),
            primaryNavItems.has('plugins') &&
              _jsxs('button', {
                ...
                children: [
                  _jsx('span', {
                    className: styles.navIcon,
                    children: _jsx(BlocksIcon, { size: 16, strokeWidth: 1.2 }),
                  }),
                  !collapsed &&
                    _jsx('span', { children: t('sidebar.plugins') }),
                ],
              }),
            primaryNavItems.has('channels') &&
              _jsxs('button', {
                ...
                children: [
                  ...
                  !collapsed &&
                    _jsx('span', { children: t('sidebar.channels') }),
                ],
              }),
            primaryNavItems.has('scheduledTasks') &&
              _jsxs('button', {
                ...
                children: [
                  _jsx('span', {
                    className: styles.navIcon,
                    children: _jsx(CalendarClockIcon, {
                      size: 16,
                      strokeWidth: 1.2,
                    }),
                  }),
                  !collapsed &&
                    _jsx('span', { children: t('sidebar.scheduledTasks') }),
                ],
              }),
            primaryNavItems.has('goals') &&
              _jsxs('button', {
                ...
                children: [
                  _jsx('span', {
                    className: styles.navIcon,
                    children: _jsx(TargetIcon, { size: 16, strokeWidth: 1.2 }),
                  }),
                  !collapsed && _jsx('span', { children: t('sidebar.goals') }),
                ],
              }),
            ...
            children: [
              !collapsed &&
                ...
                _jsx(Tabs, {
                  className: 'px-2 pb-2',
                  value: sessionSource,
                  onValueChange: (value) => setSessionSource(value),
                  ...
                  children: [
                    _jsx('div', {
                      ...
                      children: _jsxs('button', {
                        ...
                        children: [
                          _jsx('span', {
                            children: t('sidebar.pinnedSessions'),
                          }),
                          _jsx(IconChevron, { expanded: pinnedExpanded }),
                        ],
                      }),
                    }),
                    pinnedExpanded &&
                      _jsx('div', {
                        className: styles.pinnedSessionList,
                      ...
                      renderHeader: (expanded) =>
                        _jsxs(_Fragment, {
                          children: [
                            ...
                            _jsx('span', {
                              className: styles.liveWorkspaceLabel,
                              children: t('sidebar.live'),
                            }),
                            expanded
                              ? _jsx(ChevronDownIcon, {
                                  size: 15,
                ...
                _jsxs('div', {
                  ...
                  children: [
                    _jsxs('button', {
                      ...
                      children: [
                        _jsx('span', { children: t('sidebar.project') }),
                        _jsx(IconChevron, { expanded: projectsExpanded }),
                      ],
                    }),
                    _jsxs('div', {
                      className: styles.projectsHeaderActions,
                      children: [
                        _jsx('button', {
              ...
              searchOpen &&
                ...
                _jsxs('div', {
                  ...
                  children: [
                    _jsx(SearchIcon, { 'aria-hidden': 'true' }),
                    _jsx(Input, {
                      value: searchQuery,
                  ...
                  children:
                    ...
                    _jsx('div', {
                      ...
                      children: _jsx('div', {
                        ...
                        children: projectWorkspaces.map((ws) =>
                          _jsxs(
                            Fragment,
                            {
                              children: [
                                _jsx(WorkspaceSection, {
                                  workspace: ws,
                                  renderHeader:
                                    lockedWorkspaceCwd &&
                                  ...
                                  channelGroupingEnabled:
                                    channelGroupingEnabled,
                                  ungroupedLabel: t('sidebar.groupUngrouped'),
                                  onRenameGroup: canOrganizeWorkspace(ws.cwd)
                                    ? handleRenameGroup
                                    : undefined,
                                  onDeleteGroup: canOrganizeWorkspace(ws.cwd)
                                    ? handleDeleteGroup
                                    : undefined,
                                            ...
                                            children: [
                                              ...
                                              _jsx(DropdownMenuContent, {
                                                ...
                                                children: _jsxs(
                                                  ...
                                                  {
                                                    variant: 'destructive',
                                                    'aria-label': `${t('sidebar.removeWorkspace')}: ${ws.cwd}`,
                                                    onSelect: () =>
                                ...
                                (projectExpanded || searchQuery.trim())
                                  ? _jsx('div', {
                                      className: styles.workspaceSessionBody,
                                      children: body,
                                    })
                                  : null,
                              ],
                ...
                children: [
                  ...
                  footerItems.has('settings') &&
                    _jsxs('button', {
                      ...
                      children: [
                        _jsx('span', {
                          className: `${styles.navIcon} ${styles.settingsIcon}`,
                        ...
                        !collapsed &&
                          !footerCompact &&
                          _jsx('span', {
                            className: styles.footerButtonLabel,
                ...
                children: [
                  footerItems.has('theme') &&
                    _jsx('button', {
                      ...
                      children:
                        theme === WebShellThemeId.Dark
                          ? _jsx(SunIcon, { size: 16, strokeWidth: 1.2 })
                          : _jsx(MoonIcon, { size: 16, strokeWidth: 1.2 }),
                    }),
                  canOpenSessionsOverview &&
                  ...
                  !mobileOpen &&
                    ...
                    _jsx('button', {
                      ...
                      children: collapsed
                        ? _jsx(PanelLeftOpenIcon, {
                            size: 16,
                            strokeWidth: 1.2,
                          })
                        : _jsx(PanelLeftCloseIcon, {
                            size: 16,
                            strokeWidth: 1.2,
                          }),
                    }),
