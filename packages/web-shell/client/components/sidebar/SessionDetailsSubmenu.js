...
export function SessionDetailsSubmenu({
  ...
  return _jsxs(DropdownMenuSub, {
    open: open,
    onOpenChange: handleOpenChange,
    children: [
      _jsxs(DropdownMenuSubTrigger, {
        children: [_jsx(InfoIcon, {}), t('sidebar.details')],
      }),
          ...
          children: [
            ...
            _jsxs('div', {
              ...
              children: [
                ...
                completedUnread &&
                  _jsx('span', {
                    className: `${styles.tooltipTag} ${styles.tooltipTagNew}`,
                    children: t('sidebar.completedUnread'),
                  }),
                _jsx('span', {
                  className: styles.tooltipTag,
                  children: t('sidebar.clients', {
                    count: session.clientCount ?? 0,
                  }),
                }),
              ],
            }),
            _jsxs('div', {
              className: styles.sessionDetailsIdRow,
              children: [
                _jsx('span', {
                  className: styles.sessionDetailsId,
                  title: session.sessionId,
                  children: session.sessionId,
                }),
                _jsx(DropdownMenuItem, {
                  className: cn(
                    styles.sessionDetailsCopyButton,
                    'cursor-pointer',
                  ),
            ...
            _jsx('span', {
              ...
              role: 'status',
              'aria-live': 'polite',
              children: copied ? t('sidebar.sessionIdCopied') : '',
            }),
          ],
        }),
      }),
