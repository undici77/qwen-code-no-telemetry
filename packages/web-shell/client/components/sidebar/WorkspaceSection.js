              ...
              : _jsxs(_Fragment, {
                  children: [
                    _jsx('span', {
                      ...
                      children: _jsx(WorkspaceFolderIcon, { open: expanded }),
                    }),
                    _jsx('span', {
                    ...
                    !workspace.trusted &&
                      _jsx('span', {
                        ...
                        children: untrustedLabel,
                      }),
                    readOnly &&
                      _jsx('span', {
                        className: styles.badge,
                        children: readOnlyLabel,
                      }),
                  ],
                }),
          }),
          ...
          children: loadError
            ...
            : visibleSessions.length === 0
              ? // A source switch swaps the query key; until the new source's
                ...
                sessionsLoading && sessionsPage === undefined
                ? null
                : _jsx('div', {
                    className: styles.empty,
                    children: noSessionsLabel,
                  })
              : channelSessionGroups
                ? _jsx(_Fragment, {
                    children: channelSessionGroups.map((group) =>
                      _jsx(
                        SessionGroupSection,
                        {
                          id: group.id,
                      ...
                      children: [
                        ...
                        groupedSessions.ungrouped.length > 0 &&
                          _jsx(SessionGroupSection, {
                            ...
                            children: groupedSessions.ungrouped.map((session) =>
                              renderSession(session),
                            ),
                          }),
                      ],
