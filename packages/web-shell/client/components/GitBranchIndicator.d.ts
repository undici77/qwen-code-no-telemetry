 ...
 */
export declare function gitBranchAriaLabel(branch: string, status: DaemonWorkspaceGitStatus | undefined, t: TranslateFn): string;
/**
 ...
 */
export declare function GitBranchChipContent({ branch, status, compact, worktree, }: {
    branch: string;
    status?: DaemonWorkspaceGitStatus;
    compact: boolean;
    worktree?: boolean;
}): import("react/jsx-runtime").JSX.Element;
export declare function GitBranchIndicator({ branch, status, compact, onOpenDiff, worktree, }: {
    branch: string;
    status?: DaemonWorkspaceGitStatus;
    compact?: boolean;
    onOpenDiff?: () => void;
