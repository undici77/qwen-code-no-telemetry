import type { DaemonSessionArtifact, DaemonSessionMonitorTaskStatus, DaemonSessionShellTaskStatus } from '@qwen-code/sdk/daemon';
...
import { type TurnOutputFileChange, type TurnOutputOpenRequest, type TurnOutputScheduledTask } from './TurnOutputs';
...
interface ArtifactPanelProps {
    ...
    onOpenFilePreview: (change: TurnOutputFileChange, workspaceCwd?: string, workspaceId?: string) => void;
    ...
    onCreateSideTaskSession?: (tabId: string, parentSessionId: string, title: string) => Promise<{
        sessionId: string;
        displayName?: string;
    }>;
    onSideTaskCreated?: (tabId: string, sessionId: string) => void;
    onSideTaskTitleChange?: (tabId: string, title: string, fromFirstPrompt?: boolean) => void;
    onNestedRightPanelOpen?: (request: TurnOutputOpenRequest) => void;
    onNestedArtifactsChange?: (sessionId: string, artifacts: readonly DaemonSessionArtifact[]) => void;
...
export declare function ArtifactPanel({ artifacts, tabs, activeTabId, reviewChanges, selectedReviewPath, panelWidth, workspaceCwd, loading, error, onSelectTab, onCloseTab, onOpenFilePreview, latestReviewAvailable, onOpenLatestReview, items, sideTaskAvailable, sideTasks, sideTasksLoading, onCreateSideTask, onOpenSideTask, onCreateSideTaskSession, onSideTaskCreated, onSideTaskTitleChange, onNestedRightPanelOpen, onNestedArtifactsChange, onError, sessionWorkflowEnabled, onImageIngestionNotice, deferSubagentMount, onClose, variant, fullscreen, onToggleFullscreen, }: ArtifactPanelProps): import("react/jsx-runtime").JSX.Element;
export {};
