...
export const TURN_OUTPUT_KINDS = ['file', 'artifact', 'scheduled_task'];
                ...
                _jsxs('div', {
                  ...
                  children: [
                    _jsx('div', {
                      ...
                      children: t('turnOutputs.filesEdited', {
                    ...
                    _jsxs('div', {
                      ...
                      children: [
                        ...
                        _jsxs('button', {
                          ...
                          onClick: () => openReview(),
                          children: [t('turnOutputs.viewChanges'), ' \u2197'],
                        }),
                      ],
                    }),
                  ],
                    ...
                    'button',
                    {
                      ...
                      children: [
                        _jsx('span', {
                          ...
                          children: displayPath(change.path, workspaceCwd),
                        }),
                        _jsx(LineStats, {
    ...
    children: _jsxs('div', {
      ...
      children: [
        _jsx('span', {
          ...
          'aria-hidden': 'true',
          children: FormatIcon
            ? _jsx(FormatIcon, { className: styles.iconSvg, strokeWidth: 1.8 })
            : _jsx(DocumentIcon, {}),
        }),
        _jsxs('div', {
          className: styles.artifactInfo,
          children: [
            _jsx('div', { className: styles.title, children: artifact.title }),
            _jsx('div', {
              className: styles.artifactMeta,
              children: [getArtifactTypeLabel(artifact), size]
                .filter(Boolean)
                .join(' · '),
            }),
          ],
    ...
    children: _jsxs('div', {
      ...
      children: [
        _jsx('span', {
          className: styles.icon,
          'aria-hidden': 'true',
          children: _jsx(ClockIcon, {}),
        }),
        _jsxs('div', {
          className: styles.artifactInfo,
          children: [
            _jsx('div', { className: styles.title, children: task.title }),
            _jsx('div', {
              className: styles.artifactMeta,
              children: [
                scheduleLabel,
