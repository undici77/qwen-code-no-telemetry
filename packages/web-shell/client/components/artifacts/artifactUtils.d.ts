...
export declare function getArtifactTypeLabel(
  artifact: DaemonSessionArtifact,
): string;
export declare function formatArtifactSize(
  sizeBytes: number | undefined,
): string;
export declare function getArtifactImageMimeType(
  artifact: DaemonSessionArtifact,
): string | undefined;
export declare function getImageMimeTypeFromPath(
  path: string,
): string | undefined;
export declare function getReviewDownloadMimeType(value: string): string;
export declare function readWorkspaceFileAsBlob(
  readFileBytes: (
    filePath: string,
    opts?: {
      offset?: number;
