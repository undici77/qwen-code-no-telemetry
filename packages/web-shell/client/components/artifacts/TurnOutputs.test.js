...
import { getArtifactFormatIcon, getArtifactPreviewContent, getFileChangePreviewContent, isDownloadableReviewFilePath, isRenderedFilePath, } from './TurnOutputs';
import { FileAudioIcon, FileCode2Icon, FileIcon, FileImageIcon, FileTextIcon, FileVideoIcon, LinkIcon, NotebookTabsIcon, } from 'lucide-react';
describe('TurnOutputs helpers', () => {
    ...
    it('uses changed Markdown content for artifact previews', () => {
        ...
        expect(getArtifactPreviewContent(artifact, [change], '/workspace/project')).toBe('# New');
    });
