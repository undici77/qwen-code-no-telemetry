...
declare function TurnOutputsComponent({
  turnId,
  changes,
  artifacts,
  scheduledTasks,
  ...
  onOpenScheduledTask,
  onError,
}: TurnOutputsProps): import('react/jsx-runtime').JSX.Element | null;
export declare function getArtifactFormatIcon(
  kind: string,
): LucideIcon | undefined;
export declare const TurnOutputs: import('react').MemoExoticComponent<
  typeof TurnOutputsComponent
>;
export declare function getArtifactPreviewContent(
  artifact: DaemonSessionArtifact,
  changes: readonly TurnOutputFileChange[],
  workspaceCwd?: string,
): string | undefined;
export declare function getFileChangePreviewContent(
