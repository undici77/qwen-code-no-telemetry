...
function WorkspaceFolderIcon() {
    return (_jsx("svg", { viewBox: "0 0 24 24", fill: "none", "aria-hidden": "true", children: _jsx("path", { d: "M3 6.5A1.5 1.5 0 0 1 4.5 5h4l2 2h7A1.5 1.5 0 0 1 19 8.5v8A1.5 1.5 0 0 1 17.5 18h-13A1.5 1.5 0 0 1 3 16.5Z", stroke: "currentColor", strokeWidth: "1.8", strokeLinejoin: "round" }) }));
}
/**
 ...
 */
export function WorkspaceIndicator({ name, title, ariaLabel, color, compact = false, }) {
    const className = [
        ...
        .filter(Boolean)
        .join(' ');
    return (_jsx(TooltipProvider, { delayDuration: 300, children: _jsxs(Tooltip, { children: [_jsx(TooltipTrigger, { asChild: true, children: _jsxs("output", { className: className, "aria-label": ariaLabel, "data-web-shell-workspace": true, "data-web-shell-workspace-title": title, children: [_jsx("span", { className: styles.workspaceChipIcon, children: _jsx(WorkspaceFolderIcon, {}) }), _jsx("span", { className: styles.workspaceChipText, children: name })] }) }), _jsx(TooltipContent, { side: "top", children: title })] }) }));
}
