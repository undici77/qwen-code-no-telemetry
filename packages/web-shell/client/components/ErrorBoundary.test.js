...
describe('ErrorBoundary', () => {
  it('renders children when nothing throws', () => {
    const container = render(
      _jsx(ErrorBoundary, {
        fallback: _jsx('div', { 'data-testid': 'fallback' }),
        children: _jsx(Boom, { explode: false }),
      }),
    );
  ...
  it('renders the fallback when a child throws', () => {
    ...
    const container = render(
      _jsx(ErrorBoundary, {
        fallback: _jsx('div', { 'data-testid': 'fallback', children: 'down' }),
        children: _jsx(Boom, { explode: true }),
      }),
    );
  ...
  it('passes the captured error to a render-prop fallback', () => {
    ...
    const container = render(
      _jsx(ErrorBoundary, {
        fallback: (error) =>
          _jsx('div', { 'data-testid': 'fallback', children: error.message }),
        children: _jsx(Boom, { explode: true }),
      }),
    );
    expect(
