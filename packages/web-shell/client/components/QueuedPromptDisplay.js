...
export function QueuedPromptDisplay({
  ...
  return _jsxs('div', {
    className: styles.queuedPrompts,
    children: [
      mayContainDuplicateAdmission
        ? _jsx('div', {
            className: styles.queuedPromptAmbiguity,
            role: 'status',
            children: t('queue.mayCorrespond'),
          })
        : null,
      prompts.map((prompt) => {
        ...
        return _jsxs(
          'div',
          {
            className: styles.queuedPrompt,
            children: [
              _jsx('span', {
                className: styles.queuedPromptIcon,
                'aria-hidden': 'true',
                children: _jsx('span', {
              ...
              _jsxs('span', {
                className: styles.queuedPromptText,
                children: [
                  preview.parts.map((part, index) =>
                    part.type === 'text'
                      ? _jsx(Fragment, { children: part.text }, index)
                      : _jsx(
                          ReadonlyComposerTag,
                          {
                            tag: part.tag,
              ...
              isRemoving
                ? _jsxs('span', {
                    className: `${styles.queuedPromptState}${hasStateSpinner ? ` ${styles.queuedPromptStateLoading}` : ''}`,
                    role: 'status',
                    children: [
                      hasStateSpinner &&
                        _jsx('span', { className: styles.queuedPromptSpinner }),
                      _jsx('span', {
                        className: styles.queuedPromptStateLabel,
                        children: isRemoving
                          ? t('queue.removing')
                          : prompt.isEditing
                            ? t('queue.editing')
                ...
                : null,
              _jsx('span', {
                className: styles.queuedPromptActions,
                children: hasUnknownPayload
                  ? _jsxs(_Fragment, {
                      children: [
                        _jsx('button', {
                          type: 'button',
                          ...
                          onClick: () => {
                            if (
                              window.confirm(t('queue.continueEditingConfirm'))
                            ) {
