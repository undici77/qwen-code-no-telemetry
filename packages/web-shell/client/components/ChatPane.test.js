  ...
  ChatEditor: forwardRef(function MockChatEditor(props, ref) {
    ...
    return _jsxs('div', {
      ...
      children: [
        ...
        _jsx('span', {
          'data-testid': 'pane-running',
          children: String(props.isRunning),
        }),
        _jsx('span', {
          'data-testid': 'pane-dialogopen',
          children: String(props.dialogOpen),
        }),
        _jsx('span', {
          'data-testid': 'pane-toolbar',
          children: JSON.stringify(props.visibleToolbarActions ?? null),
        }),
        _jsx('span', {
          'data-testid': 'pane-commands',
          children: String((props.commands ?? []).length),
        }),
        _jsx('span', {
          'data-testid': 'pane-mode',
          children: String(props.currentMode),
        }),
        _jsx('span', {
          'data-testid': 'pane-model',
          children: String(props.currentModel),
        }),
        _jsx('span', {
          'data-testid': 'pane-models',
          children: JSON.stringify(props.availableModels ?? null),
        }),
        _jsx('span', {
          'data-testid': 'pane-queued-messages',
          children: JSON.stringify(props.queuedMessages ?? null),
        }),
        _jsx('span', {
          'data-testid': 'pane-followup',
          children: String(props.followupState?.suggestion ?? ''),
        }),
      ],
    });
  }),
...
describe('ChatPane', () => {
  ...
  it('renders the custom composer footer directly after the pane editor', () => {
    ...
    const ComposerFooter = (props) => {
      ...
      return _jsx('div', {
        'data-testid': 'pane-composer-footer',
        children: 'pane footer',
      });
    };
  ...
  it('renders host header actions scoped to the pane session', () => {
    const renderHeaderActions = vi.fn((info) =>
      _jsxs('button', {
        type: 'button',
        'data-testid': 'host-pane-action',
        children: [info.sessionId, ':', info.workspaceCwd ?? ''],
      }),
    );
    render({
      title: 'Refactor core',
