    ...
    children: [
      _jsxs('div', {
        ...
        children: [
          ...
          hint
            ? _jsx('span', { className: styles.hint, children: hint })
            : null,
        ],
      }),
      children,
...
export function ChannelEditorDialog({
    ...
    return _jsxs(
      FieldShell,
      {
        ...
        children: [
          stored?.present
            ? _jsxs('div', {
                className: styles.secretState,
                children: [
                  _jsxs('span', {
                    className: styles.secretStatus,
                    children: [
                      _jsx(CheckCircle2Icon, { size: 15 }),
                    ...
                    children: operations.map((operation) =>
                      _jsx(
                        Button,
                        {
                          ...
                          children: t(`channels.editor.secret.${operation}`),
                        },
                        operation,
                      ),
                    ),
          ...
          secret.operation === 'clear'
            ? _jsx('p', {
                ...
                children: t('channels.editor.secret.clearHint'),
              })
            : null,
        ],
      },
              ...
              _jsx(SelectContent, {
                children: field.options?.map((option) =>
                  _jsx(
                    ...
                    {
                      value: option.value,
                      children: fieldOptionLabel(field, option),
                    },
                    option.value,
                  ),
                ),
  ...
  return _jsx(Dialog, {
    ...
    children: _jsxs(DialogContent, {
      className: 'max-w-[calc(100%-2rem)] p-5 sm:max-w-xl',
      children: [
        _jsx(DialogHeader, {
          children: _jsxs('div', {
              ...
              children: [
                submitError
                  ? _jsxs(Alert, {
                      ...
                      children: [
                        _jsx(KeyRoundIcon, {}),
                        _jsx(AlertTitle, {
                          children: t('channels.editor.saveError'),
                        }),
                        _jsx(AlertDescription, { children: submitError }),
                        _jsxs(Button, {
                ...
                _jsxs('section', {
                  ...
                  children: [
                    _jsx('h3', {
                      ...
                      children: t('channels.editor.section.identity'),
                    }),
                    _jsx(FieldShell, {
                      id: `${formId}-name`,
                      ...
                      children: _jsx(Input, {
                        ...
                        'aria-required': true,
                        placeholder: t(
                          'channels.editor.instanceNamePlaceholder',
                        ),
                        onChange: (event) =>
                          setDraft((current) => ({
                            ...current,
                ...
                platformFields.length > 0
                  ? _jsxs('section', {
                      ...
                      children: [
                        _jsx('h3', {
                          className: styles.sectionHeading,
                          children: t('channels.editor.section.credentials'),
                        }),
                ...
                sessionScopeField
                  ? _jsxs('section', {
                      ...
                      children: [
                        _jsx('h3', {
                          className: styles.sectionHeading,
                          children: t('channels.editor.section.session'),
                        }),
                ...
                (() => {
                  const descriptorPolicy =
                    hasDescriptorSenderPolicy(descriptor);
                  ...
                  return _jsxs('section', {
                    ...
                    children: [
                      _jsx('h3', {
                        className: styles.sectionHeading,
                        children: t('channels.editor.section.access'),
                      }),
                      showRadioGroup
                        ? _jsxs(_Fragment, {
                            children: [
                              _jsx(RadioGroup, {
                                ...
                                children: ['pairing', 'open'].map((policy) =>
                                  _jsxs(
                                    Label,
                                    {
                                      className: styles.policyCard,
                                      'data-selected':
                                        draft.senderPolicy === policy,
                                      children: [
                                        _jsx(RadioGroupItem, { value: policy }),
                                        _jsxs('span', {
                                          className: styles.policyCopy,
                                          children: [
                                            _jsx('span', {
                                              className: styles.policyTitle,
                                              children: t(
                                                `channels.editor.policy.${policy}.title`,
                                              ),
                                            }),
                                            _jsx('span', {
                                              className:
                      ...
                      showPairing
                        ? instance?.config.senderPolicy === 'pairing' ||
                          ...
                          ? _jsx(ChannelPairingRequests, {
                              ...
                              staticAllowedUsers:
                                configuredAllowedUsers(instance),
                            })
                          : _jsxs(Alert, {
                              children: [
                                _jsx(KeyRoundIcon, {}),
