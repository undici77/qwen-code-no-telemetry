  ...
  return _jsx(Dialog, {
    ...
    children: _jsxs(DialogContent, {
      ...
      children: [
        _jsxs(DialogHeader, {
          children: [
            _jsx(DialogTitle, { children: t('skills.install.title') }),
            _jsx(DialogDescription, {
              children: t('skills.install.description'),
            }),
          ],
        }),
        _jsxs('div', {
                  ...
                  children: [
                    ...
                    _jsxs(SelectContent, {
                      children: [
                        _jsx(SelectItem, {
                          value: 'workspace',
                          children: t('skills.install.scope.workspace'),
                        }),
                        _jsx(SelectItem, {
                          value: 'global',
                          children: t('skills.install.scope.global'),
                        }),
                      ],
                    }),
                  ],
                ...
                _jsxs(TabsList, {
                  ...
                  children: [
                    ...
                    _jsx(TabsTrigger, {
                      value: 'folder',
                      disabled: installing,
                      children: t('skills.install.folder'),
                    }),
                    _jsx(TabsTrigger, {
                      value: 'zip',
                      disabled: installing,
                    ...
                    children: [
                      ...
                      zip
                        ? _jsx('div', {
                            ...
                            children: t('skills.install.zipSelected', {
                              name: zip.name,
                            }),
                          })
                        : null,
            ...
            _jsxs(Button, {
              ...
              children: [
                installing
                  ...
                  : _jsx(UploadIcon, { 'data-icon': 'inline-start' }),
