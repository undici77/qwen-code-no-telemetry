      ...
      children: [
        _jsx(TooltipTrigger, {
          ...
          children: _jsx(Badge, {
            ...
            children: t('skills.manualReference'),
          }),
        }),
        _jsx(TooltipContent, { children: t('skills.manualReferenceHint') }),
      ],
    }),
  });
}
      ...
      children: [
        ...
        _jsx(BreadcrumbItem, {
          children: selectedSkill
            ...
            : _jsx(BreadcrumbPage, { children: t('skills.title') }),
        }),
        selectedSkill ? _jsx(BreadcrumbSeparator, {}) : null,
        selectedSkill
          ? _jsx(BreadcrumbItem, {
              children: _jsx(BreadcrumbPage, { children: selectedSkill.name }),
            })
          : null,
      ],
    }),
            ...
            _jsxs('div', {
              ...
              children: [
                ...
                _jsx('div', {
                  ...
                  children: _jsxs('div', {
                    ...
                    children: [
                      ...
                      _jsx(Badge, {
                        variant: 'outline',
                        children: skillLevelLabel(selectedSkill, t),
                      }),
                      _jsx(Badge, {
                        variant: 'secondary',
                        className: skillStatusBadgeClass(selectedSkill),
                        children: skillStatusLabel(selectedSkill, t),
                      }),
                      !selectedSkill.modelInvocable
                        ? _jsx(ManualReferenceBadge, {})
                        : null,
                    ],
                  }),
                }),
                _jsxs(Button, {
                  ...
                  children: [
                    _jsx(PlayIcon, { 'data-icon': 'inline-start' }),
                    t('skills.run'),
                  ],
                }),
                _jsxs(DropdownMenu, {
                        ...
                        children: [
                          ...
                          (selectedSkill.level === 'project' ||
                            ...
                            ? _jsx(DropdownMenuItem, {
                                ...
                                children: t('skills.delete.action'),
                              })
                            : null,
                        ],
                      }),
              ...
              ? _jsxs(Alert, {
                  ...
                  children: [
                    ...
                    _jsx(AlertDescription, {
                      children: selectedSkill.error || message,
                    }),
                  ],
                })
              : null,
                ...
                _jsxs(CardContent, {
                  ...
                  children: [
                    ...
                    _jsx(DetailField, {
                      ...
                      value: selectedSkill.modelInvocable
                  ...
                  _jsxs(AlertDialogHeader, {
                    children: [
                      _jsx(AlertDialogTitle, {
                        children: t('skills.delete.title'),
                      }),
                      _jsx(AlertDialogDescription, {
                        children: t('skills.delete.description', {
        ...
        children: [
          ...
          message
            ? _jsxs(Alert, {
                ...
                children: [
                  _jsx(AlertCircleIcon, {}),
                  _jsx(AlertDescription, { children: message }),
                ],
              })
            : null,
          listNotice
                ...
                children: [
                  ...
                  _jsxs(SelectContent, {
                    children: [
                      _jsx(SelectItem, {
                        value: 'all',
                        children: t('skills.filter.status.all'),
                      }),
                      _jsx(SelectItem, {
                        value: 'enabled',
                        children: t('skills.filter.status.enabled'),
                      }),
                      _jsx(SelectItem, {
                        value: 'disabled',
                        children: t('skills.filter.status.disabled'),
                      }),
                    ],
                  }),
                ],
                                    ...
                                    _jsxs('div', {
                                      ...
                                      children: [
                                        _jsx(Badge, {
                                          ...
                                          children: skillStatusLabel(skill, t),
                                        }),
