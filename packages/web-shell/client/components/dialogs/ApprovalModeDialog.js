...
export function ApprovalModeDialog({
  ...
  return _jsx('div', {
    ...
    'data-web-shell-approval-mode-dialog': true,
    children: approvalModes.map((mode, index) => {
      ...
      return _jsxs(
        'div',
        {
          ...
          'data-web-shell-approval-mode-option': true,
          ...
          children: [
            _jsx('span', {
              ...
              children: _jsx(ModeIcon, { mode: mode.id }),
            }),
            _jsxs('span', {
