...
function Stat({ label, value }) {
  return _jsxs('div', {
    ...
    children: [
      ...
      _jsx('div', { className: styles.statLabel, children: label }),
    ],
  });
}
function Metric({ accent, value, label, hint }) {
  return _jsxs('div', {
    ...
    children: [
      _jsxs('div', {
        className: styles.metricHead,
        children: [
          _jsx('span', {
            className: `${styles.tick} ${styles[`tick_${accent}`]}`,
          }),
          _jsx('span', { className: styles.metricLabel, children: label }),
        ],
      }),
      _jsx('div', { className: styles.metricValue, children: value }),
      _jsx('div', { className: styles.metricHint, children: hint }),
    ],
  });
}
function ModelRow({ rank, model, color }) {
  ...
  return _jsxs('div', {
    ...
    children: [
      _jsxs('div', {
        className: styles.modelHead,
        children: [
          _jsx('span', {
            className: styles.modelRank,
            style: { color },
          ...
          _jsxs('div', {
            ...
            children: [
              ...
              _jsx('div', {
                className: styles.modelSub,
                children: t('daemon.usage.modelMeta', {
          ...
          _jsxs('span', {
            className: styles.modelShare,
            style: { color },
            children: [Math.round(sharePct), '%'],
          }),
        ],
      }),
      _jsx('div', {
...
function MiniBars({ points, format, locale }) {
  ...
  return _jsxs('div', {
    ...
    children: [
      ...
      points.length > 1 &&
        _jsxs('div', {
          className: styles.barsCaption,
          children: [
            _jsx('span', { children: shortDay(points[0].label, locale) }),
            _jsx('span', {
              children: shortDay(points[points.length - 1].label, locale),
            }),
          ],
        }),
    ],
...
export function UsageDashboardTab() {
  ...
  const periodToggle = _jsx('div', {
    ...
    children: RANGES.map((r) =>
      _jsx(
        ...
        {
          type: 'button',
          className: `${styles.segment} ${r === range ? styles.segmentActive : ''}`,
          'aria-pressed': r === range,
          onClick: () => setRange(r),
          children: t(PERIOD_LABEL_KEY[r]),
        },
        r,
      ),
    ),
  ...
  if (!dashboard) {
    return _jsxs('div', {
      ...
      children: [
        _jsx('div', { className: styles.toolbar, children: periodToggle }),
        loading
          ? _jsx('div', {
              className: styles.state,
              children: t('daemon.usage.loading'),
            })
          : error
            ? _jsxs('div', {
                className: styles.state,
                children: [t('daemon.usage.failed'), ': ', error.message],
              })
            : _jsx('div', {
                className: styles.state,
                children: t('daemon.usage.empty'),
              }),
      ],
    });
  }
  ...
  return _jsxs('div', {
    ...
    children: [
          ...
          _jsxs('div', {
            ...
            children: [
              _jsx('div', {
                ...
                children: t(HERO_LABEL_KEY[dashboard.range]),
              }),
              _jsx('div', {
                className: styles.heroNumber,
                children: formatMegaTokens(summary.totalTokens),
              }),
              _jsx('div', {
                className: styles.heroSub,
                children: t('daemon.usage.tokensConsumed'),
              }),
            ],
          }),
          _jsx('button', {
      ...
      _jsxs('div', {
        ...
        children: [
          _jsx(Stat, {
            label: t('daemon.usage.sessions'),
            value: summary.sessions,
          }),
          _jsx(Stat, {
            label: t('daemon.usage.requests'),
            value: summary.requests,
          }),
          _jsx(Stat, {
            label: t('daemon.usage.tools'),
            value: summary.toolCalls,
          }),
          _jsx(Stat, { label: t('daemon.usage.changes'), value: changes }),
        ],
      }),
      _jsxs('section', {
        ...
        children: [
          _jsx('h4', {
            ...
            children: t('daemon.usage.breakdownTitle'),
          }),
          _jsxs('div', {
      ...
      _jsxs('section', {
        ...
        children: [
          _jsx('h4', {
            className: styles.sectionTitle,
            children: t('daemon.usage.heatmapTitle'),
          }),
          _jsx('div', {
            className: styles.sectionSub,
            children: t('daemon.usage.heatmapSub', { months: HEATMAP_MONTHS }),
          }),
          hasHeatmap
            ? _jsx(TokenHeatmap, { heatmap: heatmap, days: heatmapDays })
            : _jsx('div', {
                className: styles.state,
                children: t('daemon.usage.empty'),
              }),
      ...
      models.length > 0 &&
        _jsxs('section', {
          ...
          children: [
            _jsxs('h4', {
              className: styles.sectionTitle,
              children: [rangeWord, ' ', t('daemon.usage.modelShareTitle')],
            }),
            _jsx('div', {
              className: styles.sectionSub,
              children: t('daemon.usage.modelShareSub'),
            }),
            _jsx('div', {
      ...
      skills.length > 0 &&
        _jsxs('section', {
          ...
          children: [
            _jsxs('h4', {
              className: styles.sectionTitle,
              children: [rangeWord, ' ', t('daemon.usage.skillTitle')],
            }),
            _jsx('div', {
              className: styles.sectionSub,
              children: t('daemon.usage.skillSub'),
            }),
            _jsxs('table', {
              ...
              children: [
                _jsx('thead', {
                  children: _jsxs('tr', {
                    children: [
                      _jsx('th', { children: t('daemon.usage.skillName') }),
                      _jsx('th', {
                        className: styles.right,
                        children: t('daemon.usage.skillCount'),
                      }),
                    ],
                  }),
                }),
      ...
      daily.length > 1 &&
        _jsxs('section', {
          ...
          children: [
            _jsxs('h4', {
              className: styles.sectionTitle,
              children: [rangeWord, ' ', t('daemon.usage.dailyTokensTitle')],
            }),
            _jsx('div', {
              className: styles.sectionSub,
              children: t('daemon.usage.dailyTokensSub'),
            }),
            _jsx(SvgLineChart, {
              series: [
                {
      ...
      daily.length > 1 &&
        _jsxs('section', {
          ...
          children: [
            _jsxs('h4', {
              className: styles.sectionTitle,
              children: [rangeWord, ' ', t('daemon.usage.dailySessionsTitle')],
            }),
            _jsx('div', {
              className: styles.sectionSub,
              children: t('daemon.usage.dailySessionsSub'),
            }),
            _jsx(MiniBars, {
