...
function renderDialog() {
    root.render(_jsx(I18nProvider, { language: "en", children: _jsx(DeleteSessionDialog, { onDeleted: onDeleted, onError: onError, onClose: onClose }) }));
}
function mount() {
    onDeleted = vi.fn();
    onError = vi.fn();
...
const isChecked = (el) => el.textContent?.includes('[x]') === true;
beforeEach(() => {
...
//# sourceMappingURL=DeleteSessionDialog.test.js.map