 ...
 */
export declare function SvgLineChart({ series, timestamps, format, formatTime, zeroBased, ariaLabel, peakLabel, }: SvgLineChartProps): import("react/jsx-runtime").JSX.Element;
export {};
