    ...
    children: [
      _jsxs('div', {
        ...
        children: [
          ...
          active != null &&
            _jsxs('div', {
              className: `${styles.tooltip} ${tooltipBelow ? styles.tooltipBelow : ''}`,
              style: { left: `${tooltipLeftPct}%` },
              role: 'tooltip',
              children: [
                timestamps &&
                  timestamps[active] != null &&
                  _jsx('div', {
                    className: styles.tooltipTime,
                    children: formatTime(timestamps[active]),
                  }),
                series.map((s) =>
                  active < s.values.length
                    ? _jsxs(
                        'div',
                        {
                          ...
                          children: [
                            ...
                            _jsx('span', {
                              ...
                              children: format(s.values[active]),
                            }),
                          ],
                        },
                        s.label,
        ...
        children: [
          ...
          hasData &&
            _jsx('span', {
              ...
              children: `${peakLabel} ${format(maxV)}`,
            }),
        ],
      }),
    ],
