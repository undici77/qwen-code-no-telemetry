    ...
    _jsxs('div', {
      ...
      children: [
        _jsx('div', {
          ...
          children: t('settings.models.fallbacks.hint', { max }),
        }),
        _jsxs('div', {
          ...
          children: [
            rows.length === 0 &&
              _jsx('div', {
                ...
                children: t('settings.models.fallbacks.empty'),
              }),
            rows.map((model) => {
            ...
            _jsxs('div', {
              ...
              children: [
                ...
                _jsx('button', {
                  ...
                  children: t('settings.models.fallbacks.confirm'),
                }),
              ],
            }),
          ],
