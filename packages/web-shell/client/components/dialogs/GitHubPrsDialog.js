  ...
  switch (checks) {
    ...
    case 'pending':
      return _jsx('span', {
        ...
        children: _jsx(ClockIcon, { size: 12 }),
      });
    default:
      return null;
  }
  ...
  const reviewBadge =
    pr.reviewDecision === 'approved'
      ? _jsx('span', {
          ...
          children: t('githubPrs.reviewApproved'),
        })
      : pr.reviewDecision === 'changes_requested'
        ? _jsx('span', {
            className: `${styles.badge} ${styles.badgeChanges}`,
            children: t('githubPrs.reviewChanges'),
          })
        : pr.reviewDecision === 'review_required'
          ? _jsx('span', {
              className: `${styles.badge} ${styles.badgeReviewRequired}`,
              children: t('githubPrs.reviewRequired'),
            })
          : null;
  return _jsxs('button', {
    type: 'button',
    ...
    children: [
      _jsxs('span', {
        ...
        children: [
          ...
          _jsx('span', { className: styles.prTitle, children: pr.title }),
          reviewBadge,
          _jsx(ChecksIcon, { checks: pr.checks }),
        ],
      }),
      _jsxs('span', {
        className: styles.prMeta,
        children: [
          '#',
          pr.number,
          ' \u00B7 ',
...
export function GitHubPrsContent({ workspaceCwd, onSubtitleChange }) {
  ...
  if (loading) {
    body = _jsx('div', {
      ...
      children: t('githubPrs.loading'),
    });
  } else if (failure === 'github_cli_unavailable') {
    body = _jsx('div', {
      className: styles.placeholder,
      children: t('githubPrs.cliUnavailable'),
    });
  } else if (failure !== null) {
    body = _jsx('div', {
      className: styles.placeholder,
      children: t('githubPrs.error'),
    });
  } else if (!list || !list.available) {
    body = _jsx('div', {
      className: styles.placeholder,
      children: t('githubPrs.unavailable'),
    });
  } else if (list.pullRequests.length === 0) {
    body = _jsx('div', {
      className: styles.placeholder,
      children: t('githubPrs.empty'),
    });
  } else {
    body = _jsx('div', {
      className: styles.prList,
      children: list.pullRequests.map((pr) =>
        _jsx(PullRequestRow, { pr: pr, now: now }, pr.number),
      ),
    });
  }
