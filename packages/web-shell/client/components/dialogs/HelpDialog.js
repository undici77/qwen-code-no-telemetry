...
function GeneralHelp() {
  ...
  return _jsx('div', {
    ...
    children: _jsx('div', {
      ...
      children: GENERAL_SHORTCUTS.map(([key, description]) =>
        _jsxs(
          'div',
          {
            ...
            children: [
              _jsx('span', {
                className: styles.shortcutDesc,
                children: t(description),
              }),
              _jsx('span', { className: styles.shortcutKey, children: key }),
            ],
          },
          key,
        ),
...
function CommandsHelp({ commands, tab, query }) {
  ...
  return _jsx('div', {
    ...
    children: visibleCommands.map((command) => {
      const expanded = expandedCommand === command.name;
      return _jsxs(
        'article',
        {
          className: `${styles.commandCard} ${expanded ? styles.commandCardExpanded : ''}`,
          children: [
            _jsxs('button', {
              type: 'button',
              ...
              children: [
                _jsx('span', {
                  ...
                  children: commandSignature(command),
                }),
                _jsx('span', {
                  className: styles.commandTag,
                  children: commandMeta(command, t),
                }),
                _jsx('svg', {
            ...
            expanded &&
              _jsxs('div', {
                className: styles.commandDetail,
                children: [
                  command.description &&
                    _jsx('div', {
                  ...
                  !!command.subcommands?.length &&
                    _jsxs('div', {
                      className: styles.commandSubcommands,
                      children: [
                        t('help.subcommands'),
                        ': ',
