    ...
    children: [
      ...
      (message || loading) &&
        _jsx('div', {
          ...
          children: _jsx('span', {
            className: dp('picker-search-hint'),
            children: message || t('tools.loading'),
          }),
        }),
              ...
              'div',
              {
                ...
                children: [
                  _jsxs('div', {
                    ...
                    children: [
                      _jsx('span', {
                        className: dp('tools-item-icon'),
                        'aria-hidden': 'true',
                      }),
                      _jsx('span', {
                        className: dp('picker-item-title'),
                        children: toolLabel(tool),
                      }),
                      _jsx('span', {
                        className: dp(
                          'tools-status-badge',
                  ...
                  expanded &&
                    desc &&
                    _jsx('div', {
                      className: dp('tools-desc-expanded'),
                      children: _jsx('div', {
                        className: dp('tools-desc-body'),
                        children: desc,
                      }),
                    }),
                ],
