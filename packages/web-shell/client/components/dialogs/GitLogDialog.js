    ...
    if (loading) {
      ...
      detailBody = _jsx('div', {
        ...
        children: _jsx('span', {
          ...
          children: t('gitLog.detailError'),
        }),
      });
    } else if (detail && detail.available) {
      detailBody = _jsxs('div', {
        className: styles.commitDetail,
        children: [
          detail.body &&
            _jsx('pre', {
          ...
          detail.files &&
            _jsxs('div', {
              ...
              children: [
                _jsx('div', {
                  className: styles.fileStatHeader,
                  children: t('gitLog.files', {
                ...
                (detail.hiddenCount ?? 0) > 0 &&
                  _jsx('div', {
                    ...
                    children: t('gitLog.hidden', {
                      count: detail.hiddenCount ?? 0,
                    }),
                  }),
              ],
            }),
        ...
        children: [
          _jsxs('button', {
            ...
            children: [
              ...
              _jsxs('span', {
                className: styles.commitMeta,
                children: [
                  entry.authorName,
                  ' \u00B7 ',
                  timeAgo(entry.authorDate, now, language),
                ],
              }),
            ],
          }),
...
export function GitLogContent({ workspaceCwd, gitCwd, onSubtitleChange }) {
  ...
  if (loading) {
    ...
    body = _jsx('div', {
      className: styles.placeholder,
      children: t('gitLog.error'),
    });
  } else if (!log || !log.available) {
    body = _jsx('div', {
      className: styles.placeholder,
      children: t('gitLog.unavailable'),
    });
  } else if (log.entries.length === 0) {
    body = _jsx('div', {
      className: styles.placeholder,
      children: t('gitLog.empty'),
    });
  } else {
...
export function GitLogDialog({ workspaceCwd, onClose }) {
  ...
  return _jsx(DialogShell, {
    ...
    onClose: onClose,
    children: _jsx(GitLogContent, { workspaceCwd: workspaceCwd }),
  });
}
