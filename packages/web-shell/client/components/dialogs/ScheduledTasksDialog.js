...
function PromptReferenceEditor({
  ...
  return _jsxs('div', {
    className: styles.promptEditorWrap,
    children: [
      _jsx('div', {
        ref: editorRef,
      ...
      value.trim().length === 0 &&
        _jsx('div', {
          className: styles.promptPlaceholder,
    ...
    referenceKind && referencePickerPosition
      ? createPortal(
          _jsx('div', {
            ...
            children: referenceLoading
              ? _jsx('div', {
                  className: styles.referenceEmpty,
                  children: t('scheduledTasks.reference.loading'),
                })
              : referenceError
                ? _jsx('div', {
                    className: styles.referenceError,
                    children: referenceError,
                  })
                : referenceItems.length === 0
                  ? _jsx('div', {
                      className: styles.referenceEmpty,
                      children: t('scheduledTasks.reference.empty'),
                    })
                  : referenceItems.map((item) =>
                      _jsxs(
                        'button',
                        {
                          ...
                          children: [
                            _jsx('span', {
                              className: styles.referenceItemLabel,
                              children: item.label,
                            }),
                            item.description &&
                              _jsx('span', {
                                className: styles.referenceItemDescription,
  ...
  return _jsxs('div', {
    ...
    children: [
      _jsx('div', {
        ...
        children: t('scheduledTasks.subtitle'),
      }),
      _jsxs('div', {
          ...
          _jsxs('div', {
            ...
            children: [
              _jsx('button', {
                ...
                onClick: () => void reload(),
                children: t('scheduledTasks.refresh'),
              }),
              _jsx('button', {
                type: 'button',
                className: styles.secondaryButton,
                onClick: onCreateViaChat,
                children: t('scheduledTasks.createViaChat'),
              }),
              _jsx('button', {
                type: 'button',
                className: styles.primaryButton,
                onClick: openCreate,
                children: t('scheduledTasks.new'),
              }),
            ],
          }),
        ],
          ...
          children: _jsxs('div', {
            ...
            children: [
                ...
                _jsxs('label', {
                  ...
                  children: [
                    _jsx('span', {
                      ...
                      children: t('scheduledTasks.workspace'),
                    }),
                    _jsx('select', {
                      ...
                      children: operableWorkspaces.map((ws) =>
                        _jsx(
                          'option',
                          {
                            value: workspaceActionId(ws) ?? '',
                            children: workspaceLabel(ws),
                          },
                          ws.id,
                        ),
                      ),
              ...
              _jsx('div', {
                ...
                children: _jsx('div', {
                  className: styles.referenceBar,
                  children: ['extension', 'skill', 'mcp'].map((kind) => {
                      ...
                      _jsx('select', {
                        ...
                        children: FREQUENCIES.map((f) =>
                          _jsx(
                            ...
                            {
                              value: f,
                              children: t(`scheduledTasks.freq.${f}`),
                            },
                            f,
                          ),
                        ),
                    ...
                    _jsxs('label', {
                      ...
                      children: [
                        ...
                        _jsx('select', {
                          ...
                          children: MINUTE_INTERVALS.map((n) =>
                ...
                children: previewLabel
                  ? _jsxs(_Fragment, {
                      children: [
                        ...
                        _jsx('code', {
                          className: styles.previewCron,
                          children: previewCron,
                        }),
                      ],
                    })
                  : _jsx('span', {
                      className: styles.previewInvalid,
      ...
      referencePicker,
      loadError &&
        _jsx('div', { className: styles.loadError, children: loadError }),
      tasks !== null &&
        tasks.length === 0 &&
        !loadError &&
        _jsx('div', {
          className: styles.empty,
          children: t('scheduledTasks.empty'),
        }),
      _jsx('div', {
              ...
              children: [
                ...
                _jsxs('div', {
                  ...
                  children: [
                    ...
                    _jsx('span', {
                      className: styles.lastFired,
                      children: describeLastRun(task, t),
                    }),
                    task.sessionId && onOpenSession
                      ...
                      : // Unbound (tool-created / legacy) task: no session to open, so
                        ...
                        _jsx('button', {
                          ...
                          children: t('scheduledTasks.runHistory', {
                            count: task.runs.length,
                          }),
                        }),
                  ],
                }),
                expandedRunsId === taskKey(task) &&
                  task.runs.length > 0 &&
                  _jsx('ul', {
                    className: styles.runsList,
                    children: [...task.runs]
                      .reverse()
                      .map((run, idx) =>
                        _jsx(
                          'li',
                          {
                            className: styles.runsItem,
                            children: describeRun(run, t),
                          },
                          `${run.at}-${idx}`,
                        ),
                      ),
