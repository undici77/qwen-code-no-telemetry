            ...
            _jsxs(Field, {
              ...
              children: [
                _jsx(FieldLabel, {
                  ...
                  children: t('sidebar.addWorkspacePath'),
                }),
                _jsxs('div', {
                  className: 'relative',
                  children: [
                      ...
                      children: [
                        ...
                        onPick &&
                          _jsxs(Button, {
                            ...
                            disabled: submitting || browsing,
                            children: [
                              _jsx(FolderOpenIcon, { 'aria-hidden': 'true' }),
                    ...
                    showList &&
                      _jsx('ul', {
                        ...
                        className:
                          'absolute inset-x-0 top-full z-50 mt-1 max-h-56 overflow-y-auto rounded-md border bg-popover py-1 text-popover-foreground shadow-md',
                ...
                _jsx(FieldDescription, {
                  id: HINT_ID,
                  children: t('sidebar.addWorkspaceHint'),
                }),
                error && _jsx(FieldError, { id: ERROR_ID, children: error }),
              ],
            }),
            displayNameEnabled &&
              _jsxs(Field, {
                children: [
                  _jsx(FieldLabel, {
                    htmlFor: 'add-workspace-display-name',
                    children: t('sidebar.addWorkspaceDisplayName'),
                  }),
                  _jsx(Input, {
                  ...
                  _jsx(FieldDescription, {
                    id: DISPLAY_NAME_HINT_ID,
                    children: t('sidebar.addWorkspaceDisplayNameHint'),
                  }),
                ],
              }),
            persistenceSupported &&
              _jsxs(Field, {
                ...
                children: [
                  _jsxs(FieldContent, {
                    children: [
                      _jsx(FieldLabel, {
                        htmlFor: 'add-workspace-persist',
                        children: t('sidebar.addWorkspacePersist'),
                      }),
                      _jsx(FieldDescription, {
                        children: t('sidebar.addWorkspacePersistHint'),
                      }),
                    ],
                  }),
                  _jsx(Switch, {
        ...
        _jsxs('div', {
          ...
          children: [
            _jsx(Button, {
              ...
              onClick: onClose,
              disabled: submitting,
              children: t('sidebar.addWorkspaceCancel'),
            }),
            _jsx(Button, {
              type: 'submit',
