...
function TimelineClockIcon() {
  return _jsxs('svg', {
    ...
    focusable: 'false',
    children: [
      _jsx('circle', { cx: '8', cy: '8', r: '6.25' }),
      _jsx('path', { d: 'M8 4.5v4l-2.5 2' }),
    ],
  });
}
...
const TurnCollapseRow = memo(function TurnCollapseRow({
  ...
  return _jsxs('div', {
    ...
    children: [
      _jsxs('span', {
        className: turnCollapseStyles.collapseLabel,
        children: [
          _jsxs('span', {
            className: turnCollapseStyles.processedLabel,
            children: [
              statusLabel,
              showVisibleMetrics &&
                _jsxs('span', {
                  className: turnCollapseStyles.processedMeta,
          ...
          showSummaryMetrics &&
            _jsx('span', {
              className: turnCollapseStyles.summaryMetrics,
              children: summaryMetrics,
            }),
          showHiddenMetrics &&
            _jsx('span', {
              className: turnCollapseStyles.hiddenMetrics,
              children: hiddenMetrics,
            }),
        ],
      }),
      hasToggle &&
        _jsx('span', {
          ...
          children: _jsx('span', {
            className: turnCollapse.collapsed
...
const SessionTimeline = memo(function SessionTimeline({
  ...
  const findTooltipAnchor = useCallback((entry) => {
    ...
    const item = Array.from(
      viewport.querySelectorAll('[data-testid="session-timeline-entry"]'),
    ...
    children: _jsxs('nav', {
      ...
      children: [
        _jsx('div', {
          ...
          children: _jsx('ol', {
            className: styles.sessionTimelineList,
            children: entries.map((entry, index) => {
              ...
              return _jsx(
                'li',
                {
                  ...
                  'data-in-current-range': isInCurrentRange
                    ? 'true'
                    : undefined,
                  children: _jsx('button', {
                    ...
                    'aria-describedby': describedByTooltip
                    ...
                    onMouseLeave: hideTooltip,
                    children: _jsx('span', {
                      className: styles.sessionTimelineTick,
                    }),
                  }),
                },
                entry.id,
        ...
        tooltip &&
          ...
          createPortal(
            _jsxs('div', {
              ...
              'data-scheduled-task': tooltip.entry.isScheduledTask
                ? 'true'
                : undefined,
              role: 'tooltip',
              style: {
              ...
              children: [
                _jsxs('span', {
                  className: styles.sessionTimelineDetailsTitle,
                  children: [
                    tooltip.entry.isScheduledTask &&
                      _jsx(TimelineClockIcon, {}),
                    _jsx('span', {
                      className: styles.sessionTimelineDetailsTitleText,
                      children: tooltip.entry.label,
                    }),
                  ],
                }),
                _jsx('span', {
                  className: styles.sessionTimelineDetailsDetail,
                  children: tooltip.entry.detail,
                }),
              ],
            }),
  ...
  return _jsxs(_Fragment, {
    children: [
      ...
      _jsxs('div', {
        ...
        children: [
          _jsx('div', {
            className: styles.loadingSkeletonUserRow,
            children: _jsxs('div', {
              className: styles.loadingSkeletonUserBubble,
              children: [
                _jsx('span', { className: styles.loadingSkeletonLineWide }),
                _jsx('span', { className: styles.loadingSkeletonLineShort }),
              ],
            }),
          }),
          _jsx('div', {
            className: styles.loadingSkeletonAssistantRow,
            children: _jsxs('div', {
              className: styles.loadingSkeletonAssistantBlock,
              children: [
                _jsx('span', { className: styles.loadingSkeletonLineMedium }),
                _jsx('span', { className: styles.loadingSkeletonLineWide }),
                _jsx('span', { className: styles.loadingSkeletonLineNarrow }),
              ],
            }),
          }),
          _jsx('div', {
            className: styles.loadingSkeletonUserRow,
            children: _jsx('div', {
              className: styles.loadingSkeletonUserBubbleCompact,
              children: _jsx('span', {
                className: styles.loadingSkeletonLineMedium,
              }),
            }),
          }),
          _jsx('div', {
...
export const MessageList = memo(
  forwardRef(function MessageList(
    ...
    ] = useState(latestBackgroundNotificationId);
    ...
    useLayoutEffect(() => {
      ...
      olderHistoryAnchorFrame.current = requestAnimationFrame(() => {
        ...
        const anchorRow = olderHistoryAnchor.rowKey
          ? Array.from(current.querySelectorAll('[data-message-row-key]')).find(
    ...
    const loadOlderHistory = useCallback(
      async (allowRetry = false, force = false) => {
          ...
          virtualAnchor = await new Promise((resolve) => {
            const waitForTopRange = () => {
              ...
              const firstMessageRow = Array.from(
                el.querySelectorAll('[data-message-row-key]'),
        ...
        const anchorRow = virtualAnchor
          ? undefined
          : Array.from(el.querySelectorAll('[data-message-row-key]')).find(
              (row) => {
                const key = row.dataset.messageRowKey;
                return (
                  key !== undefined &&
      ...
      (index) => {
        const renderDisplayItem = (displayItem, isLatest) => {
          if (displayItem.type === 'parallel_agents') {
            return _jsx(MessageTimestamp, {
              timestamp: displayItem.timestamp,
              children: _jsx('div', {
                className: displayItemMatchesLocateTarget(
                  displayItem,
                  flashTarget,
                )
                  ? flashStyles.flash
                  : undefined,
                children: _jsx(ParallelAgentsGroup, {
          ...
          if (displayItem.type === 'turn_outputs') {
            return _jsx(TurnOutputs, {
              ...
              onOpenScheduledTask: onOpenScheduledTask ?? noopTurnOutputAction,
              onError: onError,
            });
          }
          if (displayItem.type === 'turn_collapse') {
            return _jsx(TurnCollapseRow, {
    ...
    const getRowClassName = useCallback(
      (item) => (item ? getChatRowClassName(item) : undefined),
      [],
    );
    ...
    return _jsxs('div', {
      ...
      'data-web-shell-message-list': true,
      onClickCapture: handleDisclosureClickCapture,
      children: [
        showLoadingSkeleton &&
          _jsx(LoadingTranscriptSkeleton, {
            label: t('editor.sessionLoading'),
          }),
        loadingOlderHistory &&
          !showLoadingSkeleton &&
          !suppressOlderHistoryLoadingStatus &&
          _jsx('div', {
            ...
            role: 'status',
            children: t('history.loadingEarlier'),
          }),
        historyCapacityReached &&
          ...
          _jsx('div', {
            className: styles.historyStatus,
            role: 'status',
            children: t('history.capacityReached'),
          }),
        historyPaginationError &&
          !showLoadingSkeleton &&
          !historyCapacityReached &&
          _jsxs('div', {
            ...
            children: [
              _jsx('span', {
                role: 'status',
                children: t('history.paginationError'),
              }),
              onLoadOlderHistory &&
                _jsx('button', {
                  type: 'button',
              ...
              children: virtualItems.map((virtualRow) =>
                _jsx(
                  'div',
                  {
                    ...
                    'data-message-row-key': String(
                      getItemKey(virtualRow.index),
                    ),
                    'data-web-shell-message-row': true,
                    style: {
                      position: 'absolute',
                      top: 0,
                      left: 0,
                    ...
                    children: renderVirtualItem(virtualRow.index),
                  },
                  virtualRow.key,
                ),
              ),
          ...
          : Array.from({ length: totalCount }, (_, index) => {
              ...
              return _jsx(
                'div',
                {
                  ...
                  'data-web-shell-message-row': true,
                  children: renderVirtualItem(index),
                },
                key,
              );
            }),
