...
function DialogPortal({ container, ...props }) {
    ...
    return (_jsx(DialogPrimitive.Portal, { "data-slot": "dialog-portal", container: container ?? portalRoot ?? undefined, ...props }));
}
function DialogClose({ ...props }) {
    return _jsx(DialogPrimitive.Close, { "data-slot": "dialog-close", ...props });
}
const DialogOverlay = React.forwardRef(function DialogOverlay({ className, ...props }, ref) {
    return (_jsx(DialogPrimitive.Overlay, { ref: ref, "data-slot": "dialog-overlay", className: cn(
        ...
        'fixed inset-0 isolate z-[var(--web-shell-dialog-backdrop-z-index,50)] bg-black/10 duration-100 data-open:animate-in data-open:fade-in-0 data-closed:animate-out data-closed:fade-out-0', className), ...props }));
});
const DialogContent = React.forwardRef(function DialogContent({ className, children, showCloseButton = true, overlayProps, ...props }, ref) {
    return (_jsxs(DialogPortal, { children: [_jsx(DialogOverlay, { ...overlayProps }), _jsxs(DialogPrimitive.Content, { ref: ref, "data-slot": "dialog-content", className: cn('fixed top-1/2 left-1/2 z-[var(--web-shell-dialog-backdrop-z-index,50)] grid w-full max-w-[calc(100%-2rem)] -translate-x-1/2 -translate-y-1/2 gap-4 rounded-xl bg-popover p-4 text-sm text-popover-foreground ring-1 ring-foreground/10 duration-100 outline-none sm:max-w-sm data-open:animate-in data-open:fade-in-0 data-open:zoom-in-95 data-closed:animate-out data-closed:fade-out-0 data-closed:zoom-out-95', className), ...props, children: [children, showCloseButton && (_jsx(DialogPrimitive.Close, { "data-slot": "dialog-close", asChild: true, children: _jsxs(Button, { variant: "ghost", className: "absolute top-2 right-2", size: "icon-sm", children: [_jsx(XIcon, {}), _jsx("span", { className: "sr-only", children: "Close" })] }) }))] })] }));
});
