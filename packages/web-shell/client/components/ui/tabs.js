...
function Tabs({ className, orientation = 'horizontal', ...props }) {
    return (_jsx(TabsPrimitive.Root, { orientation: orientation, "data-slot": "tabs", "data-orientation": orientation, className: cn('group/tabs flex gap-2 data-horizontal:flex-col', className), ...props }));
}
