  ...
  if (events.length === 0) {
    ...
    if (allCompleted) {
      return _jsx('div', {
        ...
        children: _jsxs('div', {
          className: `${styles.row} ${styles.completed}`,
          children: [
            _jsx('span', {
    ...
    return _jsx('div', {
      className: styles.summary,
      children: _jsxs('div', {
        className: `${styles.row} ${statusClass(current.status)}`,
        children: [
          _jsx('span', {
            className: styles.icon,
            'aria-hidden': 'true',
            children: getTodoStatusIcon(current.status),
          }),
          _jsx('span', { className: styles.text, children: current.content }),
        ],
      }),
    });
  }
  return _jsx('div', {
    ...
    children: events.map((event) =>
      _jsxs(
        'div',
        {
          className: `${styles.row} ${event.kind === 'completed' ? styles.completed : styles.inProgress}`,
          children: [
            _jsx('span', {
              className: styles.icon,
              'aria-hidden': 'true',
              children: getTodoStatusIcon(
                event.kind === 'completed' ? 'completed' : 'in_progress',
              ),
            }),
            _jsx('span', { className: styles.text, children: event.content }),
          ],
        },
        `${event.kind}-${event.id}`,
      ),
...
function DetailSection({ title, children }) {
  return _jsxs('div', {
    ...
    children: [
      _jsx('div', { className: styles.detailSectionTitle, children: title }),
      _jsx('div', { className: styles.detailRows, children: children }),
    ],
  });
}
/**
...
function TodoDetailBlock({ detail }) {
  ...
  return _jsxs('div', {
    ...
    children: [
      hasTime &&
        _jsxs(DetailSection, {
          title: t('todo.detail.sectionTime'),
          children: [
            startTs !== undefined &&
              _jsx(DetailRow, {
            ...
            endTs !== undefined &&
              _jsx(DetailRow, {
                ...
                suffix:
                  startTs !== undefined
                    ? _jsxs('span', {
                        className: styles.detailDuration,
                        children: [
                          ' ',
                          '(',
      ...
      hasTokens &&
        _jsxs(DetailSection, {
          title: t('todo.detail.sectionTokens'),
          children: [
            _jsx(DetailRow, {
      ...
      hasSpent &&
        _jsxs(DetailSection, {
          title: t('todo.detail.sectionSpent'),
          children: [
      ...
      !resources &&
        _jsx('div', {
          className: styles.detailHint,
          children: t('todo.detail.noResources'),
        }),
    ],
  });
}
...
export function TodoFullList({ todos, numbered = false }) {
  ...
  return _jsx('div', {
    ...
    children: todos.map((todo, index) => {
      ...
      const rowInner = _jsxs(_Fragment, {
        children: [
          numbered &&
            _jsxs('span', {
              className: styles.num,
              style: { minWidth: numColumnWidth },
              children: [index + 1, '.'],
            }),
          _jsx('span', {
            className: styles.icon,
            'aria-hidden': 'true',
            children: getTodoStatusIcon(todo.status),
          }),
          _jsx('span', { className: styles.text, children: todo.content }),
          expandable &&
            _jsx('span', {
      ...
      return _jsxs(
        'div',
        {
          ...
          children: [
            ...
            isOpen && detail && _jsx(TodoDetailBlock, { detail: detail }),
          ],
        },
        rowKey,
      );
