...
export function AskUserQuestion({
  ...
  const submitDecision = useCallback(
    async (optionId, submittedAnswers) => {
  ...
  return _jsxs('div', {
    className: `${styles.question} ${variant === 'floating' ? styles.floating : ''} ${collapsed ? styles.collapsed : ''}`,
    'data-web-shell-ask-panel': true,
    role: 'dialog',
    tabIndex: -1,
      ...
      _jsxs('div', {
        ...
        children: [
          ...
          _jsx('span', {
            ...
            id: headingId,
            children: localizeToolDisplayName('ask_user_question', t),
          }),
          _jsx('span', {
            className: styles.toolDesc,
            children: t('askUser.progress', {
              ...
              _jsx('div', {
                ...
                children: questions.map((_, i) =>
                  _jsx(
                    'span',
                    {
                      className: `${styles.tab} ${i === currentIdx ? styles.tabActive : ''}`,
                      'aria-hidden': 'true',
                    },
                    i,
                  ),
                      ...
                      children: [
                        ...
                        isMulti &&
                          _jsxs('span', {
                            ...
                            children: [' ', '(', t('askUser.multiHint'), ')'],
                          }),
                      ],
                    }),
                    _jsx('p', {
                      className: styles.description,
                      children: t('askUser.selectAnswer'),
                    }),
                    _jsxs('div', {
                      ...
                      children: [
                        current.options.map((opt, i) => {
                          ...
                          const isSelected = isMulti
                            ? (selectedMulti[currentIdx] || []).includes(
                                opt.label,
                              )
                          ...
                          return _jsxs(
                            'button',
                            {
                              ...
                              'data-web-shell-ask-option': true,
                        ...
                        (() => {
                          ...
                          return _jsxs('div', {
                            className: `${styles.option} ${hasCustomValue ? styles.optionSelected : ''}`,
                            ...
                            children: [
                              ...
                              customFocused
                                ...
                                : _jsx('button', {
                                    type: 'button',
                                    ref: customRef,
                                    className: `${styles.customTrigger} ${hasCustomValue ? '' : styles.optionPlaceholder}`,
                                    'data-web-shell-ask-option': true,
                  ...
                  _jsxs(_Fragment, {
                    children: [
                      ...
                      _jsx('button', {
                        ...
                        className: styles.button,
                        disabled:
                          submitting || currentIdx >= questions.length - 1,
                        onClick: handleNext,
