...
interface AskUserQuestionProps {
    ...
    onConfirm: (id: string, selectedOption: string, answers?: Record<string, string>) => Promise<boolean>;
...
export declare function AskUserQuestion({ request, onConfirm, onError, variant, keyboardActive, }: AskUserQuestionProps): import("react/jsx-runtime").JSX.Element | null;
export {};
