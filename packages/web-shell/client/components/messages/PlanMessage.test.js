...
function renderPlan(id, todos, timeline) {
    const container = document.createElement('div');
    document.body.appendChild(container);
    const root = createRoot(container);
    act(() => {
        root.render(_jsx(I18nProvider, { language: "en", children: _jsx(TodoTimelineContext.Provider, { value: timeline ?? new Map(), children: _jsx(PlanMessage, { id: id, todos: todos }) }) }));
    });
...
describe('PlanMessage', () => {
    ...
    it('expands to the full list on click', () => {
        const container = renderPlan('p1', TODOS);
        const chevron = [...container.querySelectorAll('span')].find((s) => s.textContent === '▸');
...
//# sourceMappingURL=PlanMessage.test.js.map