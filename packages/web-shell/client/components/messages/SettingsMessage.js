  ...
  return _jsxs(Field, {
    ...
    children: [
      _jsxs(FieldContent, {
        className: 'min-w-0',
        children: [
          _jsxs(FieldTitle, { children: [title, metadata] }),
          description &&
      ...
      _jsx('div', {
        className: 'flex min-w-0 justify-end max-md:justify-start',
        children: control,
      }),
    ],
  });
  ...
  const renderSettingControl = (setting) => {
    ...
    if (setting.key === LANGUAGE_SETTING_KEY) {
      return renderSelect(
        ...
        (next) => onLanguageChange(next, scope),
    ...
    if (SUB_DIALOG_KEYS.has(setting.key)) {
      return _jsx(Button, {
        ...
        children: formatValue(setting, scope, t) || t('settings.action.select'),
      });
    }
    if (setting.type === 'boolean') {
    ...
    children: [
      ...
      (message || showInitialLoading) &&
        _jsxs(Alert, {
          ...
          children: [
            showInitialLoading && _jsx(Spinner, {}),
            _jsx(AlertDescription, {
              children: message || t('settings.loading'),
            }),
          ],
        }),
      _jsxs(Tabs, {
        ...
        children: [
          _jsxs('div', {
            className:
              'flex items-center justify-between gap-4 border-b border-border px-3 py-2',
            children: [
              _jsxs(TabsList, {
                className: 'p-0',
                children: [
                  ...
                  _jsx(TabsTrigger, {
                    value: 'user',
                    children: t('settings.scope.user'),
                  }),
                ],
              }),
              restartPending &&
                _jsx(Badge, {
                  variant: 'secondary',
                  children: t('settings.requiresRestart'),
                }),
            ],
          }),
          _jsxs(TabsContent, {
            ...
            forceMount: true,
            className:
              'grid min-h-0 flex-1 grid-cols-[190px_minmax(0,1fr)] outline-none max-md:grid-cols-1',
            children: [
              _jsx('nav', {
                className:
                  'flex min-h-0 flex-col gap-1 overflow-y-auto border-r border-border bg-muted/20 p-3 max-md:flex-row max-md:overflow-x-auto max-md:border-r-0 max-md:border-b',
                ...
                children: categories.map((category) =>
                  _jsxs(
                    Button,
                    {
                      ...
                      className:
                        'w-full justify-start gap-2 px-2.5 max-md:w-auto max-md:shrink-0',
                      onClick: () => setActiveCategory(category.id),
                      children: [
                        _jsx(CategoryIcon, { category: category.id }),
                        _jsx('span', {
              ...
              _jsxs('section', {
                className:
                  'min-h-0 min-w-0 overflow-y-auto bg-background p-5 max-md:p-3',
                children: [
                  !loading &&
                    !activeGroup &&
                    _jsx(Empty, {
                      ...
                      children: _jsxs(EmptyHeader, {
                        children: [
                          _jsx(EmptyMedia, {
                            variant: 'icon',
                            children: _jsx(Settings2Icon, {}),
                          }),
                          _jsx(EmptyTitle, { children: t('settings.empty') }),
                    ...
                    _jsxs('div', {
                      ...
                      children: [
                          ...
                          children: [
                            ...
                            _jsx(CardContent, {
                              ...
                              children: _jsx(FieldGroup, {
                                className: 'gap-0',
                                children: activeGroup.items.map(
                                  (item, index) => {
                                    const separator =
                                      index > 0 &&
                                      _jsx(Separator, {
                                        className: 'mx-5 w-auto max-md:mx-4',
                                      });
                                    if (item.type === 'local') {
                                      return _jsxs(
                                        'div',
                                    ...
                                    const description =
                                      formatSettingDescription(setting, t);
                                    const hintKey = scopeHintKey(
                                      setting,
                                      scope,
                                    );
                                    const hasScopeValue = scopeHasValue(
                                      setting,
                                      scope,
                                    );
                        ...
                        isModelCategory &&
                          ...
                          _jsx('div', {
                            className: 'mt-4',
                            children: _jsx(ModelManagementSection, {
                              ...modelManagement,
                            }),
                          }),
                      ],
      ...
      !embedded &&
        _jsx('div', {
          className:
            'border-t border-border px-5 py-3 text-xs text-muted-foreground',
          children: t('settings.footer'),
        }),
    ],
  });
}
