...
export function PlanExecutionView({ todos, tools, tasks, onOpenSubagent }) {
      ...
      'div',
      {
        ...
        children: [
          _jsxs('button', {
            ...
            children: [
              _jsx('span', {
                className: styles.executionLabel,
                children: label,
              }),
              _jsx('span', {
                className: styles.executionStatus,
                children: t(executionStatusKey(status)),
              }),
            ],
          }),
          nestedTasks.map(({ task, depth }) => {
            ...
            const content = _jsxs(_Fragment, {
              children: [
                ...
                _jsx('span', {
                  className: styles.executionStatus,
                  children: t(executionStatusKey(task.status)),
                }),
              ],
            });
            return nestedTool
                ...
                children: [
                  _jsxs('span', {
                    ...
                    children: [
                      ...
                      nestedTool.title ||
                        String(
                          nestedTool.args?.description ?? nestedTool.toolName,
                        ),
                    ],
                  }),
                  _jsx('span', {
  ...
  return _jsxs('section', {
    ...
    'aria-label': t('planExecution.title'),
    children: [
      _jsxs('div', {
                  ...
                  children: layer.map((todo) => {
                    ...
                    return _jsxs(
                      'article',
                      {
                        ...
                        'data-selected':
                          selectedTodoId === todo.id || undefined,
                        ref: (node) => {
                        ...
                        children: [
                              ...
                              _jsxs('div', {
                                ...
                                children: [
                                  ...
                                  _jsx('span', {
                                    ...
                                    children: t(statusKey(state.status)),
                                  }),
                                  state.attention &&
                                    _jsx('span', {
                                      className: styles.attention,
                                      children: t('planExecution.attention'),
                                    }),
                                ],
                              }),
                              _jsx('div', {
                          ...
                          executions.length > 0 &&
                            _jsx('div', {
                              ...
                              children: executions.map(renderExecution),
                            }),
                        ],
                      },
                      todo.id,
      ...
      selectedTodo &&
        ...
        _jsxs('section', {
          ...
          'data-plan-step-details': true,
          id: detailsId,
          'aria-label': `${t('planExecution.stepDetails')}: ${selectedTodo.id}`,
          children: [
            _jsxs('div', {
              className: styles.stepDetailsHeading,
              children: [
                _jsx('span', { children: t('planExecution.stepDetails') }),
                _jsx('span', {
                  className: styles.nodeId,
                  children: selectedTodo.id,
                }),
                _jsx('span', {
                  className: `${styles.nodeStatus} ${styles[selectedState.status]}`,
                  children: t(statusKey(selectedState.status)),
                }),
            ...
            selectedExecutions.length > 0 &&
              _jsxs('div', {
                className: styles.stepExecutions,
                children: [
                  _jsx('div', {
                    className: styles.stepExecutionsTitle,
                    children: t('planExecution.subagents'),
                  }),
                  _jsx('div', {
                    className: styles.executions,
                    children: selectedExecutions.map(renderExecution),
                  }),
                ],
              }),
          ],
        ...
        _jsxs('div', {
          ...
          children: [
            _jsx('div', {
              ...
              children: t('planExecution.unassigned'),
            }),
            _jsx('div', {
              className: styles.executions,
              children: unassigned.map(renderExecution),
            }),
          ],
        }),
    ],
