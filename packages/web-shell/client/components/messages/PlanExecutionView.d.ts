...
export type PlanNodeStatus =
  ...
  | 'in_progress'
  | 'ready';
export declare function layerPlanTodos(
  todos: readonly TodoItem[],
): TodoItem[][];
export declare function nestedTasksForTool(
  tool: ACPToolCall,
...
export declare function getPlanNodeState(
  todo: TodoItem,
...
export declare function PlanExecutionView({
  todos,
  tools,
  tasks,
  onOpenSubagent,
