...
import { computeAgentTreeInfo, computeUserBlockingIds, reorderChildrenUnderParents, } from './agentForest';
...
describe('reorderChildrenUnderParents', () => {
    ...
    it('keeps non-agent entries at their exact positions', () => {
        const shell = { kind: 'shell', id: 'sh-1' };
        const monitor = { kind: 'monitor', id: 'mon-1' };
        const entries = [
            agent('p'),
            shell,
            agent('q'),
...
//# sourceMappingURL=agentForest.test.js.map