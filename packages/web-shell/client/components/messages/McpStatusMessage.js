...
} = createSentinelSerializer('web-shell:mcp-status:v1:');
...
function schemaSummary(tool, t) {
  ...
  if (!properties || typeof properties !== 'object') {
    ...
    return raw
      ? _jsx('pre', { className: styles.schema, children: raw })
      : null;
  }
  ...
  return _jsxs('div', {
    ...
    children: [
      _jsx('div', {
        ...
        children: t('mcp.parameters'),
      }),
      entries.map(([name, param]) => {
        const details = param && typeof param === 'object' ? param : {};
        const type =
        ...
        return _jsx(
          'div',
          {
            ...
            children: `• ${name}${requiredMarker(required.has(name), t)}: ${type}${description ? ` - ${description}` : ''}`,
          },
          name,
        );
      }),
        ...
        _jsxs('div', {
          ...
          children: [
            _jsx('div', {
              ...
              children: t('mcp.manageServers'),
            }),
            _jsx('div', {
              className: styles.secondary,
              children: t('mcp.servers', { count: 0 }),
            }),
          ],
        }),
        _jsx('div', { className: styles.secondary, children: t('mcp.empty') }),
        _jsx('div', {
  ...
  return _jsxs('div', {
    ...
    children: [
      ...
      _jsxs('div', {
        className: styles.header,
        children: [
          _jsx('div', { className: styles.title, children: title }),
          subtitle &&
            _jsx('div', { className: styles.secondary, children: subtitle }),
        ],
      }),
      step === 'servers' &&
        _jsx('div', {
          className: styles.list,
          children: groupedServers.map((group) => {
            let offset = 0;
      ...
      step === 'server' &&
        ...
        _jsxs('div', {
          ...
          children: [
            _jsxs('div', {
              className: styles.serverFields,
              children: [
                _jsxs('div', {
                  className: styles.serverField,
                  children: [
                    _jsxs('span', {
                      className: styles.serverFieldLabel,
                      children: [t('mcp.status'), ':'],
                    }),
                    _jsxs('span', {
                      className: statusDisplay(selectedServer, t).className,
                      children: [
                ...
                _jsxs('div', {
                  ...
                  children: [
                    _jsxs('span', {
                      className: styles.serverFieldLabel,
                      children: [t('mcp.source'), ':'],
                    }),
                    _jsx('span', { children: sourceLabel(selectedServer, t) }),
                  ],
                }),
                _jsxs('div', {
                  className: styles.serverField,
                  children: [
                    ...
                    _jsx('span', {
                      ...
                      children: formatServerCommand(selectedServer, t),
                    }),
                  ],
                }),
                selectedServer.config?.cwd &&
                  _jsxs('div', {
                    ...
                    children: [
                      _jsxs('span', {
                        className: styles.serverFieldLabel,
                        children: [t('mcp.workingDirectory'), ':'],
                      }),
                      _jsx('span', {
                        className: styles.truncate,
                        children: selectedServer.config.cwd,
                      }),
                    ],
                  }),
                !selectedServer.disabled &&
            ...
            _jsx('div', {
              className: styles.list,
              children: serverActions.map((action, index) => {
                ...
                return _jsxs(
                  'div',
                  {
                    ...
                    children: [
                      ...
                      _jsx('span', { children: action.label }),
                    ],
                  },
                  action.id,
                );
        ...
        _jsxs('div', {
          ...
          children: [
            !selectedTool.isValid &&
              _jsxs('div', {
                className: styles.invalidBlock,
                children: [
                  _jsx('div', {
                    className: styles.sectionTitle,
                    children: t('mcp.invalidToolWarning'),
                  }),
                  _jsxs('div', {
                    children: [
            ...
            selectedTool.description &&
              _jsxs('div', {
                ...
                children: [
                  _jsx('div', {
                    className: styles.sectionTitle,
                    children: t('mcp.description'),
                  }),
                  _jsx('div', {
                    className: styles.description,
                    children: selectedTool.description.trim(),
                  }),
                ],
              }),
            toolAnnotationText(selectedTool, t) &&
              _jsxs('div', {
                ...
                children: [
                  _jsx('span', {
                    className: styles.sectionTitle,
                    children: t('mcp.annotations'),
                  }),
                  ' ',
                  _jsx('span', {
                    children: toolAnnotationText(selectedTool, t),
                  }),
                ],
              }),
