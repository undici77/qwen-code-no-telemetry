...
export declare function ParallelAgentsGroup({ agents, autoManageExpansion, automaticCollapseDelayMs, deferAutomaticCollapse, expandActiveWhenLive, onAutomaticExpansionChange, pendingApproval, }: ParallelAgentsGroupProps): import("react/jsx-runtime").JSX.Element;
export {};
