    ...
    children: [
        ...
        children: [
          ...
          _jsxs('span', {
            ...
            children: [
              ...
              runningDuration &&
                _jsxs(_Fragment, { children: [' ', runningDuration] }),
              _jsx('span', {
      ...
      renderGroup &&
        _jsx('div', {
          ...
          className: `${styles.groupViewport} ${automaticCollapseClosing ? styles.groupViewportClosing : ''}`,
          'data-agent-collapse-exit': automaticCollapseClosing
            ? 'true'
            : undefined,
          'aria-hidden': automaticCollapseClosing || undefined,
          children: _jsx('div', {
            className: styles.groupViewportInner,
            children: _jsx('div', {
                    ...
                    'div',
                    {
                      children: [
                        _jsxs('button', {
                          ...
                          'data-detail-mode': subagentDetails
                            ? 'panel'
                            : 'inline',
                          'aria-expanded': subagentDetails
                            ? undefined
                            : isExpanded,
                          title: subagentDetails
                          ...
                          children: [
                              ...
                              children: [
                                ...
                                _jsx('span', {
                                  ...
                                  children: truncateText(
                                    desc || localizedAgentType,
                                    50,
                                  ),
                                }),
                                activity &&
                                  _jsxs('span', {
                                    className: styles.rowActivity,
                                    children: ['(', activity, ')'],
                                  }),
                              ],
                            }),
                            (stats.duration || stats.tokens) &&
                              _jsxs('span', {
                                ...
                                children: [
                                  stats.duration &&
                                    _jsx('span', { children: stats.duration }),
                                  stats.duration &&
                                    stats.tokens &&
                                    _jsx('span', {
                                      'aria-hidden': 'true',
                                  ...
                                  stats.tokens &&
                                    _jsx('span', { children: stats.tokens }),
                                ],
                              }),
