...
function SubToolTime({ timestamp, children }) {
  if (timestamp === undefined) return _jsx(_Fragment, { children: children });
  return _jsxs('div', {
    className: styles.toolTimeRow,
    children: [
      children,
      _jsx('span', {
        className: styles.toolTimeTip,
        'aria-hidden': 'true',
...
const SubToolLine = memo(function SubToolLine({ tool }) {
  ...
  const body =
    tool.subTools || tool.subContent
      ? _jsx(SubAgentPanel, { tool: tool })
      : _jsx(ToolLine, {
          tool: tool,
          forceExpandable: true,
          hideCollapsedOutput: true,
        });
...
function TaskToolCallLine({ tc }) {
  const { t } = useI18n();
  return _jsx('div', {
    className: chromeStyles.line,
    children: _jsxs('div', {
      className: chromeStyles.lineMain,
      children: [
        _jsx(StatusIcon, { status: tc.status }),
        _jsx('span', {
          className: chromeStyles.lineName,
          children: localizeToolDisplayName(tc.name, t),
        }),
      ],
    }),
  });
...
function SubAgentResult({ content }) {
  const { compactThinking } = useWebShellCustomization();
  return _jsx('div', {
    className: compactThinking ? styles.scrollWindow : undefined,
    children: _jsx(Markdown, { content: content, source: 'assistant' }),
  });
}
/**
...
function SubAgentTools({ pinTail, itemCount, children }) {
  ...
  return _jsx('div', {
    ref: windowRef,
    className: `${styles.tools} ${styles.scrollWindow}`,
    children: children,
  });
}
export function SubAgentPanel({ tool, defaultExpanded, hideHeader, inline }) {
  ...
  return _jsxs('div', {
    className: inline ? undefined : styles.panel,
    children: [
      !hideHeader &&
        _jsxs('div', {
          ...
          children: [
            _jsx(StatusIcon, { status: displayStatus }),
            _jsxs('span', {
              className: chromeStyles.lineName,
              children: [localizeAgentTypeName(agentType, t), ':'],
            }),
            description &&
              _jsx('span', {
                className: styles.desc,
                children: truncateText(description, 50),
              }),
            isComplete &&
              subToolCount > 0 &&
              _jsxs('span', {
          ...
          children: [
            isComplete &&
              ...
              _jsxs('div', {
                ...
                children: [
                  showSectionCaps &&
                    _jsx('div', {
                      className: styles.sectionCap,
                      children: t('subagent.result'),
                    }),
                  _jsx(SubAgentResult, {
                    content: tool.subContent || resultText,
                  }),
                ],
              }),
            showSectionCaps &&
              _jsx('div', {
                className: styles.sectionCap,
                children: t('subagent.tools', { count: subToolCount }),
              }),
            tool.subTools &&
              ...
              _jsx(SubAgentTools, {
                ...
                children: tool.subTools.map((sub) =>
                  _jsx(
                    'div',
                    {
                      className: styles.step,
                      'data-status': sub.status,
                      children: _jsx(SubToolLine, { tool: sub }),
                    },
                    sub.callId,
                  ),
                ),
            ...
            taskToolCalls &&
              ...
              _jsx(SubAgentTools, {
                ...
                children: taskToolCalls.map((tc) =>
                  _jsx(
                    'div',
                    {
                      className: styles.step,
                      'data-status': tc.status,
                      children: _jsx(TaskToolCallLine, { tc: tc }),
                    },
                    tc.callId,
                  ),
                ),
            ...
            !isComplete &&
              ...
              _jsx('div', {
                className: styles.content,
                children: _jsx(SubAgentStream, { text: tool.subContent }),
              }),
          ],
        }),
    ],
