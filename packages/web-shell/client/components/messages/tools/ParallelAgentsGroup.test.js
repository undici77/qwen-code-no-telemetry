...
function renderExpandedGroup(agents) {
  ...
  act(() => {
    root.render(
      _jsx(I18nProvider, {
        language: 'en',
        children: _jsx(ParallelAgentsGroup, { agents: agents }),
      }),
    );
  });
...
function renderManagedGroup(agents, options = {}) {
  ...
  const render = (nextAgents, nextOptions = options) => {
    act(() => {
      ...
      root.render(
        nextOptions.strictMode ? _jsx(StrictMode, { children: group }) : group,
      );
    });
  };
  render(agents);
    ...
    try {
      ...
      act(() => {
        root.render(
          _jsx(I18nProvider, {
            language: 'en',
            children: _jsx(ParallelAgentsGroup, { agents: [early, late] }),
          }),
        );
      });
      mounted.push({ root, container });
    ...
    try {
      ...
      act(() => {
        root.render(
          _jsx(I18nProvider, {
            language: 'en',
            children: _jsx(ParallelAgentsGroup, { agents: [first, second] }),
          }),
        );
      });
      mounted.push({ root, container });
      ...
      act(() => {
        root.render(
          _jsx(I18nProvider, {
            language: 'en',
            children: _jsx(ParallelAgentsGroup, { agents: finished }),
          }),
        );
      });
      ...
      root.render(
        _jsx(I18nProvider, {
          ...
          children: _jsx(SubagentDetailsProvider, {
            onOpen: onOpen,
            children: _jsx(ParallelAgentsGroup, { agents: [nested] }),
          }),
        }),
      );
    });
