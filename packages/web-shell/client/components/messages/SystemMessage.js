...
export const SystemMessage = memo(function SystemMessage({
  ...
  if (source === 'prompt_cancelled') {
    return _jsx('div', {
      ...
      role: 'status',
      children: _jsx('span', { children: t('turn.stopped') }),
    });
  }
  const contextUsage =
  ...
  if (contextUsage) {
    return _jsx('div', {
      className: styles.flushMessage,
      children: _jsx(ContextUsageMessage, {
        status: contextUsage,
  ...
  if (statusInfo) {
    return _jsx('div', {
      className: styles.flushMessage,
      children: _jsx(StatusMessage, { info: statusInfo }),
    });
  }
  ...
  if (mcpStatus) {
    return _jsx('div', {
      className: styles.flushMessage,
      children: _jsx(McpStatusMessage, { message: mcpStatus }),
    });
  }
  const tasksStatus =
  ...
  if (tasksStatus) {
    return _jsx('div', {
      className: styles.flushMessage,
      children: _jsx(TasksStatusMessage, { message: tasksStatus }),
    });
  }
  const goalStatus =
    variant === 'info'
  ...
  if (goalStatus) {
    return _jsx('div', {
      className: styles.flushMessage,
      children: _jsx(GoalStatusMessage, {
        status: goalStatus,
        activateFooter: isLatest,
      }),
    });
  }
  ...
  const renderedContent = preserveWhitespace
    ? _jsx('pre', { children: content })
    : variant === 'info'
      ? _jsx(Markdown, { content: content })
      : _jsx('pre', { children: content });
  if (isTaskNotification) {
    return _jsx('div', {
      className: styles.notificationBubbleRow,
      children: _jsx('div', {
        className: styles.notificationBubbleColumn,
        children: _jsxs('div', {
          ...
          children: [
            _jsx('span', {
              ...
              children: _jsx(TaskNotificationIcon, { 'aria-hidden': 'true' }),
            }),
            _jsx('div', {
              className: styles.notificationText,
              children: taskI18nText ?? _jsx(Markdown, { content: content }),
            }),
          ],
        }),
      }),
  ...
  return _jsx('div', {
    className: `${styles.message} ${styles[variant]} ${preserveWhitespace ? styles.modelSwitch : ''} ${isRecap ? styles.recap : ''}`,
    children: _jsxs('div', {
