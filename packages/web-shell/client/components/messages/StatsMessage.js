...
function KvRow({ label, children }) {
  return _jsxs('div', {
    ...
    children: [
      _jsx('span', { className: styles.kvLabel, children: label }),
      _jsx('span', { className: styles.kvValue, children: children }),
    ],
  });
}
function KvSubRow({ label, children }) {
  return _jsxs('div', {
    className: styles.kvSubRow,
    children: [
      _jsxs('span', {
  ...
  const cellClass =
    variant === 'section'
      ...
      : variant === 'sub'
        ...
        : styles.metricCell;
  return _jsxs('div', {
    className: styles.pivotRow,
    children: [
      _jsx('span', {
        className: cellClass,
        children: variant === 'sub' ? `↳ ${metric}` : metric,
      }),
      values.map((v, i) =>
        _jsx('span', { className: styles.modelCell, children: v }, i),
      ),
    ],
  });
}
...
function StatsOverview({ status }) {
  ...
  return _jsxs('div', {
    ...
    children: [
      _jsx('div', { className: styles.title, children: t('stats.title') }),
      _jsx('div', {
        className: styles.sectionTitle,
        children: t('stats.overview'),
      }),
      _jsx(KvRow, {
        label: t('stats.duration'),
        children: formatDuration(status.durationMs),
      }),
      _jsx(KvRow, { label: t('stats.prompts'), children: status.promptCount }),
      _jsx(KvRow, {
        ...
        children: _jsxs('span', {
          children: [
            tools.totalCalls,
            ' ',
            _jsx('span', { className: styles.secondary, children: '(' }),
            _jsxs('span', {
      ...
      _jsx('div', {
        className: styles.sectionTitle,
        children: t('stats.performance'),
      }),
      _jsxs(KvSubRow, {
        label: t('stats.apiTime'),
        children: [
          formatDuration(totalApiTime),
          ' ',
          _jsxs('span', {
            className: styles.secondary,
            children: ['(', apiPercent.toFixed(1), '%)'],
          }),
        ],
      }),
      _jsxs(KvSubRow, {
        label: t('stats.toolTime'),
        children: [
          formatDuration(totalToolTime),
          ' ',
          _jsxs('span', {
            className: styles.secondary,
            children: ['(', toolPercent.toFixed(1), '%)'],
          }),
        ],
      }),
      entries.length > 0 &&
          ...
          children: [
            ...
            _jsxs('div', {
              ...
              children: [
                ...
                _jsx('span', {
                  className: styles.tableValueCol,
                  children: t('stats.reqs'),
                }),
                _jsx('span', {
                  className: styles.tableValueCol,
                  children: t('stats.inputTokens'),
                }),
                _jsx('span', {
                  className: styles.tableValueCol,
                  children: t('stats.outputTokens'),
                }),
              ],
            }),
              ...
              _jsxs(
                'div',
                {
                  ...
                  children: [
                    ...
                    _jsx('span', {
                      className: styles.tableValueCol,
                      children: e.metrics.api.totalRequests,
                    }),
                    _jsx('span', {
                      className: `${styles.tableValueCol} ${styles.warning}`,
                      children: e.metrics.tokens.prompt.toLocaleString(),
                    }),
                    _jsx('span', {
                      className: `${styles.tableValueCol} ${styles.warning}`,
                      children: e.metrics.tokens.candidates.toLocaleString(),
                    }),
                  ],
                },
                e.key,
                ...
                children: [
                  ...
                  _jsxs('div', {
                    children: [
                      _jsx('span', {
                        className: styles.success,
                        children: t('stats.savingsHighlight'),
                      }),
                      ' ',
...
function ModelStatsCard({ status }) {
    ...
    return _jsxs('div', {
      ...
      children: [
        _jsx('div', {
          ...
          children: t('stats.modelStats'),
        }),
        _jsx('div', { children: t('stats.noApiCalls') }),
      ],
    });
  }
  ...
  return _jsxs('div', {
    className: styles.panel,
    children: [
      _jsx('div', { className: styles.title, children: t('stats.modelStats') }),
      _jsx('div', { className: styles.spacer }),
      _jsxs('div', {
        className: styles.pivotRow,
        children: [
          _jsx('span', {
            className: styles.metricCellSection,
            children: t('stats.metric'),
          }),
          entries.map((e) =>
            _jsx(
              'span',
              { className: styles.modelCellHeader, children: e.label },
              e.key,
            ),
          ),
        ],
...
function ToolStatsCard({ status }) {
  ...
  if (entries.length === 0) {
    return _jsxs('div', {
      ...
      children: [
        _jsx('div', {
          className: styles.title,
          children: t('stats.toolStats'),
        }),
        _jsx('div', { children: t('stats.noToolCalls') }),
      ],
    });
  }
  ...
  return _jsxs('div', {
    className: styles.panel,
    children: [
      _jsx('div', { className: styles.title, children: t('stats.toolStats') }),
      _jsx('div', { className: styles.spacer }),
      _jsxs('div', {
        className: styles.tableRow,
        children: [
          _jsx('span', {
            className: styles.tableToolCol,
            children: t('stats.toolName'),
          }),
          _jsx('span', {
            className: styles.tableNumCol,
            children: t('stats.calls'),
          }),
          _jsx('span', {
            className: styles.tableNumCol,
      ...
      entries.map((e) => {
        ...
        return _jsxs(
          'div',
          {
            ...
            children: [
              _jsx('span', {
                className: `${styles.tableToolCol} ${styles.metricCell}`,
                children: localizeToolDisplayName(e.name, t),
              }),
              _jsx('span', {
                className: styles.tableNumCol,
                children: e.stats.count,
              }),
              _jsxs('span', {
                className: `${styles.tableNumCol} ${
                  rate >= 90
              ...
              _jsx('span', {
                className: styles.tableNumCol,
                children: formatDuration(avgDur),
              }),
            ],
          },
          e.name,
      ...
      _jsx('div', {
        className: styles.sectionTitle,
        children: t('stats.decisionSummary'),
      }),
      _jsx(KvRow, { label: t('stats.totalReviewed'), children: totalReviewed }),
      _jsx(KvSubRow, {
            ...
            totalReviewed > 0
              ? agreementRate >= 90
                ...
                : agreementRate >= 70
                  ...
                  : styles.error
              : undefined,
          children: totalReviewed > 0 ? `${agreementRate.toFixed(1)}%` : '--',
        }),
      }),
    ],
  });
