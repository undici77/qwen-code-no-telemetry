...
export const AssistantMessage = memo(function AssistantMessage({
  ...
  return _jsxs('div', {
    ...
    children: [
      content &&
        _jsx('div', {
          className: `${styles.content}${isLocateFlashing ? ` ${flashStyles.flash}` : ''}`,
          children: _jsx('div', {
      ...
      customFooter &&
        _jsx('div', { className: styles.customFooter, children: customFooter }),
      showFooter &&
        _jsxs('div', {
...
function BranchIcon() {
  return _jsxs('svg', {
    ...
    children: [
      ...
      _jsx('circle', { cx: '5', cy: '3.5', r: '1.5', fill: 'currentColor' }),
      _jsx('circle', { cx: '11', cy: '4', r: '1.5', fill: 'currentColor' }),
      _jsx('circle', { cx: '11', cy: '12.5', r: '1.5', fill: 'currentColor' }),
    ],
  });
}
...
export const ThinkingMessage = memo(function ThinkingMessage({
  ...
  return _jsx('div', {
    className: `${styles.message}${isLocateFlashing ? ` ${flashStyles.flash}` : ''}`,
    children:
      content &&
      !compactMode &&
      _jsx('div', {
        ...
        children: _jsxs('div', {
          ...
          children: [
            _jsxs('div', {
              className: `${styles.thinkingHeader}${thinkingExpanded ? ` ${styles.thinkingHeaderExpanded}` : ''}`,
              onClick: (event) => {
              ...
              children: [
                _jsxs('button', {
                  ...
                  title: thinkingExpanded
                    ? t('thinking.collapse')
                    : t('thinking.expand'),
                  children: [
                    _jsx('span', {
                      className: styles.thinkingSummaryIcon,
                      'aria-hidden': 'true',
                      children: _jsx(ThinkingDoneIcon, {}),
                    }),
                    _jsx('span', {
                      className: thinkingActive
                      ...
                      _jsxs(PopoverContent, {
                        ...
                        children: [
                          _jsx('div', {
                            ...
                            children: t('thinking.translation'),
                          }),
                          translationError
                            ? _jsx('div', {
                                className: styles.translationError,
                                children: t('thinking.translationFailed'),
                              })
                            : translation?.text
                              ? _jsx('div', {
                              ...
                              : _jsx('div', {
                                  className: styles.translationPending,
                                  children: t(
                                    translationThinking
                          ...
                          _jsxs('div', {
                            className: styles.translationFooter,
                            children: [
                              _jsx('div', {
                                className: styles.translationUsage,
                                children:
                                  !translationLoading &&
                                  translation?.text &&
                                  _jsxs(_Fragment, {
                                    children: [
                                      _jsx('span', {
                                        children: t('thinking.inputTokens', {
                                          count:
                                            translation.inputTokens ?? '--',
                                        }),
                                      }),
                                      _jsx('span', {
                                        children: t('thinking.outputTokens', {
                                          count:
                              ...
                              _jsxs('div', {
                                className: styles.translationActions,
                                children: [
                                  _jsx(Button, {
                                    type: 'button',
                                    variant: 'outline',
                                    ...
                                    children: t('thinking.retranslate'),
                                  }),
                                  _jsx(Button, {
                                    type: 'button',
                                    variant: 'outline',
            ...
            thinkingExpanded &&
              _jsx('div', {
                className: styles.thinkingExpandedClip,
                children: _jsx('div', {
                  className: styles.thinkingExpandedInner,
                  children: _jsx('div', {
