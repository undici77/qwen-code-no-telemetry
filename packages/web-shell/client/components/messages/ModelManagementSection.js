      ...
      _jsxs('div', {
        ...
        children: [
          _jsx('span', {
            ...
            children: t('settings.models.title'),
          }),
          _jsx('button', {
            type: 'button',
            ...
            disabled: busy,
            onClick: onAddModel,
            children: t('settings.models.add'),
          }),
        ],
      }),
      error && _jsx('div', { className: styles.hint, children: error.message }),
      loading &&
        !hasModels &&
        _jsx('div', {
          className: styles.hint,
          children: t('settings.models.loading'),
        }),
      !loading &&
        !hasModels &&
        !error &&
        _jsx('div', {
          ...
          children: t('settings.models.empty'),
        }),
                            ...
                            children: [
                              ...
                              current &&
                                _jsx('span', {
                                  ...
                                  children: t('settings.models.current'),
                                }),
                              model.isRuntime &&
                                _jsx('span', {
                                  className: styles.runtimeBadge,
                                  children: t('settings.models.runtime'),
                                }),
                              model.baseUrl &&
                                _jsx('span', {
                                  className: styles.modelBaseUrl,
                                  children: model.baseUrl,
                                }),
                            ],
                          }),
                          _jsxs('div', {
                            className: styles.modelActions,
                            children: [
                              !current &&
                                _jsx('button', {
                                  type: 'button',
                                  ...
                                  children: t('settings.models.setCurrent'),
                                }),
                              !model.isRuntime &&
                                (confirming
                                  ? _jsxs(_Fragment, {
                                      children: [
                                        ...
                                        _jsx('button', {
                                          ...
                                          children: t('settings.models.cancel'),
                                        }),
                                      ],
                                    })
                                  : _jsx('button', {
                                      ...
                                      children: t('settings.models.delete'),
                                    })),
                            ],
                          }),
                        ],
