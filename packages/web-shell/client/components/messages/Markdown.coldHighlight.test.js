...
const mocks = vi.hoisted(() => ({
    getCachedHtml: vi.fn(() => null),
    highlightToHtmlSync: vi.fn(),
    getCodeHighlighter: vi.fn(),
    isTooLargeToHighlight: vi.fn(() => false),
}));
...
beforeEach(() => {
    ...
    mocks.highlightToHtmlSync
        .mockReset()
        .mockImplementation((code, lang) => lang === 'typescript' ? `<span data-hl>${String(code)}</span>` : null);
...
//# sourceMappingURL=Markdown.coldHighlight.test.js.map