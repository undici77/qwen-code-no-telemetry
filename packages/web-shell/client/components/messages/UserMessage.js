...
export const UserMessage = memo(function UserMessage({
  ...
  const renderedContent = useMemo(() => {
    ...
    if (inputAnnotations && inputAnnotations.length > 0) {
      return _jsx(DefaultUserMessageContent, {
        composerTagIcons: composerTagIcons,
        content: content,
  ...
  return _jsx('div', {
    ...
    children: _jsxs('div', {
      ...
      children: [
        _jsxs('div', {
          className: `${styles.chatBubble}${isLocateFlashing ? ` ${flashStyles.flash}` : ''}`,
          children: [
            _jsxs('div', {
              ref: contentRef,
              className: `${styles.chatContent} ${heightOverflowing && !expanded ? styles.chatContentCollapsed : ''}`,
              children: [
                images &&
                  images.length > 0 &&
                  _jsx('div', {
                    className: styles.chatImages,
        ...
        sendFailed &&
          onRetrySend &&
          _jsxs('div', {
            className: styles.sendFailure,
            children: [
              _jsx('span', { children: t('userMessage.sendFailed') }),
              _jsxs('button', {
                type: 'button',
                ...
                children: [
                  _jsx(RefreshCwIcon, { 'aria-hidden': 'true' }),
                  _jsx('span', { children: t('common.retry') }),
                ],
              }),
            ],
          }),
...
export function ReadonlyComposerTag({
  ...
  const safeIconUrl =
    iconUrl && (isBuiltinComposerTagIconUrl(iconUrl) || isSafeImageSrc(iconUrl))
      ...
      : undefined;
  return _jsxs('span', {
    className: `${styles.messageTag}${clickable ? ` ${styles.messageTagClickable}` : ''}`,
    ...
    children: [
      custom ??
        _jsxs(_Fragment, {
          children: [
            ...
            tagLabel &&
              _jsx('span', {
                className: styles.messageTagLabel,
                children: tagLabel,
              }),
            tagValue
              ? _jsx('span', {
                  className: styles.messageTagValue,
                  children: tagValue,
                })
              : !tagLabel
                ? _jsx('span', {
      ...
      tooltip !== undefined &&
        tooltip !== null &&
        _jsx('span', {
          className: styles.messageTagTooltip,
          role: 'tooltip',
          children: tooltip,
        }),
    ],
