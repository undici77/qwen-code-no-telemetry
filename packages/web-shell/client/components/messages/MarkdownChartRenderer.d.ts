...
export declare function createMarkdownChartRegistry(
...
export declare function createWebShellMarkdownChartPre(
...
export declare function WebShellMarkdownChartProvider({
  customization,
  source,
  streaming,
  theme,
 ...
 */
export declare function createEchartsFullDataRenderer(
 ...
 * fence instead.
 */
export declare function EchartsFullDataBlock({
  option,
  parseError,
  isStreaming,
  theme,
