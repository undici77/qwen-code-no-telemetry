import type { DaemonSessionMonitorTaskStatus, DaemonSessionShellTaskStatus, DaemonSessionTasksStatus } from '@qwen-code/sdk/daemon';
...
export declare function TasksStatusMessage({ message, embedded, manageActiveEvent, onClose, planTodos, agentTools, onOpenSubagent, onOpenMonitor, }: {
...
export declare function MonitorTaskDetail({ task, actions: providedActions, }: {
    task: DaemonSessionMonitorTaskStatus;
    actions?: DaemonSessionActions;
}): import("react/jsx-runtime").JSX.Element;
export declare function ShellTaskDetail({ task, actions: providedActions, }: {
