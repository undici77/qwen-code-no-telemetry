import type { DaemonWorkspaceActions, DaemonWorkspaceMcpToolsStatus, DaemonWorkspaceMcpResourcesStatus } from '@qwen-code/webui/daemon-react-sdk';
type DaemonWorkspaceMcpStatus = Awaited<ReturnType<DaemonWorkspaceActions['loadMcpStatus']>>;
...
declare function parseMcpStatusMessage(content: string): SerializedMcpStatusMessage | null;
export { serializeMcpStatusMessage, parseMcpStatusMessage, type SerializedMcpStatusMessage, };
export declare function McpStatusMessage({ message, }: {
