    ...
    root.render(
      _jsx(I18nProvider, {
        ...
        children: _jsx(WebShellCustomizationProvider, {
          value: customization,
          children: _jsx(ToolLine, { tool: tool, ...props }),
        }),
      }),
    );
  });
  ...
  act(() => {
    root.render(
      _jsx(I18nProvider, {
        ...
        children: _jsx(WebShellCustomizationProvider, {
          value: customization,
          children: _jsx(ToolGroup, { tools: tools }),
        }),
      }),
    );
  });
      ...
      ],
      {
        renderToolHeaderExtra: (info) =>
          _jsxs('span', {
            ...
            children: [info.kind, ':', info.description],
          }),
      },
    );
    ...
    act(() => {
      root.render(
        _jsx(I18nProvider, {
          language: 'en',
          children: readonly
            ? _jsx(TranscriptRenderModeProvider, {
                value: 'readonly',
                children: toolLine,
              })
            : toolLine,
...
describe('tool row rendering', () => {
    ...
    try {
      const container = renderToolGroup(
        ...
        ],
        {
          renderToolHeaderExtra: (info) =>
            info.elapsed
              ? _jsxs('span', { children: ['custom ', info.elapsed] })
              : null,
        },
      );
      const summary = container.querySelector('button');
  ...
  it('keeps completed elapsed data available to custom header renderers', () => {
    const container = renderToolLine(
      ...
      {
        renderToolHeaderExtra: (info) =>
          _jsx('span', { children: info.elapsed }),
      },
    );
    expect(container.textContent).toContain('5s');
  });
      ...
      root.render(
        _jsx(I18nProvider, {
          ...
          children: _jsx(SubagentDetailsProvider, {
            onOpen: onOpen,
            children: _jsx(ToolGroup, { tools: [tool] }),
          }),
        }),
      );
    });
  ...
  it('opens a single monitor from the tool summary', async () => {
    ...
    act(() => {
      root.render(
        _jsx(I18nProvider, {
          language: 'en',
          children: _jsx(MonitorDetailsProvider, {
            onOpen: onOpen,
            children: _jsx(ToolGroup, { tools: [tool] }),
          }),
        }),
    ...
    act(() => {
      root.render(
        _jsx(I18nProvider, {
          ...
          children: _jsx(MonitorDetailsProvider, {
            onOpen: onOpen,
            children: _jsx(ToolLine, { tool: tool }),
          }),
        }),
      );
    });
    ...
    act(() => {
      root.render(
        _jsx(I18nProvider, {
          ...
          children: _jsx(MonitorDetailsProvider, {
            onOpen: onOpen,
            children: _jsx(ToolGroup, { tools: [nextTool] }),
          }),
        }),
      );
    });
    ...
    act(() => {
      root.render(
        _jsx(I18nProvider, {
          ...
          children: _jsx(MonitorDetailsProvider, {
            onOpen: onOpen,
            children: _jsx(ToolLine, { tool: tool, forceExpandable: true }),
          }),
        }),
      );
    });
