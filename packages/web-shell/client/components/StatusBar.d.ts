...
export declare function getTaskPillLabel(tasks: readonly DaemonSessionTaskStatus[], t: ReturnType<typeof useI18n>['t']): string;
export declare const StatusBar: import("react").ForwardRefExoticComponent<StatusBarProps & import("react").RefAttributes<StatusBarHandle>>;
export {};
