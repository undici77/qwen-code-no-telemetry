...
import { type DaemonSessionArtifact, type DaemonSessionMonitorTaskStatus, type DaemonWorkspaceCapability } from '@qwen-code/sdk/daemon';
...
export type PaneHeaderActionsRenderer = (info: PaneHeaderActionsInfo) => ReactNode;
 ...
 */
export declare function ChatPane({ title, workspaceCwd, renderHeaderActions, onClose, onToggleMaximize, isMaximized, onError, onImageIngestionNotice, onSlashCommand, onRightPanelOpen, onOpenMonitor, onPaneArtifactsChange, messageTurnOutputs, restartSseOnPrompt, embedded, onFirstPromptAdmitted, reportCatalogTurnCompletion, hidden, voiceUserRevision, voiceWorkspaceRevisions, voiceWorkspaces, sessionWorkflowEnabled, }: ChatPaneProps): import("react/jsx-runtime").JSX.Element;
