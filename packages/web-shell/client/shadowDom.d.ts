...
export declare function resolveWebShellShadowDom(value: WebShellShadowDom | undefined): ResolvedWebShellShadowDomOptions;
export declare function installWebShellShadowStyles(shadowRoot: ShadowRoot, additionalStyles?: string): () => void;
