...
export declare function getMissingSlashPrefixCompletion(
  text: string,
  commands: CommandInfo[],
): string | null;
export declare function getImplicitTabCompletion(
  text: string,
  commands: CommandInfo[],
  language: WebShellLanguage,
): string | null;
export declare function getSlashCommandArgumentHint(
  text: string,
  commands: CommandInfo[],
  language: WebShellLanguage,
): string | null;
export declare function getSlashCommandCompletionResult(
  text: string,
  cursor: number,
  commands: CommandInfo[],
  skills?: SkillInfo[],
...
export declare function slashCompletionSource(
