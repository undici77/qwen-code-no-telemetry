...
const packagePath = join(import.meta.dir, '..', 'apps', 'live-host', 'package.json');
const input = process.argv[2];
if (!input || process.argv.length !== 3) {
    console.error('Usage: bun run bump-live-host-version <version>');
    process.exit(1);
}
try {
...
//# sourceMappingURL=bump-live-host-version.js.map