 ...
 */
export function getDefaultLabelConfig() {
    return {
        version: 1,
        labels: [
            {
 ...
 */
export function loadLabelConfig(workspaceRootPath) {
 ...
 */
export function saveLabelConfig(workspaceRootPath, config) {
 ...
 */
export function listLabels(workspaceRootPath) {
 ...
 */
export function listLabelsFlat(workspaceRootPath) {
    const config = loadLabelConfig(workspaceRootPath);
 ...
 */
export function getLabel(workspaceRootPath, labelId) {
    const config = loadLabelConfig(workspaceRootPath);
 ...
 */
export function isValidLabelId(workspaceRootPath, labelId) {
    const config = loadLabelConfig(workspaceRootPath);
 ...
 */
export function isValidLabelIdFormat(labelId) {
    if (!labelId)
        return false;
