...
import { MAX_BUNDLE_SIZE_BYTES, collectDirectoryFiles, } from '../utils/bundle-files.ts';
// Re-export BundleFile and MAX_BUNDLE_SIZE_BYTES for backward compatibility
export { MAX_BUNDLE_SIZE_BYTES } from '../utils/bundle-files.ts';
/**
 ...
 */
export function serializeSession(workspaceRootPath, sessionId) {
