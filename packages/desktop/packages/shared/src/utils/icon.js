 ...
 */
export function validateIconValue(icon, context = 'Icon') {
 ...
 */
export function findIconFile(dir) {
 ...
 */
export async function downloadIcon(targetDir, iconUrl, context = 'Icon', filenameBase = 'icon') {
 ...
 */
export function needsIconDownload(iconValue, localIconPath) {
 ...
 */
export function resolveIcon(iconValue, localIconPath) {
