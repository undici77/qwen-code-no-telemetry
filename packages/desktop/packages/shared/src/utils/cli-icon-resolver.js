 ...
 */
export function splitCommands(commandStr) {
    const commands = [];
    let current = '';
 ...
 */
export function extractCommandName(subCommand) {
 ...
 */
export function extractCommandNames(commandStr) {
 ...
 */
export function loadToolIconConfig(toolIconsDir) {
    try {
 ...
 */
export function resolveToolIcon(commandStr, toolIconsDir) {
...
//# sourceMappingURL=cli-icon-resolver.js.map