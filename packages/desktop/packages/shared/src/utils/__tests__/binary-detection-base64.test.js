...
function makeRealBase64(byteLength) {
...
describe('extractBase64Binary() — false positive regression (#344)', () => {
    ...
    it('rejects log lines with timestamps and UUIDs', () => {
        const logs = Array.from({ length: 20 }, (_, i) => `2024-01-${String(i + 1).padStart(2, '0')}T12:00:00Z [INFO] session=a1b2c3d4-e5f6-7890-abcd-ef1234567890 Processing request ${i}`).join('\n');
...
//# sourceMappingURL=binary-detection-base64.test.js.map