 ...
 */
function getThumbPath(iconPath) {
 ...
 */
function isThumbValid(iconPath, thumbPath) {
 ...
 */
export function encodeIconToDataUrl(iconPath, options) {
    if (!iconPath) {
        return undefined;
    }
    ...
    if (isRaster && options?.resize) {
        ...
        try {
            ...
            if (resized) {
                ...
                try {
                    writeFileSync(thumbPath, resized);
                }
 ...
 */
export async function encodeIconToDataUrlAsync(iconPath, options) {
    if (!iconPath) {
        return undefined;
    }
    if (iconPath.startsWith('data:')) {
 ...
 */
export function getEmojiIcon(value) {
    if (value && isEmoji(value)) {
        return value;
    }
    return undefined;
}
//# sourceMappingURL=icon-encoder.js.map