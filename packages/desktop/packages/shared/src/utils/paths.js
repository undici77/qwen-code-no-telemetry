 ...
 */
export function expandPath(inputPath, basePath) {
    if (!inputPath)
        return inputPath;
 ...
 */
export function toPortablePath(absolutePath) {
    if (!absolutePath)
        return absolutePath;
    const home = homedir();
 ...
 */
export function hasPathVariables(path) {
    if (!path)
        return false;
 ...
 */
export function isPortablePath(path) {
    if (!path)
        return false;
 ...
 */
export function pathStartsWith(filePath, dirPath) {
 ...
 */
export function stripPathPrefix(filePath, prefix) {
    const normalizedFile = normalizePathForComparison(filePath);
 ...
 */
export function setBundledAssetsRoot(dir) {
    _assetsRoot = dir;
}
/**
 ...
 */
export function getBundledAssetsDir(subfolder) {
    const candidates = [
