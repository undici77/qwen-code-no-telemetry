 ...
 */
function parseTokenResponse(body, contentType) {
 ...
 */
export function prepareGenericOAuth(options) {
 ...
 */
export async function exchangeGenericOAuth(params) {
    try {
 ...
 */
export async function refreshGenericOAuthToken(refreshToken, tokenUrl, clientId, clientSecret) {
    const body = new URLSearchParams({
        client_id: clientId,
...
//# sourceMappingURL=generic-oauth.js.map