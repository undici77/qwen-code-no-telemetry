 ...
 */
export const MICROSOFT_SERVICE_SCOPES = {
    outlook: [
 ...
 */
export function getMicrosoftScopes(options) {
 ...
 */
export function prepareMicrosoftOAuth(options) {
    if (!isMicrosoftOAuthConfigured()) {
        throw new Error('Microsoft OAuth not configured. Set MICROSOFT_OAUTH_CLIENT_ID environment variable.');
    }
 ...
 */
export async function exchangeMicrosoftOAuth(params) {
    try {
 ...
 * });
 */
export async function startMicrosoftOAuth(options = {}) {
    try {
...
//# sourceMappingURL=microsoft-oauth.js.map