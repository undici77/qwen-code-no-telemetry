...
import { validateIconValue, downloadIcon, needsIconDownload, isIconUrl, ICON_EXTENSIONS, } from '../utils/icon.ts';
 ...
 */
export function ensureDefaultIconFiles(workspaceRootPath) {
...
function validateStatusConfig(config) {
    ...
    return requiredFixedStatuses.every(id => config.statuses.some(s => s.id === id && s.isFixed));
}
/**
 ...
 */
export function loadStatusConfig(workspaceRootPath) {
 ...
 */
export function saveStatusConfig(workspaceRootPath, config) {
 ...
 */
export function getStatus(workspaceRootPath, statusId) {
 ...
 */
export function listStatuses(workspaceRootPath) {
    const config = loadStatusConfig(workspaceRootPath);
 ...
 */
export function isValidStatusId(workspaceRootPath, statusId) {
    const config = loadStatusConfig(workspaceRootPath);
 ...
 */
export function getStatusCategory(workspaceRootPath, statusId) {
 ...
 */
export function findStatusIcon(workspaceRootPath, statusId) {
    const iconsDir = join(workspaceRootPath, STATUS_ICONS_DIR);
 ...
 */
export async function downloadStatusIcon(workspaceRootPath, statusId, iconUrl) {
    const iconsDir = join(workspaceRootPath, STATUS_ICONS_DIR);
 ...
 */
export function statusNeedsIconDownload(workspaceRootPath, status) {
