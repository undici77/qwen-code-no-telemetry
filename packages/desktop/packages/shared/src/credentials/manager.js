...
export class CredentialManager {
    ...
    async getWorkspaceOAuth(workspaceId) {
    ...
    async setWorkspaceOAuth(workspaceId, credentials) {
    ...
    async deleteWorkspaceCredentials(workspaceId) {
     ...
     */
    async getLlmApiKey(connectionSlug) {
     ...
     */
    async setLlmApiKey(connectionSlug, apiKey) {
     ...
     */
    async deleteLlmApiKey(connectionSlug) {
     ...
     */
    async getLlmOAuth(connectionSlug) {
     ...
     */
    async setLlmOAuth(connectionSlug, credentials) {
     ...
     * @param connectionSlug - The connection slug
     */
    async deleteLlmCredentials(connectionSlug) {
     ...
     */
    async getLlmIamCredentials(connectionSlug) {
        const cred = await this.get({ type: 'llm_iam', connectionSlug });
        if (!cred || !cred.awsAccessKeyId)
            return null;
        return {
     ...
     */
    async setLlmIamCredentials(connectionSlug, credentials) {
     ...
     */
    async getLlmServiceAccount(connectionSlug) {
     ...
     */
    async setLlmServiceAccount(connectionSlug, credentials) {
     ...
     */
    async hasLlmCredentials(connectionSlug, authType, providerType) {
     ...
     * @internal
     */
    async hasLlmApiKeyCredential(connectionSlug) {
     ...
     * @internal
     */
    async hasLlmOAuthCredential(connectionSlug, providerType) {
     ...
     * @internal
     */
    async hasLlmIamCredential(connectionSlug) {
     ...
     * @internal
     */
    async hasLlmServiceAccountCredential(connectionSlug) {
        ...
        try {
            ...
            if (defaultSlug) {
                ...
                if (connection && connection.authType !== 'none' && connection.authType !== 'environment') {
                    const hasCredentials = await this.hasLlmCredentials(defaultSlug, connection.authType, connection.providerType);
                    if (!hasCredentials) {
                        issues.push({
