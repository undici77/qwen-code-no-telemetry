...
import { detectCredentialMode, getEffectiveHeaderNames, } from '../../../../session-tools-core/src/source-helpers.ts';
describe('detectCredentialMode', () => {
    ...
    test('should preserve other modes when no headerNames anywhere', () => {
        const modes = ['bearer', 'basic', 'header', 'query'];
...
//# sourceMappingURL=credential-prompt-detection.test.js.map