...
import { registerSessionScopedToolCallbacks, mergeSessionScopedToolCallbacks, unregisterSessionScopedToolCallbacks, } from '../session-scoped-tools.ts';
...
function createBaseContext(sessionId) {
...
describe('backend session self-management regression (#511)', () => {
    ...
    it('context WITH bindings resolves callbacks from registry', async () => {
        ...
        const setLabelsCalled = [];
        const setStatusCalled = [];
...
//# sourceMappingURL=session-self-management-bindings.test.js.map