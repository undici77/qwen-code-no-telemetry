 ...
 */
export function attachSessionSelfManagementBindings(context, sessionId) {
    ...
    Object.defineProperty(context, 'unbindMessagingChannel', {
        get() {
            ...
            if (!fn)
                return undefined;
            return (sid, platform) => fn(sid ?? sessionId, platform);
        },
        configurable: true,
        enumerable: true,
    });
...
//# sourceMappingURL=session-self-management-bindings.js.map