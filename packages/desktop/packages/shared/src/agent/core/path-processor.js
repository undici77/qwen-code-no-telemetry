...
import { expandPath, normalizePath, normalizePathForComparison, pathStartsWith, toPortablePath, } from '../../utils/paths.ts';
...
export class PathProcessor {
     ...
     */
    isWithinDirectory(filePath, dirPath) {
