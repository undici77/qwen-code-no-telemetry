...
export class PromptBuilder {
     ...
     */
    buildContextParts(options, sourceStateBlock) {
        const parts = [];
    ...
    getWorkingDirectoryContext() {
        ...
        return getWorkingDirectoryContext(effectiveWorkingDir, isSessionRoot, this.config.session?.sdkCwd);
    }
    // ============================================================
    // Recovery Context
    // ============================================================
...
`;
     ...
     */
    formatPreferences(forceRefresh = false) {
