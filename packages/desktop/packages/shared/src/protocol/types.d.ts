 ...
 */
export type MessageType = 'handshake' | 'handshake_ack' | 'request' | 'response' | 'event' | 'error' | 'sequence_ack';
...
export type ErrorCode = 'HANDLER_ERROR' | 'INVALID_ARGUMENT' | 'CHANNEL_NOT_FOUND' | 'AUTH_FAILED' | 'PROTOCOL_VERSION_UNSUPPORTED' | 'SESSION_NOT_IDLE' | 'SESSION_ID_CONFLICT' | 'ARTIFACT_NOT_PORTABLE' | 'TRANSFER_TOO_LARGE' | 'TRANSFER_TIMEOUT' | 'TRANSFER_VERIFICATION_FAILED' | 'REQUEST_TIMEOUT' | 'CAPABILITY_UNAVAILABLE' | 'CLIENT_DISCONNECTED' | 'CLIENT_REQUEST_TIMEOUT';
...
export declare const HEARTBEAT_MAX_MISSED = 2;
/** Default request timeout in ms. */
export declare const REQUEST_TIMEOUT_MS = 30000;
/** Max events to retain per client in the ring buffer. */
export declare const EVENT_BUFFER_MAX_SIZE = 500;
/** Events older than this are evicted from the buffer. */
export declare const EVENT_BUFFER_TTL_MS = 30000;
/** How long to retain a disconnected client's buffer for potential reconnect. */
export declare const DISCONNECTED_CLIENT_TTL_MS = 60000;
/** Client sends a sequence_ack every N ms. */
export declare const SEQUENCE_ACK_INTERVAL_MS = 5000;
