 ...
 */
import type { Message, TypedError, MessageTextElement, ToolDisplayMeta, AnnotationV1, WorkspaceKind, PermissionRequest as BasePermissionRequest, AvailableSlashCommand as BaseAvailableSlashCommand, AvailableSkillDetail as BaseAvailableSkillDetail } from '@craft-agent/core/types';
import type { PermissionMode } from '../agent/mode-types';
import type { ThinkingLevel } from '../agent/thinking-levels';
import type { AuthRequest as SharedAuthRequest, CredentialInputMode as SharedCredentialInputMode, CredentialAuthRequest as SharedCredentialAuthRequest } from '../agent/index';
...
export type QwenHookEvent = 'UserPromptSubmit' | 'Stop' | 'Notification' | 'PreToolUse' | 'PostToolUse' | 'PostToolUseFailure' | 'SessionStart' | 'SessionEnd' | 'PreCompact' | 'SubagentStart' | 'SubagentStop' | 'PermissionRequest';
...
export interface QwenExtensionSettingsEntry {
    ...
    skills: string[];
    mcpServers: string[];
    settings: Array<QwenExtensionSettingDefinition & {
        name: string;
        envVar: string;
