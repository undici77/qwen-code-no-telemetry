...
export const RPC_CHANNELS = {
    ...
    input: {
        ...
        GET_VOICE_MODEL: 'input:getVoiceModel',
        SET_VOICE_MODEL: 'input:setVoiceModel',
        GET_VOICE_ENABLED: 'input:getVoiceEnabled',
        SET_VOICE_ENABLED: 'input:setVoiceEnabled',
 ...
 */
export function getAllChannelValues() {
    const values = [];
