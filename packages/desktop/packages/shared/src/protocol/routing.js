...
// ---------------------------------------------------------------------------
export const LOCAL_ONLY_CHANNELS = new Set([
...
// REMOTE_ELIGIBLE — runs on whichever server owns the workspace
// ---------------------------------------------------------------------------
export const REMOTE_ELIGIBLE_CHANNELS = new Set([
...
// Query helpers
// ---------------------------------------------------------------------------
export function isLocalOnly(channel) {
    return LOCAL_ONLY_CHANNELS.has(channel);
}
export function isRemoteEligible(channel) {
