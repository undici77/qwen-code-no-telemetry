 ...
 */
export function getBuiltinSources(_workspaceId, _workspaceRootPath) {
    return [];
}
/**
 * Get the built-in Qwen Code docs source.
 *
 ...
 */
export function getDocsSource(workspaceId, workspaceRootPath) {
    ...
    const placeholderConfig = {
        ...
        tagline: 'Search Qwen Code documentation and source setup guides',
        icon: '📚',
 ...
 */
export function isBuiltinSource(_slug) {
    return false;
}
//# sourceMappingURL=builtin-sources.js.map