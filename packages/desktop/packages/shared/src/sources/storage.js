...
import { validateIconValue, findIconFile, downloadIcon, needsIconDownload, isIconUrl, } from '../utils/icon.ts';
// ============================================================
// Directory Utilities
// ============================================================
/**
 ...
 */
export function ensureSourcesDir(workspaceRootPath) {
 ...
 */
export function markSourceAuthenticated(workspaceRootPath, sourceSlug) {
 ...
 */
export function saveSourceConfig(workspaceRootPath, config) {
 ...
 */
export function loadSourceGuide(workspaceRootPath, sourceSlug) {
    try {
 ...
 */
export function extractTagline(guide) {
    if (!guide?.raw)
        return null;
 ...
 * Save guide.md
 */
export function saveSourceGuide(workspaceRootPath, sourceSlug, guide) {
 ...
 */
export function findSourceIcon(workspaceRootPath, sourceSlug) {
 ...
 */
export async function downloadSourceIcon(workspaceRootPath, sourceSlug, iconUrl) {
 ...
 */
export function sourceNeedsIconDownload(workspaceRootPath, sourceSlug, config) {
 ...
 */
export function loadSource(workspaceRootPath, sourceSlug) {
    const config = loadSourceConfig(workspaceRootPath, sourceSlug);
    if (!config)
        return null;
 ...
 */
export function loadWorkspaceSources(workspaceRootPath) {
 ...
 */
export function getEnabledSources(workspaceRootPath) {
 ...
 */
export function isSourceUsable(source) {
    ...
    if (authType === 'none' || authType === undefined)
        return true;
 ...
 */
export function getSourcesBySlugs(workspaceRootPath, slugs) {
    const workspaceId = basename(workspaceRootPath);
    const sources = [];
 ...
 */
export function loadAllSources(workspaceRootPath) {
    const workspaceId = basename(workspaceRootPath);
 ...
 */
export function generateSourceSlug(workspaceRootPath, name) {
    let slug = name
        .toLowerCase()
        .replace(/[^a-z0-9]+/g, '-')
        .substring(0, 50)
 ...
 */
export async function createSource(workspaceRootPath, input) {
 ...
 */
export function deleteSource(workspaceRootPath, sourceSlug) {
    const dir = getSourcePath(workspaceRootPath, sourceSlug);
    if (existsSync(dir)) {
