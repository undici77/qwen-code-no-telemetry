 ...
 */
function validateMultiHeaderConfig(config) {
    const warnings = [];
    ...
    if (api.headerNames && api.headerNames.length > 0 && api.authType === 'none') {
        warnings.push(`Config has headerNames [${api.headerNames.join(', ')}] but authType is "none". ` +
    ...
    if (api.authType === 'header' && !api.headerNames && !api.headerName) {
        warnings.push(`Config has authType "header" but no headerName or headerNames specified. ` +
...
//# sourceMappingURL=source-config-validation.test.js.map