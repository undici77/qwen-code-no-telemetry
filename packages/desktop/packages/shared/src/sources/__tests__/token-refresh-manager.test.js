...
import { isOAuthSource, hasRenewEndpoint, isRefreshableSource } from '../types.ts';
...
describe('isOAuthSource', () => {
    ...
    describe('Authentication state', () => {
        ...
        test('returns true even if isAuthenticated is undefined (type check only)', () => {
            ...
            delete source.config.isAuthenticated;
            expect(isOAuthSource(source)).toBe(true);
        });
    });
...
function createMockCredManager(overrides = {}) {
    return {
...
//# sourceMappingURL=token-refresh-manager.test.js.map