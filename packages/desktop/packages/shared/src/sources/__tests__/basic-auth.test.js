 ...
 */
function storeBasicAuthCredential(username, password) {
 ...
 */
function getApiCredential(storedValue, isBasicAuth) {
    if (!storedValue)
        return null;
    if (isBasicAuth) {
        try {
 ...
 */
function buildBasicAuthHeader(credential) {
...
//# sourceMappingURL=basic-auth.test.js.map