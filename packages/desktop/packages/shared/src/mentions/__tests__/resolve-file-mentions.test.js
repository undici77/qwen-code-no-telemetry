...
describe('resolveFileMentions', () => {
    describe('file mentions', () => {
        ...
        it('wraps Windows absolute file path in semantic marker', () => {
            expect(resolveFileMentions('[file:C:\\Users\\me\\project\\README.md] check this', WINDOWS_WORK_DIR)).toBe('[Mentioned file: README.md (at C:\\Users\\me\\project\\README.md)] check this');
        });
        it('wraps Windows forward-slash absolute file path in semantic marker', () => {
            expect(resolveFileMentions('[file:C:/Users/me/project/README.md] check this', WINDOWS_WORK_DIR)).toBe('[Mentioned file: README.md (at C:/Users/me/project/README.md)] check this');
        });
        it('wraps Windows UNC file path in semantic marker', () => {
            expect(resolveFileMentions('[file:\\\\server\\share\\project\\README.md] check this', WINDOWS_WORK_DIR)).toBe('[Mentioned file: README.md (at \\\\server\\share\\project\\README.md)] check this');
        });
    ...
    describe('folder mentions', () => {
        ...
        it('wraps Windows absolute folder path in semantic marker', () => {
            expect(resolveFileMentions('[folder:C:\\Users\\me\\project\\src] explore', WINDOWS_WORK_DIR)).toBe('[Mentioned folder: src (at C:\\Users\\me\\project\\src)] explore');
        });
    });
...
//# sourceMappingURL=resolve-file-mentions.test.js.map