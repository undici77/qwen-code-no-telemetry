...
import { validateSessionId, sanitizeSessionId, isValidSessionId, } from '../src/sessions/validation.ts';
import { getSessionPath, getSessionAttachmentsPath, getSessionPlansPath, getSessionDownloadsPath, } from '../src/sessions/storage.ts';
// ============================================================
// validateSessionId
// ============================================================
describe('validateSessionId', () => {
    ...
    describe('invalid formats', () => {
        ...
        it('rejects null/undefined', () => {
            expect(() => validateSessionId(null)).toThrow('Security Error');
            expect(() => validateSessionId(undefined)).toThrow('Security Error');
        });
...
//# sourceMappingURL=session-validation.test.js.map