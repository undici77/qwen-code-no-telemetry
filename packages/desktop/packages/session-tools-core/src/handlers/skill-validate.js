...
import { validateSlug, validateSkillContent, formatValidationResult, } from '../validation.ts';
/**
 ...
 */
export async function handleSkillValidate(ctx, args) {
    ...
    try {
        ...
        return errorResponse(`Cannot read file: ${e instanceof Error ? e.message : 'Unknown error'}`);
    }
