...
export async function handleSendAgentMessage(ctx, args) {
    ...
    try {
        ...
        return successResponse(`Message sent to session ${args.sessionId}. The session will process it independently.`);
    }
    catch (error) {
...
//# sourceMappingURL=send-agent-message.js.map