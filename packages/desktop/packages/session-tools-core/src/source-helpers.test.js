...
import { getSourceConfigPath, getSourceGuidePath, getSourcePath, loadSourceConfig, sourceConfigExists, sourceExists, } from './source-helpers.ts';
describe('session source helper slug validation', () => {
    it('resolves valid source helper paths', () => {
        ...
        expect(getSourceConfigPath(workspaceRoot, 'craft-kb')).toBe(join(workspaceRoot, 'sources', 'craft-kb', 'config.json'));
        expect(getSourceGuidePath(workspaceRoot, 'craft-kb')).toBe(join(workspaceRoot, 'sources', 'craft-kb', 'guide.md'));
    });
...
//# sourceMappingURL=source-helpers.test.js.map