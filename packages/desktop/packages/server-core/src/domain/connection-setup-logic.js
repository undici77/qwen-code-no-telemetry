 ...
 */
import { QWEN_CODE_CONNECTION_SLUG, } from '@craft-agent/shared/config';
// ============================================================
// Error Parsing
// ============================================================
/**
 ...
 */
export function parseTestConnectionError(msg) {
    ...
    if (lower.includes('no api key found for'))
        return 'Qwen Code is not configured correctly.';
 ...
 */
export function setupTestRequiresApiKey(baseUrl) {
 ...
 */
export function createBuiltInConnection(slug, baseUrl) {
 ...
 * objects.
 */
export function validateModelList(models, defaultModel) {
...
//# sourceMappingURL=connection-setup-logic.js.map