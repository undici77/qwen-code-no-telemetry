...
export function getBrowserToolCommandVerb(toolInput) {
...
export function shouldActivateBrowserOverlay(toolName, toolInput) {
    const normalizedToolName = normalizeBrowserToolName(toolName);
    if (normalizedToolName !== 'browser_tool')
        return false;
...
//# sourceMappingURL=browser-tool-detection.js.map