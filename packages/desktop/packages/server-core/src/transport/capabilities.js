...
export const LOCAL_CLIENT_CAPABILITIES = [
 ...
 */
export async function requestClientOpenExternal(server, clientId, url) {
    try {
 ...
 */
export async function requestClientOpenPath(server, clientId, path) {
    try {
 ...
 */
export async function requestClientShowInFolder(server, clientId, path) {
 ...
 */
export async function requestClientConfirmDialog(server, clientId, spec) {
 ...
 */
export async function requestClientOpenFileDialog(server, clientId, spec) {
