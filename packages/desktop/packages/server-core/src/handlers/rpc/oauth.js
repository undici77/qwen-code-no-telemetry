...
export async function completeOAuthFlow(opts) {
    ...
    if (opts.clientId !== undefined) {
        if (flow.ownerClientId !== opts.clientId)
            throw new Error('OAuth flow owned by different client');
    }
    if (opts.workspaceId != null) {
        if (flow.workspaceId !== opts.workspaceId)
...
export function registerOAuthHandlers(server, deps) {
