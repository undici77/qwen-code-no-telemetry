...
function makeAdapter(platform = 'telegram') {
    const calls = [];
    let nextId = 100;
    const caps = {
        messageEditing: true,
...
function makeBinding(platform, id = 'bind-1') {
    return {
        id,
        workspaceId: 'ws-1',
        sessionId: 'sess-1',
...
function planEvent(content, planPath = '/tmp/plan.md') {
    return {
        type: 'plan_submitted',
        sessionId: 'sess-1',
        message: {
...
//# sourceMappingURL=renderer-plan.test.js.map