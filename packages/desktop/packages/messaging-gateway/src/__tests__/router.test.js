...
function makeRouter() {
    ...
    const router = new Router(sessionManager, store, commands);
...
describe('Router', () => {
    ...
    it('routes unbound channels to Commands.handle', async () => {
        ...
        await router.route(makeFakeAdapter(), baseMsg({ channelId: 'unbound-channel', text: '/help' }));
