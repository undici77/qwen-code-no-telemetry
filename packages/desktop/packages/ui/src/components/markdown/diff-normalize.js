...
function findFileHeaderPairBefore(lines, endIndex) {
...
function containsUnifiedFileBreakCandidate(lines) {
 ...
 */
export function ensureUnifiedDiffFormat(raw) {
    ...
    if (allHunksValid && hasFileIdentity)
        return raw;
...
//# sourceMappingURL=diff-normalize.js.map