...
import { clampScale, computeFitScale, cursorAnchoredTranslate, zoomStepScale, } from '../useRichBlockInteractions';
describe('useRichBlockInteractions helpers', () => {
    ...
    it('computes zoom-to-fit scale with 90% padding', () => {
        const fit = computeFitScale({ width: 1000, height: 800 }, { width: 2000, height: 1000 }, 0.25, 4);
        // min((1000*0.9)/2000 = 0.45, (800*0.9)/1000 = 0.72) = 0.45
        expect(fit).toBeCloseTo(0.45);
    });
});
//# sourceMappingURL=useRichBlockInteractions.test.js.map