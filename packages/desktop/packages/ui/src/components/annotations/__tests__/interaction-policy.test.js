...
import { getAnnotationChipInteraction, isAnnotationChipClickable, } from '../interaction-policy';
function createAnnotation(note = 'Follow-up note') {
    return createTextSelectionAnnotation('msg-1', {
        start: 0,
        end: 4,
        selectedText: 'test',
        prefix: '',
...
//# sourceMappingURL=interaction-policy.test.js.map