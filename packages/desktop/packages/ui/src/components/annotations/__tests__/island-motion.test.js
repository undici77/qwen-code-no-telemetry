...
import { buildAnnotationChipEntryTransition, buildSelectionEntryTransition, } from '../island-motion';
describe('annotation island motion utils', () => {
    ...
    it('buildSelectionEntryTransition derives finite values from pointer snapshots', () => {
        const transition = buildSelectionEntryTransition({ x: 100, y: 100, ts: 1000 }, { x: 160, y: 120, ts: 1100 });
...
//# sourceMappingURL=island-motion.test.js.map