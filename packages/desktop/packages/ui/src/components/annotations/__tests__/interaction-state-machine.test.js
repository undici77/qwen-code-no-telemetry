...
describe('annotation interaction state machine', () => {
    it('opens selection into compact view and then confirm follow-up', () => {
        const withSelection = annotationInteractionReducer(initialAnnotationInteractionState, annotationInteractionActions.openFromSelection({
            start: 1,
            end: 4,
            selectedText: 'abc',
            prefix: 'x',
        ...
        const confirm = annotationInteractionReducer(withSelection, annotationInteractionActions.openFollowUpFromSelection());
    ...
    it('opens annotation detail in view mode and keeps anchor', () => {
        const next = annotationInteractionReducer(initialAnnotationInteractionState, annotationInteractionActions.openFromAnnotation({ annotationId: 'ann-1', index: 2, anchorX: 300, anchorY: 160 }, 'Existing note', 'view'));
    ...
    it('cancel from annotation detail closes fully', () => {
        const opened = annotationInteractionReducer(initialAnnotationInteractionState, annotationInteractionActions.openFromAnnotation({ annotationId: 'ann-2', index: 1, anchorX: 220, anchorY: 120 }, 'note', 'view'));
    ...
    it('cancel from pending selection returns to compact while preserving pending selection', () => {
        const selectionState = annotationInteractionReducer(initialAnnotationInteractionState, annotationInteractionActions.openFromSelection({
            start: 2,
            end: 7,
...
//# sourceMappingURL=interaction-state-machine.test.js.map