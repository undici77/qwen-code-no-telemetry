...
import { clearDomSelection, restoreDomSelection, scheduleDomSelectionRestore, } from '../selection-restore';
describe('selection restore helpers', () => {
    it('returns false when selection is missing', () => {
        const restored = restoreDomSelection({}, null);
...
//# sourceMappingURL=selection-restore.test.js.map