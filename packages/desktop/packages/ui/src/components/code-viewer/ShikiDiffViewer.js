...
import { parseDiffFromFile, DIFFS_TAG_NAME } from '@pierre/diffs';
 ...
 */
export function getDiffStats(fileDiff) {
    let additions = 0;
    let deletions = 0;
 ...
 */
export function ShikiDiffViewer({ original, modified, filePath = 'file', language, diffStyle = 'unified', theme = 'light', shikiTheme, disableBackground = false, disableFileHeader = true, onFileHeaderClick, onReady, className, }) {
