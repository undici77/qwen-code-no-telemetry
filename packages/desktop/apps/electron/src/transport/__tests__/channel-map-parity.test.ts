...
type ApiToChannelMapKeys = Exclude<
  ...
  | 'setWorkspacePinned' // direct IPC to main process — modifies local config
  | 'reorderWorkspaces' // direct IPC to main process — modifies local config
  ...
  | 'getVoiceStreamUrl' // direct IPC to main process — reads the loopback voice WS url
> | BrowserPaneKeys
