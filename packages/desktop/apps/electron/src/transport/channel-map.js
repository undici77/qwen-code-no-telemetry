...
function invoke(channel, transform) {
    return { type: 'invoke', channel, ...(transform && { transform }) };
}
...
export const CHANNEL_MAP = {
    ...
    onSessionListRefreshStateChanged: listener(RPC_CHANNELS.sessions.LIST_REFRESH_STATE_CHANGED),
    ...
    setQwenExtensionSetting: invoke(RPC_CHANNELS.settings.SET_QWEN_EXTENSION_SETTING),
    getQwenPermissionSettings: invoke(RPC_CHANNELS.settings.GET_QWEN_PERMISSION_SETTINGS),
    setQwenPermissionRules: invoke(RPC_CHANNELS.settings.SET_QWEN_PERMISSION_RULES),
    getGlobalPermissionMode: invoke(RPC_CHANNELS.settings.GET_GLOBAL_PERMISSION_MODE),
    setGlobalPermissionMode: invoke(RPC_CHANNELS.settings.SET_GLOBAL_PERMISSION_MODE),
    ...
    'browserPane.toggleDockExpanded': invoke(RPC_CHANNELS.browserPane.TOGGLE_DOCK_EXPANDED),
