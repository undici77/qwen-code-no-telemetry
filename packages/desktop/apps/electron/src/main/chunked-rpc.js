...
export function getChunkCount(totalBytes) {
    return Math.ceil(totalBytes / CHUNK_SIZE);
}
export function prepareChunkedPayload(value) {
 ...
 */
export async function invokeChunked(client, channel, args, largeArgIndex, onProgress, prepared) {
...
//# sourceMappingURL=chunked-rpc.js.map