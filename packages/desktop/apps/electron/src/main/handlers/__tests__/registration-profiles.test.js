...
async function getExpectedCoreChannels() {
    // Core handler channels (now in server-core)
    const [auth, automations, files, labels, llm, oauth, sessions, settings, skills, sources, statuses, system, workspace, onboarding,] = await Promise.all([
...
async function getExpectedGuiChannels() {
...
//# sourceMappingURL=registration-profiles.test.js.map