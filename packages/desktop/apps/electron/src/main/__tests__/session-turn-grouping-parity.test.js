...
// ============================================================================
function simulatePersistAndReload(messages) {
...
function createMessage(role, overrides = {}) {
...
function getAssistantTurns(turns) {
    return turns.filter(t => t.type === 'assistant');
}
// ============================================================================
// Tests
// ============================================================================
...
//# sourceMappingURL=session-turn-grouping-parity.test.js.map