...
import { getMacAppBundlePath, parseMacCodeSignatureStatus, } from '../auto-update-signature';
describe('auto-update-signature', () => {
    ...
    it('rejects unsigned apps', () => {
        const status = parseMacCodeSignatureStatus('/Applications/OpenWork.app', 1, '/Applications/OpenWork.app: code object is not signed at all');
        expect(status.trustedForAutoUpdate).toBe(false);
...
//# sourceMappingURL=auto-update-signature.test.js.map