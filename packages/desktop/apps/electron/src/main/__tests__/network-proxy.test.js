...
describe('shouldBypassProxy', () => {
    ...
    it('does not bypass for malformed port suffixes', () => {
        expect(shouldBypassProxy('https://example.com/path', parseNoProxyRules('example.com:443abc'))).toBe(false);
        expect(shouldBypassProxy('http://[::1]:3000/path', parseNoProxyRules('[::1]:abc'))).toBe(false);
    });
...
//# sourceMappingURL=network-proxy.test.js.map