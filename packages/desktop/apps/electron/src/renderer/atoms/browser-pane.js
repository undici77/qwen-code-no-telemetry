...
export const browserInstancesMapAtom = atom(new Map());
/** Derived: array of all browser instances (for iteration) */
export const browserInstancesAtom = atom((get) => Array.from(get(browserInstancesMapAtom).values()));
/** Derived: count of active browser instances */
export const browserInstanceCountAtom = atom((get) => get(browserInstancesMapAtom).size);
/** Currently active browser instance ID (selected/focused by user interactions) */
export const activeBrowserInstanceIdAtom = atom(null);
/** Tombstones for instances removed from renderer state (guards against late out-of-order updates) */
export const removedBrowserInstanceIdsAtom = atom(new Set());
...
export const updateBrowserInstanceAtom = atom(null, (get, set, info) => {
...
export const removeBrowserInstanceAtom = atom(null, (get, set, id) => {
    const map = new Map(get(browserInstancesMapAtom));
    map.delete(id);
    set(browserInstancesMapAtom, map);
...
export const setBrowserInstancesAtom = atom(null, (get, set, instances) => {
    const map = new Map();
...
//# sourceMappingURL=browser-pane.js.map