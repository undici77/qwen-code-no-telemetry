...
import { generateCallbackPage } from '@craft-agent/shared/auth/callback-page';
/**
 ...
 */
function OAuthCallbackPreview({ isSuccess, errorDetail, appType, }) {
    ...
    return (_jsx("iframe", { srcDoc: html, sandbox: "allow-scripts", className: "w-full h-full border-0", title: "OAuth Callback Preview" }));
}
