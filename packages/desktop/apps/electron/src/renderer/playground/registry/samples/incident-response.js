...
export const incidentResponseActivities = [
    sentryFetchError,
    slackPostAlert,
    readErrorFile,
    grepErrorPattern,
...
export const incidentResponseResponse = {
