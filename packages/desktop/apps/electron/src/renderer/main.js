...
function CrashFallback() {
    return (_jsxs("div", { className: "flex flex-col items-center justify-center h-screen font-sans text-foreground/50 gap-3", children: [_jsx("p", { className: "text-base font-medium", children: "Something went wrong" }), _jsx("p", { className: "text-[13px]", children: "Please restart the app. The error has been reported." }), _jsx("button", { onClick: () => window.location.reload(), className: "mt-2 px-4 py-1.5 rounded-md bg-background shadow-minimal text-[13px] text-foreground/70 cursor-pointer", children: "Reload" })] }));
}
/**
...
function Root() {
    ...
    return (_jsxs(ThemeProvider, { activeWorkspaceId: workspaceId, children: [_jsx(App, {}), _jsx(Toaster, {}), _jsx(PetWindowController, {})] }));
}
ReactDOM.createRoot(document.getElementById('root')).render(_jsx(React.StrictMode, { children: _jsx(Sentry.ErrorBoundary, { fallback: _jsx(CrashFallback, {}), children: _jsx(JotaiProvider, { children: _jsx(Root, {}) }) }) }));
