 ...
 */
function readMap() {
    return storage.get(storage.KEYS.turnCardExpansion, {});
}
/**
 ...
 */
export function useTurnCardExpansion(sessionId) {
    ...
    const toggleTurn = useCallback((turnId, expanded) => {
...
//# sourceMappingURL=useTurnCardExpansion.js.map