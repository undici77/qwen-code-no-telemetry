...
import { createInitialState, singleSelect, toggleSelect, rangeSelect, extendSelection, selectAll, clearMultiSelect, removeFromSelection, isMultiSelectActive, getSelectionCount, isItemSelected, } from '../useMultiSelect';
describe('useMultiSelect', () => {
    ...
    describe('clearMultiSelect', () => {
        it('clears selection keeping only active item', () => {
            ...
            const withSelected = { ...initial, selected: 'c' };
...
//# sourceMappingURL=useMultiSelect.test.js.map