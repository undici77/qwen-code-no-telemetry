 ...
 */
export function useDynamicStack(options) {
    ...
    const callbackRef = useCallback((el) => {
        ...
        const compute = () => {
            ...
            if (V >= minNonLastWidth) {
                ...
                for (let i = 0; i < childCount; i++) {
                    ;
                    children[i].style.marginLeft = i === 0 ? '0px' : `${uniformMargin}px`;
                }
            }
            else {
                ...
                for (let i = 0; i < childCount; i++) {
                    if (i === 0) {
                        ...
                        children[i].style.marginLeft = `${blended}px`;
                    }
                }
            }
            ...
            for (let i = 0; i < childCount; i++) {
                ...
                if (i === childCount - 1) {
                    ...
                    const nextMargin = parseFloat(children[i + 1].style.marginLeft || '0');
...
//# sourceMappingURL=useDynamicStack.js.map