 ...
 */
export function useStaleSessionRecovery({ store, refreshSessionFromServer, }) {
    const lastEventTimestamps = useRef(new Map());
    const refreshingSessionIds = useRef(new Set());
    const trackSessionActivity = useCallback((sessionId) => {
...
//# sourceMappingURL=useStaleSessionRecovery.js.map