...
import { parseMentions, stripAllMentions, resolveSkillMentions, resolveSourceMentions } from '@craft-agent/shared/mentions';
export { parseMentions, stripAllMentions, resolveSkillMentions, resolveSourceMentions };
// ============================================================================
// Constants
// ============================================================================
 ...
 */
export function findMentionMatches(text, availableSkillSlugs, availableSourceSlugs) {
    const matches = [];
 ...
 */
export function removeMention(text, type, id) {
    let pattern;
    switch (type) {
        case 'source':
 ...
 */
export function hasMentions(text, availableSkillSlugs, availableSourceSlugs) {
 ...
 */
export function parseSkillMentions(text, availableSlugs) {
 ...
 */
export function stripSkillMentions(text) {
 ...
 */
export function extractBadges(text, skills, sources, workspaceId) {
