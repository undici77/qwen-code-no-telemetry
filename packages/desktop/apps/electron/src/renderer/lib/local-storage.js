 ...
 */
export function get(key, fallback, suffix) {
    try {
 ...
 */
export function set(key, value, suffix) {
    try {
 ...
 */
export function getKeyString(key, suffix) {
