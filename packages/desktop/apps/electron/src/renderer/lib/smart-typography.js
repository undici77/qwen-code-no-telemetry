 ...
 */
export function applySmartTypography(text, cursor) {
    ...
    for (const { pattern, replacement } of REPLACEMENTS) {
        if (textBeforeSpace.endsWith(pattern)) {
            ...
            const newText = text.slice(0, patternStart) + replacement + ' ' + text.slice(cursor);
...
//# sourceMappingURL=smart-typography.js.map