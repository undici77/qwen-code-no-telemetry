...
function BrowserEmptyStateApp() {
    ...
    const handlePromptSelect = useCallback(async (fullPrompt) => {
    ...
    return (_jsx("div", { className: "h-screen w-screen bg-foreground-2 overflow-hidden", children: _jsx("div", { className: "h-full w-full bg-background overflow-auto", children: _jsx(BrowserEmptyStateCard, { title: t("browser.readyTitle"), description: t("browser.readyDescription"), prompts: EMPTY_STATE_PROMPT_SAMPLES, showExamplePrompts: true, showSafetyHint: true, onPromptSelect: (sample) => handlePromptSelect(sample.full) }) }) }));
}
ReactDOM.createRoot(document.getElementById('root')).render(_jsx(React.StrictMode, { children: _jsx(BrowserEmptyStateApp, {}) }));
//# sourceMappingURL=browser-empty-state.js.map