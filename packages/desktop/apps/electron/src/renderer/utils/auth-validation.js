 ...
 */
export function validateBasicAuthCredentials(username, password, passwordRequired = true) {
 ...
 */
export function getPasswordValue(password, passwordRequired = true) {
 ...
 */
export function getPasswordLabel(baseLabel, passwordRequired = true) {
 ...
 */
export function getPasswordPlaceholder(baseLabel, passwordRequired = true) {
    return passwordRequired
