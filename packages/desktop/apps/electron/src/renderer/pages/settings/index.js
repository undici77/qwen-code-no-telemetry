...
export { default as GeneralSettingsPage, meta as GeneralSettingsMeta, } from './GeneralSettingsPage';
export { default as McpServersSettingsPage, meta as McpServersSettingsMeta, } from './McpServersSettingsPage';
export { default as HooksSettingsPage, meta as HooksSettingsMeta, } from './HooksSettingsPage';
export { default as ExtensionsSettingsPage, meta as ExtensionsSettingsMeta, } from './ExtensionsSettingsPage';
