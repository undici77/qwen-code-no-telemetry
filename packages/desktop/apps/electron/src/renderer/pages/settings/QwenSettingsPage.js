...
async function runSharedQwenSettingsCommand(command) {
...
export default function QwenSettingsPage({ tab }) {
    ...
    const runCommand = useCallback(async (command) => {
        ...
        return normalizeQwenSettingsSnapshot(result);
    }, []);
...
function GeneralTab({ snapshot, onSave, }) {
    ...
    return (_jsxs(_Fragment, { children: [_jsx(SettingsSection, { title: t('settings.qwen.general.responseLanguage'), description: t('settings.qwen.general.responseLanguageDesc'), children: _jsx(SettingsCard, { children: _jsx(SettingsInput, { inCard: true, label: t('settings.qwen.general.outputLanguage'), description: t('settings.qwen.general.outputLanguageDesc'), value: outputLanguageDraft, placeholder: t('settings.qwen.option.auto'), onChange: (value) => {
                            setOutputLanguageDraft(value);
                            void onSave('general.outputLanguage', value);
                        } }) }) }), _jsx(SettingsSection, { title: t('settings.qwen.general.everydayBehavior'), description: t('settings.qwen.general.everydayBehaviorDesc'), children: _jsxs(SettingsCard, { children: [_jsx(SettingsSelect, { inCard: true, label: t('settings.qwen.general.toolApprovalMode'), description: t('settings.qwen.general.toolApprovalModeDesc'), value: stringValue(snapshot, 'tools.approvalMode', 'default'), options: approvalModeOptions, onValueChange: (value) => void onSave('tools.approvalMode', value) }), _jsx(SettingsToggle, { label: t('settings.qwen.general.commitAttribution'), description: t('settings.qwen.general.commitAttributionDesc'), checked: boolValue(snapshot, 'general.gitCoAuthor.commit', true), onCheckedChange: (checked) => void onSave('general.gitCoAuthor.commit', checked) }), _jsx(SettingsToggle, { label: t('settings.qwen.general.prAttribution'), description: t('settings.qwen.general.prAttributionDesc'), checked: boolValue(snapshot, 'general.gitCoAuthor.pr', true), onCheckedChange: (checked) => void onSave('general.gitCoAuthor.pr', checked) }), _jsx(SettingsSelect, { inCard: true, label: t('settings.qwen.general.defaultFileEncoding'), description: t('settings.qwen.general.defaultFileEncodingDesc'), value: stringValue(snapshot, 'general.defaultFileEncoding', 'utf-8'), options: fileEncodingOptions, onValueChange: (value) => void onSave('general.defaultFileEncoding', value) })] }) }), _jsx(SettingsSection, { title: t('settings.qwen.general.fileSearch'), description: t('settings.qwen.general.fileSearchDesc'), children: _jsxs(SettingsCard, { children: [_jsx(SettingsToggle, { label: t('settings.qwen.general.respectGitIgnore'), description: t('settings.qwen.general.respectGitIgnoreDesc'), checked: boolValue(snapshot, 'context.fileFiltering.respectGitIgnore', true), onCheckedChange: (checked) => void onSave('context.fileFiltering.respectGitIgnore', checked) }), _jsx(SettingsToggle, { label: t('settings.qwen.general.respectQwenIgnore'), description: t('settings.qwen.general.respectQwenIgnoreDesc'), checked: boolValue(snapshot, 'context.fileFiltering.respectQwenIgnore', true), onCheckedChange: (checked) => void onSave('context.fileFiltering.respectQwenIgnore', checked) }), _jsx(SettingsToggle, { label: t('settings.qwen.general.fuzzyFileSearch'), description: t('settings.qwen.general.fuzzyFileSearchDesc'), checked: boolValue(snapshot, 'context.fileFiltering.enableFuzzySearch', true), onCheckedChange: (checked) => void onSave('context.fileFiltering.enableFuzzySearch', checked) })] }) })] }));
}
function McpServersTab({ snapshot, runCommand, setSnapshot, }) {
    ...
    return (_jsxs(_Fragment, { children: [_jsxs(SettingsSection, { title: t('settings.qwen.mcp.configuredServers'), description: t('settings.qwen.mcp.configuredServersDesc'), children: [_jsx("div", { className: "flex justify-end gap-2", children: _jsxs(Button, { size: "sm", onClick: () => {
                                setDraft(createEmptyMcpDraft());
                                setShowEditor(true);
                            }, children: [_jsx(Plus, { className: "w-4 h-4" }), t('settings.qwen.mcp.addServer')] }) }), _jsx("div", { className: "mt-3 space-y-3", children: entries.length === 0 ? (_jsx(EmptyState, { title: t('settings.qwen.mcp.noServersTitle'), description: t('settings.qwen.mcp.noServersDesc') })) : (entries.map((entry) => (_jsx(SettingsCard, { className: "px-4 py-3.5", children: _jsxs("div", { className: "flex items-start justify-between gap-3", children: [_jsxs("div", { className: "min-w-0", children: [_jsx("div", { className: "text-sm font-medium", children: entry.name }), _jsxs("div", { className: "text-xs text-muted-foreground mt-0.5", children: [entry.scope, " \u00B7 ", entry.server.transport, " \u00B7", ' ', entry.server.command ??
                                                    ...
                                                    setShowEditor(true);
                                                }, "aria-label": t('common.edit'), children: _jsx(Settings2, { className: "w-4 h-4" }) }), _jsx(Button, { size: "sm", variant: "ghost", onClick: () => void remove(entry), children: _jsx(Trash2, { className: "w-4 h-4 text-destructive" }) })] }))] }) }, `${entry.scope}:${entry.name}`)))) })] }), showEditor ? (_jsx(SettingsSection, { title: t('settings.qwen.mcp.addOrEditServer'), description: t('settings.qwen.mcp.addOrEditServerDesc'), children: _jsxs(SettingsCard, { className: "p-4 space-y-3", children: [_jsxs("div", { className: "grid grid-cols-1 sm:grid-cols-3 gap-3", children: [_jsx(SettingsSelect, { label: t('settings.qwen.common.scope'), value: draft.scope, options: scopeOptions, onValueChange: (scope) => setDraft((current) => ({
                                        ...current,
                                        scope: scope,
                                    })) }), _jsx(SettingsSelect, { label: t('settings.qwen.mcp.transport'), value: draft.transport, options: TRANSPORT_OPTIONS, onValueChange: (transport) => setDraft((current) => ({
                                        ...current,
                                        transport: transport,
                                    })) }), _jsx(SettingsInput, { label: t('settings.qwen.common.name'), value: draft.name, onChange: (name) => setDraft((current) => ({ ...current, name })), placeholder: "my-server" })] }), _jsx(SettingsInput, { label: draft.transport === 'stdio'
                                ? t('settings.qwen.common.command')
                                : t('settings.qwen.common.url'), value: draft.commandOrUrl, onChange: (commandOrUrl) => setDraft((current) => ({ ...current, commandOrUrl })), placeholder: draft.transport === 'stdio'
                                ? 'node'
                                : 'http://localhost:3000/mcp' }), draft.transport === 'stdio' ? (_jsx(SettingsTextarea, { label: t('settings.qwen.mcp.arguments'), description: t('settings.qwen.mcp.oneArgumentPerLine'), value: draft.args, onChange: (args) => setDraft((current) => ({ ...current, args })), placeholder: '-m\nmy_mcp_server', rows: 3 })) : (_jsx(SettingsTextarea, { label: t('settings.qwen.common.headers'), description: t('settings.qwen.common.oneKeyValuePerLine'), value: draft.headers, onChange: (headers) => setDraft((current) => ({ ...current, headers })), placeholder: "Authorization=Bearer ${TOKEN}", rows: 3 })), _jsxs("div", { className: "grid grid-cols-1 sm:grid-cols-2 gap-3", children: [_jsx(SettingsInput, { label: t('settings.qwen.common.timeout'), value: draft.timeout, onChange: (timeout) => setDraft((current) => ({ ...current, timeout })), placeholder: "15000" }), _jsx(SettingsInput, { label: t('settings.qwen.common.description'), value: draft.description, onChange: (description) => setDraft((current) => ({ ...current, description })), placeholder: "Internal tools" })] }), draft.transport === 'stdio' ? (_jsx(SettingsTextarea, { label: t('settings.qwen.common.environment'), description: t('settings.qwen.common.oneKeyValuePerLine'), value: draft.env, onChange: (env) => setDraft((current) => ({ ...current, env })), placeholder: "API_KEY=${API_KEY}", rows: 3 })) : null, _jsx(SettingsToggle, { inCard: false, label: t('settings.qwen.mcp.trustThisServer'), description: t('settings.qwen.mcp.trustThisServerDesc'), checked: draft.trust, onCheckedChange: (trust) => setDraft((current) => ({ ...current, trust })) }), _jsxs("div", { className: "flex justify-end gap-2", children: [_jsx(Button, { variant: "ghost", onClick: () => {
                                        setDraft(createEmptyMcpDraft());
                                        setShowEditor(false);
                                    }, children: t('common.clear') }), _jsxs(Button, { onClick: () => void save(), disabled: !draft.name.trim() || !draft.commandOrUrl.trim(), children: [_jsx(Save, { className: "w-4 h-4 mr-2" }), t('settings.qwen.mcp.saveServer')] })] })] }) })) : null] }));
}
function HooksTab({ snapshot, runCommand, setSnapshot, onSave, scrollViewportRef, }) {
    ...
    return (_jsxs(_Fragment, { children: [_jsx(SettingsSection, { title: t('settings.qwen.hooks.hookControl'), description: t('settings.qwen.hooks.hookControlDesc'), children: _jsx(SettingsCard, { children: _jsx(SettingsToggle, { label: t('settings.qwen.hooks.disableAllHooks'), description: t('settings.qwen.hooks.disableAllHooksDesc'), checked: boolValue(snapshot, 'disableAllHooks', false), onCheckedChange: (checked) => void onSave('disableAllHooks', checked) }) }) }), _jsxs(SettingsSection, { title: t('settings.qwen.hooks.configuredHooks'), description: t('settings.qwen.hooks.configuredHooksDesc'), children: [_jsx("div", { className: "flex justify-end gap-2", children: _jsxs(Button, { size: "sm", onClick: () => {
                                openEditor(createEmptyHookDraft());
                            }, children: [_jsx(Plus, { className: "w-4 h-4" }), t('settings.qwen.hooks.addHook')] }) }), _jsx("div", { className: "mt-3 space-y-3", children: entries.length === 0 ? (_jsx(EmptyState, { title: t('settings.qwen.hooks.noHooksTitle'), description: t('settings.qwen.hooks.noHooksDesc') })) : (entries.map((entry) => {
                            const config = entry.hook.hooks[0];
                        ...
                        })) })] }), showEditor ? (_jsx("div", { ref: editorRef, children: _jsx(SettingsSection, { title: t('settings.qwen.hooks.addOrEditHook'), description: t('settings.qwen.hooks.addOrEditHookDesc'), children: _jsxs(SettingsCard, { className: "p-4 space-y-3", children: [_jsxs("div", { className: "grid grid-cols-1 sm:grid-cols-3 gap-3", children: [_jsx(SettingsSelect, { label: t('settings.qwen.common.scope'), value: draft.scope, options: scopeOptions, onValueChange: (scope) => setDraft((current) => ({
                                            ...current,
                                            scope: scope,
                                        })) }), _jsx(SettingsSelect, { label: t('settings.qwen.hooks.event'), value: draft.event, options: HOOK_EVENT_OPTIONS, onValueChange: (event) => setDraft((current) => ({
                                            ...current,
                                            event: event,
                                        })) }), _jsx(SettingsSelect, { label: t('settings.qwen.hooks.type'), value: draft.type, options: hookTypeOptions, onValueChange: (type) => setDraft((current) => ({
                                            ...current,
                                            type: type,
                                        })) })] }), _jsx(SettingsInput, { label: t('settings.qwen.hooks.matcher'), value: draft.matcher, onChange: (matcher) => setDraft((current) => ({ ...current, matcher })), placeholder: "*" }), _jsx(SettingsInput, { label: draft.type === 'command'
                                    ? t('settings.qwen.common.command')
                                    : t('settings.qwen.common.url'), value: draft.commandOrUrl, onChange: (commandOrUrl) => setDraft((current) => ({ ...current, commandOrUrl })), placeholder: draft.type === 'command'
                                    ? '$QWEN_PROJECT_DIR/.qwen/hooks/check.sh'
                                    : 'http://127.0.0.1:8080/hook' }), _jsxs("div", { className: "grid grid-cols-1 sm:grid-cols-2 gap-3", children: [_jsx(SettingsInput, { label: t('settings.qwen.common.name'), value: draft.name, onChange: (name) => setDraft((current) => ({ ...current, name })) }), _jsx(SettingsInput, { label: t('settings.qwen.common.timeout'), value: draft.timeout, onChange: (timeout) => setDraft((current) => ({ ...current, timeout })), placeholder: "10000" })] }), _jsx(SettingsInput, { label: t('settings.qwen.common.description'), value: draft.description, onChange: (description) => setDraft((current) => ({ ...current, description })) }), draft.type === 'command' ? (_jsx(SettingsTextarea, { label: t('settings.qwen.common.environment'), description: t('settings.qwen.common.oneKeyValuePerLine'), value: draft.env, onChange: (env) => setDraft((current) => ({ ...current, env })), rows: 3 })) : (_jsxs(_Fragment, { children: [_jsx(SettingsTextarea, { label: t('settings.qwen.common.headers'), description: t('settings.qwen.common.oneKeyValuePerLine'), value: draft.headers, onChange: (headers) => setDraft((current) => ({ ...current, headers })), rows: 3 }), _jsx(SettingsTextarea, { label: t('settings.qwen.hooks.allowedEnvVars'), description: t('settings.qwen.hooks.allowedEnvVarsDesc'), value: draft.allowedEnvVars, onChange: (allowedEnvVars) => setDraft((current) => ({ ...current, allowedEnvVars })), rows: 3 })] })), _jsxs("div", { className: "grid grid-cols-1 sm:grid-cols-2 gap-2", children: [_jsx(SettingsToggle, { inCard: false, label: t('settings.qwen.hooks.sequential'), description: t('settings.qwen.hooks.sequentialDesc'), checked: draft.sequential, onCheckedChange: (sequential) => setDraft((current) => ({ ...current, sequential })) }), _jsx(SettingsToggle, { inCard: false, label: draft.type === 'command'
                                            ? t('settings.qwen.hooks.async')
                                            : t('settings.qwen.hooks.once'), description: draft.type === 'command'
                                            ? t('settings.qwen.hooks.asyncDesc')
                                            : t('settings.qwen.hooks.onceDesc'), checked: draft.type === 'command' ? draft.async : draft.once, onCheckedChange: (checked) => setDraft((current) => draft.type === 'command'
                                            ...
                                            setDraft(createEmptyHookDraft());
                                            setShowEditor(false);
                                        }, children: t('common.clear') }), _jsxs(Button, { onClick: () => void save(), disabled: !draft.commandOrUrl.trim(), children: [_jsx(Save, { className: "w-4 h-4 mr-2" }), t('settings.qwen.hooks.saveHook')] })] })] }) }) })) : null] }));
}
function ExtensionsTab({ snapshot, runCommand, setSnapshot, }) {
    const { t } = useTranslation();
    return (_jsx(SettingsSection, { title: t('settings.qwen.extensions.installedExtensions'), description: t('settings.qwen.extensions.installedExtensionsDesc'), children: _jsx("div", { className: "space-y-3", children: snapshot.merged.extensions.length === 0 ? (_jsx(EmptyState, { title: t('settings.qwen.extensions.noExtensionsTitle'), description: t('settings.qwen.extensions.noExtensionsDesc') })) : (snapshot.merged.extensions.map((extension) => (_jsx(ExtensionCard, { extension: extension, runCommand: runCommand, setSnapshot: setSnapshot }, extension.id)))) }) }));
}
function ExtensionCard({ extension, runCommand, setSnapshot, }) {
    ...
    return (_jsxs(SettingsCard, { className: "px-4 py-3.5", children: [_jsx("div", { className: "flex items-start justify-between gap-3", children: _jsxs("div", { className: "min-w-0", children: [_jsx("div", { className: "text-sm font-medium", children: extension.displayName ?? extension.name }), _jsxs("div", { className: "text-xs text-muted-foreground mt-0.5", children: [extension.version, " \u00B7", ' ', extension.isActive
                                    ...
                                    : t('settings.qwen.extensions.inactive')] }), _jsx("div", { className: "text-[11px] text-muted-foreground/70 mt-1 truncate font-mono", children: extension.path })] }) }), _jsx("div", { className: "mt-3 text-xs text-muted-foreground", children: t('settings.qwen.extensions.summary', {
                    commands: extension.commands.length,
                    skills: extension.skills.length,
                    mcpServers: extension.mcpServers.length,
                }) }), _jsx("div", { className: "mt-3 divide-y divide-border/60", children: extension.settings.length === 0 ? (_jsx("div", { className: "py-3 text-xs text-muted-foreground", children: t('settings.qwen.extensions.noConfigurableSettings') })) : (extension.settings.map((setting) => (_jsx(ExtensionSettingRow, { extension: extension, setting: setting, runCommand: runCommand, setSnapshot: setSnapshot }, setting.envVar)))) })] }));
}
function ExtensionSettingRow({ extension, setting, runCommand, setSnapshot, }) {
    ...
    return (_jsxs("div", { className: "py-3", children: [_jsxs("div", { className: "flex items-start justify-between gap-3", children: [_jsxs("div", { className: "min-w-0", children: [_jsx("div", { className: "text-sm font-medium", children: setting.name }), _jsx("div", { className: "text-xs text-muted-foreground mt-0.5", children: setting.description }), _jsx("div", { className: "text-[11px] text-muted-foreground/70 mt-1 font-mono", children: setting.envVar })] }), _jsx(SettingsSelect, { value: scope, options: scopeOptions, onValueChange: (value) => setScope(value), className: "w-32" })] }), _jsxs("div", { className: "flex gap-2 mt-2", children: [_jsx(Input, { value: draft, type: setting.sensitive ? 'password' : 'text', onChange: (event) => setDraft(event.target.value), placeholder: setting.sensitive &&
                            ...
                            : t('settings.qwen.extensions.value'), className: "h-8 bg-muted/50" }), _jsx(Button, { size: "sm", onClick: () => void save(), disabled: !draft && setting.sensitive, children: _jsx(Save, { className: "w-4 h-4" }) })] })] }));
}
//# sourceMappingURL=QwenSettingsPage.js.map