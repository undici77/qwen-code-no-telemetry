 ...
 */
export function FadingText({ children, className, fadeWidth = 24 }) {
    ...
    return (_jsx("span", { ref: ref, className: cn("overflow-hidden whitespace-nowrap min-w-0", className), style: isOverflowing ? {
            maskImage: `linear-gradient(to right, black calc(100% - ${fadeWidth}px), transparent)`
        } : undefined, children: children }));
}
//# sourceMappingURL=fading-text.js.map