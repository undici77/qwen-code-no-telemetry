 ...
 */
export function truncateForChipTooltip(text, maxLength) {
 ...
 */
export function formatFollowUpSection(followUps, options) {
 ...
 */
export function normalizeFollowUpsMarkdown(message) {
...
//# sourceMappingURL=ChatDisplay.follow-ups.js.map