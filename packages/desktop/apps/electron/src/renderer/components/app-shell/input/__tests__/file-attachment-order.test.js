...
function imageFile(name, lastModified) {
...
describe('sortFilesForAttachmentInput', () => {
    it('sorts pasted files by natural filename order', () => {
        ...
        expect(sortFilesForAttachmentInput([image10, image2, image1]).map((file) => file.name)).toEqual(['image-1.png', 'image-2.png', 'image-10.png']);
    });
...
//# sourceMappingURL=file-attachment-order.test.js.map