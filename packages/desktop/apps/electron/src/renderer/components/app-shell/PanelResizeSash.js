...
import { PANEL_MIN_WIDTH, PANEL_SASH_FLEX_MARGIN, PANEL_SASH_HALF_HIT_WIDTH, PANEL_SASH_LINE_WIDTH, PANEL_STACK_VERTICAL_OVERFLOW, } from './panel-constants';
export { PANEL_MIN_WIDTH };
export function PanelResizeSash({ leftIndex, rightIndex, }) {
    ...
    const handleMouseDown = useCallback((e) => {
        ...
        const leftPanel = sashEl.previousElementSibling;
        const rightPanel = sashEl.nextElementSibling;
    ...
    return (_jsx("div", { ref: ref, className: "relative w-0 h-full cursor-col-resize flex justify-center shrink-0", style: { margin: `0 ${PANEL_SASH_FLEX_MARGIN}px` }, onMouseDown: handleMouseDown, onMouseMove: handlers.onMouseMove, onMouseLeave: handlers.onMouseLeave, onDoubleClick: handleDoubleClick, children: _jsx("div", { className: "absolute inset-y-0 flex justify-center cursor-col-resize", style: { left: -PANEL_SASH_HALF_HIT_WIDTH, right: -PANEL_SASH_HALF_HIT_WIDTH }, children: _jsx("div", { className: "absolute left-1/2 -translate-x-1/2", style: {
                    ...gradientStyle,
...
//# sourceMappingURL=PanelResizeSash.js.map