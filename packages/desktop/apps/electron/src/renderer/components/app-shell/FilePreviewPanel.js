...
export function FilePreviewPanel({ children }) {
    const [width, setWidth] = React.useState(() => clampWidth(storage.get(storage.KEYS.filePreviewWidth, DEFAULT_WIDTH)));
    ...
    const handleResizeStart = React.useCallback((event) => {
    ...
    return (_jsxs("div", { className: "relative h-full shrink-0 flex flex-col", style: { width }, "data-testid": "file-preview-panel", children: [_jsx("div", { role: "separator", "aria-orientation": "vertical", "aria-label": "Resize file preview", onMouseDown: handleResizeStart, className: "group absolute left-0 top-0 bottom-0 z-20 w-2 -translate-x-1/2 cursor-col-resize", children: _jsx("div", { className: cn('mx-auto h-full w-px transition-colors', isResizing ? 'bg-accent' : 'bg-border group-hover:bg-accent/70') }) }), _jsx("div", { className: "flex-1 min-h-0 h-full pl-px", children: children })] }));
}
//# sourceMappingURL=FilePreviewPanel.js.map