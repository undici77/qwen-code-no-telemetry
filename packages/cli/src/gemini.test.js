...
import { createNonInteractivePromptId, main, setupUnhandledRejectionHandler, validateDnsResolutionOrder, startInteractiveUI, } from './gemini.js';
...
describe('gemini.tsx main function', () => {
    ...
    const runSandboxRelaunch = async (argv, sessionId = '123e4567-e89b-12d3-a456-426614174000') => {
        const originalArgv = process.argv;
        process.argv = argv;
        const processExitSpy = vi
            .spyOn(process, 'exit')
