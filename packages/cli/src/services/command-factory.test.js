...
describe('createSlashCommandFromDefinition', () => {
    ...
    it('marks custom file commands with stable source detail', () => {
        const command = createSlashCommandFromDefinition('/workspace/.qwen/commands/review.toml', '/workspace/.qwen/commands', {
    ...
    it('marks extension commands with stable source detail', () => {
        const command = createSlashCommandFromDefinition('/workspace/.qwen/extensions/demo/commands/review.md', '/workspace/.qwen/extensions/demo/commands', {
            prompt: 'Review the current changes',
        }, 'demo', '.md');
