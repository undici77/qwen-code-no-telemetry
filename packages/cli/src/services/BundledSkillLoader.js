 ...
 */
import { createDebugLogger, appendToLastTextPart, buildSkillLlmContent, } from '@qwen-code/qwen-code-core';
            ...
            return skills.map((skill) => ({
                ...
                action: async (context, _args) => {
                    ...
                    const content = context.invocation?.args
                        ? appendToLastTextPart([{ text: skillPrompt }], context.invocation.raw)
                        : [{ text: skillPrompt }];
                    return {
                        type: 'submit_prompt',
                        content,
