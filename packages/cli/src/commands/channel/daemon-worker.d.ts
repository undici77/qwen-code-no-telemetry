...
export declare function createDaemonSessionFactory({
  client,
  DaemonSessionClient,
  clientId,
}: {
...
export declare function createDaemonChannelBridgeFacade(
  bridge: ChannelAgentBridge,
  opts: {
    exposeShellCommand: boolean;
  },
): ChannelAgentBridge;
export declare function runChannelDaemonWorker(
  opts: RunChannelDaemonWorkerOptions,
): Promise<ChannelDaemonWorkerHandle>;
interface DaemonWorkerArgs {
  channel?: string[];
}
export declare const daemonWorkerCommand: CommandModule<
  unknown,
  DaemonWorkerArgs
>;
export {};
