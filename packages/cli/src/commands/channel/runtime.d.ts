...
export declare function daemonObservedContactsPath(
  workspaceCwd: string,
): string;
export declare function daemonChannelLoopPath(workspaceCwd: string): string;
export declare function daemonChannelStateDir(
  workspaceCwd: string,
  channelName: string,
): string;
export declare function channelLoopPath(): string;
export declare function loadChannelsConfig(
  cwd?: string,
  settings?: LoadedSettings,
): Record<string, unknown>;
export declare function resolveExtensionChannelEntrySpecifier(
...
export declare function selectFirstModel(
  parsed: ParsedChannel[],
  bridgeLabel: string,
): string | undefined;
export declare function registerToolCallDispatch(
  bridge: ChannelAgentBridge,
  router: SessionRouter,
  channels: Map<string, ChannelBase>,
): void;
export declare function registerBackgroundResponseRelay(
  bridge: ChannelAgentBridge,
  router: SessionRouter,
  channels: Map<string, ChannelBase>,
): void;
export declare function registerPermissionRelay(
  bridge: ChannelAgentBridge,
  router: SessionRouter,
  channels: Map<string, ChannelBase>,
): void;
export declare function registerSessionCleanup(
  bridge: ChannelAgentBridge,
  router: SessionRouter,
  channels: Map<string, ChannelBase>,
): void;
export declare function parseConfiguredChannels(
