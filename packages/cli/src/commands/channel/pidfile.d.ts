...
export declare function writeServeServiceInfo({
  channels,
  servePid,
  workerPid,
  workers,
...
export declare function reserveServeServiceInfo({
  channels,
  servePid,
}: {
  channels: string[];
 ...
 */
export declare function signalService(
  pid: number,
 ...
 */
export declare function waitForExit(
  pid: number,
  timeoutMs?: number,
  pollMs?: number,
): Promise<boolean>;
