...
import { extensionConsentString, requestConsentOrFail, requestChoicePluginNonInteractive, } from './consent.js';
...
describe('extensionConsentString', () => {
    ...
    it('should include MCP servers when present', () => {
        ...
        const result = extensionConsentString(config);
        expect(result).toContain('This extension will run the following MCP servers');
    ...
    it('should include skills when present', () => {
        ...
        expect(result).toContain('This extension will install the following skills');
    ...
    it('should include subagents when present', () => {
        ...
        expect(result).toContain('This extension will install the following subagents');
...
describe('requestConsentOrFail', () => {
    ...
    it('should throw error when user declines consent', async () => {
        ...
        await expect(requestConsentOrFail(mockRequestConsent, {
            extensionConfig: { name: 'test-extension', version: '1.0.0' },
            originSource: 'QwenCode',
...
describe('requestChoicePluginNonInteractive', () => {
    ...
    it('should throw error when plugins array is empty', async () => {
        ...
        await expect(requestChoicePluginNonInteractive(marketplace)).rejects.toThrow('No plugins available in this marketplace.');
    });
    ...
    it('should throw error when selection is cancelled', async () => {
        ...
        await expect(requestChoicePluginNonInteractive(marketplace)).rejects.toThrow('Plugin selection cancelled.');
    });
});
