...
describe('mcp reconnect command', () => {
    ...
    describe('reconnect specific server', () => {
        ...
        it('passes pending gated servers to the reconnect config', async () => {
            ...
            expect(MockedConfig).toHaveBeenCalledWith(expect.objectContaining({
                mcpServers,
                pendingMcpServers: ['pending'],
            }));
            expect(mockToolRegistry.discoverToolsForServer).toHaveBeenCalledWith('approved');
        });
        ...
        it('reconnects project servers from assembled MCP config', async () => {
            ...
            expect(mockedAssembleMcpServers).toHaveBeenCalledWith(settingsServers, process.cwd());
            expect(mockToolRegistry.discoverToolsForServer).toHaveBeenCalledWith('project');
        });
