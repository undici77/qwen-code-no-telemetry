...
export const serveCommand = {
    ...
    builder: (yargs) => yargs
        ...
        .option('workspace', {
        type: 'string',
        description: 'Absolute workspace path this daemon binds to. ' +
        ...
        description: 'Per-session SSE replay ring depth (#3803 §02 target). Sets the ' +
        ...
        type: 'boolean',
        default: true,
        description: 'Stage 1 mode: one `qwen --acp` child per daemon (the daemon binds to ' +
        ...
        description: 'How --mcp-client-budget is enforced (issue #4175 PR 14). ' +
