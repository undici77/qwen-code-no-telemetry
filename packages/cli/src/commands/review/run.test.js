...
const { buildReviewPrompt, newestArtifactSince, exitCodeFor, killProcessGroup, runCommand, } = await import('./run.js');
...
describe('newestArtifactSince', () => {
    ...
    it('returns the newest matching artifact from this run', () => {
        ...
        expect(newestArtifactSince(dir, /^qwen-review-.*composed\.json$/, start)).toBe(newer);
    });
