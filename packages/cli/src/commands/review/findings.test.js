...
import { applyOutcomes, buildReport, compressSummary, CONFIDENCES, findingsCommand, OUTCOMES, renderFindings, SEVERITIES, sortFindings, SOURCES, validateFindings, validateOutcomes, holdCriticalsFailingOnBase, sharedFailingFilesOf, } from './findings.js';
