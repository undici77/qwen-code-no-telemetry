...
export type Responder = (req: RespondedRequest) => MockReply | Promise<MockReply>;
...
export declare function messagesText(body: Record<string, unknown> | null): string;
/**
 ...
 */
export declare function chunk(delta: Record<string, unknown>, finish?: string | null): Record<string, unknown>;
/** The chunk sequence for a reply — the half the caller should never write. */
export declare function chunksFor(reply: MockReply): Array<Record<string, unknown>>;
/** A non-streaming answer, for the side queries 20% of the corpus classified. */
export declare function completionFor(reply: MockReply): Record<string, unknown>;
/**
...
export declare function anthropicMessage(reply: MockReply): Record<string, unknown>;
/**
 ...
 * its requests.
 */
export declare function anthropicText(body: Record<string, unknown> | null): string;
...
export declare function startMockProvider(args: MockProviderArgs, respondOverride?: Responder): Promise<{
