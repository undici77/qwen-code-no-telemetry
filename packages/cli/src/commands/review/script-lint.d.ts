...
export declare function toolFor(path: string, firstLine: string): LintTool | null;
 ...
 */
export declare function buildToolInvocation(tool: LintTool, absPath: string): {
    argv: string[];
...
export declare function runScriptLint(args: ScriptLintArgs, runner?: ToolRunner): ScriptLintReport;
