...
const { ghMock, ghApiMock, ghApiAllMock, ghApiAllNestedMock, currentUserMock, ensureAuthenticatedMock, setGhHostMock, readFileSyncMock, writeFileSyncMock, writeStdoutLineMock, } = vi.hoisted(() => ({
    ghMock: vi.fn(),
    ghApiMock: vi.fn(),
    ghApiAllMock: vi.fn(),
        ...
        ghApiAllNestedMock.mockImplementation((path) => path.endsWith('/check-runs')
            ? [
                ...
                },
                {
                    ...
                    status: 'in_progress',
                    conclusion: null,
                    details_url: 'https://github.com/QwenLM/qwen-code/actions/runs/28788268483/job/85362025778',
                },
            ]
            : []);
        ghApiMock.mockReturnValue(null);
