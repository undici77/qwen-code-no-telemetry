...
export declare function observedTestCounts(report: BuildTestReport | null): number[];
...
export declare function runTestPlan(args: TestPlanArgs, fetchBody?: (ownerRepo: string, pr: string) => string): TestPlanReport;
