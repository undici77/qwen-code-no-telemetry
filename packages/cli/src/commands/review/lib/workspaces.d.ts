 ...
 */
export declare function isWorkspaceMember(
  filePath: string,
 ...
 */
export declare function workspaceDirFor(
  filePath: string,
  workspaceGlobs: string[],
): string | null;
/**
 ...
 */
export declare function isNegationExcluded(
  filePath: string,
  workspaceGlobs: string[],
): boolean;
/**
...
export declare function affectedWorkspaces(
  changedFiles: string[],
  workspaceGlobs: string[],
): string[];
/**
 ...
 */
export declare function reverseDependencyClosure(
  affected: string[],
  packages: WorkspacePackage[],
): string[];
/**
 ...
 * does not touch.
 */
export declare function buildSetFor(
  affected: string[],
  packages: WorkspacePackage[],
  alsoBuild?: string[],
): string[];
