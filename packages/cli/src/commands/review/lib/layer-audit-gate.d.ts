 ...
 */
export declare const REVERSE_AUDIT_IDENTITY = "You are review agent `reverse-audit`";
 ...
 */
export declare function layerAuditGate(planPath: string | undefined, env?: NodeJS.ProcessEnv, readReturns?: (planPath: string, env: NodeJS.ProcessEnv, diffPath: string | undefined) => AuditorReturns): {
    unreviewed: string[];
};
export {};
