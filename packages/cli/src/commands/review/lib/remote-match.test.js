...
import { parseRemoteUrl, matchRemotes, normalizeSegment, } from './remote-match.js';
...
describe('matchRemotes', () => {
    ...
    it('matches a GHE remote only under its own host', () => {
        ...
        expect(matchRemotes(remotes, { owner: 'QwenLM', repo: 'qwen-code' }).matched).toEqual(['origin']);
    });
