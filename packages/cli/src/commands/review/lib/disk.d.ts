 ...
 */
export declare const INSTALL_MIN_FREE_BYTES: number;
export declare const BUILD_MIN_FREE_BYTES: number;
/**
 ...
 * invent them.
 */
export declare function freeDiskBytes(dir: string): number | null;
export declare const gib: (bytes: number) => string;
