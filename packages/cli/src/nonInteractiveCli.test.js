 ...
 */
import { executeToolCall, ToolErrorType, shutdownTelemetry, GeminiEventType, OutputFormat, uiTelemetryService, FatalInputError, ApprovalMode, SendMessageType, } from '@qwen-code/qwen-code-core';
...
describe('runNonInteractive', () => {
    ...
    describe('--json-schema structured output', () => {
        ...
        it('skips side-effecting tool calls that precede structured_output in the same turn', async () => {
            ...
            const leadingToolResult = events.find((m) => extractToolResultId(m) === 'tool-leading');
