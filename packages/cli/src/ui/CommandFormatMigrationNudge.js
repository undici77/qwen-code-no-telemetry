...
export function CommandFormatMigrationNudge({ tomlFiles, onComplete, }) {
    ...
    return (_jsxs(Box, { flexDirection: "column", borderStyle: "round", borderColor: theme.status.warning, padding: 1, width: "100%", marginLeft: 1, children: [_jsxs(Box, { marginBottom: 1, flexDirection: "column", children: [_jsxs(Text, { children: [_jsx(Text, { color: theme.status.warning, children: '⚠  ' }), _jsx(Text, { bold: true, children: t('Command Format Migration') })] }), _jsx(Text, { color: theme.text.secondary, children: count > 1
