...
import { AppContainer, dedupeNewestFirst, getNextRenderMode, isRenderModeToggleKey, } from './AppContainer.js';
...
describe('AppContainer State Management', () => {
    ...
    describe('Keyboard Input Handling', () => {
        ...
        describe('Ctrl+O compact mode toggle (issue #3899)', () => {
            ...
            const findGlobalKeypressHandler = () => mockedUseKeypress.mock.calls
                .map((call) => call[0])
                .reverse()
                .find((handler) => typeof handler === 'function' &&
