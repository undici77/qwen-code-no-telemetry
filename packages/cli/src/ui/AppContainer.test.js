...
import { makeFakeConfig, SendMessageType, } from '@qwen-code/qwen-code-core';
...
describe('AppContainer State Management', () => {
    ...
    describe('Context Providers', () => {
        ...
        it('submits /btw immediately instead of queueing while responding', () => {
            ...
            expect(mockSubmitQuery).toHaveBeenCalledWith('/btw quick side question', SendMessageType.UserQuery, undefined, { submittedPrompt: '/btw quick side question' });
