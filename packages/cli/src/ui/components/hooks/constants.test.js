...
import { HookEventName, HooksConfigSource, hookEventSupportsMatcher, } from '@qwen-code/qwen-code-core';
...
describe('hooks constants', () => {
    ...
    describe('createEmptyHookEventInfo', () => {
        ...
        it('should create empty info for Stop', () => {
            ...
            expect(info.shortDescription).toBe('Right before Qwen Code concludes its response');
