...
import { __resetActiveGoalStoreForTests, registerGoalHook, unregisterGoalHook, } from '@qwen-code/qwen-code-core';
...
describe('GoalPill', () => {
    ...
    it('renders nothing when no goal is active', () => {
        const { lastFrame, unmount } = renderWithProviders(_jsx(GoalPill, {}), {
            config: makeConfig(),
        });
