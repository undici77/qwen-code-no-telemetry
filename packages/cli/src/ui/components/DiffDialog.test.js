...
const renderWide = (columns) => {
    ...
    const instance = inkRender(_jsx(ShellFocusContext.Provider, { value: true, children: _jsx(KeypressProvider, { kittyProtocolEnabled: false, children: _jsx(DiffDialog, { history: [], cwd: "/tmp", fileHistoryService: undefined, fileCheckpointingEnabled: false, onClose: vi.fn() }) }) }), {
        stdout: stdout,
        stderr: stderr,
        stdin: stdin,
...
async function withDialogAtWidth(columns, fn) {
...
//# sourceMappingURL=DiffDialog.test.js.map