...
function renderWithMockedStats(metrics) {
    ...
    return render(_jsx(SkillStatsDisplay, {}));
}
function createMetrics(skills) {
    return {
        models: {},
        tools: {
            totalCalls: 0,
...
describe('<SkillStatsDisplay />', () => {
    it('renders an empty state when no skills have been called', () => {
        const { lastFrame } = renderWithMockedStats(createMetrics({
            totalCalls: 0,
            totalSuccess: 0,
            totalFail: 0,
            byName: {},
...
//# sourceMappingURL=SkillStatsDisplay.test.js.map