...
import { getActiveGoal } from '@qwen-code/qwen-code-core';
 ...
 */
function useActiveGoal(sessionId) {
    const [goal, setGoal] = useState(() => getActiveGoal(sessionId));
...
export const GoalPill = () => {
    ...
    return _jsxs(Text, { color: theme.text.accent, children: ["\u25CE /goal active", suffix] });
};
