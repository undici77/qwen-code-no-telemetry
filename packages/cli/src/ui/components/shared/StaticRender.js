 ...
 */
const StaticRender = memo(({ children, width }) => (_jsx(Box, { width: width, flexDirection: "column", flexShrink: 0, children: children })), (prev, next) => prev.children === next.children && prev.width === next.width);
