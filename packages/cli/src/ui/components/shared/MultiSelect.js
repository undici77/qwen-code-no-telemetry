...
export function MultiSelect({ items, initialIndex = 0, selectedKeys = EMPTY_SELECTED_KEYS, onConfirm, onChange, onSelectedKeysChange, onHighlight, isFocused = true, disableVimNav = false, showNumbers = true, showScrollArrows = false, maxItemsToShow = 10, checkedText = '[✓]', uncheckedText = '[ ]', showActiveMarker = false, }) {
