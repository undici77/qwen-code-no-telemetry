...
import { aggregateModelTokens, buildStatusLinePresetData, buildStatusLinePresetLines, DEFAULT_STATUS_LINE_PRESET_CONFIG, normalizeStatusLinePresetConfig, orderStatusLinePresetItems, STATUS_LINE_PRESET_ITEMS, } from '../statusLinePresets.js';
...
export function StatusLineDialog({ settings, config, uiState, addItem, onSaved, onClose, availableTerminalHeight, }) {
    ...
    const handleConfirm = useCallback(() => {
        ...
        const statusLine = settings.forScope(effectiveScope).settings.ui?.statusLine;
        const hideContextIndicator = statusLine && typeof statusLine === 'object'
