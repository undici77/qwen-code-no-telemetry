 ...
 */
export function getPillLabel(snapshot) {
 ...
 */
export const MCPHealthPill = () => {
    const snapshot = useMCPHealth();
    const label = getPillLabel(snapshot);
    if (!label)
        return null;
    return (_jsxs(_Fragment, { children: [_jsx(Text, { color: theme.text.secondary, wrap: "truncate", children: ' · ' }), _jsx(Text, { color: theme.status.warning, wrap: "truncate", children: label })] }));
};
//# sourceMappingURL=MCPHealthPill.js.map