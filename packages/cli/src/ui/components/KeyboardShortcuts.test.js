...
describe('KeyboardShortcuts', () => {
    ...
    ])('advertises the %s image-paste key', (platform, expectedPasteCell, absentKeys) => {
        stubPlatform(platform);
        const { lastFrame } = render(_jsx(KeyboardShortcuts, {}));
...
//# sourceMappingURL=KeyboardShortcuts.test.js.map