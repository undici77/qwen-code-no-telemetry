 ...
 */
export declare function defaultRenderLine({ lineText, isOnCursorLine, cursorCol, showCursor, }: RenderLineOptions): ReactNode;
...
export declare function getPhysicalCursorPosition(node: DOMElement | null, { hasMeasured, showCursor, cursorVisualRow, cursorVisualCol, scrollVisualRow, linesToRender, prefixWidth, }: PhysicalCursorState): {
    x: number;
    y: number;
} | undefined;
export declare const BaseTextInput: ({ buffer, onSubmit, onKeypress, showCursor, placeholder, prefix, prefixWidth, borderColor, topRightLabel, isActive, renderLine, mouseEnabled, }: BaseTextInputProps) => ReactNode;
