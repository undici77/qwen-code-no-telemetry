...
function renderPanel(options = { entries: [] }) {
    ...
    let result;
    act(() => {
        result = render(_jsx(ConfigContext.Provider, { value: options.config, children: _jsx(BackgroundTaskViewStateContext.Provider, { value: state, children: _jsx(LiveAgentPanel, { width: options.width, maxRows: options.maxRows }) }) }));
    });
    return result;
}
/**
