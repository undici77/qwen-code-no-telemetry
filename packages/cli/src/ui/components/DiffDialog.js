...
function FileRow({ file, selected, maxPathChars, }) {
    ...
    return (_jsxs(Box, { flexDirection: "row", children: [_jsxs(Text, { color: selected ? theme.text.accent : theme.text.primary, bold: selected, children: [pointer, path] }), _jsxs(Text, { color: theme.text.secondary, children: [tag, " "] }), file.isBinary ? (_jsx(Text, { color: theme.text.secondary, italic: true, children: t('binary') })) : (_jsxs(_Fragment, { children: [file.added > 0 ? (_jsxs(Text, { color: theme.status.success, children: ["+", file.added] })) : null, file.added > 0 && file.removed > 0 ? _jsx(Text, { children: " " }) : null, file.removed > 0 ? (_jsxs(Text, { color: theme.status.error, children: ["-", file.removed] })) : null] }))] }));
}
