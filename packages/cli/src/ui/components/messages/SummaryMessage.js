...
export const SummaryMessage = ({ summary }) => {
    ...
    return (_jsxs(Box, { flexDirection: "row", children: [_jsx(Box, { width: 2, flexShrink: 0, children: getIcon() }), _jsx(Box, { flexGrow: 1, children: _jsx(Text, { color: summary.isPending ? Colors.AccentPurple : Colors.AccentGreen, children: getText() }) })] }));
};
