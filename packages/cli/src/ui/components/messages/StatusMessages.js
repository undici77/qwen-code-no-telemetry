...
export const InfoMessage = ({ text, linkUrl, linkText, }) => (_jsx(StatusMessage, { text: text, prefix: "\u25CF", prefixColor: theme.text.primary, textColor: theme.text.primary, footer: linkUrl && (_jsx(Link, { url: linkUrl, children: _jsx(Text, { color: theme.text.link, underline: true, children: linkText ?? linkUrl }) })) }));
...
export const WarningMessage = ({ text }) => (_jsx(StatusMessage, { text: text, prefix: "\u25B3", prefixColor: theme.status.warning, textColor: theme.status.warning }));
...
export const AwayRecapMessage = ({ text }) => (_jsxs(Box, { flexDirection: "row", children: [_jsx(Box, { width: 2, flexShrink: 0, children: _jsx(Text, { color: theme.text.secondary, children: "\u203B" }) }), _jsxs(Text, { wrap: "wrap", children: [_jsxs(Text, { color: theme.text.secondary, bold: true, children: ["recap:", ' '] }), _jsx(Text, { color: theme.text.secondary, italic: true, children: text })] })] }));
