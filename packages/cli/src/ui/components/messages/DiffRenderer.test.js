...
`;
        ...
        expect(mockColorizeCode).toHaveBeenCalledWith('print("hello world")', 'python', undefined, 80, undefined, mockSettings, 4);
    });
...
`;
        ...
        expect(mockColorizeCode).toHaveBeenCalledWith('some content', null, undefined, 80, undefined, mockSettings, 4);
    });
...
`;
        ...
        expect(mockColorizeCode).toHaveBeenCalledWith('some text content', null, undefined, 80, undefined, mockSettings, 4);
    });
