...
describe('<OverflowProvider><DiffRenderer /></OverflowProvider>', () => {
    ...
    const sanitizeOutput = (output, contentWidth) => output?.replace(/GAP_INDICATOR/g, '═'.repeat(contentWidth));
...
+print("hello world")
`;
        render(_jsx(OverflowProvider, { children: _jsx(DiffRenderer, { diffContent: newFileDiffContent, filename: "test.py", contentWidth: 80, settings: mockSettings }) }));
        expect(mockColorizeCode).toHaveBeenCalledWith('print("hello world")', 'python', undefined, 80, { settings: mockSettings, tabWidth: 4 });
    });
...
+some content
`;
        render(_jsx(OverflowProvider, { children: _jsx(DiffRenderer, { diffContent: newFileDiffContent, filename: "test.unknown", contentWidth: 80, settings: mockSettings }) }));
        expect(mockColorizeCode).toHaveBeenCalledWith('some content', null, undefined, 80, { settings: mockSettings, tabWidth: 4 });
    });
...
+some text content
`;
        render(_jsx(OverflowProvider, { children: _jsx(DiffRenderer, { diffContent: newFileDiffContent, contentWidth: 80, settings: mockSettings }) }));
        expect(mockColorizeCode).toHaveBeenCalledWith('some text content', null, undefined, 80, { settings: mockSettings, tabWidth: 4 });
    });
...
+new line
`;
        const { lastFrame } = render(_jsx(OverflowProvider, { children: _jsx(DiffRenderer, { diffContent: existingFileDiffContent, filename: "test.txt", contentWidth: 80, settings: mockSettings }) }));
...
+++ b/file.txt
`;
        const { lastFrame } = render(_jsx(OverflowProvider, { children: _jsx(DiffRenderer, { diffContent: noChangeDiff, filename: "file.txt", contentWidth: 80, settings: mockSettings }) }));
    ...
    it('should handle empty diff content', () => {
        const { lastFrame } = render(_jsx(OverflowProvider, { children: _jsx(DiffRenderer, { diffContent: "", contentWidth: 80, settings: mockSettings }) }));
...
@@ -10,2 +10,2 @@
 ...
 context line 11
`;
        const { lastFrame } = render(_jsx(OverflowProvider, { children: _jsx(DiffRenderer, { diffContent: diffWithGap, filename: "file.txt", contentWidth: 80, settings: mockSettings }) }));
        const output = lastFrame();
...
@@ -11,5 +11,5 @@
 ...
 context line 15
`;
        const { lastFrame } = render(_jsx(OverflowProvider, { children: _jsx(DiffRenderer, { diffContent: diffWithSmallGap, filename: "file.txt", contentWidth: 80, settings: mockSettings }) }));
        const output = lastFrame();
...
22   console.log('end of
     second hunk');`,
        ...
        ])('with contentWidth $contentWidth and height $height', ({ contentWidth, height, expected }) => {
            const { lastFrame } = render(_jsx(OverflowProvider, { children: _jsx(DiffRenderer, { diffContent: diffWithMultipleHunks, filename: "multi.js", contentWidth: contentWidth, availableTerminalHeight: height, settings: mockSettings }) }));
            const output = lastFrame();
...
`;
        const { lastFrame } = render(_jsx(OverflowProvider, { children: _jsx(DiffRenderer, { diffContent: newFileDiff, filename: "TEST", contentWidth: 80, settings: mockSettings }) }));
        const output = lastFrame();
...
\\ No newline at end of file  
`;
        const { lastFrame } = render(_jsx(OverflowProvider, { children: _jsx(DiffRenderer, { diffContent: newFileDiff, filename: "Dockerfile", contentWidth: 80, settings: mockSettings }) }));
        const output = lastFrame();
...
`;
        it('should show line numbers by default when settings is undefined', () => {
            const { lastFrame } = render(_jsx(OverflowProvider, { children: _jsx(DiffRenderer, { diffContent: diffContent, filename: "test.txt", contentWidth: 80 }) }));
            const output = lastFrame();
        ...
        it('should show line numbers when showLineNumbers is true', () => {
            ...
            const { lastFrame } = render(_jsx(OverflowProvider, { children: _jsx(DiffRenderer, { diffContent: diffContent, filename: "test.txt", contentWidth: 80, settings: mockSettings }) }));
            const output = lastFrame();
            expect(output).toContain('1 -');
            expect(output).toContain('1 +');
            expect(output).toContain('2  ');
        ...
        it('excludes line numbers but keeps diff markers when copied', () => {
            const { stdout } = render(_jsx(OverflowProvider, { children: _jsx(DiffRenderer, { diffContent: diffContent, filename: "test.txt", contentWidth: 80, settings: mockSettings }) }));
