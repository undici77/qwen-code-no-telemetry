...
export const MemorySavedMessage = ({ item, }) => {
    ...
    return (_jsxs(Box, { flexDirection: "row", children: [_jsx(Box, { width: 2, flexShrink: 0, children: _jsx(Text, { dimColor: true, children: ICON.CIRCLE_FILLED }) }), _jsxs(Text, { dimColor: true, children: [verb, " ", n, " ", label] })] }));
};
