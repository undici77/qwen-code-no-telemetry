...
describe('DiffStatsDisplay', () => {
    it('renders header and per-file rows aligned in columns', () => {
        ...
        const { lastFrame } = render(_jsx(DiffStatsDisplay, { model: model }));
    ...
    it('renders the (new, partial) marker for truncated untracked text files', () => {
        ...
        const visible = stripAnsi(render(_jsx(DiffStatsDisplay, { model: model })).lastFrame() ?? '');
...
//# sourceMappingURL=DiffStatsDisplay.test.js.map