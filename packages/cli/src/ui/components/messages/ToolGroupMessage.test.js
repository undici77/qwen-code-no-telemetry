...
vi.mock('./ToolMessage.js', () => ({
    ToolMessage: function MockToolMessage({ callId, name, description, status, emphasis, resultDisplay, isFocused, forceShowResult, }) {
...
describe('<ToolGroupMessage />', () => {
    ...
    describe('Compact mode + terminal subagent expansion', () => {
        ...
        const renderCompact = (component, compactMode = true) => render(_jsx(ConfigContext.Provider, { value: mockConfig, children: _jsx(CompactModeProvider, { value: { compactMode }, children: component }) }));
