 ...
 */
export declare function useSelectionList<T>({ items, initialIndex, onSelect, onHighlight, isFocused, showNumbers, disableVimNav, }: UseSelectionListOptions<T>): UseSelectionListResult;
