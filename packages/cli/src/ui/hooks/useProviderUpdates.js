...
import { ALL_PROVIDERS, applyProviderInstallPlan, buildInstallPlan, buildProviderTemplate, computeModelListVersion, getDefaultModelIds, PROVIDER_METADATA_NS, resolveBaseUrl, resolveMetadataKey, resolveOwnsModel, } from '@qwen-code/qwen-code-core';
...
export function useProviderUpdates(settings, config, addItem) {
    ...
    const executeUpdate = useCallback(async (providerCfg, baseUrl) => {
        try {
            ...
            await applyProviderInstallPlan(installPlan, {
                ...
                syncAuthState: (authType, modelId) => config.getModelsConfig().syncAfterAuthRefresh(authType, modelId),
