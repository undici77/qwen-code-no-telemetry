...
describe('AuthDialog', { timeout: 15000 }, () => {
    ...
    itWhenTuiInputReliable('should submit Token Plan through the shared subscription handler', async () => {
        ...
        await pressEnterAndWaitFor(stdin, lastFrame, 'Alibaba ModelStudio · Step 1/2 · API Key');
        await typeText(stdin, 'sk-token-plan');
        await pressEnterAndWaitFor(stdin, lastFrame, 'Alibaba ModelStudio · Step 2/2 · Model IDs');
        stdin.write('\r');
        await vi.waitFor(() => {
