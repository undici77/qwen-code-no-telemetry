...
describe('App', () => {
    ...
    const renderWithProviders = (uiState) => render(_jsx(UIActionsContext.Provider, { value: mockUIActions, children: _jsx(AgentViewProvider, { children: _jsx(UIStateContext.Provider, { value: uiState, children: _jsx(SettingsContext.Provider, { value: mockSettings, children: _jsx(App, {}) }) }) }) }));
