...
describe('getVoiceUnavailableReason', () => {
    it('is available on supported desktop platforms', () => {
        expect(getVoiceUnavailableReason({ platform: 'darwin', env: {} })).toBeUndefined();
        expect(getVoiceUnavailableReason({ platform: 'linux', env: {} })).toBeUndefined();
        expect(getVoiceUnavailableReason({ platform: 'win32', env: {} })).toBeUndefined();
    });
    it('flags unsupported platforms', () => {
        expect(getVoiceUnavailableReason({
            platform: 'aix',
            env: {},
...
//# sourceMappingURL=voice-availability.test.js.map