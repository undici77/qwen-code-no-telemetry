...
import type { NormalizedSelection, Point, SelectionMode } from './selection-state.js';
/**
...
export declare function lineSpanAt(frame: ReadonlyFrame | null, x: number, y: number): NormalizedSelection | null;
/** Resolve the span at a point for a word/line selection mode. */
export declare function spanAtForMode(frame: ReadonlyFrame | null, mode: Exclude<SelectionMode, 'char'>, point: Point): NormalizedSelection | null;
