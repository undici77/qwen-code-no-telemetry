 ...
 */
export declare function terminalToGrid(col: number, row: number, terminalHeight: number, frameHeight: number): Point;
/** Whether a grid point falls inside the history viewport region. */
export declare function pointInViewport(point: Point, rect: ViewportRect): boolean;
/** Clamps a grid point to the viewport interior, for drag extension. */
export declare function clampToViewport(point: Point, rect: ViewportRect): Point;
