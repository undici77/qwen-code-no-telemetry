...
describe('TextSelectionController', () => {
    ...
    afterEach(cleanup);
    const mount = () => {
        render(_jsx(TextSelectionController, { isActive: true, getViewportRect: () => viewportRect, getAdditionalSelectableRects: () => additionalSelectableRects, getScrollState: () => scrollState, hitTestScrollbar: () => false }));
