...
import { formatClaudeMcpImportResult, importConfigCommand, parseImportConfigArgs, resolveImportSourceForScope, } from './importConfigCommand.js';
...
describe('importConfigCommand', () => {
    ...
    it('uses project Claude Code configs for default project-scope imports', () => {
        expect(resolveImportSourceForScope('all', 'project', false)).toBe('claude-code');
    });
...
//# sourceMappingURL=importConfigCommand.test.js.map