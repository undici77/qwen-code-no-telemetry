...
describe('rememberCommand', () => {
    ...
    it('routes to managed memory when available', () => {
        ...
        expect(result.content).toContain('memory system');
        expect(result.content).not.toContain('<user-content>');
    ...
    it('falls back to QWEN.md in bare mode', () => {
        ...
        expect(result.content).toContain('QWEN.md');
...
//# sourceMappingURL=rememberCommand.test.js.map