 ...
 */
export declare function getDirPathCompletions(partialArg: string): CommandCompletionItem[];
export declare function getSingleDirPathCompletions(partialArg: string): CommandCompletionItem[];
