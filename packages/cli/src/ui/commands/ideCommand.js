 ...
 */
import { IdeClient, logIdeConnection, IdeConnectionEvent, IdeConnectionType, } from '@qwen-code/qwen-code-core';
import { QWEN_CODE_COMPANION_EXTENSION_NAME, getIdeInstaller, IDEConnectionStatus, ideContextStore, } from '@qwen-code/qwen-code-core';
    ...
    if (!currentIDE) {
        return {
            ...
            action: () => ({
                type: 'message',
                messageType: 'error',
                content: t('IDE integration is not supported in your current environment. To use this feature, run Qwen Code in one of these supported IDEs: VS Code or VS Code forks.'),
            }),
        };
    }
