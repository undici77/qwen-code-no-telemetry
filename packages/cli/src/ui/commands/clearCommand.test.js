...
describe('clearCommand', () => {
    ...
    it('should persist usage when session has activity before clearing', async () => {
        ...
        core.uiTelemetryService.getMetrics.mockReturnValue({
    ...
    describe('non-interactive mode', () => {
        ...
        it('blocks session clearing while background work is still running', async () => {
            ...
            expect(content).toContain("Stop the current session's running background tasks before starting a new session.");
