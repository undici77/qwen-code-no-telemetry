...
import { loadServerHierarchicalMemory, ConditionalRulesRegistry, expandHomeDir, } from '@qwen-code/qwen-code-core';
                    ...
                    if (added.length > 0) {
                        try {
                            if (config.isSafeMode()) {
                                ...
                                messages.push(t('Successfully added QWEN.md files from the following directories if there are:\n- {{directories}}', { directories: added.join('\n- ') }));
                            }
                        }
                        catch (error) {
