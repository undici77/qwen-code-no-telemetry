...
import { MCPServerStatus, MCPDiscoveryState, getMCPServerStatus, getMCPDiscoveryState, } from '@qwen-code/qwen-code-core';
    ...
    describe('with configured MCP servers', () => {
        ...
        it('should warn when using the legacy auth argument with a server name', async () => {
            ...
            expect(result).toEqual({
                type: 'message',
                messageType: 'warning',
                content: "MCP OAuth is now managed in the /mcp dialog. Open /mcp, select 'server1', then use the Auth actions there.",
            });
        });
        it('should warn when using the legacy auth argument without a server name', async () => {
            ...
            expect(result).toEqual({
                type: 'message',
                messageType: 'warning',
                content: 'MCP OAuth is now managed in the /mcp dialog. Open /mcp, select a server, then use the Auth actions there.',
            });
        });
