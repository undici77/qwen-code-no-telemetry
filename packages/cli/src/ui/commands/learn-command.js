 ...
 */
import { AuthType, buildLearnSkillPrompt, buildLearnVideoSkillRequest, expandHomeDir, parseLearnVideoInput, readPathFromWorkspace, } from '@qwen-code/qwen-code-core';
...
export const learnCommand = {
    ...
    action: async (context, args) => {
        ...
        if (video) {
            ...
            const supportsVideoTransport = authType === AuthType.USE_OPENAI || authType === AuthType.QWEN_OAUTH;
