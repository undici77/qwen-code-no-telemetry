...
import { ExtensionManager, parseInstallSource, } from '@qwen-code/qwen-code-core';
...
describe('extensionsCommand', () => {
    ...
    describe('explore', () => {
        ...
        it('should open the selected extensions gallery through the shared browser helper', async () => {
            ...
            expect(mockOpenBrowserSecurely).toHaveBeenCalledWith('https://geminicli.com/extensions/');
        });
    ...
    describe('install', () => {
        ...
        it('should redact URL credentials in install progress messages', async () => {
            ...
            await installAction(mockContext, 'https://user:token@example.com/test/extension');
            expect(mockContext.ui.addItem).toHaveBeenCalledWith({
                type: MessageType.INFO,
        ...
        it('should redact URL credentials in install error messages and causes', async () => {
            mockParseInstallSource.mockRejectedValue(new Error('Install source not found: https://user:token@example.com/test/extension'));
            await installAction(mockContext, 'https://user:token@example.com/test/extension');
            expect(mockContext.ui.addItem).toHaveBeenCalledWith({
                type: MessageType.ERROR,
