...
describe('SessionStatsContext', () => {
    ...
    it('should read metrics for the provided session id', () => {
        ...
        render(_jsx(SessionStatsProvider, { sessionId: "session-a", children: _jsx(TestHarness, { contextRef: contextRef }) }));
    ...
    it('should update when skill metrics are mutated in place', () => {
        ...
        render(_jsx(SessionStatsProvider, { sessionId: "session-a", children: _jsx(CountingTestHarness, {}) }));
    ...
    it('should update when generation metrics are mutated in place', () => {
        ...
        expect(contextRef.current?.stats.metrics.generation?.last?.ttftMs).toBe(150);
        uiTelemetryService.reset();
    });
