...
import { formatDuration, formatMemoryUsage, formatRelativeTime, formatTokenCount, } from './formatters.js';
describe('formatters', () => {
    ...
    describe('formatDuration', () => {
        ...
        describe('with hideTrailingZeros', () => {
            ...
            it('keeps fractional seconds under a minute', () => {
                ...
                expect(formatDuration(12345, { hideTrailingZeros: true })).toBe('12.3s');
            });
            ...
            it('does not affect multi-unit output', () => {
                expect(formatDuration(123000, { hideTrailingZeros: true })).toBe('2m 3s');
