...
import { collectInlineImages, extractInlineContentRuns, getInlineImageData, MAX_INLINE_IMAGE_ENCODED_LENGTH, MAX_INLINE_IMAGES_PER_ITEM, } from './inline-image-parts.js';
describe('collectInlineImages', () => {
    ...
    it('caps images and reports how many were omitted', () => {
        ...
        expect(collectInlineImages(images.map((inlineData) => ({ inlineData })))).toEqual({
...
describe('extractInlineContentRuns', () => {
    it('preserves text-image-text order and skips thought parts', () => {
        ...
        expect(extractInlineContentRuns([
            { text: 'before' },
...
//# sourceMappingURL=inline-image-parts.test.js.map