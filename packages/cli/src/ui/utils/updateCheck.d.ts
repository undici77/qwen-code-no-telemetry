 ...
 */
export declare function classifyUpdateCheckError(
  error: unknown,
 ...
 */
export declare function describeUpdateCheckFailure(
  error: unknown,
  timeoutMs?: number,
): string;
declare const execFileAsync: typeof execFile.__promisify__;
export declare function runGlobalNpm(
  args: string[],
  run?: typeof execFileAsync,
  platform?: NodeJS.Platform,
  nodePath?: string,
  resolveNpmCliPath?: typeof getNpmCliPath,
): Promise<string>;
export declare function fetchGlobalNpmUpdateInfo(
  packageName: string,
...
export declare function checkForUpdatesDetailed(
  fetchGlobalNpm?: typeof fetchGlobalNpmUpdateInfo,
