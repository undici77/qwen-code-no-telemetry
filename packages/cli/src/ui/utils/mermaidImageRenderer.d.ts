...
export declare function detectTerminalImageProtocol(
  env?: NodeJS.ProcessEnv,
): TerminalImageProtocol | null;
export declare function encodeITerm2InlineImage(
  png: Buffer,
  widthCells: number,
  rows: number,
): string;
export declare function encodeKittyImage(
  png: Buffer,
  widthCells: number,
  rows: number,
): string;
export declare function encodeKittyVirtualImage(
  png: Buffer,
  imageId: number,
  widthCells: number,
  rows: number,
): string;
export declare function buildKittyPlaceholder(
  imageId: number,
  widthCells: number,
  rows: number,
 ...
 */
export declare function renderMermaidImageSync({
  source,
  contentWidth,
  availableTerminalHeight,
  env,
}: MermaidImageRenderOptions): MermaidImageRenderResult;
export declare function renderMermaidImageAsync({
  source,
  contentWidth,
  availableTerminalHeight,
  env,
...
export declare function createRendererChildEnv(
  env: NodeJS.ProcessEnv,
): NodeJS.ProcessEnv;
export {};
