...
describe('buildHeatmapData', () => {
    ...
    it('supports monthOffset to shift view backward', () => {
        const data = { '2025-04-15': 100 };
        const noOffset = buildHeatmapData(data, 8, 0);
        const withOffset = buildHeatmapData(data, 8, 1);
        expect(new Date(withOffset.endDate).getTime()).toBeLessThan(new Date(noOffset.endDate).getTime());
    });
});
...
//# sourceMappingURL=asciiCharts.test.js.map