...
import { TABLE_CHROME_ROWS, estimateWrappedRows, isTableStart, fitPendingSlice, splitMarkdownTableRow, } from './pending-rendered-height.js';
...
describe('fitPendingSlice', () => {
    ...
    it('charges the vertical height on a WIDE terminal when cells wrap past MAX_ROW_LINES', () => {
        ...
        const lines = [
            ...
            '| A | B | C | D | E | F | G |',
            '| - | - | - | - | - | - | - |',
            ...Array.from({ length: 4 }, () => `| ${wide} | ${wide} | ${wide} | ${wide} | ${wide} | ${wide} | ${wide} |`),
        ];
...
//# sourceMappingURL=pending-rendered-height.test.js.map