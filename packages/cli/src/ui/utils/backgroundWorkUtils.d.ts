...
export declare function resetBackgroundStateForSessionSwitch(
  config: Config,
): void;
 ...
 * an empty list.
 */
export declare function describeBlockingBackgroundWork(
  config: Config,
 ...
 */
export declare function buildBackgroundWorkBlockedMessage(
  config: Config,
  baseMessage: string,
): string;
