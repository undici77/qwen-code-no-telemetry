...
export function getSoftwareCursorBackground(backgroundColor = getEffectiveTerminalBackground()) {
...
export function renderSoftwareCursor(text) {
    return chalk.bgHex(getSoftwareCursorBackground())(text || ' ');
}
//# sourceMappingURL=software-cursor.js.map