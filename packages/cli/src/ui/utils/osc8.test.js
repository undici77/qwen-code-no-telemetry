...
import { HYPERLINK_ENV_KEYS, isSafeOscScheme, labelMayDeceive, osc8Close, osc8Hyperlink, osc8Open, sanitizeForOsc, supportsHyperlinks, trimTrailingUrlPunctuation, } from './osc8.js';
const ESC = '\x1b';
const BEL = '\x07';
