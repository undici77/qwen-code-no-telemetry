...
import { isStackedSkillCompletableCommand, isValidStackedSkillPrefix, } from '../../utils/commands.js';
...
const getSlashCommandFirstToken = (query) => query.slice(1).trimStart().split(/\s+/u)[0] ?? '';
