...
export async function runNonInteractive(config, settings, input, prompt_id, options = {}) {
    return promptIdContext.run(prompt_id, async () => {
        ...
        try {
             ...
             */
            const handledProviderToolCallIds = geminiClient.getHistoryFunctionResponseIds();
            ...
            const processToolCallBatch = async (batchRequests, setModelOverride, runtimeView) => {
                ...
                const repeatedDuplicateRequest = findRepeatedDuplicateProviderToolCall([...uniqueBatchRequests, ...duplicateBatchRequests], getProviderResponseId, handledProviderToolCallIds, duplicateProviderToolCallResponseIds);
