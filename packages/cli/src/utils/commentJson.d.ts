 ...
 */
export declare function updateSettingsFilePreservingFormat(filePath: string, updates: Record<string, unknown>, sync?: boolean): boolean;
export declare function applyUpdates(current: Record<string, unknown>, updates: Record<string, unknown>, sync?: boolean): Record<string, unknown>;
