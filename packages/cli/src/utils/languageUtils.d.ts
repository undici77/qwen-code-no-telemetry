 ...
 */
export declare function resolveOutputLanguageOrPreserveAuto(value: string | undefined | null): string;
/**
 ...
 */
export declare function writeOutputLanguageFile(language: string, targetPath?: string): void;
/**
 ...
 */
export declare function updateOutputLanguageFile(settingValue: string, targetPath?: string): void;
/**
 ...
 * SettingsDialog.
 */
export declare function writeOutputLanguageAndRegisterPath(settingValue: string, config?: {
