...
import { beginAcpBootstrapConfigProfiling, buildAndFreezeAcpStartupProfile, endAcpBootstrapConfigProfiling, initializeAcpStartupProfiler, isAcpStartupProfilerEnabled, markAcpStartup, recordAcpConfigStartupEvent, resetAcpStartupProfilerForTesting, } from './acp-startup-profiler.js';
const CONFIG_EVENTS = [
...
function recordCompleteProfile() {
    ...
    for (const event of CONFIG_EVENTS)
        recordAcpConfigStartupEvent(event);
...
//# sourceMappingURL=acp-startup-profiler.test.js.map