 ...
 */
export function updateSettingsFilePreservingFormat(filePath, updates, sync = false) {
...
export function applyUpdates(current, updates, sync = false) {
    ...
    for (const key of Object.getOwnPropertyNames(updates)) {
        ...
        if (typeof value === 'object' &&
            ...
            result[key] = applyUpdates(result[key], value, sync);
        }
        else {
            result[key] = value;
        }
