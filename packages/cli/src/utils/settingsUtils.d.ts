...
export declare function validateSettingValue(
...
export declare function setNestedPropertyForce(
  obj: Record<string, unknown>,
  path: string,
  value: unknown,
): void;
export declare function setNestedPropertySafe(
  obj: Record<string, unknown>,
  path: string,
  value: unknown,
): void;
export declare function deleteNestedPropertySafe(
  obj: Record<string, unknown>,
  path: string,
): void;
/**
