...
export declare function isSafeTarLinkTarget(
  entryPath: string,
  linkPath: string,
  resolvedDest: string,
): boolean;
export declare function isSafeTarEntry(
  entryPath: string,
 ...
 */
export declare function ensureBinWrapper(
  standaloneDir: string,
  target: string,
): BinWrapperArtifacts;
/**
...
export declare function cleanupFirstTimeMigrationArtifacts(
  artifacts?: BinWrapperArtifacts,
): void;
export declare function performStandaloneUpdate(
  standaloneDir: string,
  newVersion: string,
 ...
 */
export declare function rollbackStandaloneUpdate(
  standaloneDir: string,
): RollbackResult;
export {};
