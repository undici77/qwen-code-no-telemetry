...
export declare function skillSettingStrings(
  settings: LoadedSettings,
  scope: SettingScope,
  key: SkillSettingListKey,
): string[];
export declare function resolveSkillSettings(
  settings: LoadedSettings,
): ResolvedSkillSettings;
export declare function updateWorkspaceSkillSettingLists(
 ...
 */
export declare function computeWorkspaceSkillListUpdates(
