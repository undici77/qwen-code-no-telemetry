...
function getSandboxCommand(sandbox) {
    ...
    if (typeof sandbox === 'string' && sandbox) {
        ...
        throw new FatalSandboxError(`Missing sandbox command '${sandbox}' (from QWEN_SANDBOX)`);
    }
    ...
    if (sandbox === true) {
        throw new FatalSandboxError('QWEN_SANDBOX is true but failed to determine command for sandbox; ' +
