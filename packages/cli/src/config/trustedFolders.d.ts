...
export declare function onTrustedFoldersChanged(listener: TrustedFoldersChangeListener): () => void;
...
export declare function getExplicitTrustLevel(trustConfig: Record<string, TrustLevel>, workspaceCwd: string): TrustLevel | null;
export declare function getWorkspaceTrustStatus(settings: Settings, workspaceCwd: string, trustConfig?: Record<string, TrustLevel>): WorkspaceTrustStatus;
export declare function isWorkspaceTrusted(settings: Settings, trustConfig?: Record<string, TrustLevel>, workspacePath?: string): TrustResult;
