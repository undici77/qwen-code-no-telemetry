...
export async function parseArguments() {
    ...
    const yargsInstance = yargs(rawArgv)
        ...
        .option('worktree', {
        type: 'string',
        description: 'Start the session inside a git worktree at <repoRoot>/.qwen/worktrees/<slug>/. ' +
...
hostPolicy) {
    ...
    if (argv.continue || argv.resume) {
        ...
        const sessionService = new SessionService(cwd);
        const exists = await sessionService.sessionExistsInAnyState(argv['sessionId']);
        if (exists) {
