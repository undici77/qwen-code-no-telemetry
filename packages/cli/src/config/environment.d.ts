 ...
 */
export declare function getHomeEnvFallbackVars(onReadError?: (message: string) => void): Record<string, string>;
/**
 ...
 * implementation.
 */
export declare function findEnvFiles(settings: Settings, startDir: string, userLevelPaths?: Set<string>, workspaceTrusted?: boolean): string[];
...
export declare function buildRuntimeEnvironment(settings: Settings, startDir?: string, baseEnv?: Readonly<NodeJS.ProcessEnv>, workspaceTrusted?: boolean): RuntimeEnvironmentSnapshot;
/**
 ...
 * 5. defaults
 */
export declare function loadEnvironment(settings: Settings, startDir?: string): void;
 ...
 */
export declare function reloadEnvironment(settings: Settings, workspaceCwd: string, workspaceTrusted?: boolean): EnvReloadResult;
