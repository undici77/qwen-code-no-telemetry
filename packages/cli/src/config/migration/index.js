 ...
 */
export const DOWNGRADE_MIGRATIONS = [v5ToV4Migration];
/**
 ...
 * ```
 */
export function runMigrations(settings, scope) {
...
export function needsMigration(settings) {
    ...
    const hasApplicableMigration = CONVERGENCE_MIGRATIONS.some((migration) => migration.shouldMigrate(settings));
