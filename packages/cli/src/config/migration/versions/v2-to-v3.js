 ...
 */
import { deleteNestedPropertySafe, getNestedProperty, setNestedPropertySafe, } from '../../../utils/settingsUtils.js';
/**
    ...
    migrate(settings, scope) {
        ...
        for (const [newPath, oldPaths] of Object.entries(CONSOLIDATED_V2_PATHS)) {
            ...
            for (const oldPath of oldPaths) {
                ...
                if (normalized.isValid) {
                    ...
                    warnings.push(`Removed deprecated setting '${oldPath}' from ${scope} settings because the value is invalid. Expected boolean.`);
                }
            }
        ...
        for (const [oldPath, newPath] of Object.entries(V2_TO_V3_BOOLEAN_MAP)) {
            ...
            if (normalized.isValid) {
                ...
                warnings.push(`Removed deprecated setting '${oldPath}' from ${scope} settings because the value is invalid. Expected boolean or string "true"/"false".`);
            }
        }
...
//# sourceMappingURL=v2-to-v3.js.map