 ...
 */
import { CONSOLIDATED_DISABLE_KEYS, V1_INDICATOR_KEYS, V1_TO_V2_MIGRATION_MAP, V1_TO_V2_PRESERVE_DISABLE_MAP, V2_CONTAINER_KEYS, } from './v1-to-v2-shared.js';
    ...
    migrate(settings, _scope) {
        ...
        for (const [v1Key, v2Path] of Object.entries(V1_TO_V2_MIGRATION_MAP)) {
            if (v1Key in source) {
                ...
                if (V2_CONTAINER_KEYS.has(v1Key) &&
                    typeof value === 'object' &&
                    value !== null &&
                    !Array.isArray(value)) {
        ...
        for (const key of Object.keys(source)) {
            if (!processedKeys.has(key)) {
                ...
                const isParentOfMigratedPath = Array.from(processedKeys).some((processedKey) => {
                    ...
                    const v2Path = V1_TO_V2_MIGRATION_MAP[processedKey] ||
