 ...
 */
export type LspConfigChangeEvent = LspConfigRuntimeChangeEvent | LspConfigInvalidEvent;
...
export type LspConfigChangeListener = (event: LspConfigChangeEvent) => void | Promise<void>;
/**
