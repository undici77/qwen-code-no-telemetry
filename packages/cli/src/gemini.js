 ...
 */
import { AuthType, InputFormat, isDebugLoggingDegraded, isBareMode, logUserPrompt, QWEN_CODE_SIMPLE_ENV_VAR, Storage, SessionService, setStartupEventSink, createDebugLogger, writeRuntimeStatus, } from '@qwen-code/qwen-code-core';
...
import { createMinimalSettings, getSettingsWarnings, loadSettings, preResolveHomeEnvOverrides, } from './config/settings.js';
...
export async function main() {
    ...
    }
    {
        ...
        const exitCode = await runNonInteractive(nonInteractiveConfig, settings, input, prompt_id);
