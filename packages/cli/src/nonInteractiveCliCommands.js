...
import { Logger, uiTelemetryService, createDebugLogger, recordSkillInvocation, } from '@qwen-code/qwen-code-core';
...
export const handleSlashCommand = async (rawQuery, abortController, config, settings, sessionHooks) => {
    ...
    if (result.type === 'submit_prompt') {
        ...
        return handleCommandResult({ ...result, content: hookResult.content }, outputHistoryItems);
    }
