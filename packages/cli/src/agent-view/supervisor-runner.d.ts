...
export declare const INTERNAL_AGENT_VIEW_SUPERVISOR_ARG =
...
export declare function ensureAgentViewSupervisor(
  options?: EnsureAgentViewSupervisorOptions,
): Promise<AgentViewSupervisorClientHandle>;
export declare function connectExistingAgentViewSupervisor(
  options?: EnsureAgentViewSupervisorOptions,
): Promise<AgentViewSupervisorClientHandle | undefined>;
export declare function runAgentViewSupervisor(
