...
export interface AgentViewSupervisorMaintenanceResult extends AgentViewSupervisorHibernationResult {
...
export interface AgentViewSupervisorProcessOptions extends AgentViewSupervisorPathOptions {
    hibernationPolicy?: AgentViewSupervisorHibernationPolicy;
    now?: () => Date;
    onShutdown?: () => void | Promise<void>;
}
export declare function getAgentViewSupervisorSocketPath(options?: AgentViewSupervisorPathOptions): string;
export declare function createAgentViewSupervisorHandler(options?: AgentViewSupervisorProcessOptions): AgentViewSupervisorHandler & AgentViewSupervisorMaintenance;
