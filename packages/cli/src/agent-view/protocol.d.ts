 ...
 */
export declare const AGENT_VIEW_PROTOCOL_VERSION = 1;
export type AgentViewOwnership = 'unmanaged' | 'adopting' | 'managed' | 'removing';
export type AgentViewSessionState = 'starting' | 'working' | 'needs_input' | 'idle' | 'completed' | 'stopped' | 'failed';
export type AgentViewProcessState = 'starting' | 'alive' | 'hibernating' | 'hibernated' | 'restarting' | 'exited';
...
export type AgentViewWorkerAnswerOutcome = 'proceed_once' | 'proceed_always' | 'proceed_always_project' | 'proceed_always_user' | 'modify_with_editor' | 'restore_previous' | 'cancel';
