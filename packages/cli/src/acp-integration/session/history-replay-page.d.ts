...
export declare function copyCumulativeUsage(
  target: CumulativeUsage,
  source: CumulativeUsage,
): void;
export declare function collectHistoryReplayUpdates({
  sessionId,
  config,
  records,
  gaps,
...
export declare function liftSessionUpdateTimestamps(
  updates: SessionUpdate[],
): SessionUpdate[];
...
export declare function replayTranscriptRecordPage({
  sessionId,
  page,
  config,
  encodeCursor,
