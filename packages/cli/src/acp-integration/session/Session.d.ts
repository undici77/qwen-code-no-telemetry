...
export declare function resolveExistingFile(
  resolved: string,
...
export declare function resolveHomeLoopResolverRoots({
  homeQwenDir,
  homeDir,
  qwenHome,
}?: {
...
export declare function computeInitialTurnFromHistory(
  records: ChatRecord[],
  sessionId: string,
): number;
export declare function fireSessionPermissionDeniedForAutoMode(
  config: Config,
...
export declare function buildAvailableCommandsSnapshot(
  config: Config,
...
export declare class Session implements SessionContext {
  ...
  appendLiveConversationTranscript(
