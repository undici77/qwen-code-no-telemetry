...
export declare function selectVisibleHistoryRecords(
  records: ChatRecord[],
 ...
 */
export declare const AUTH_PREFLIGHT_ENV_KEYS: Readonly<
...
type QwenCoreSettingKey =
  ...
  | 'disableAllHooks';
export declare function extractFilesFromTarGz(
 ...
 */
export declare function fetchAllowedGitHub(
  url: string,
  init?: RequestInit,
  maxRedirects?: number,
): Promise<Response>;
export declare function normalizeCoreSettingValue(
 ...
 */
export declare function deliverClientMcpMessage(
 ...
 */
export declare function createManagedExternalToolGuard(
  connection: AgentSideConnection,
): ToolInvocationGuard;
export declare function runAcpAgent(
  config: Config,
...
export declare function toStdioServer(
  server: McpServer,
): McpServerStdio | undefined;
export declare function toSseServer(server: McpServer):
  | (McpServerSse & {
      type: 'sse';
    })
  | undefined;
export declare function toHttpServer(server: McpServer):
  | (McpServerHttp & {
      type: 'http';
    })
  | undefined;
 ...
 */
export declare function createWorkspaceMcpBudget(
