...
export declare function buildDaemonLogLine(args: BuildDaemonLogLineArgs): string;
...
type DaemonLoggerFs = Pick<typeof nodeFs.promises, 'appendFile' | 'chmod' | 'lstat' | 'mkdir' | 'open' | 'readFile' | 'readdir' | 'rename' | 'rm' | 'stat' | 'symlink' | 'unlink' | 'writeFile'>;
...
export declare function resolveDaemonLogBaseDir(runtimeOutputDir?: string, cwd?: string): string;
export declare function initDaemonLogger(opts: InitDaemonLoggerOptions): Promise<DaemonLogger>;
export {};
