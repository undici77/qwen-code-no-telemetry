...
import type { VoiceStreamCallbacks, VoiceStreamSession } from '../../ui/voice/voice-stream-session.js';
...
export interface VoiceWsDeps {
    ...
    openStream?: (ctx: DaemonVoiceContext, callbacks: VoiceStreamCallbacks, abortSignal?: AbortSignal) => Promise<VoiceStreamSession>;
    transcribe?: (ctx: DaemonVoiceContext, pcm: Uint8Array, abortSignal?: AbortSignal) => Promise<string>;
 ...
 */
export declare function createVoiceWsConnectionHandler(boundWorkspace: string, deps?: VoiceWsDeps): (ws: WebSocket, req: IncomingMessage) => void;
