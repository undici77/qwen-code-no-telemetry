...
export declare function daemonTelemetryMiddleware(resolveWorkspaceCwd: (req: Request) => string, recordRequest?: (durationMs: number, statusCode: number) => void): (req: Request, res: Response, next: NextFunction) => void;
export {};
