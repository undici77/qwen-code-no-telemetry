 ...
 */
import { hashDaemonWorkspace, recordDaemonError, recordDaemonHttpRequest, recordDaemonHttpResponse, withDaemonRequestSpan, } from '@qwen-code/qwen-code-core';
            ...
            const finish = () => {
                ...
                try {
                    ...
                    if (context?.workspaceCwd !== undefined) {
                        span?.setAttribute('qwen-code.workspace.hash', resolveWorkspaceHash(context.workspaceCwd));
                    }
                }
                catch {
