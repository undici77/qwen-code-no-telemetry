 ...
 */
export declare function getWorkspaceSessionInfoForResponse(
  bridge: AcpSessionBridge,
  workspaceCwd: string,
  options?: {
    includeLive?: boolean;
...
export declare function parseSessionPageSizeQuery(
  raw: unknown,
): number | undefined;
