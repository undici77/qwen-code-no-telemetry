...
import { DeviceFlowRegistry, type DeviceFlowProvider, type DeviceFlowProviderId } from '../auth/device-flow.js';
 ...
 */
export declare function setupDeviceFlowRegistry(deps: SetupDeviceFlowRegistryDeps): ServeDeviceFlowRuntime;
export {};
