...
import { FS_ACCESS_EVENT_TYPE, FS_DENIED_EVENT_TYPE, createWorkspaceFileSystemFactory, } from './index.js';
...
describe('WorkspaceFileSystem - multi-root workspaces', () => {
    ...
    it.skipIf(process.platform === 'win32' || process.getuid?.() === 0)('throws AggregateError when every workspace root glob fails', async () => {
