...
export declare function createBoundChannelDeliveryHandler(
 ...
 */
export declare function validatePolicyConfig(
  policyConfig?: {
...
export declare function formatChannelWorkerDaemonUrl(
  host: string,
  port: number,
): string;
/**
 ...
 */
export declare function extractContextFilename(
  value: unknown,
): string | undefined;
/**
 ...
 */
export declare function subSessionConcurrencyCapsFromSettings(
  serve: {
...
export declare function createLazyBridgeProxy(
  getBridge: () => AcpSessionBridge | undefined,
  getStartupError?: () => string | undefined,
): AcpSessionBridge;
export declare function resolveRuntimeStartupTimeoutMs(
  override: number | undefined,
): number;
export declare function waitForRuntimeStartingForShutdown(
 ...
 */
export declare function validateAndCanonicalizeWorkspaceInput(
  rawWorkspace: string,
): string;
export declare function runQwenServe(
