...
describe('createTotalSessionAdmissionController', () => {
    it('counts live bridge sessions plus in-flight reservations across runtimes', () => {
        ...
        expect(() => admission.admit({ operation: 'spawn', workspaceCwd: '/work/b' })).toThrow(TotalSessionLimitExceededError);
        try {
        ...
        expect(() => admission.admit({ operation: 'spawn', workspaceCwd: '/work/c' })).toThrow(TotalSessionLimitExceededError);
    });
    ...
    it('tracks per-workspace reservations and supports drain rollback', () => {
        ...
        expect(() => admission.admit({ operation: 'spawn', workspaceCwd: '/work/a' })).toThrow(WorkspaceDrainingError);
...
//# sourceMappingURL=total-session-admission.test.js.map