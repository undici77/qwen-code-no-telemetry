...
export declare function normalizeWorkspaceDisplayName(
  value: unknown,
): string | undefined;
...
export declare function workspaceRegistrationScopeHash(
  primaryWorkspace: string,
): string;
export declare function workspaceRegistrationId(workspace: string): string;
export declare function getWorkspaceRegistrationStorePath(
  primaryWorkspace: string,
  qwenHome?: string,
): string;
