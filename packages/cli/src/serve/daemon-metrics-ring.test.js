...
describe('computeCpuPercent', () => {
    ...
    it('computes a normalized, clamped windowed percent', () => {
        ...
        expect(computeCpuPercent(cpu(0, 0), cpu(500_000, 500_000), 2000, 1)).toBe(50);
    });
