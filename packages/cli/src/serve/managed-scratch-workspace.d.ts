 ...
 */
export type WorkspaceRuntimeProvenance = 'existing' | 'managed-scratch' | 'live-conversation';
...
export declare function isManagedScratchChild(canonicalCwd: string, canonicalRoot: string): boolean;
/**
 ...
 */
export declare function isScratchRootCompatible(canonicalCwd: string, canonicalRoot: string): boolean;
/**
 ...
 */
export declare function prepareManagedScratchRoot(root: string, startupWorkspaceCwds: readonly string[]): ManagedScratchRoot;
/** Atomically creates one private, canonical direct child of the accepted root. */
export declare function createManagedScratchDirectory(root: ManagedScratchRoot): Promise<string>;
