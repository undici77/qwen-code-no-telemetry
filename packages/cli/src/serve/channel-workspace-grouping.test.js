...
import { resolveChannelOwnerCwd, resolveChannelWorkspaceGroups, } from './channel-workspace-grouping.js';
const PRIMARY = path.resolve('/ws/primary');
const SECONDARY = path.resolve('/ws/secondary');
const UNREGISTERED = path.resolve('/ws/other');
function workspaces(overrides = {}) {
    return [
        {
...
function loader(byWorkspace) {
    return (cwd) => byWorkspace[cwd] ?? {};
}
...
//# sourceMappingURL=channel-workspace-grouping.test.js.map