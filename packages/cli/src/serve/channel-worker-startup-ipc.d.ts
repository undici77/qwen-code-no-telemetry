...
export declare function isChannelStartupFailure(
  value: unknown,
): value is ChannelStartupFailure;
export declare function isChannelStartupReportMessage(
  value: unknown,
): value is ChannelStartupReportMessage;
export declare function isChannelStartupReportAckMessage(
  value: unknown,
