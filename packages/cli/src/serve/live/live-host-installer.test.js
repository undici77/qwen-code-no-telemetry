...
describe('LiveHostInstaller', () => {
    it('prefers the OSS mirror and retains the independent GitHub fallback', () => {
        expect(LIVE_HOST_OSS_BASE_URL).toBe('https://qwen-code-assets.oss-cn-hangzhou.aliyuncs.com/live-host');
        expect(LIVE_HOST_RELEASE_BASE_URL).toBe('https://github.com/QwenLM/qwen-code/releases/download/live-host-latest');
