...
import { type LiveAppshotReadiness, type LiveMuteUpdate, type LiveProviderReadiness, type LiveSessionLocator, type LiveState, type LiveStatus } from './types.js';
interface LiveCall {
    epoch: number;
    callId: string;
    mode: 'resume' | 'new';
...
export declare class LiveHostCoordinator {
    ...
    captureScreenContext(callerSessionId: string): Promise<LiveScreenContextCapture>;
