...
export declare function readLoadableLiveConversationMetadata(sessionId: string, readMetadata: (sessionId: string) => Promise<LiveSessionCreationMetadata>): Promise<LiveSessionCreationMetadata | undefined>;
