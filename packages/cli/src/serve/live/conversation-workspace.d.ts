...
export declare function revalidateLiveConversationRoot(root: LiveConversationRootIdentity): Promise<LiveConversationRootIdentity>;
export declare function assertExactLiveConversationRoot(root: LiveConversationRootIdentity, candidate: string): Promise<LiveConversationRootIdentity>;
