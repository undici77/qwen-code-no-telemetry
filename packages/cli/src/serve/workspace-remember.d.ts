...
type WorkspaceRememberResolvedRouteDeps = Omit<WorkspaceRememberRouteDeps, 'mutate'>;
...
type WorkspaceRememberRouteDepsResolver = (req: Request, res: Response, options: WorkspaceRememberRouteResolveOptions) => WorkspaceRememberResolvedRouteDeps | null;
export declare function mountWorkspaceMemoryRememberRoutes(app: Application, deps: WorkspaceRememberRouteDeps): void;
export declare function mountWorkspaceQualifiedMemoryRememberRoutes(app: Application, deps: {
