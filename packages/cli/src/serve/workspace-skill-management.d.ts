...
export declare function installWorkspaceSkill(workspace: string, request: WorkspaceSkillInstallRequest, githubToken?: string, assertGenerationOpen?: () => void): Promise<WorkspaceSkillMutationResult>;
export declare function deleteWorkspaceSkill(workspace: string, scope: WorkspaceSkillScope, skillNameInput: string, installedPath: string, assertGenerationOpen?: () => void): Promise<WorkspaceSkillMutationResult>;
