...
import { type WorkspaceVoiceStateUpdate, type WorkspaceVoiceTranscriptionInput, type WorkspaceVoiceTranscriptionResult } from '../../services/voice-service.js';
...
type WorkspaceVoiceTranscriber = (input: WorkspaceVoiceTranscriptionInput) => Promise<WorkspaceVoiceTranscriptionResult>;
type PersistSetting = (workspace: string, scope: SettingScope, key: string, value: unknown, assertGenerationOpen?: () => void) => Promise<void | LoadedSettings>;
...
export declare function parseWorkspaceVoiceUpdateParams(body: Record<string, unknown>): WorkspaceVoiceStateUpdate | {
    error: string;
    code: string;
};
export declare function registerWorkspaceVoiceRoutes(app: Application, deps: WorkspaceVoiceRouteDeps): void;
export declare function registerWorkspaceQualifiedVoiceRoutes(app: Application, deps: WorkspaceQualifiedVoiceRouteDeps): void;
export {};
