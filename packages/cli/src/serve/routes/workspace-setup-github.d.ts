...
export declare function createSetupGithubFileOps(factory: WorkspaceFileSystemFactory, route: string, originatorClientId: string | undefined, assertGenerationOpen?: () => void): SetupGithubFileOps & {
    assertCanWrite(): void;
};
...
export declare function resolveSetupGithubProxy(boundWorkspace: string, env: Readonly<NodeJS.ProcessEnv>, workspaceTrusted?: boolean): string | undefined;
export {};
