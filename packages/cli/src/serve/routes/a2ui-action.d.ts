 ...
 */
export declare function findFromSettingsFile(
  workspaceCwd: string,
...
export declare function buildTransport(
  cfg: McpServerConfigLike,
  baseEnv?: Readonly<Record<string, string | undefined>>,
): Transport;
/** Exported for unit testing the MCP content normalization rules. */
export declare function extractA2uiActionResult(
...
export declare function callA2uiAction(
  cfg: McpServerConfigLike,
  args: A2uiActionArgs,
  env?: Readonly<Record<string, string | undefined>>,
): Promise<A2uiActionResult>;
export declare function registerA2uiActionRoutes(
  app: Application,
