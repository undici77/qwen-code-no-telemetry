...
export interface WorkspaceManagementHandle {
    ...
    publishOwnedRuntime(canonicalCwd: string, provenance: Exclude<WorkspaceRuntimeProvenance, 'existing'>, validate: (runtime: WorkspaceRuntime) => void | Promise<void>): Promise<WorkspaceRuntime>;
}
