...
export declare function registerWorkspaceFileWriteRoutes(
  app: Application,
  deps: RegisterDeps,
): void;
export declare function registerWorkspaceQualifiedFileWriteRoutes(
  app: Application,
  deps: RegisterDeps & {
...
export declare function createUploadConcurrencyGate(
  max?: number,
...
export declare function registerWorkspaceFileUploadRoutes(
  app: Application,
  deps: FileUploadLegacyDeps,
): void;
export declare function registerWorkspaceQualifiedFileUploadRoutes(
  app: Application,
