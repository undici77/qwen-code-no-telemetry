...
async function resolveTarget(req, res, resolveRuntime, resolveService) {
...
export function registerWorkspaceChannelManagementRoutes(app, deps) {
    ...
    const qualified = (req, res) => resolveWorkspaceRuntimeFromParam(deps.workspaceRegistry, req, res);
    const register = (prefix, resolveRuntime) => {
        ...
        const target = (req, res) => resolveTarget(req, res, resolveRuntime, deps.resolveService);
