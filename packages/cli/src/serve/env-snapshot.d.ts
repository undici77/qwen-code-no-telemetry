...
export declare function snapshotProcessEnv(): Record<
  string,
  string | undefined
>;
/**
 ...
 */
export declare function readProxyVar(
 ...
 */
export declare function buildEnvStatusFromProcess(
  workspaceCwd: string,
  acpChannelLive: boolean,
): ServeWorkspaceEnvStatus;
export declare function buildEnvStatusFromEnv(
  workspaceCwd: string,
  acpChannelLive: boolean,
