...
import { isChannelStartupFailure, isChannelStartupReportAckMessage, isChannelStartupReportMessage, isChannelStartupReportType, MAX_CHANNEL_STARTUP_FAILURE_CHANNEL_LENGTH, MAX_CHANNEL_STARTUP_FAILURE_CODE_LENGTH, MAX_CHANNEL_STARTUP_FAILURE_MESSAGE_LENGTH, } from './channel-worker-startup-ipc.js';
describe('channel worker startup IPC', () => {
    it('accepts bounded connect failures and protocol messages', () => {
        ...
        expect(isChannelStartupReportMessage({
    ...
    it('distinguishes known startup report types from unrelated IPC', () => {
        expect(isChannelStartupReportType({ type: 'channel_startup_failure' })).toBe(true);
...
//# sourceMappingURL=channel-worker-startup-ipc.test.js.map