...
import type { ChildHeapMode, ChildHeapPolicySnapshot } from '@qwen-code/acp-bridge/childHeapPolicy';
...
export declare function toDaemonStatusMemoryLimits(budget: DaemonMemoryBudget | undefined, childHeap?: ChildHeapPolicySnapshot): DaemonStatusMemoryLimits | null;
