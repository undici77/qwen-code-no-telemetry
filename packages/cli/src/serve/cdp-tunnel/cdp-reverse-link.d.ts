...
export type CdpOutboundFrame = CdpCommandFrame | CdpAttachFrame | CdpReleaseFrame;
...
export declare class CdpReverseLink {
    ...
    constructor(sendToExtension: CdpSendToExtension, commandTimeoutMs?: number, 
    /** Optional diagnostic sink for dropped/unexpected inbound frames. */
     ...
     */
    readonly forwardToTab: (method: string, params: Record<string, unknown> | undefined) => Promise<unknown>;
    /**
