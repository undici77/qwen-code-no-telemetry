...
export interface CdpEmulatorCallbacks {
     ...
     */
    forwardToTab(method: string, params: Record<string, unknown> | undefined): Promise<unknown>;
}
...
export declare class CdpBrowserEmulator {
     ...
     */
    emitTabEvent(method: string, params: Record<string, unknown> | undefined): void;
}
