...
export declare function preferTerminalTaskStatus(
  metricsStatus: string | undefined,
  selectedStatus: string,
): string;
export declare function createVirtualSubagentSessionId(
  parentSessionId: string,
  agentId: string,
): string;
export declare function parseVirtualSubagentSessionId(
  sessionId: string,
