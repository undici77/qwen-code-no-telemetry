...
describe('createDaemonWorkspaceService', () => {
    ...
    describe('setWorkspaceSkillsEnabled', () => {
        ...
        it('persists and refreshes once while preserving ordered target outcomes', async () => {
            ...
            expect(persistDisabledSkillsBatch).toHaveBeenCalledWith('/workspace', ['review', 'locked', 'deploy'], false, undefined);
        ...
        it('returns validation errors without persisting when no target is valid', async () => {
            ...
            await expect(svc.setWorkspaceSkillsEnabled(makeCtx(), ['missing', 'hidden', 'inactive'], false)).resolves.toMatchObject({
                activation: 'applied',
                sessionsRefreshed: 0,
                sessionsFailed: 0,
                results: [],
