...
export interface RateLimitConfig {
    ...
    onLimitReached?: (tier: RateLimitTier, key: string, suppressed: number) => void;
...
export declare function createKeyExtractor(hostname: string): (req: Request) => string;
export declare function createRateLimiter(config: RateLimitConfig): RateLimiterInstance;
export declare function setRateLimiter(app: {
    locals: Record<string, unknown>;
}, limiter: RateLimiterInstance): void;
