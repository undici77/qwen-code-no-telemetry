...
export declare class ChannelDeliveryAuthorizationStore {
    #private;
    authorizePrompt(workspaceCwd: string, authorization: PromptAuthorization): void;
    revokePrompt(workspaceCwd: string, sessionId: string, deliveryId: string): void;
    registerScheduledTask(workspaceCwd: string, authorization: Omit<ScheduledTaskAuthorization, 'lastConsumedAt'> & {
        lastFiredAt?: number;
    }): void;
    revokeScheduledTask(workspaceCwd: string, sessionId: string, taskId: string): void;
