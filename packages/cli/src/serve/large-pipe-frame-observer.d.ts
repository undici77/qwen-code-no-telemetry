...
export declare const LARGE_PIPE_FRAME_EVENT_NAME =
  'qwen-code.daemon.pipe.large_frame';
...
export declare function createLargePipeFrameObserver(
  options: LargePipeFrameObserverOptions,
): (observation: LargePipeFrameObservation) => void;
export declare function classifyLargePipeFrame(
