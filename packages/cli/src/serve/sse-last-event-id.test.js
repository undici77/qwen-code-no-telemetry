...
const { parseLastEventId, parseEventEpochHeader } = await import('./sse-last-event-id.js');
...
describe('parseLastEventId', () => {
    ...
    it.each(['1abc', '1.5', '-1', '0x10', '1e5', ' 7 '])('rejects non-decimal %j with a log', (raw) => {
...
describe('parseEventEpochHeader', () => {
    ...
    it.each(['has space', 'semi;colon', 'new\nline', 'päth', 'époch'])('rejects %j (outside [A-Za-z0-9_-]) with a log', (raw) => {
...
//# sourceMappingURL=sse-last-event-id.test.js.map