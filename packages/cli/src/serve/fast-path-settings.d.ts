...
type ServeFastPathPolicy = Pick<NonNullable<Settings['policy']>, 'consensusQuorum' | 'permissionStrategy'>;
type ServeFastPathPolicyInput = {
    [Key in keyof ServeFastPathPolicy]?: unknown;
};
export type ServeFastPathSettings = Pick<Settings, 'advanced' | 'context' | 'env' | 'security' | 'tools'> & {
...
export declare function loadServeFastPathEnvironment(settings: ServeFastPathSettings, startDir?: string): void;
export declare function consumeServeFastPathRejectedLoaderKeys(): readonly string[];
export declare function loadServeFastPathSettings(workspaceDir: string): ServeFastPathSettings;
export {};
