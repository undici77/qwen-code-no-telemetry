...
import { ChannelLoopMcpWorkerHost, isChannelLoopMcpControlMessage, isChannelLoopMcpRequestMessage, isChannelLoopMcpResultMessage, } from './channel-loop-mcp-ipc.js';
...
describe('ChannelLoopMcpWorkerHost', () => {
    ...
    it('returns a valid bounded error when a handler throws an empty error', async () => {
        ...
        await drainMicrotasks();
        const result = sent.find((message) => message.type === 'channel_loop_mcp_result');
...
describe('channel loop MCP IPC validation', () => {
    it('accepts bounded messages and rejects malformed payloads', () => {
        expect(isChannelLoopMcpRequestMessage({
            type: 'channel_loop_mcp_message',
            id: 'request',
            sessionId: 'session',
        ...
        expect(isChannelLoopMcpResultMessage({
            type: 'channel_loop_mcp_result',
            id: 'request',
            ok: true,
...
//# sourceMappingURL=channel-loop-mcp-ipc.test.js.map