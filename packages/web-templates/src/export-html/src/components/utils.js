 ...
 */
export const isChatViewerMessage = (value) => Boolean(value) && typeof value === 'object';
/**
 * Parse chat data from the embedded script tag
 */
export const parseChatData = () => {
 ...
 */
export const formatSessionDate = (startTime) => {
    if (!startTime) {
        return '-';
    }
    try {
 ...
 */
export const formatExportTime = (exportTime) => {
    if (!exportTime) {
        return '-';
    }
    try {
 ...
 */
export const formatRelativeTime = (startTime) => {
    if (!startTime) {
        return '-';
    }
    try {
 ...
 */
export const formatPath = (path, maxLength = 40) => {
 ...
 */
export const formatTokenLimit = (tokens) => {
