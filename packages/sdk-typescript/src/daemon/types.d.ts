 ...
 */
export declare const DAEMON_ERROR_KINDS: readonly ["missing_binary", "blocked_egress", "auth_env_error", "init_timeout", "protocol_error", "missing_file", "parse_error", "budget_exhausted", "mcp_budget_would_exceed", "mcp_server_spawn_failed", "invalid_config", "prompt_deadline_exceeded", "writer_idle_timeout"];
...
export type DaemonMcpManageAction = 'enable' | 'disable' | 'authenticate' | 'clear-auth';
...
export type DaemonExtensionInstallType = 'git' | 'local' | 'link' | 'github-release' | 'npm';
