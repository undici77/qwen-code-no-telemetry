...
export type KnownDaemonSessionArtifactKind = 'file' | 'link' | 'html' | 'image' | 'video' | 'audio' | 'pdf' | 'notebook' | 'other';
 ...
 * advertised sequence.
 */
export declare const DAEMON_APPROVAL_MODES: readonly ["plan", "default", "auto-edit", "auto", "yolo"];
...
import type { DaemonAuthDeviceFlowStatus, DaemonAuthDeviceFlowErrorKind } from './events.js';
...
export type DaemonExtensionInstallType = 'git' | 'local' | 'link' | 'archive-url' | 'github-release' | 'npm';
