 ...
 */
export declare const DAEMON_ERROR_KINDS: readonly ["missing_binary", "blocked_egress", "auth_env_error", "init_timeout", "protocol_error", "missing_file", "parse_error", "budget_exhausted"];
...
export type DaemonEnvKind = 'runtime' | 'platform' | 'sandbox' | 'proxy' | 'env_var';
