 ...
 */
export function denormalizeAcpNotification(notification) {
    ...
    if (notification.method === 'session/update') {
        ...
        return {
            ...
            data,
            _meta: meta,
            originatorClientId: typeof params['originatorClientId'] === 'string'
    ...
    if (notification.method === '_qwen/notify') {
        ...
        const type = typeof params['type'] === 'string' && params['type'].length > 0
            ? params['type']
            : params['kind'];
 ...
 */
export function* filterEventsBySession(events, sessionId) {
 ...
 * @internal
 */
export function _resetSyntheticIdCounter() {
    nextSyntheticId = 1;
}
...
//# sourceMappingURL=AcpEventDenormalizer.js.map