...
export declare function createDaemonTranscriptState(
  opts?: DaemonTranscriptReducerOptions,
): DaemonTranscriptState;
export declare function appendLocalUserTranscriptMessage(
...
export declare function reduceDaemonTranscriptEvents(
  state: DaemonTranscriptState,
  events: readonly DaemonUiEvent[],
  opts?: DaemonTranscriptReducerOptions,
): DaemonTranscriptState;
export declare function finalizeOfflineDaemonTranscriptState(
  state: DaemonTranscriptState,
): DaemonTranscriptState;
export declare function rebuildDaemonTranscriptBlockIndex(
 ...
 */
export declare function formatMissedRange(
  lastDeliveredId: number,
  earliestAvailableId: number,
): string;
export declare function selectTranscriptBlocks(
  state: DaemonTranscriptState,
): readonly DaemonTranscriptBlock[];
export declare function selectPendingPermissionBlocks(
  state: DaemonTranscriptState,
): ReadonlyArray<
  Extract<
    DaemonTranscriptBlock,
  ...
  >
>;
export declare function selectTranscriptBlocksOrderedByEventId(
  state: DaemonTranscriptState,
): readonly DaemonTranscriptBlock[];
/**
 ...
 * `blocks[]`.
 */
export declare function selectCurrentTool(state: DaemonTranscriptState):
  | Extract<
      DaemonTranscriptBlock,
      {
        kind: 'tool';
 ...
 */
export declare function selectApprovalMode(
  state: DaemonTranscriptState,
): string | undefined;
/**
 ...
 */
export declare function selectLastFollowupSuggestion(
  state: DaemonTranscriptState,
):
  | {
      suggestion: string;
 ...
 */
export declare function selectToolProgress(
  state: DaemonTranscriptState,
  toolCallId: string,
):
  | {
  ...
  | undefined;
export declare function selectSubagentChildBlocks(
  state: DaemonTranscriptState,
 ...
 */
export declare function isSubagentChildBlock(
 ...
 */
export declare function formatBlockTimestamp(
  block: DaemonTranscriptBlock,
