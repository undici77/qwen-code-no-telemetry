 ...
 */
export declare function daemonBlockToMarkdown(
 ...
 */
export declare function daemonToolPreviewToMarkdown(
 ...
 */
export declare function daemonBlockToPlainText(
  block: DaemonTranscriptBlock,
  opts?: DaemonRenderOptions,
): string;
 ...
 */
export declare function daemonBlockToHtml(
  block: DaemonTranscriptBlock,
