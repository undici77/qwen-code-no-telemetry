 ...
 */
export declare function matchRoute(path: string, httpMethod: string): {
 ...
 */
export declare function synthesizeResponse(status: number, body: unknown): Response;
/**
 * Map a JSON-RPC error code to an HTTP status code.
 */
export declare function jsonRpcErrorToHttpStatus(code: number): number;
export declare function jsonRpcErrorToHttpStatusWithData(code: number, data?: unknown): number;
/**
 ...
 */
export declare function mergeHeaders(transportHeaders: Record<string, string>, initHeaders: HeadersInit | undefined): Record<string, string>;
