...
describe('DaemonClient Live Voice helpers', () => {
    it('uses process-global Live routes with bearer and client identity', async () => {
        ...
        await client.setLiveMute({ inputMuted: true, outputMuted: false }, 'client-5');
        ...
        expect(calls.map((call) => call.headers['authorization'])).toEqual(new Array(6).fill('Bearer daemon-token'));
...
//# sourceMappingURL=DaemonClientLive.test.js.map