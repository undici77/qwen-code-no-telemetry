...
describe('query()', () => {
    ...
    it('maps string systemPrompt to TransportOptions.systemPrompt', async () => {
        ...
        expect(mockProcessTransport).toHaveBeenCalledWith(expect.objectContaining({
            systemPrompt: 'You are a strict reviewer.',
        }));
    });
    ...
    it('passes new option fields through to TransportOptions', async () => {
        ...
        expect(transportOptions.sessionId).not.toBe('123e4567-e89b-12d3-a456-426614174000');
    ...
    it('uses explicit sessionId when forkSession is true', async () => {
        ...
        const transportOptions = mockProcessTransport.mock.calls[0]?.[0];
        expect(transportOptions.sessionId).toBe('234e5678-e89b-12d3-a456-426614174001');
        expect(transportOptions.sessionId).not.toBe('123e4567-e89b-12d3-a456-426614174000');
    });
});
//# sourceMappingURL=createQuery.test.js.map