...
describe('@qwen-code/sdk/daemon/transports — opt-in transport surface', () => {
    ...
    it('AcpHttpTransport advertises native replay (supportsReplay)', () => {
        ...
        const t = new Transports.AcpHttpTransport('http://localhost:0', undefined, globalThis.fetch.bind(globalThis));
...
//# sourceMappingURL=daemon-transports-surface.test.js.map