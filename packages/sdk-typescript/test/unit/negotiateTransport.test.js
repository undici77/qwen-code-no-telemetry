...
describe('negotiateTransport', () => {
    ...
    describe('acp-ws probe', () => {
        it('attempts WS probe when acp-ws is in transports list', async () => {
            ...
            const transport = await negotiateTransport('http://localhost:8080', undefined, {
                probeTimeoutMs: 100,
            });
    ...
    describe('probe timeout', () => {
        ...
        it('custom probeTimeoutMs is respected', async () => {
            ...
            const transport = await negotiateTransport('http://localhost:8080', undefined, { probeTimeoutMs: 100 });
            expect(transport.type).toBe('rest');
            transport.dispose();
        });
    });
    ...
    describe('token handling', () => {
        it('passes token as Authorization header to capabilities probe', async () => {
            ...
            const transport = await negotiateTransport('http://localhost:8080', 'secret-token');
...
//# sourceMappingURL=negotiateTransport.test.js.map