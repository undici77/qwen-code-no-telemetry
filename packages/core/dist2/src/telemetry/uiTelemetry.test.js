...
describe('UiTelemetryService', () => {
    ...
    describe('Tool Call Event Processing', () => {
        ...
        it('redacts function_args for structured_output calls while preserving metrics', () => {
            const toolCall = createFakeCompletedToolCall('structured_output', true, 250, ToolConfirmationOutcome.ProceedOnce);
        ...
        it('does not redact function_args for non-structured_output tools', () => {
            const toolCall = createFakeCompletedToolCall('write_file', true, 100, ToolConfirmationOutcome.ProceedOnce);
            toolCall.request.args = {
                path: '/tmp/x',
                content: 'hello',
            };
