...
let cachedWindowsPathFingerprint;
let cachedMergedWindowsPath;
/**
 ...
 */
export function mergeWindowsPathValues(env, pathKeys) {
    const mergedEntries = [];
 ...
 */
function getWindowsPathFingerprint(env, pathKeys) {
 ...
 */
function sortPathKeys(pathKeys) {
 ...
 */
export function normalizePathEnvForWindows(env) {
    ...
    const canonicalValue = fingerprint === cachedWindowsPathFingerprint
