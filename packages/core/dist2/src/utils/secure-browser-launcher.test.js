...
describe('secure-browser-launcher', () => {
    ...
    describe('Error handling', () => {
        it('should handle browser launch failures gracefully by logging instead of throwing', async () => {
            ...
            await expect(openBrowserSecurely('https://example.com')).resolves.toBeUndefined();
            expect(consoleSpy).toHaveBeenCalledWith(expect.stringContaining('Failed to open browser automatically'));
