...
import { BackgroundShellRegistry, MAX_RETAINED_TERMINAL_SHELLS, } from './backgroundShellRegistry.js';
    ...
    describe('terminal-entry retention cap', () => {
        ...
        it('never evicts running entries even when the cap is exceeded', () => {
            ...
            for (let i = 0; i < MAX_RETAINED_TERMINAL_SHELLS + 1; i++) {
                reg.register(makeEntry({ shellId: `done-${i}`, startTime: 100 + i * 10 }));
        ...
        it('prunes after fail() too, not just complete()', () => {
            ...
            reg.register(makeEntry({ shellId: 'overflow', startTime: overflowStart }));
