...
describe('FileDiscoveryService', () => {
    ...
    describe('shouldGitIgnoreFile & shouldQwenIgnoreFile', () => {
        ...
        it('should return true for qwen-ignored files', () => {
            const service = new FileDiscoveryService(projectRoot);
            expect(service.shouldQwenIgnoreFile(path.join(projectRoot, 'debug.log'))).toBe(true);
        });
        it('should return false for non-qwen-ignored files', () => {
            const service = new FileDiscoveryService(projectRoot);
            expect(service.shouldQwenIgnoreFile(path.join(projectRoot, 'src/index.ts'))).toBe(false);
        });
    });
    describe('edge cases', () => {
