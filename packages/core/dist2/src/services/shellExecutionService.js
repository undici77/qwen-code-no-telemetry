...
export class ShellExecutionService {
    ...
    static async execute(commandToExecute, cwd, onOutputEvent, abortSignal, shouldUseNodePty, shellExecutionConfig, options = {}) {
        if (shouldUseNodePty) {
            ...
            if (ptyInfo) {
                try {
                    return this.executeWithPty(commandToExecute, cwd, onOutputEvent, abortSignal, shellExecutionConfig, ptyInfo, options.postPromote);
                }
                catch (_e) {
        ...
        return this.childProcessFallback(commandToExecute, cwd, onOutputEvent, abortSignal, options.streamStdout ?? false, options.postPromote);
    }
    static childProcessFallback(commandToExecute, cwd, onOutputEvent, abortSignal, streamStdout, postPromote) {
        try {
    ...
    static executeWithPty(commandToExecute, cwd, onOutputEvent, abortSignal, shellExecutionConfig, ptyInfo, postPromote) {
        if (!ptyInfo) {
