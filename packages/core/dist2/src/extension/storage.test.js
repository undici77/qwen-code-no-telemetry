...
describe('ExtensionStorage', () => {
    ...
    beforeEach(() => {
        ...
        vi.mocked(Storage.getUserExtensionsDir).mockReturnValue(path.join(mockHomeDir, '.qwen', 'extensions'));
    ...
    it('should return the correct extension directory', () => {
        const expectedDir = path.join(mockHomeDir, '.qwen', 'extensions', extensionName);
        expect(storage.getExtensionDir()).toBe(expectedDir);
    });
    it('should return the correct config path', () => {
        const expectedPath = path.join(mockHomeDir, '.qwen', 'extensions', extensionName, EXTENSIONS_CONFIG_FILENAME);
        expect(storage.getConfigPath()).toBe(expectedPath);
    });
    it('should return the correct env file path', () => {
        const expectedPath = path.join(mockHomeDir, '.qwen', 'extensions', extensionName, EXTENSION_SETTINGS_FILENAME);
