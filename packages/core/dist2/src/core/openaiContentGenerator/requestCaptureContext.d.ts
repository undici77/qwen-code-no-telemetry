 ...
 */
export type OpenAIRequestCapture = (request: OpenAI.Chat.ChatCompletionCreateParams) => void;
export declare const openaiRequestCaptureContext: AsyncLocalStorage<OpenAIRequestCapture>;
