...
import { buildAgentContentGeneratorConfig, createRuntimeContentGeneratorView, resolveCredentialField, } from './content-generator-config.js';
...
describe('createRuntimeContentGeneratorView', () => {
    ...
    it('should bind the new ContentGenerator to contentGeneratorOwner, not base', async () => {
        ...
        fakeGenerator);
        const view = await createRuntimeContentGeneratorView(baseConfig, ownerConfig, 'custom-model', { authType: 'openai' });
