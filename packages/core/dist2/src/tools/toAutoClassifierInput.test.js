...
describe('SkillTool.toAutoClassifierInput', () => {
    it('forwards only the skill name', () => {
        const result = SkillTool.prototype.toAutoClassifierInput.call({}, { skill: 'my-skill' });
...
describe('AgentTool.toAutoClassifierInput', () => {
    it('forwards full prompt and subagent_type (no truncation)', () => {
        ...
        const result = AgentTool.prototype.toAutoClassifierInput.call({}, {
...
//# sourceMappingURL=toAutoClassifierInput.test.js.map