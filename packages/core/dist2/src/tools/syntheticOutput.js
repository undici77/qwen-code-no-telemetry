...
export class SyntheticOutputTool extends BaseDeclarativeTool {
    static Name = ToolNames.STRUCTURED_OUTPUT;
    constructor(userSchema) {
        super(SyntheticOutputTool.Name, ToolDisplayNames.STRUCTURED_OUTPUT, structuredOutputDescription, Kind.Think, userSchema, false, // isOutputMarkdown
...
class SyntheticOutputInvocation extends BaseToolInvocation {
    ...
    async execute(_signal) {
        return {
            llmContent: 'Structured output accepted. The session will end now — do not send further content.',
            returnDisplay: 'Structured output accepted.',
        };
    }
}
//# sourceMappingURL=syntheticOutput.js.map