 ...
 */
export declare const STRUCTURED_OUTPUT_REDACTED_ARGS: {
    readonly __redacted: "structured_output payload (see stdout result)";
};
/**
 ...
 */
export declare class SyntheticOutputTool extends BaseDeclarativeTool<StructuredOutputParams, ToolResult> {
    static readonly Name: string;
    constructor(userSchema: Record<string, unknown>);
    protected createInvocation(params: StructuredOutputParams): SyntheticOutputInvocation;
}
declare class SyntheticOutputInvocation extends BaseToolInvocation<StructuredOutputParams, ToolResult> {
