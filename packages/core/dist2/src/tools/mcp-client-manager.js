...
import { McpClient, MCPDiscoveryState, MCPServerStatus, getMCPServerStatus, populateMcpServerCommand, removeMCPServerStatus, } from './mcp-client.js';
...
export class McpClientManager {
     ...
     */
    onBudgetEvent;
    constructor(config, toolRegistry, eventEmitter, sendSdkMcpMessage, healthConfig, budgetConfig) {
