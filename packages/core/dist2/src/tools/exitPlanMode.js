...
export class ExitPlanModeTool extends BaseDeclarativeTool {
    ...
    constructor(config) {
        super(ExitPlanModeTool.Name, ToolDisplayNames.EXIT_PLAN_MODE, exitPlanModeToolDescription, Kind.Think, exitPlanModeToolSchemaData.parametersJsonSchema, true, // isOutputMarkdown
