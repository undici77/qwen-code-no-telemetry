...
import { assertRealProjectSkillPath, getProjectSkillsRoot, isProjectSkillPath, } from '../skills/skill-paths.js';
...
function buildTaskPrompt(skillsRoot) {
    return [
...
export async function runSkillReviewByAgent(params) {
    ...
    const result = await runForkedAgent({
        ...
        maxTimeMinutes: (params.timeoutMs ?? DEFAULT_AUTO_SKILL_TIMEOUT_MS) / 60_000,
        tools: [
            ToolNames.READ_FILE,
            ToolNames.LS,
