...
export declare function metricsToUsageRecord(sessionId: string, project: string, startTime: number, endTime: number, metrics: SessionMetrics): UsageSummaryRecord;
/**
 ...
 * written.
 */
export declare function persistUsageBeforeTranscriptDeletion(transcriptPath: string): Promise<boolean>;
export declare function loadUsageHistory(skipSessionInRebuild?: string, options?: {
...
export declare function aggregateUsage(records: UsageSummaryRecord[], range: TimeRange): AggregatedReport;
