...
describe('GitWorktreeService.createUserWorktree() — hooksPath setup', () => {
    ...
    function readWorktreeConfig(worktreePath, key) {
        try {
    ...
    it('points core.hooksPath at .husky when present', async () => {
        ...
        const hooksPath = readWorktreeConfig(result.worktree.path, 'core.hooksPath');
...
//# sourceMappingURL=gitWorktreeService.hooks.integ.test.js.map