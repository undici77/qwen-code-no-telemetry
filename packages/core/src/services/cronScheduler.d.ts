...
export declare function normalizeRecurringMaxAge(value: number, fallback: number): number;
...
export declare class CronScheduler {
     ...
     */
    scheduleWakeup(delaySeconds: number, prompt: string, todoWorkChainId?: string): {
        id: string;
        scheduledFor: string;
     ...
     */
    createDurable(cronExpr: string, prompt: string, recurring: boolean): Promise<CronJob>;
    /**
 ...
 */
export declare function buildMissedCronNotification(missed: DurableCronTask[]): string;
export declare function nextDurableFireMs(task: Pick<DurableCronTask, 'id' | 'cron' | 'recurring' | 'lastFiredAt' | 'createdAt'>): number | null;
