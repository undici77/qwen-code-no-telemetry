...
export declare class SessionService {
     ...
     * `sessionExistsInAnyState()` for archive-aware lookups.
     */
    forkSession(sourceSessionId: string, newSessionId: string, options?: {
        source?: {
            sourceType: string;
            sourceId?: string;
        };
 ...
 */
export declare function getResumeTokenCounts(conversation: ConversationRecord): ResumeTokenCounts | undefined;
