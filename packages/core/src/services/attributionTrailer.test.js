    ...
    describe('buildGitNotesCommand', () => {
        ...
        it('should return null when note exceeds size limit', () => {
            ...
            for (let i = 0; i < 2000; i++) {
                hugeNote.files[`src/very/long/path/to/some/deeply/nested/file_${i}.ts`] = { aiChars: 999999, humanChars: 999999, percent: 50 };
            }
...
//# sourceMappingURL=attributionTrailer.test.js.map