 ...
 */
export type SessionWriterProcessKind = 'interactive' | 'acp' | 'daemon' | 'unknown';
export type SessionWriterErrorKind = 'session_writer_conflict' | 'session_writer_lost' | 'session_transcript_changed' | 'session_writer_unavailable';
...
export declare function getSessionWriterLockPath(runtimeBaseDir: string, sessionId: string): string;
export declare class SessionWriterLease {
    ...
    static acquire(options: AcquireSessionWriterLeaseOptions): Promise<SessionWriterLease>;
