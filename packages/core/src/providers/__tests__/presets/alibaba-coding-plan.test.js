...
import { AuthType, CODING_PLAN_CHINA_BASE_URL, CODING_PLAN_ENV_KEY, codingPlanProvider, buildInstallPlan, buildProviderTemplate, computeModelListVersion, getDefaultModelIds, resolveBaseUrl, } from '@qwen-code/qwen-code-core';
describe('coding plan provider', () => {
    it('creates a Coding Plan install plan', () => {
        const baseUrl = resolveBaseUrl(codingPlanProvider, CODING_PLAN_CHINA_BASE_URL);
        const template = buildProviderTemplate(codingPlanProvider, CODING_PLAN_CHINA_BASE_URL);
    ...
    it('owns Coding Plan models', () => {
        expect(codingPlanProvider.ownsModel?.({
            id: 'coding-model',
            baseUrl: CODING_PLAN_CHINA_BASE_URL,
            envKey: CODING_PLAN_ENV_KEY,
        })).toBe(true);
...
//# sourceMappingURL=alibaba-coding-plan.test.js.map