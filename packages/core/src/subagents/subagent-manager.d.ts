...
export declare class SubagentManager {
    ...
    private applyBuiltinSettings;
    resolveModelGrade(grade: string | undefined, agentConfig: SubagentConfig): string | undefined;
    getAvailableModelGrades(): Map<string, string>;
    private getBuiltinAgent;
    private getBuiltinAgents;
    /**
     ...
     */
    updateSubagent(name: string, updates: Partial<SubagentConfig>, level?: SubagentLevel, options?: {
     ...
     */
    deleteSubagent(name: string, level?: SubagentLevel, extensionName?: string, options?: {
        assertCanCommit?: () => void;
    }): Promise<void>;
    /**
