 ...
 */
export declare function downloadFromNpmRegistry(installMetadata: ExtensionInstallMetadata, destination: string, signal?: AbortSignal): Promise<NpmDownloadResult>;
/**
 * Check if an npm-installed extension has an update available.
 */
export declare function checkNpmUpdate(installMetadata: ExtensionInstallMetadata, signal?: AbortSignal): Promise<ExtensionUpdateState>;
