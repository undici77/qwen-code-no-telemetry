...
import { ExtensionStore, type ExtensionActivation, type ExtensionActivationResult, type ExtensionStoreSnapshot, type InitialExtensionActivation } from './extension-store.js';
