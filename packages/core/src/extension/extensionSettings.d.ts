...
export declare function validateExtensionSettingEnvVars(settings: readonly ExtensionSetting[] | undefined): void;
...
export declare function maybePromptForSettings(extensionConfig: ExtensionConfig, extensionId: string, requestSetting: (setting: ExtensionSetting) => Promise<string>, previousExtensionConfig?: ExtensionConfig, previousSettings?: Record<string, string>, envFilePathOverride?: string, deferKeychainMutations?: boolean): Promise<PreparedExtensionSettingsMutation | undefined>;
