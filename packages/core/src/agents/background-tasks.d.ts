...
export declare const BACKGROUND_AGENT_CONCURRENCY_ENV =
  'QWEN_CODE_MAX_BACKGROUND_AGENTS';
export declare function resolveMaxConcurrentBackgroundAgents(
 ...
 */
export declare function buildBackgroundEntryLabel(
  entry: {
    description: string;
    subagentType?: string;
  },
