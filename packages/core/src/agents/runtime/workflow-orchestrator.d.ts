...
export type WorkflowAgentDispatch = (prompt: string, opts: WorkflowAgentOpts) => Promise<WorkflowAgentResult>;
/**
 ...
 */
onTokens?: (outputTokens: number, opts: WorkflowAgentOpts) => void, bridgeApprovalEvents?: (emitter: AgentEventEmitter) => () => void): WorkflowAgentDispatch;
