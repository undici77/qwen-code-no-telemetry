...
export declare class AgentCore {
     ...
     */
    processFunctionCalls(functionCalls: FunctionCall[], abortController: AbortController, promptId: string, currentRound: number, toolsList: FunctionDeclaration[], responseId?: string, wasOutputTruncated?: boolean, handledProviderToolCallIds?: Set<string>, duplicateProviderToolCallResponseIds?: Set<string>): Promise<{
        messages: Content[];
