...
import type { PromptConfig, ModelConfig, RunConfig, ToolConfig, AgentExternalInput } from './agent-types.js';
...
export declare class AgentHeadless {
     ...
     */
    static create(name: string, runtimeContext: Config, promptConfig: PromptConfig, modelConfig: ModelConfig, runConfig: RunConfig, toolConfig?: ToolConfig, eventEmitter?: AgentEventEmitter, hooks?: AgentHooks, runtimeView?: RuntimeContentGeneratorView): Promise<AgentHeadless>;
    /**
     ...
     */
    execute(context: ContextState, externalSignal?: AbortSignal, options?: {
        resetStats?: boolean;
    }): Promise<void>;
    executeExternalInputs(inputs: AgentExternalInput[], externalSignal?: AbortSignal, options?: {
        resetStats?: boolean;
    }): Promise<void>;
    private executeTurn;
    /**
    ...
    setExternalMessageWaiter(waiter: (signal: AbortSignal) => Promise<AgentExternalInput[]>): void;
