...
export declare const MAX_TEAMMATES = 10;
/** Reserved name for the team leader (case-insensitive in messaging). */
export declare const LEADER_NAME = "leader";
/** Directory name under ~/.qwen for team configs. */
export declare const TEAMS_DIR = "teams";
...
export declare const TEAM_CONFIG_FILENAME = "config.json";
 ...
 */
export declare const TEAMMATE_COLORS: readonly ["#FF6B6B", "#4ECDC4", "#45B7D1", "#FFA07A", "#98D8C8", "#DDA0DD", "#F0E68C", "#87CEEB", "#FFB347", "#B0E0E6"];
