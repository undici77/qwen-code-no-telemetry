...
export declare enum TeamEventType {
...
export interface TeammateApprovalRequestEvent {
    ...
    respond: (outcome: ToolConfirmationOutcome, payload?: ToolConfirmationPayload) => Promise<void>;
    timestamp: number;
}
...
export declare class TeamEventEmitter {
    private ee;
    on<E extends keyof TeamEventMap>(event: E, listener: (payload: TeamEventMap[E]) => void): void;
    off<E extends keyof TeamEventMap>(event: E, listener: (payload: TeamEventMap[E]) => void): void;
    emit<E extends keyof TeamEventMap>(event: E, payload: TeamEventMap[E]): void;
    once<E extends keyof TeamEventMap>(event: E, listener: (payload: TeamEventMap[E]) => void): void;
