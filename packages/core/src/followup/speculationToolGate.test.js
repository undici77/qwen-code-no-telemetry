...
describe('speculationToolGate', () => {
    ...
    describe('WRITE_TOOLS', () => {
        ...
        it('redirects edit in auto mode', async () => {
            const result = await evaluateToolCall(ToolNames.EDIT, {}, overlayFs, ApprovalMode.AUTO);
            expect(result.action).toBe('redirect');
        });
        it('redirects write_file in auto mode', async () => {
            const result = await evaluateToolCall(ToolNames.WRITE_FILE, {}, overlayFs, ApprovalMode.AUTO);
            expect(result.action).toBe('redirect');
        });
