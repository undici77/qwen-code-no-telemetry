...
export declare function getMcpOAuthDialogInstruction(
 ...
 */
export declare function createStreamableHttpCompatibilityFetch(
  mcpServerName: string,
...
export declare class McpClient {
  ...
  constructor(
    ...
    debugMode: boolean,
    sendSdkMcpMessage?: SendSdkMcpMessage | undefined,
  );
  /**
...
export declare function probeMcpServerForOAuth(
  mcpServerName: string,
  mcpServerConfig: MCPServerConfig,
  error?: unknown,
): Promise<boolean>;
export declare function attemptAutomaticMcpOAuth(
  mcpServerName: string,
  mcpServerConfig: MCPServerConfig,
 ...
 */
export declare function listMcpPrompts(
  mcpServerName: string,
  mcpClient: Client,
 ...
 */
export declare function listMcpResources(
  mcpServerName: string,
  mcpClient: Client,
