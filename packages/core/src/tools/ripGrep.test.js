...
describe('RipGrepTool', () => {
    ...
    describe('execute', () => {
        ...
        it('should treat summary-only JSON output as no matches', async () => {
            ...
            const result = await invocation.execute(abortSignal);
            expect(result.llmContent).toBe('No matches found for pattern "missing" in the workspace directory.');
        ...
        it('should preserve absolute result paths reported by ripgrep', async () => {
            const absoluteMatchPath = path.join(tempRootDir, 'packages/core/src/skills/target.ts');
            runRipgrep.mockResolvedValue({
        ...
        it('should parse Windows-style absolute result paths reported by ripgrep', async () => {
            const absoluteMatchPath = 'C:\\repo\\packages\\core\\src\\skills\\target.ts';
            runRipgrep.mockResolvedValue({
    ...
    describe('multi-directory workspace', () => {
        it('should search across all workspace directories when no path is specified', async () => {
            ...
            expect(runRipgrep).toHaveBeenCalledWith(expect.arrayContaining([
                '--json',
                '--no-messages',
                tempRootDir,
                secondDir,
