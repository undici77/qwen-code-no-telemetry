...
import type { Config, ModelInvocableCommandExecutorResult } from '../config/config.js';
...
declare class SkillToolInvocation extends BaseToolInvocation<SkillParams, ToolResult> {
    ...
    private promptId;
    constructor(config: Config, skillManager: SkillManager, params: SkillParams, onSkillLoaded: (name: string) => void, commandExecutor?: ((name: string, args?: string) => Promise<ModelInvocableCommandExecutorResult | null>) | null, isSkillLoaded?: (name: string) => boolean);
