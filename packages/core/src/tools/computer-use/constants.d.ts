 ...
 */
export declare const OSS_MIRROR_BASE =
...
export declare const GITHUB_RELEASE_BASE =
 ...
 */
export declare function resolveAssetTarget(
 ...
 */
export declare function resolveAssetUrls(
  asset: string,
  env?: NodeJS.ProcessEnv,
  version?: string,
): string[];
/** URL for the release `checksums.txt` (same source order as assets). */
export declare function resolveChecksumUrls(
  env?: NodeJS.ProcessEnv,
  version?: string,
): string[];
/** Env var name for overriding the screenshot longest-edge cap. */
export declare const MAX_IMAGE_DIMENSION_ENV =
  'QWEN_COMPUTER_USE_MAX_IMAGE_DIMENSION';
/**
 ...
 */
export declare function resolveMaxImageDimension(
  settingValue?: number,
  env?: NodeJS.ProcessEnv,
): number | undefined;
 ...
 */
export declare function binaryPath(
  home?: string,
  platform?: NodeJS.Platform,
  arch?: string,
  version?: string,
