...
import { MCPServerStatus, type DiscoveredMCPPrompt, type DiscoveredMCPResource, type McpClient } from './mcp-client.js';
import type { DiscoveredMCPTool } from './mcp-tool.js';
import { type McpTransportKind } from './mcp-pool-key.js';
import { type ConnectionId, type PoolEntryState, type PoolEvent } from './mcp-pool-events.js';
 ...
 * in the design doc.
 */
export declare function defaultPoolEntryOptions(transport: McpTransportKind): PoolEntryOptions;
/**
...
export declare class PoolEntry {
     ...
     */
    constructor(id: ConnectionId, serverName: string, entryIndex: number, cfg: MCPServerConfig, client: McpClient, cliConfig: Config, opts: PoolEntryOptions, onClosed: (id: ConnectionId) => void, aggregateStatusByName: (name: string) => MCPServerStatus);
     ...
     */
    markActive(initialTools: DiscoveredMCPTool[], initialPrompts: DiscoveredMCPPrompt[], initialResources: DiscoveredMCPResource[]): void;
    /**
     ...
     */
    attach(sessionId: string, view: SessionMcpView, opts?: {
        skipReplay?: boolean;
        release?: () => void;
    }): PooledConnection;
    /**
