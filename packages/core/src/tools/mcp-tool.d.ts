...
export declare class DiscoveredMCPTool extends BaseDeclarativeTool<ToolParams, ToolResult> {
     ...
     */
    withSessionConfig(trust: boolean | undefined, alwaysLoad: boolean): DiscoveredMCPTool;
