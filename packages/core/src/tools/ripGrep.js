...
function toAbsoluteResultPath(filePath, searchPaths) {
...
class GrepToolInvocation extends BaseToolInvocation {
    ...
    async execute(signal) {
        try {
            ...
            const { stdout: rawOutput, truncated: truncatedBySystemLimit } = await this.performRipgrepSearch({
            ...
            const resultFilePaths = Array.from(new Set(visibleLines.map((line) => toAbsoluteResultPath(line.filePath, searchPaths))));
            return {
