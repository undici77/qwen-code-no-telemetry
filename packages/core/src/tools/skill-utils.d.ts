 ...
 * invalidation hooks.
 */
export declare function clearCollectedSkillEntriesCache(skillManager?: SkillManager): void;
/**
 ...
 */
export declare function collectAvailableSkillEntries(skillManager: SkillManager, config: Config): Promise<CollectedAvailableSkills>;
/**
 ...
 */
export declare function renderAvailableSkillsBlock(entries: AvailableSkillEntry[]): string;
/**
 ...
 */
export declare function applySkillAllowedTools(permissionManager: PermissionManager | null | undefined, allowedTools: string[] | undefined): void;
