...
import type { LspServerHandle, LspServiceReinitializeResult, LspServerStatus, LspStatusSnapshot, NativeLspServiceOptions } from './types.js';
export declare class NativeLspService {
    ...
    private reinitializeQueue;
    private reinitializeAbortController;
    private stopping;
    ...
    private throwIfReinitializeAborted;
    private doReinitialize;
    private filterServerConfigs;
    private clearDocumentTrackingForServers;
    private snapshotOpenDocuments;
    private replayOpenDocuments;
