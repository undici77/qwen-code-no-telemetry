...
export declare function isToolArtifactLike(value: unknown): value is ToolArtifact;
export declare const MAX_USER_PROMPT_EXPANSION_ADDITIONAL_CONTEXT_LENGTH = 10000;
export declare function sanitizeUserPromptExpansionAdditionalContext(raw: string): string;
/**
 ...
 */
export declare class UserPromptExpansionHookOutput extends DefaultHookOutput {
    getAdditionalContext(): string | undefined;
}
/**
 * Specific hook output class for PostToolBatch events.
 */
export declare class PostToolBatchHookOutput extends DefaultHookOutput {
    /**
 ...
 */
export type StopFailureErrorType = 'rate_limit' | 'authentication_failed' | 'billing_error' | 'invalid_request' | 'server_error' | 'max_output_tokens' | 'loop_detected' | 'unknown';
/**
