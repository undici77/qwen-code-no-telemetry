...
export declare function isToolArtifactLike(
  value: unknown,
): value is ToolArtifact;
export declare const MAX_USER_PROMPT_EXPANSION_ADDITIONAL_CONTEXT_LENGTH = 10000;
export declare function sanitizeUserPromptExpansionAdditionalContext(
  raw: string,
): string;
/**
 ...
 */
export declare function detectTodoChanges(
  oldTodos: TodoItem[],
  newTodos: TodoItem[],
): TodoChanges;
/**
