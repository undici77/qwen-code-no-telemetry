...
import type { ContextUsageData, SessionStartSource, SessionEndReason, AgentType, PostToolBatchToolCall, PreCompactTrigger, PostCompactTrigger, NotificationType, PermissionDeniedReason, PermissionSuggestion, MessagesProvider, StopFailureErrorType, TodoItem, TodoStatus, InstructionMemoryType, InstructionLoadReason } from './types.js';
...
export declare class HookEventHandler {
     ...
     */
    fireUserPromptSubmitEvent(prompt: string, signal?: AbortSignal, submittedPrompt?: string): Promise<AggregatedHookResult>;
    /**
     ...
     */
    fireUserPromptExpansionEvent(commandName: string, commandArgs: string, prompt: string, signal?: AbortSignal): Promise<AggregatedHookResult>;
    /**
     * Fire a Stop event
     * Called by handleHookExecutionRequest - executes hooks directly
     */
     ...
     */
    fireSessionDeleteEvent(deletedSessionId: string, signal?: AbortSignal): Promise<AggregatedHookResult>;
    /**
     * Fire a PreToolUse event
     * Called before tool execution begins
     */
    firePreToolUseEvent(toolName: string, toolInput: Record<string, unknown>, toolUseId: string, permissionMode: PermissionMode, signal?: AbortSignal, tool_call_id?: string): Promise<AggregatedHookResult>;
    /**
     * Fire a PostToolUse event
     * Called after successful tool execution
     */
    firePostToolUseEvent(toolName: string, toolInput: Record<string, unknown>, toolResponse: Record<string, unknown>, toolUseId: string, permissionMode: PermissionMode, signal?: AbortSignal, tool_call_id?: string): Promise<AggregatedHookResult>;
    /**
     * Fire a PostToolUseFailure event
     * Called when tool execution fails
     */
    firePostToolUseFailureEvent(toolUseId: string, toolName: string, toolInput: Record<string, unknown>, errorMessage: string, isInterrupt?: boolean, permissionMode?: PermissionMode, signal?: AbortSignal, tool_call_id?: string): Promise<AggregatedHookResult>;
    /**
     ...
     */
    firePostToolBatchEvent(toolCalls: PostToolBatchToolCall[], permissionMode?: PermissionMode, signal?: AbortSignal): Promise<AggregatedHookResult>;
    /**
     ...
     */
    firePermissionDeniedEvent(toolName: string, toolInput: Record<string, unknown>, toolUseId: string, reason: PermissionDeniedReason, signal?: AbortSignal, tool_call_id?: string): Promise<AggregatedHookResult>;
    /**
