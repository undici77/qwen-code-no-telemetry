...
describe('loadServerHierarchicalMemory', () => {
    ...
    it('should skip implicit global, project, and rule discovery in explicit-only mode', async () => {
        await createTestFile(path.join(homedir, QWEN_DIR, DEFAULT_CONTEXT_FILENAME), 'global context');
        ...
        await createTestFile(path.join(projectRoot, QWEN_DIR, 'rules', 'baseline.md'), 'project rule');
