 ...
 * never closes it.
 */
export declare function readTextRangeFromHandle(fileHandle: FileHandle, request: ReadTextRangeFromHandleRequest): Promise<ReadTextRangeResult>;
/**
 ...
 */
export declare function readTextCursorWindowFromHandle(fileHandle: FileHandle, request: ReadTextCursorWindowRequest): Promise<ReadTextCursorWindowResult>;
export declare function detectLineEndingFromContent(content: string): 'crlf' | 'lf';
