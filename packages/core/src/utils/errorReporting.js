 ...
 */
export async function reportError(error, baseMessage, context, type = 'general') {
    let errorToReport;
    ...
    try {
        ...
        debugLogger.error(`${reportLabel} Could not stringify report content (likely due to context):`, stringifyError, error);
        ...
        try {
            ...
            debugLogger.error(`${reportLabel} Failed to stringify minimal error report:`, minimalStringifyError, error);
        }
        return;
    }
