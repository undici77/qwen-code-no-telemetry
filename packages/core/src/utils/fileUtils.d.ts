...
export declare function decodeBufferWithEncodingInfoAsync(
  full: Buffer,
 ...
 */
export declare function readFileWithEncodingInfo(
  filePath: string,
  signal?: AbortSignal,
): Promise<FileReadResult>;
/**
 ...
 */
export declare function detectFileEncoding(
 ...
 */
export declare function isCacheableReadResult(
