...
import { isWithinRoot, isBinaryFile, detectFileType, processSingleFileContent, detectBOM, decodeBufferWithEncodingInfo, readFileWithEncoding, readFileWithEncodingInfo, detectFileEncoding, fileExists, } from './fileUtils.js';
    ...
    describe('BOM detection and encoding', () => {
        ...
        describe('readFileWithEncodingInfo', () => {
            it('should decode plain UTF-8 buffers without reading from a path', () => {
                const result = decodeBufferWithEncodingInfo(Buffer.from('Hello', 'utf8'));
            ...
            it('should decode UTF-8 BOM buffers without reading from a path', () => {
                const result = decodeBufferWithEncodingInfo(Buffer.concat([
