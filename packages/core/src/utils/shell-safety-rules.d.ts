...
export declare function classifySedScriptSafety(
  script: string,
): SedScriptSafety;
export declare function classifySedCommandSafety(
  args: string[],
): SedScriptSafety;
export declare function classifyAwkScriptSafety(
  script: string,
): AwkScriptSafety;
export declare function classifyAwkCommandSafety(
  args: string[],
): AwkScriptSafety;
