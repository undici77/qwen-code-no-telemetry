 ...
 */
export declare function saveCacheSafeParams(
  generationConfig: GenerateContentConfig,
  history: Content[],
  model: string,
): void;
 ...
 */
export declare function createForkedChat(
  config: Config,
 ...
 */
export declare function runWithForkedChatModel<T>(
  config: Config,
 ...
 *     Use for: memory extract, dream consolidation.
 */
export declare function runForkedAgent(
