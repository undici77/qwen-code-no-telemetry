...
export declare function gitEnv(base?: Readonly<Record<string, string | undefined>>): Record<string, string | undefined>;
/**
 ...
 */
export declare function fetchGitBranches(cwd: string, env?: Readonly<Record<string, string | undefined>>): Promise<GitBranchesResult>;
/**
 ...
 */
export declare function gitCheckout(cwd: string, ref: string, env?: Readonly<Record<string, string | undefined>>): Promise<GitCheckoutResult>;
/**
 * Create a new branch and check it out. Throws if the branch already exists
 * or the working tree is dirty.
 */
export declare function gitCreateBranch(cwd: string, name: string, startPoint?: string, env?: Readonly<Record<string, string | undefined>>): Promise<GitCheckoutResult>;
 ...
 */
export declare function gitPush(cwd: string, opts?: {
    setUpstream?: boolean;
    force?: boolean;
}, env?: Readonly<Record<string, string | undefined>>): Promise<GitPushResult>;
 ...
 */
export declare function gitPull(cwd: string, opts?: {
    rebase?: boolean;
    fetchOnly?: boolean;
}, env?: Readonly<Record<string, string | undefined>>): Promise<GitPullResult>;
...
export declare function gitCommit(cwd: string, message: string, opts?: {
    all?: boolean;
}, env?: Readonly<Record<string, string | undefined>>): Promise<GitCommitResult>;
