...
export declare class WorkspaceContext {
    ...
    static resolveRootDirectories(directory: string, additionalDirectories?: readonly string[]): ResolvedWorkspaceDirectories;
    /**
 ...
 */
export declare function isPathWithinRoot(pathToCheck: string, rootDirectory: string): boolean;
