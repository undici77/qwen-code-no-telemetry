...
export declare function renameWithRetry(
  ...
  retries: number,
  delayMs: number,
  _renameImpl?: (s: string, d: string) => Promise<void>,
): Promise<void>;
/**
...
export declare function atomicWriteJSON(
  filePath: string,
  data: unknown,
  options?: AtomicWriteFileOptions,
): Promise<void>;
 ...
 */
export declare function renameWithRetrySync(
  src: string,
  dest: string,
  retries: number,
  delayMs: number,
  _renameImpl?: (s: string, d: string) => void,
): void;
/**
