...
export type GitHubPullRequestChecks = 'passing' | 'failing' | 'pending' | 'none';
 ...
 */
export declare function fetchGitHubPullRequests(cwd: string, env?: Readonly<Record<string, string | undefined>>): Promise<FetchGitHubPullRequestsResult>;
 ...
 */
export declare function createGitHubPullRequest(cwd: string, opts: CreateGitHubPullRequestOptions, env?: Readonly<Record<string, string | undefined>>): Promise<CreateGitHubPullRequestResult>;
/**
 * Get the default branch as a fully-qualified remote ref (e.g.
 * "origin/main").
 */
export declare function getDefaultBranch(cwd: string, env?: Readonly<Record<string, string | undefined>>): Promise<string | null>;
