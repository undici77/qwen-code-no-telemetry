...
export declare const USER_PROMPT_SUBMIT_CONTEXT_OPEN = "<qwen:user-prompt-submit-context>";
export declare const USER_PROMPT_SUBMIT_CONTEXT_CLOSE = "</qwen:user-prompt-submit-context>";
...
export declare function isUserPromptSubmitContextPartText(text: string): boolean;
/**
