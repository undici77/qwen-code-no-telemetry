...
import type { GoalEvidenceCheckpoint, GoalEvidenceCheckpointClaim, GoalEvidenceProofKind } from './goal-protocol.js';
...
export type GoalCheckpointVerifier = (input: GoalCheckpointVerifierInput, attemptSignal?: AbortSignal) => Promise<GoalCheckpointVerificationResult>;
