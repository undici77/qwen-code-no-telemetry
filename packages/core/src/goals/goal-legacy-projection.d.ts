 ...
 */
import type { GoalRecord, GoalSnapshotV2, GoalStateCause, GoalStateRecordPayloadV2 } from './goal-protocol.js';
export type LegacyGoalStatusKind = 'set' | 'achieved' | 'cleared' | 'failed' | 'aborted' | 'paused' | 'checking';
...
export declare function projectGoalStateToLegacy(payload: GoalStateRecordPayloadV2, previousGoal?: GoalRecord | null): LegacyGoalProjection;
