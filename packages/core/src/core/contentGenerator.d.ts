 ...
 */
export declare function resolveContentGeneratorConfigWithSources(
  config: Config,
  authType: AuthType | undefined,
 ...
 */
export declare function validateModelConfig(
  config: ContentGeneratorConfig,
  isStrictModelProvider?: boolean,
...
/** @internal */
export declare function preloadContentGenerator(
  generator: ContentGenerator,
): Promise<void>;
/** @internal */
export declare function resetPreloadedContentGenerator(
