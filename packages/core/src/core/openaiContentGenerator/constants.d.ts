 ...
 */
export declare function resolveRequestTimeout(
  timeout: number | null | undefined,
): number;
export declare const DEFAULT_STREAM_IDLE_TIMEOUT_MS = 240000;
export declare const QWEN_STREAM_IDLE_TIMEOUT_MS_ENV =
