...
export declare function createDuplicateProviderToolCallResponse(
  request: ToolCallRequestInfo,
): ToolCallResponseInfo;
export declare function markDuplicateProviderToolCallResponseSent(
  providerCallId: string,
  duplicateProviderToolCallResponseIds: Set<string>,
): void;
export declare function findRepeatedDuplicateProviderToolCall<T>(
  items: readonly T[],
