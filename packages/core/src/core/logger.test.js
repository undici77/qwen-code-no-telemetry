...
describe('Logger', () => {
    ...
    describe('logMessage', () => {
        ...
        it('removeLastUserMessage targets the duplicate-skipped row, not the older USER', async () => {
            ...
            await fs.writeFile(testLogFilePath, JSON.stringify([firstOnDisk, secondRow], null, 2), 'utf-8');
            ...
            // secondRow.
            vi.spyOn(logger, '_updateLogFile').mockImplementationOnce(async (entry) => {
