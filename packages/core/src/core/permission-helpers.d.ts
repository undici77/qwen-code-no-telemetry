 ...
 */
export declare function buildPermissionCheckContext(toolName: string, toolParams: Record<string, unknown>, targetDir: string, toolAliases?: readonly string[]): PermissionCheckContext;
