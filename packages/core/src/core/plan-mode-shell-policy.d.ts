...
declare const WRITE_BLOCK_MESSAGE = "Plan mode blocked this shell command because it was classified as state-modifying. Do not retry it through wrappers or obfuscation; continue read-only investigation and include the action in the plan.";
declare const NO_APPROVAL_MESSAGE = "Plan mode could not determine whether this shell command is read-only, and no approval surface is available. The command was not run; Plan mode remains active.";
...
/** @internal */
export declare function decoratePlanModeShellConfirmation(decision: PlanModeShellDecision, confirmation: ToolCallConfirmationDetails): ToolCallConfirmationDetails;
/** @internal */
