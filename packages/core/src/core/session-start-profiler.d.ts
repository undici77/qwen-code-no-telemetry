...
export declare const SESSION_START_PROFILE_ENV = "QWEN_CODE_PROFILE_SESSION_START";
...
export declare function createSessionStartProfiler(source: SessionStartSource, options?: SessionStartProfilerOptions): SessionStartProfiler;
export {};
