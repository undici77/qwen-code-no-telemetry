...
export declare const REPEATED_TOOL_FAILURE_GUARD_COUNT =
...
export declare const SUBAGENT_EXECUTION_COUNT =
...
export declare function recordToolExecutionMetrics(
  config: TelemetryRuntimeConfig,
  attributes: MetricDefinitions[typeof TOOL_EXECUTION_COUNT]['attributes'],
): void;
export declare function recordRepeatedToolFailureGuardMetrics(
 ...
 */
export declare function recordApiRetry(
  config: Config,
 ...
 */
export declare function recordSubagentExecutionMetrics(
  config: Config,
  subagentName: string,
...
export declare function recordArenaAgentCompletedMetrics(
  config: Config,
  modelId: string,
  status: string,
  durationMs: number,
...
export declare function recordArenaSessionEndedMetrics(
  config: Config,
  status: string,
...
export declare function recordMemoryExtractMetrics(
  config: Config,
  durationMs: number,
  attrs: {
    trigger: 'auto' | 'manual';
...
export declare function recordMemoryDreamMetrics(
  config: Config,
  durationMs: number,
  attrs: {
    trigger: 'auto' | 'manual';
...
export declare function recordMemoryRecallMetrics(
  config: Config,
  durationMs: number,
  attrs: {
...
export declare function recordMemoryRecallDeliveryMetrics(
  config: Config,
  latencyMs: number,
  attrs: {
