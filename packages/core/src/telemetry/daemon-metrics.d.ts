...
export declare function registerDaemonGaugeCallbacks(
  callbacks: DaemonGaugeCallbacks,
): void;
export declare function recordDaemonHttpRequest(
  durationMs: number,
  route: string,
  statusCode: number,
  deferredRuntimePath?: 'started_on_request' | 'joined',
): void;
export declare function recordDaemonSessionLifecycle(
  action: 'spawn' | 'close' | 'die',
): void;
export declare function recordDaemonChannelLifecycle(
  action: 'spawn' | 'exit',
  expected?: boolean,
): void;
...
export declare function recordDaemonPipeMessage(
