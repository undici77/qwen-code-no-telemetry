...
export declare function startInteractionSpan(
  config: Config,
  options: StartInteractionOptions,
): void;
export declare function endInteractionSpan(
  status: InteractionStatus,
  metadata?: EndInteractionOptions,
): void;
export declare function withInteractionSpan<T>(
  config: Config,
  options: StartInteractionOptions & {
...
export declare function startLLMRequestSpan(
  model: string,
  promptId: string,
  options?: StartLLMRequestSpanOptions,
): Span;
export declare function startLLMRequestSpanWithContext(
  model: string,
  promptId: string,
  options?: StartLLMRequestSpanOptions,
): {
...
export declare function endLLMRequestSpan(
  span: Span,
  metadata?: LLMRequestMetadata,
): void;
export declare function startToolSpan(
  toolName: string,
 ...
 */
export declare function endToolSpan(
  span: Span,
...
export declare function startToolExecutionSpan(
  options?: StartToolExecutionSpanOptions,
): Span;
export declare function endToolExecutionSpan(
  span: Span,
 ...
 */
export declare function startToolBlockedOnUserSpan(
  toolSpan: Span,
  attrs?: {
    tool_name?: string;
    call_id?: string;
 ...
 */
export declare function endToolBlockedOnUserSpan(
  span: Span,
  metadata?: {
 ...
 */
export declare function endHookSpan(
  span: Span,
  metadata?: HookSpanMetadata,
): void;
 ...
 */
export declare function runInSubagentSpanContext<T>(
  span: Span,
  fn: () => Promise<T>,
): Promise<T>;
/**
 ...
 */
export declare function endSubagentSpan(
  span: Span,
