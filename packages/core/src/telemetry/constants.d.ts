...
export declare const EVENT_REPEATED_TOOL_FAILURE_GUARD = "qwen-code.repeated_tool_failure_guard";
...
export declare const EVENT_RIPGREP_RUNTIME_RECOVERY = "qwen-code.ripgrep_runtime_recovery";
...
export declare const EVENT_TOOL_OUTPUT_TRUNCATED = "qwen-code.tool_output_truncated";
...
export declare const EVENT_MEMORY_RECALL_DELIVERY = "qwen-code.memory.recall.delivery";
