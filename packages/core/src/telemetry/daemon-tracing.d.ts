...
export declare function withDaemonSpan<T>(
  name: string,
...
export declare function withDaemonRequestSpan<T>(
  options: DaemonRequestSpanOptions,
  fn: (span: Span) => Promise<T>,
): Promise<T>;
export declare function withDaemonBridgeSpan<T>(
  operation: string,
  attributes: DaemonAttributes,
  fn: () => Promise<T>,
): Promise<T>;
export declare function recordDaemonHttpResponse(
  span: Span | undefined,
  statusCode: number,
): void;
export declare function addDaemonRequestAttribute(
  key: string,
  value: string | number | boolean,
): void;
export declare function recordDaemonError(
  span: Span | undefined,
  error: unknown,
  attributes?: DaemonAttributes,
): void;
export declare function emitDaemonLog(
  body: string,
...
export declare function runWithDaemonTelemetryContext<T>(
  captured: unknown,
  fn: () => Promise<T>,
): Promise<T>;
export declare function injectDaemonTraceContext<T extends object>(
  request: T,
): T;
export declare function extractDaemonTraceContext(
  source: unknown,
): Context | undefined;
