...
export declare function extractOpenAiRequestAttributes(
  request: object,
): Attributes;
export declare function extractAnthropicRequestAttributes(
  request: object,
): Attributes;
export declare function extractGeminiRequestAttributes(
  request: object,
): Attributes;
...
export declare function createGenAiExchange(
  parent: Context,
  span: Span,
 ...
 */
export declare function createGenAiRequestObserverContext(
  parent: Context,
  span: Span,
): Context;
export declare function reportOpenAiRequest(
  request: object,
  requestContext?: Context,
): GenAiAttemptHandle | undefined;
export declare function reportAnthropicRequest(
  request: object,
  requestContext?: Context,
): GenAiAttemptHandle | undefined;
export declare function reportAnthropicFollowingRequest(
  request: object,
  previousAttempt: GenAiAttemptHandle | undefined,
): GenAiAttemptHandle | undefined;
export declare function reportGeminiRequest(
  request: object,
  requestContext?: Context,
): GenAiAttemptHandle | undefined;
export declare function reportOpenAiResponse(
  handle: GenAiAttemptHandle | undefined,
  response: object,
): void;
export declare function reportOpenAiChunk(
  handle: GenAiAttemptHandle | undefined,
  chunk: object,
): void;
export declare function reportAnthropicResponse(
  handle: GenAiAttemptHandle | undefined,
  response: object,
): void;
export declare function reportAnthropicEvent(
  handle: GenAiAttemptHandle | undefined,
  event: object,
): void;
export declare function reportGeminiResponse(
  handle: GenAiAttemptHandle | undefined,
  response: object,
): void;
export declare function reportGeminiChunk(
  handle: GenAiAttemptHandle | undefined,
  chunk: object,
): void;
