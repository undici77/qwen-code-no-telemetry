...
export declare function extractOpenAiContent(request: object): GenAiContentAttributes;
export declare function extractAnthropicContent(request: object): GenAiContentAttributes;
export declare function extractGeminiContent(request: object): GenAiContentAttributes;
export declare function stringifyGenAiJson(value: unknown, maxLength: number, requireObject?: boolean): string | undefined;
