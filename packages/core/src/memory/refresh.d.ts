...
export declare function didWriteManagedMemory(
  candidates: readonly MemoryWriteCandidate[],
  projectRoot: string,
): boolean;
export declare function didWriteProjectContextFile(
  candidates: readonly MemoryWriteCandidate[],
  projectRoot: string,
): boolean;
export declare function refreshMemoryInstruction(
  config: Config,
  options?: Pick<RefreshMemoryAfterWriteOptions, 'logContext'>,
): Promise<void>;
export declare function refreshMemoryAfterManagedWrite(
  config: Config,
  candidates: readonly MemoryWriteCandidate[],
