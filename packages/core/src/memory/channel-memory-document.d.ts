...
export declare function parseChannelMemoryDocument(raw: string): ChannelMemoryDocument;
export declare function parseLegacyChannelMemory(raw: Buffer): ChannelMemoryDocument;
...
export declare function renderChannelMemoryRecall(entries: readonly ChannelMemoryEntry[]): string;
export declare function serializeChannelMemoryDocument(document: ChannelMemoryDocument): string;
