 ...
 * exists on disk.
 */
export declare function stageSkillDirs(touchedFiles: string[], projectRoot: string, preExistingDirNames?: ReadonlySet<string>, taskId?: string): Promise<PendingSkill[]>;
/**
 ...
 */
export declare function acceptPendingSkill(pending: PendingSkill): Promise<void>;
/** Delete a staged skill. Never touches the skills root. */
export declare function rejectPendingSkill(pending: PendingSkill): Promise<void>;
