 ...
 */
export declare const MODEL_GENERATION_CONFIG_FIELDS: readonly [
  'samplingParams',
  'timeout',
  'maxRetries',
  'retryInitialDelayMs',
 ...
 */
export declare const CREDENTIAL_FIELDS: readonly [
  'model',
  'apiKey',
  'apiKeyEnvKey',
  'baseUrl',
 ...
 */
export declare const PROVIDER_SOURCED_FIELDS: readonly [
  'model',
  'apiKey',
  'apiKeyEnvKey',
  'baseUrl',
