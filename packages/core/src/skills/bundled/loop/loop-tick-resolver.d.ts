...
export declare class LoopTickResolver {
     ...
     */
    buildTransientErrorTick(mode: LoopMode, projectChecked: boolean, code: string): LoopTickResult;
    /**
     ...
     */
    resolve(mode: LoopMode, allowProjectFileOverride?: boolean): Promise<LoopTickResult>;
}
