...
import { DEFAULT_DAEMON_BASE_URL, getDaemonConfig, isLoopbackUrl, } from './config.js';
...
describe('daemon config', () => {
    ...
    it('falls back to the default daemon config for remote stored URLs', async () => {
        ...
        expect(consoleWarn).toHaveBeenCalledWith('[DaemonConfig] ignoring non-loopback baseUrl:', 'https://attacker.example.com');
    });
