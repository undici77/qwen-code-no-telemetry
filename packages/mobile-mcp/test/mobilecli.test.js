...
test_1.test.describe('mobilecli', () => {
  ...
  test_1.test.describe('getVersion', () => {
    ...
    (0, test_1.test)(
      'should return failed when MOBILECLI_PATH points to invalid location',
      () => {
        try {
    ...
    (0, test_1.test)(
      'should call executeCommand with --version argument',
      () => {
  ...
  test_1.test.describe('getDevices', () => {
    ...
    (0, test_1.test)(
      'should call executeCommand with devices argument when no options',
      () => {
    ...
    (0, test_1.test)(
      'should call executeCommand with includeOffline flag',
      () => {
        const { mobilecli, calls } = createMockMobilecli(mockDevicesResponse);
