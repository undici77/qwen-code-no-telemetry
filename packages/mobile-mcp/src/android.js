...
class AndroidRobot {
    ...
    async getOrientation() {
        const rotation = this.adb('shell', 'settings', 'get', 'system', 'user_rotation')
            .toString()
            .trim();
        return rotation === '0' ? 'portrait' : 'landscape';
    }
    async dumpUiHierarchy(compressed = false) {
        ...
        throw new robot_1.ActionableError('Failed to get UIAutomator XML dump');
    }
