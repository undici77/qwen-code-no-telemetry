...
export declare const encodePayloadMessage: (message: JSONRPCMessage) => JSONRPCMessage;
export declare const decodePayloadMessage: (message: JSONRPCMessage) => JSONRPCMessage;
