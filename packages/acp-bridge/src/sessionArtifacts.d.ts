 ...
 */
import type { RebuiltSessionArtifactSnapshot, SessionArtifactEventRecordPayload, SessionArtifactPersistenceWarning, SessionArtifactRestoreState, SessionArtifactRetention, SessionArtifactSnapshotRecordPayload } from '@qwen-code/qwen-code-core';
export type DaemonSessionArtifactKind = 'file' | 'link' | 'html' | 'image' | 'video' | 'audio' | 'pdf' | 'notebook' | 'other';
export type DaemonSessionArtifactStorage = 'workspace' | 'external_url' | 'managed' | 'published';
...
export type DaemonSessionArtifactRetention = Exclude<SessionArtifactRetention, 'pinned'>;
export declare function isArtifactRestoreFailureWarning(warning: string): boolean;
...
export type SessionArtifactRemovalReason = 'eviction' | 'explicit' | 'unpin_to_ephemeral';
...
export declare class SessionArtifactAuthorizationError extends Error {
    ...
    constructor(sessionId: string, artifactId: string, ownerClientId: string, requesterClientId?: string | undefined);
}
...
export declare class SessionArtifactStore {
    ...
    upsertMany(inputs: SessionArtifactInput[], options?: {
        strict?: boolean;
    ...
    remove(artifactId: string, options?: {
        clientId?: string;
    }): Promise<SessionArtifactMutationResult>;
    restore(snapshot: RebuiltSessionArtifactSnapshot | undefined, options?: SessionArtifactRestoreOptions): Promise<string[]>;
...
export declare function publicArtifactsEqual(a: DaemonSessionArtifact, b: DaemonSessionArtifact): boolean;
export {};
