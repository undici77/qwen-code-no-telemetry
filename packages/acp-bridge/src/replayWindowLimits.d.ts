...
export declare function normalizeCompactedReplayMaxBytes(
  value: number | undefined,
): number;
export declare function normalizeMaxJournalEvents(
  value: number | undefined,
): number;
export declare function normalizeMaxJournalBytes(
  value: number | undefined,
): number;
