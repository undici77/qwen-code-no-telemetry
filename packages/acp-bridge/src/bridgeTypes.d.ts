...
import type { CancelNotification, LoadSessionResponse, PromptRequest, PromptResponse, RequestPermissionResponse, ResumeSessionResponse, SetSessionModelRequest, SetSessionModelResponse } from '@agentclientprotocol/sdk';
import type { BridgeEvent, SubscribeOptions } from './eventBus.js';
import type { ServeSessionContextStatus, ServeSessionSupportedCommandsStatus, ServeWorkspaceEnvStatus, ServeWorkspaceMcpStatus, ServeWorkspacePreflightStatus, ServeWorkspaceProvidersStatus, ServeWorkspaceSkillsStatus } from './status.js';
...
export interface HttpAcpBridge {
     ...
     * `SessionNotFoundError` when the id is unknown.
     */
    subscribeEvents(sessionId: string, opts?: SubscribeOptions): AsyncIterable<BridgeEvent>;
    /**
     ...
     */
    closeSession(sessionId: string, context?: BridgeClientRequestContext): Promise<void>;
    /**
     ...
     * session SSE bus.
     */
    setWorkspaceToolEnabled(toolName: string, enabled: boolean, originatorClientId: string | undefined): Promise<{
        toolName: string;
        enabled: boolean;
    }>;
    /**
    ...
    initWorkspace(opts: {
        force?: boolean;
    }, originatorClientId: string | undefined): Promise<{
        path: string;
     ...
     */
    restartMcpServer(serverName: string, originatorClientId: string | undefined): Promise<{
        serverName: string;
        restarted: true;
        durationMs: number;
    } | {
