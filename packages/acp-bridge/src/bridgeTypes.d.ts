...
export declare const LOAD_REPLAY_PAGE_SIZE_META_KEY =
  'qwen.session.loadReplayPageSize';
export declare const LOAD_REPLAY_HIDE_INHERITED_META_KEY =
...
export declare const CHANNEL_STARTUP_PROFILE_META_KEY =
  'qwen.daemon.channelStartupProfile';
export declare const CHANNEL_STARTUP_PROFILE_VERSION: 1;
export declare const ACTIVE_WORK_HEARTBEAT_META_KEY =
...
export declare const ACTIVE_WORK_NOTIFICATION_METHOD =
...
export declare const WORKTREE_MCP_DEFER_META_KEY =
  'qwen.session.deferMcpDiscovery';
/**
...
export declare function isValidTrustedModelPrompt(
  value: unknown,
): value is string;
export declare const DAEMON_CHANNEL_DELIVERY_META_KEY =
  'qwen.daemon.channelDelivery';
export declare const DAEMON_PROMPT_DISPLAY_TEXT_META_KEY =
 ...
 */
export declare const TODO_STOP_GUARD_CONTINUATION_CLAIM_METHOD =
 ...
 */
export declare const TODO_STOP_GUARD_QUEUE_RELEASE_METHOD =
