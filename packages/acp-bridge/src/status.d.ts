 ...
 */
export declare const SERVE_ERROR_KINDS: readonly ["missing_binary", "blocked_egress", "auth_env_error", "init_timeout", "restore_timeout", "protocol_error", "missing_file", "parse_error", "stat_failed", "budget_exhausted", "mcp_budget_would_exceed", "mcp_server_spawn_failed", "invalid_config", "prompt_deadline_exceeded", "writer_idle_timeout"];
...
export type ServeSessionTaskLifecycleStatus = 'running' | 'paused' | 'completed' | 'failed' | 'cancelled';
export type ServeSessionProcessTaskLifecycleStatus = 'running' | 'completed' | 'failed' | 'cancelled';
...
export type ServeSessionTaskStatus = ServeSessionAgentTaskStatus | ServeSessionShellTaskStatus | ServeSessionMonitorTaskStatus;
...
export type ServeHookMatcherKind = 'toolName' | 'agentType' | 'trigger' | 'sessionTrigger' | 'error' | 'notificationType' | 'commandName' | 'filePath';
...
export type ServeHookConfig = ServeCommandHookConfig | ServeHttpHookConfig | ServeFunctionHookConfig | ServePromptHookConfig | ServeUnknownHookConfig;
export type ServeHookSource = 'project' | 'user' | 'system' | 'extensions' | 'session';
...
export declare const IDLE_HOOK_EVENTS: Record<HookEventName, ServeHookEventMeta>;
export type ServeExtensionInstallType = 'git' | 'local' | 'link' | 'github-release' | 'npm' | 'archive-url';
export type ServeExtensionOriginSource = 'QwenCode' | 'Claude' | 'Gemini' | 'Qoder' | 'AgentPlugins';
...
export type ServeExtensionUpdateState = 'checking for updates' | 'updated, needs restart' | 'updated with warnings' | 'updating' | 'updated' | 'update available' | 'up to date' | 'error' | 'not updatable' | 'unknown';
...
export declare function createIdleWorkspaceExtensionsStatus(workspaceCwd: string): ServeWorkspaceExtensionsStatus;
export declare function createIdleWorkspaceHooksStatus(workspaceCwd: string): ServeWorkspaceHooksStatus;
 ...
 */
export type ServeEnvKind = 'runtime' | 'platform' | 'sandbox' | 'proxy' | 'env_var' | 'memory';
