 ...
 */
export declare const PRIVATE_EXTERNAL_TOOL_GUARD_ENV =
 ...
 */
export declare const EXTERNAL_TOOL_GUARD_READY_META_KEY =
...
export declare const EXTERNAL_TOOL_GUARD_TOKEN_ENV =
 ...
 */
export declare function containsUnsafeExternalToolGuardControlCharacter(
  value: string,
): boolean;
/** Validates a denial reason returned by an external tool guard provider. */
export declare function isValidExternalToolGuardDenialReason(
  reason: unknown,
): reason is string;
