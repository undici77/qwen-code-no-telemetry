 ...
 */
export const PRIVATE_EXTERNAL_TOOL_GUARD_ENV = 'QWEN_CODE_PRIVATE_EXTERNAL_TOOL_GUARD';
/**
 ...
 */
export const EXTERNAL_TOOL_GUARD_READY_META_KEY = 'qwen-code/external-tool-guard-ready';
/**
...
export const EXTERNAL_TOOL_GUARD_TOKEN_ENV = 'QWEN_CODE_EXTERNAL_TOOL_GUARD_TOKEN';
 ...
 */
export function containsUnsafeExternalToolGuardControlCharacter(value) {
