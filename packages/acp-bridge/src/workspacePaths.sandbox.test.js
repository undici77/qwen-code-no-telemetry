...
vi.mock('node:fs', async (importOriginal) => {
    ...
    return {
        ...actual,
        existsSync: (p) => p === '/c/qwen-repro' ? true : actual.existsSync(p),
    };
});
describe('canonicalizeWorkspace inside a POSIX container sandbox (#7139)', () => {
    ...
    it.skipIf(process.platform === 'win32')('resolves a Windows-shaped workspace to its bind-mount location', () => {
    ...
    it.skipIf(process.platform === 'win32')('keeps Windows-shaped input untouched outside a sandbox', () => {
...
//# sourceMappingURL=workspacePaths.sandbox.test.js.map