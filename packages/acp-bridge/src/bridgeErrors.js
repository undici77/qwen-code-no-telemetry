...
export class RestoreInProgressError extends Error {
    ...
    constructor(sessionId, activeAction, requestedAction) {
        super(`Session "${sessionId}" is already being restored via session/${activeAction}; retry session/${requestedAction} after it completes`);
...
export class WorkspaceMismatchError extends Error {
    ...
    constructor(bound, requested) {
        ...
        const safeRequested = requested.length > MAX_WORKSPACE_PATH_LENGTH
            ...
            : requested;
        super(`Workspace mismatch: daemon is bound to "${bound}" but ` +
