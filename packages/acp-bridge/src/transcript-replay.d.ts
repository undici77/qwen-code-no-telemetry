...
export declare function toTranscriptEpochMs(
  timestamp?: string | number,
): number | undefined;
export declare function createTranscriptMessageUpdate(
  options: TranscriptMessageUpdateOptions,
): SessionUpdate;
export declare function createTranscriptImageUpdate(
  options: UpdateMetaOptions & {
    readonly data: string;
    readonly mimeType: string;
  },
): SessionUpdate;
export declare function createTranscriptUsageUpdate(
  usageMetadata: TranscriptUsageMetadataInput,
  options?: TranscriptUsageUpdateOptions,
): SessionUpdate;
export declare function createTranscriptToolCallStartUpdate(
  options: TranscriptToolCallStartOptions,
): SessionUpdate;
export declare function createTranscriptToolCallResultUpdate(
  options: TranscriptToolCallResultOptions,
): SessionUpdate;
export declare function createTranscriptPlanUpdate(
  todos: readonly TranscriptTodoItem[],
  cumulativeUsage?: TranscriptReplayUsageState,
  options?: UpdateMetaOptions,
): SessionUpdate;
export declare function extractTranscriptTodos(
  resultDisplay: unknown,
  args?: Readonly<Record<string, unknown>>,
): TranscriptTodoItem[] | null;
export declare function extractTranscriptTodoPlan(
  resultDisplay: unknown,
  args?: Readonly<Record<string, unknown>>,
): TranscriptTodoPlan | null;
export declare function createTranscriptReplayMachine(
