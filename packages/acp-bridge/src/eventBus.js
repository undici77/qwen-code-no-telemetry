...
function normalizeReplayBudgetBytes(value) {
    if (value === undefined)
        return DEFAULT_REPLAY_BUDGET_BYTES;
    if (!Number.isSafeInteger(value) || value < 1) {
...
export function logEventSizingFailed(type) {
    try {
...
export class EventBus {
    ...
    subscribe(opts = {}) {
        ...
        if (opts.lastEventId !== undefined) {
            ...
            const epochMismatch = opts.epoch !== undefined && opts.epoch !== this.epoch;
