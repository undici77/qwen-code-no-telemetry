...
export declare function serializedBridgeEventByteLength(event: BridgeEvent): number | undefined;
...
export declare class EventBus {
    ...
    private closed;
    constructor(ringSize?: number, maxSubscribers?: number, compactionEngine?: CompactionEngine | undefined, opts?: EventBusOptions);
