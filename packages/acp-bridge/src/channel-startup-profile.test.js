...
import { CHANNEL_STARTUP_PROFILE_META_KEY, } from './bridgeTypes.js';
...
describe('channel startup profile parsing', () => {
    ...
    it('ignores missing and unsupported profiles', () => {
        expect(getChannelStartupProfileAttributes({}, 1_000, 10_000)).toBeUndefined();
        expect(getChannelStartupProfileAttributes(makeResponse({ ...makeProfile(), v: 2 }), 1_000, 10_000)).toBeUndefined();
    });
