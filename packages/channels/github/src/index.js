...
export const plugin = {
    ...
    management: {
        fields: [
            ...
            },
            {
                ...
                label: 'Reason Filter',
                kind: 'string-list',
                description: 'Optional. Comma-separated notification reasons to process. ' +
    ...
    createChannel: (name, config, bridge, options) => new GithubChannel(name, config, bridge, options),
};
