...
export declare class WeComChannel extends ChannelBase {
    ...
    protected onPromptBufferDrained(_chatId: string, _sessionId: string, messageIds: string[]): void;
    protected onPromptBufferDropped(_chatId: string, sessionId: string, messageIds: string[]): void;
    protected onPromptEnd(_chatId: string, sessionId: string, messageId?: string): void;
