...
import type { ChannelConfig, ChannelBaseOptions, Envelope, ChannelAgentBridge, ChannelOutputSegmentContext, ChannelOutputSegmentEndReason, ChannelUserInputRequestContext, UserInputPresentationResult, ChannelTaskLifecycleEvent, SessionTarget } from '@qwen-code/channel-base';
export declare class FeishuChannel extends ChannelBase {
    ...
    protected onOutputSegmentEnd(chatId: string, sessionId: string, _segment: ChannelOutputSegmentContext, reason: ChannelOutputSegmentEndReason): Promise<void>;
    ...
    protected onPromptStart(_chatId: string, sessionId: string, messageId?: string): void;
