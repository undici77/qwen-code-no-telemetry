...
export declare class ChannelProactiveDeliveryError extends Error {
    ...
    constructor(disposition: ChannelProactiveDeliveryDisposition, message: string, options?: ErrorOptions);
}
export declare function isChannelProactiveDeliveryError(error: unknown): error is ChannelProactiveDeliveryError;
