...
export declare const CHANNEL_PROMPT_DISPLAY_TEXT_META_KEY =
  'qwen.daemon.promptDisplayText';
export declare const CHANNEL_PROMPT_AUTHORIZATION_META_KEY =
  'qwen.daemon.channelPromptAuthorization';
export declare const CHANNEL_PROMPT_META_KEY = 'qwen.channel.prompt';
export declare const ACP_PRIVATE_PARENT_CAPABILITY_META_KEY =
  'qwen-code/private-parent-capability';
export declare const ACP_PRIVATE_PARENT_CAPABILITY_ENV =
