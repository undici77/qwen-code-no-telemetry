...
export declare const CHANNEL_PROMPT_DISPLAY_TEXT_META_KEY = "qwen.daemon.promptDisplayText";
export declare const CHANNEL_PROMPT_AUTHORIZATION_META_KEY = "qwen.daemon.channelPromptAuthorization";
export declare const CHANNEL_PROMPT_META_KEY = "qwen.channel.prompt";
export declare const ACP_PRIVATE_PARENT_CAPABILITY_META_KEY = "qwen-code/private-parent-capability";
export declare const ACP_PRIVATE_PARENT_CAPABILITY_ENV = "QWEN_CODE_PRIVATE_ACP_CAPABILITY";
...
export interface ChannelLoopToolHandler {
    ...
    create(sessionId: string, input: ChannelLoopToolCreateInput): Promise<string | ChannelLoopToolResult>;
    list(sessionId: string): Promise<string | ChannelLoopToolResult>;
    cancel(sessionId: string, id: string): Promise<string | ChannelLoopToolResult>;
}
...
export interface ChannelAgentBridge {
    ...
    on<K extends keyof ChannelAgentBridgeEventMap>(eventName: K, listener: (...args: ChannelAgentBridgeEventMap[K]) => void): unknown;
    off<K extends keyof ChannelAgentBridgeEventMap>(eventName: K, listener: (...args: ChannelAgentBridgeEventMap[K]) => void): unknown;
