...
export declare class PairingStore {
     ...
     */
    createRequest(senderId: string, senderName: string): CreatePairingRequestResult;
    createGroupRequest(groupId: string, groupName: string, senderId: string, senderName: string): CreatePairingRequestResult;
