...
export declare function selectRelevantChannelMemory(message: string, entries: readonly ChannelMemoryEntry[]): ChannelMemoryEntry[];
export declare function createChannelMemoryRecallIndex(entries: readonly ChannelMemoryEntry[]): ChannelMemoryRecallIndex;
export declare function selectRelevantChannelMemoryFromIndex(message: string, recallIndex: ChannelMemoryRecallIndex): ChannelMemoryEntry[];
export {};
