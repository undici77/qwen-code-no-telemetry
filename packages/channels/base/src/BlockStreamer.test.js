...
describe('BlockStreamer', () => {
    ...
    function createStreamer(overrides = {}) {
    ...
    it('force-splits at maxChars', async () => {
        ...
        expect(sent[0] + ' ' + sent[1]).toBe('aaaa bbbb cccc dddd eeee ffff gggg hhhh');
    });
...
//# sourceMappingURL=BlockStreamer.test.js.map