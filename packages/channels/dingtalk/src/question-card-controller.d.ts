import type { ChannelUserInputRequestContext, UserInputPresentationResult } from '@qwen-code/channel-base';
import { type DingtalkInteractiveCardClient } from './interactive-card-client.js';
import type { DingtalkCardCallback, DingtalkCardCallbackResult } from './interactive-card-types.js';
export interface QuestionCardControllerOptions {
    ...
    reserveRunProjection?(runId: string): ((operation: () => Promise<void>) => Promise<void>) | undefined;
...
export declare class QuestionCardController {
    ...
    present(context: ChannelUserInputRequestContext, target: {
        chatId: string;
        isGroup: boolean;
