...
export declare function parseDingtalkInteractiveCardConfig(value: unknown): DingtalkInteractiveCardConfig;
export declare function parseDingtalkCardCallback(value: unknown): DingtalkCardCallback | undefined;
export declare function parseDingtalkCardActorId(value: unknown): string | undefined;
