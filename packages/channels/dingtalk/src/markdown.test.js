...
import { splitChunks, extractTitle, normalizeDingTalkMarkdown, } from './markdown.js';
describe('DingTalk markdown utilities', () => {
    ...
    describe('extractTitle', () => {
        ...
        it('truncates to 20 chars', () => {
            expect(extractTitle('This is a very long title that should be truncated')
