...
export class DingtalkConnectionManager {
    options;
    running = false;
    generation = 0;
    hasStarted = false;
    ...
    retryTimer;
    resolveRetryDelay;
    cancelConnectionAttempts = new Set();
    constructor(options) {
    ...
    async connectClient(client, generation) {
        ...
        try {
            ...
            if (abortAttempt) {
                void connect.then(() => this.safeDisconnect(client, 'late connection client'), () => undefined);
            }
            throw error;
        }
        finally {
...
//# sourceMappingURL=DingtalkConnectionManager.js.map