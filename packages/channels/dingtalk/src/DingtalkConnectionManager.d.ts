...
export interface DingtalkConnectionManagerOptions<T extends DingtalkManagedClient> {
    initialClient: T;
    createClient(): T;
...
export declare class DingtalkConnectionManager<T extends DingtalkManagedClient> {
