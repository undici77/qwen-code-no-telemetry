...
export const plugin = {
    ...
    management: {
        fields: [
            ...
            },
            {
                ...
                kind: 'record',
                required: true,
                description: 'Only actions with a template are processed; others are skipped. ' +
    ...
    createChannel: (name, config, bridge, options) => new GitlabChannel(name, config, bridge, options),
};
