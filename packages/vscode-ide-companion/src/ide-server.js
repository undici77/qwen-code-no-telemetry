...
import { CloseDiffRequestSchema, detectIdeFromEnv, IdeContextNotificationSchema, OpenDiffRequestSchema, } from '@qwen-code/qwen-code-core';
...
const IDE_DIR = 'ide';
async function getGlobalIdeDir() {
...
async function writePortAndWorkspace({ context, port, lockFile, authToken, log, }) {
...
const createMcpServer = (diffManager) => {
