 ...
 */
import type { ModelInfo, AvailableCommand, RequestPermissionRequest } from '@agentclientprotocol/sdk';
import type { AskUserQuestionRequest, SlashCommandNotification } from './acpTypes.js';
...
export interface QwenAgentCallbacks {
    ...
    onAskUserQuestion?: (request: AskUserQuestionRequest) => Promise<{
        optionId: string;
