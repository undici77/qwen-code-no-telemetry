...
export const AccountInfoDialog = ({ info, onClose, }) => {
    ...
    return (
    /* Backdrop */
    _jsx("div", { className: "fixed inset-0 z-[1000] flex items-center justify-center", style: { backgroundColor: 'rgba(0,0,0,0.45)' }, onClick: onClose, children: _jsxs("div", { className: "relative w-[480px] rounded-lg border p-5 shadow-xl", style: {
