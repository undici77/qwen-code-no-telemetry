...
export const DISCONTINUED_MESSAGES = {
    ...
    blockedError: 'Qwen OAuth free tier was discontinued on 2026-04-15. Please select a model from another provider or run /auth to switch.',
};
/**
 ...
 */
export function parseAcpModelId(modelId) {
 ...
 */
export function isDiscontinuedModel(modelId) {
...
//# sourceMappingURL=discontinuedModel.js.map