...
import { buildSlashCommandItems, isExpandableSlashCommand, shouldAllowCompletionQuery, } from './slashCommandUtils.js';
const availableCommands = [
    {
        name: 'export',
        description: 'Export current session to a file. Available formats: html, md, json, jsonl.',
        input: null,
    },
    {
        name: 'help',
...
//# sourceMappingURL=slashCommandUtils.test.js.map