...
export declare function expandUserMessageWithImages(message: WebViewMessageBase): {
    messages: WebViewMessage[];
    imagePaths: string[];
};
export declare function applyImageResolution(messages: WebViewMessage[], resolutions: Map<string, string | null>): WebViewMessage[];
export declare function useImagePaste({ onError, }?: {
...
export declare function useImageResolution({ vscode, }: {
    vscode: {
    ...
    mergeResolvedImages: (messages: WebViewMessage[], resolved: Array<{
        path: string;
        src?: string | null;
    }>) => WebViewMessage[];
