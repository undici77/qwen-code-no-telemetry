...
export class PanelManager {
    ...
    async createPanel() {
        ...
        if (existingGroup) {
            ...
            logger.log('[PanelManager] Found existing Qwen Code group, creating panel in same group');
            ...
            try {
                ...
                logger.warn('[PanelManager] Failed to create right editor group (continuing):', error);
                        ...
                        if (group && group.tabs.length === 0) {
                            ...
                            try {
                                ...
                                try {
                                    ...
                                    logger.warn('[PanelManager] Failed to close empty group after Qwen panel disposed:', err);
                                }
                            }
                        }
                    }
                    catch (err) {
                        logger.warn('[PanelManager] Error while trying to close empty Qwen group:', err);
                    }
                }, 50);
            }
        }, null, disposables);
