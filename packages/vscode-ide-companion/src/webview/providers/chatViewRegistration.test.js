...
import { detectSecondarySidebarSupport, registerChatViewProviders, } from './chatViewRegistration.js';
...
describe('registerChatViewProviders', () => {
    ...
    it('registers sidebar and secondary hosts with retained webview context', () => {
        ...
        expect(executeCommand).toHaveBeenCalledWith('setContext', 'qwen-code:supportsSecondarySidebar', true);
    ...
    it('sets context key to false when secondary sidebar is unavailable', () => {
        ...
        expect(executeCommand).toHaveBeenCalledWith('setContext', 'qwen-code:supportsSecondarySidebar', false);
    });
});
