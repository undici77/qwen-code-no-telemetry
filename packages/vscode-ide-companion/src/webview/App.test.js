...
vi.mock('./components/layout/InputForm.js', () => ({
    InputForm: ({ inputText, inputFieldRef, onCompletionSelect, onCompletionFill, }) => (_jsxs("div", { children: [_jsx("div", { "data-testid": "input-field", ref: inputFieldRef, contentEditable: true, suppressContentEditableWarning: true, children: inputText }), _jsx("div", { "data-testid": "input-text", children: inputText }), _jsx("button", { onClick: () => onCompletionSelect(slashSkillsItem), children: "select-skills-command" }), _jsx("button", { onClick: () => onCompletionSelect(secondarySkillItem), children: "select-skill-enter" }), _jsx("button", { onClick: () => onCompletionFill?.(secondarySkillItem), children: "select-skill-tab" }), _jsx("button", { onClick: () => onCompletionSelect(commitCommandItem), children: "select-commit-enter" }), _jsx("button", { onClick: () => onCompletionSelect(clearCommandItem), children: "select-clear-enter" }), _jsx("button", { onClick: () => onCompletionFill?.(clearCommandItem), children: "select-clear-tab" })] })),
}));
