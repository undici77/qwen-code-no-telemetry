...
describe('shouldResolveAgainstWorkspace', () => {
    ...
    it('returns false for Windows drive-letter paths', () => {
        expect(shouldResolveAgainstWorkspace('C:\\workspace\\src\\app.ts')).toBe(false);
        expect(shouldResolveAgainstWorkspace('C:/workspace/src/app.ts')).toBe(false);
    });
    it('returns false for Windows UNC paths', () => {
        expect(shouldResolveAgainstWorkspace('\\\\server\\share\\app.ts')).toBe(false);
    });
});
//# sourceMappingURL=file-path.test.js.map