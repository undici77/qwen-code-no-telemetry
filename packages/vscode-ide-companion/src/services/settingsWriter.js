...
import { ALL_PROVIDERS, AuthType, CUSTOM_API_KEY_ENV_PREFIX, Storage, applyProviderInstallPlan, resolveMetadataKey, } from '@qwen-code/qwen-code-core';
...
function readSettings() {
    ...
    try {
        ...
        // treating it as `{}`.
        console.error(`[settingsWriter] Failed to parse ${settingsPath}; refusing to overwrite a malformed file.`, err);
...
export function snapshotSettingsForRollback() {
    try {
        ...
        console.warn('[settingsWriter] snapshotSettingsForRollback failed; credential rollback disabled:', err instanceof Error ? err.constructor.name : typeof err);
        return null;
    }
}
/**
...
export function readQwenSettingsForVSCode() {
    ...
    try {
        ...
        console.error('[settingsWriter] readQwenSettingsForVSCode failed; returning null:', error);
        return null;
    }
...
export function clearPersistedAuth() {
    try {
        ...
        console.error('[settingsWriter] Failed to clear persisted auth credentials:', error);
    }
}
