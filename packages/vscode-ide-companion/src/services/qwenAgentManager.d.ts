 ...
 */
export declare function extractSessionListItems(
  response: unknown,
...
export declare class QwenAgentManager {
   ...
   */
  getSessionListPaged(params?: { cursor?: number; size?: number }): Promise<{
   ...
   */
  onAskUserQuestion(
    callback: (request: AskUserQuestionRequest) => Promise<{
      optionId: string;
