    ...
    async readSessionsFromDir(chatsDir) {
        ...
        for (const file of jsonSessionFiles) {
            ...
            try {
                ...
                logger.error('[QwenSessionReader] Failed to read session file:', filePath, error);
            }
        }
        ...
        for (const file of jsonlSessionFiles) {
            ...
            try {
                ...
                logger.error('[QwenSessionReader] Failed to read JSONL session file:', filePath, error);
            }
        }
        return sessions;
    }
