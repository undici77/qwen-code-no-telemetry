...
function isLinkedGitWorktree(rootDir) {
...
function appPortOffset(defaultPort) {
...
function numberedPort(instanceNumber, defaultPort) {
...
export function detectDevInstance(rootDir) {
    ...
    if (!isLinkedGitWorktree(rootDir))
        return null;
...
export function resolveDevPort(rootDir, defaultPort, envVar, options = {}) {
...
//# sourceMappingURL=dev-instance.js.map