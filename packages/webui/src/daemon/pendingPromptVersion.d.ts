...
export declare function subscribePendingPromptVersion(
  listener: () => void,
): () => void;
export declare function subscribePendingPromptEvents(
  listener: () => void,
): () => void;
export declare function bumpPendingPromptVersion(): void;
export declare function consumePendingPromptEvents(
