...
export declare function resolveSessionRestoreTimeouts(
  capabilities: DaemonCapabilities | undefined,
): {
  requestTimeoutMs: number;
  watchdogTimeoutMs: number | undefined;
};
export declare function normalizeWorkspaceIdentity(
...
export declare function getConnectionAfterSessionClear(
...
export declare function getPromptSettledKey(
  sessionId: string,
  promptId: string,
): string;
export {};
