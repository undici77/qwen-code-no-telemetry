 ...
 */
import { type DaemonTranscriptBlock, type DaemonTranscriptState, type DaemonTranscriptStore, type DaemonUiEvent } from '@qwen-code/sdk/daemon';
import type { DaemonConnectionState, DaemonPromptStatus, DaemonSessionActions, DaemonSessionContextValue, DaemonSessionNotice, DaemonSessionProviderProps, DaemonSessionOwnerGuard, DaemonWorkspaceEventSignals } from './types.js';
...
declare function projectMainTranscriptEvents(events: DaemonUiEvent[]): DaemonUiEvent[];
export declare const projectMainTranscriptEventsForTesting: typeof projectMainTranscriptEvents;
export declare function DaemonSessionProvider(props: DaemonSessionProviderProps): import("react/jsx-runtime").JSX.Element;
