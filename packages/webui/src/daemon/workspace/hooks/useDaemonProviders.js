 ...
 */
export function useDaemonProviders(options = {}) {
    const workspaceActions = useDaemonWorkspaceActions();
    const load = useCallback(() => workspaceActions.loadProviders(), [workspaceActions]);
...
//# sourceMappingURL=useDaemonProviders.js.map