 ...
 */
export function useDaemonUsageDashboard(options = {}) {
    const { range, heatmapDays, ...resourceOptions } = options;
    const workspaceActions = useDaemonWorkspaceActions();
    const load = useCallback(() => workspaceActions.loadUsageDashboard({ range, heatmapDays }), [workspaceActions, range, heatmapDays]);
...
//# sourceMappingURL=useDaemonUsageDashboard.js.map