...
export declare function useDaemonTools(options?: DaemonResourceOptions): {
    status: import("@qwen-code/sdk/daemon").DaemonWorkspaceToolsStatus | undefined;
    tools: import("@qwen-code/sdk/daemon").DaemonWorkspaceToolStatus[];
    preheat: (timeoutMs?: number) => Promise<import("@qwen-code/sdk").DaemonWorkspaceAcpPreheatResult>;
    setEnabled: (toolName: string, enabled: boolean) => Promise<unknown>;
    reload: () => Promise<import("@qwen-code/sdk/daemon").DaemonWorkspaceToolsStatus | undefined>;
