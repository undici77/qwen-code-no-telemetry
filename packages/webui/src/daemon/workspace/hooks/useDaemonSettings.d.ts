...
export declare function useDaemonSettings(options?: DaemonResourceOptions): {
    status: import("@qwen-code/sdk/daemon").DaemonWorkspaceSettingsStatus | undefined;
    ...
    reload: () => Promise<import("@qwen-code/sdk/daemon").DaemonWorkspaceSettingsStatus | undefined>;
    data: import("@qwen-code/sdk/daemon").DaemonWorkspaceSettingsStatus | undefined;
    loading: boolean;
