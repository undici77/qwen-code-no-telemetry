 ...
 */
import type { DaemonSessionArchiveState, DaemonSessionExportFormat } from '@qwen-code/sdk/daemon';
...
export declare function useDaemonSessions(options?: DaemonSessionsOptions): {
    ...
    reload: () => Promise<import("@qwen-code/sdk/daemon").DaemonSessionSummary[] | undefined>;
    ...
    exportSession: (sessionId: string, format?: DaemonSessionExportFormat) => Promise<import("@qwen-code/sdk/daemon").DaemonSessionExportResult>;
