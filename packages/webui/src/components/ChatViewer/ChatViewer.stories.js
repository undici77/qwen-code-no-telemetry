...
const createMessage = (uuid, type, text, timestamp, model) => ({
    uuid,
    parentUuid: null,
...
export const Default = {
    args: {
        messages: [
            createMessage('1', 'user', 'How do I create a React component?', '2026-01-19T10:00:00.000Z'),
            createMessage('2', 'assistant', "To create a React component, you can use either a function or a class. Here's a simple example of a functional component:\n\n```tsx\nimport React from 'react';\n\nconst MyComponent: React.FC = () => {\n  return <div>Hello, World!</div>;\n};\n\nexport default MyComponent;\n```\n\nThis creates a basic component that renders \"Hello, World!\". You can then use it in other components like `<MyComponent />`.", '2026-01-19T10:00:05.000Z', 'coder-model'),
        ],
    },
};
export const MultiTurn = {
    args: {
        messages: [
            createMessage('1', 'user', 'What is TypeScript?', '2026-01-19T10:00:00.000Z'),
            createMessage('2', 'assistant', 'TypeScript is a strongly typed programming language that builds on JavaScript. It adds optional static typing and class-based object-oriented programming to the language.', '2026-01-19T10:00:05.000Z', 'coder-model'),
            createMessage('3', 'user', 'How do I define an interface?', '2026-01-19T10:00:30.000Z'),
            createMessage('4', 'assistant', 'You can define an interface in TypeScript like this:\n\n```typescript\ninterface User {\n  id: number;\n  name: string;\n  email?: string; // optional property\n}\n\nconst user: User = {\n  id: 1,\n  name: "John Doe"\n};\n```\n\nInterfaces help you define the shape of objects and enable better type checking.', '2026-01-19T10:00:35.000Z', 'coder-model'),
            createMessage('5', 'user', 'Can interfaces extend other interfaces?', '2026-01-19T10:01:00.000Z'),
            createMessage('6', 'assistant', 'Yes! Interfaces can extend one or more interfaces. Here\'s an example:\n\n```typescript\ninterface Person {\n  name: string;\n  age: number;\n}\n\ninterface Employee extends Person {\n  employeeId: string;\n  department: string;\n}\n\n// Employee now has: name, age, employeeId, and department\nconst employee: Employee = {\n  name: "Jane",\n  age: 30,\n  employeeId: "E001",\n  department: "Engineering"\n};\n```\n\nYou can also extend multiple interfaces: `interface Manager extends Person, Employee { ... }`', '2026-01-19T10:01:05.000Z', 'coder-model'),
        ],
    },
};
export const WithCodeBlocks = {
    args: {
        messages: [
            createMessage('1', 'user', 'Show me how to implement a debounce function', '2026-01-19T10:00:00.000Z'),
            createMessage('2', 'assistant', `Here's a debounce function implementation in TypeScript:
...
The debounce function delays the execution until there's a pause in calls for the specified wait time (300ms in this case).`, '2026-01-19T10:00:10.000Z', 'coder-model'),
        ],
    },
};
export const LongConversation = {
    args: {
        messages: [
            createMessage('1', 'user', 'I need to build a REST API. What framework should I use?', '2026-01-19T10:00:00.000Z'),
            createMessage('2', 'assistant', 'For building a REST API, there are several excellent options depending on your needs:\n\n1. **Express.js** - Minimal and flexible, great for small to medium projects\n2. **Fastify** - High performance, excellent for high-throughput APIs\n3. **NestJS** - Full-featured framework with TypeScript, great for enterprise applications\n4. **Hono** - Ultra-fast and lightweight, perfect for edge computing\n\nWhat language/runtime are you planning to use?', '2026-01-19T10:00:05.000Z', 'coder-model'),
            createMessage('3', 'user', 'I want to use TypeScript with Node.js. The API will handle about 10k requests per second.', '2026-01-19T10:00:30.000Z'),
            createMessage('4', 'assistant', "For high throughput (10k req/s) with TypeScript, I recommend **Fastify**. It's designed for performance and has excellent TypeScript support out of the box.\n\nHere's a quick setup:\n\n```bash\nnpm init -y\nnpm install fastify\nnpm install -D typescript @types/node\n```\n\n```typescript\nimport Fastify from 'fastify';\n\nconst app = Fastify({ logger: true });\n\napp.get('/health', async () => {\n  return { status: 'ok' };\n});\n\napp.listen({ port: 3000 }, (err) => {\n  if (err) throw err;\n});\n```\n\nFastify benchmarks show it can handle 30k+ req/s on modest hardware.", '2026-01-19T10:00:35.000Z', 'coder-model'),
            createMessage('5', 'user', 'How do I add request validation?', '2026-01-19T10:01:00.000Z'),
            createMessage('6', 'assistant', "Fastify has built-in JSON Schema validation. Here's how to add it:\n\n```typescript\nconst createUserSchema = {\n  body: {\n    type: 'object',\n    required: ['email', 'name'],\n    properties: {\n      email: { type: 'string', format: 'email' },\n      name: { type: 'string', minLength: 2 },\n      age: { type: 'integer', minimum: 0 }\n    }\n  },\n  response: {\n    201: {\n      type: 'object',\n      properties: {\n        id: { type: 'string' },\n        email: { type: 'string' },\n        name: { type: 'string' }\n      }\n    }\n  }\n};\n\napp.post('/users', { schema: createUserSchema }, async (req, reply) => {\n  const { email, name, age } = req.body;\n  // Create user...\n  reply.code(201).send({ id: '123', email, name });\n});\n```\n\nInvalid requests automatically return 400 with detailed error messages.", '2026-01-19T10:01:10.000Z', 'coder-model'),
        ],
    },
};
export const Empty = {
...
export const SingleUserMessage = {
    args: {
        messages: [
            createMessage('1', 'user', 'This is a single user message without any response yet.', '2026-01-19T10:00:00.000Z'),
        ],
    },
};
export const SingleAssistantMessage = {
    args: {
        messages: [
            createMessage('1', 'assistant', 'This is a standalone assistant message, perhaps from a system prompt or welcome message.', '2026-01-19T10:00:00.000Z', 'coder-model'),
        ],
    },
};
...
Would you like me to apply these changes to your codebase?`,
    ...
    parameters: {
        docs: {
            description: {
                story: 'A real debugging conversation about Chrome extension native host connection issues. Demonstrates multi-turn conversation with code blocks and mixed languages (English and Chinese).',
            },
        },
    },
};
// Helper to create tool call data
const createToolCall = (id, kind, title, status, content, locations) => ({
    toolCallId: id,
    kind,
    title,
    status,
    ...
    args: {
        messages: [
            ...
            },
            {
                ...
                type: 'tool_call',
                toolCall: createToolCall('read-1', 'read', 'package.json', 'completed', [
                    {
                        type: 'content',
                        content: {
                            type: 'text',
  ...
  "devDependencies": {
    ...
    "vite": "^5.0.0"
            ...
            },
            {
                ...
                type: 'tool_call',
                toolCall: createToolCall('edit-1', 'edit', 'package.json', 'completed', [
                    {
                        type: 'diff',
                        path: 'package.json',
...
\`\`\``,
    ...
    parameters: {
        docs: {
            description: {
                story: 'Demonstrates a conversation with Read and Edit tool calls, showing file reading and modification.',
            },
        },
    },
};
// Conversation with Shell commands
export const WithShellCommands = {
    args: {
        messages: [
            {
                uuid: 'sh-1',
            ...
            },
            {
                ...
                message: {
                    role: 'assistant',
                    content: 'Sure, let me create a standard React component folder structure.',
                },
            },
            {
                uuid: 'sh-3',
                ...
                type: 'tool_call',
                toolCall: createToolCall('shell-1', 'bash', 'mkdir -p src/components/Button', 'completed', [
                    {
                        type: 'content',
                        content: {
                            type: 'text',
            ...
            },
            {
                ...
                type: 'tool_call',
                toolCall: createToolCall('write-1', 'write', 'src/components/Button/Button.tsx', 'completed', [
                    {
                        type: 'content',
                        content: {
                            type: 'text',
    ...
    <button className={\`button button--\${variant}\`} onClick={onClick}>
      {children}
            ...
            },
            {
                ...
                type: 'tool_call',
                toolCall: createToolCall('write-2', 'write', 'src/components/Button/Button.css', 'completed', [
                    {
                        type: 'content',
                        content: {
                            type: 'text',
...
.button--secondary {
  ...
  color: #1f2937;
            ...
            },
            {
                ...
                type: 'tool_call',
                toolCall: createToolCall('write-3', 'write', 'src/components/Button/index.ts', 'completed', [
                    {
                        type: 'content',
                        content: {
                            type: 'text',
...
\`\`\``,
    ...
    parameters: {
        docs: {
            description: {
                story: 'Shows a conversation with Shell and Write tool calls, creating a complete component structure.',
            },
        },
    },
};
// Conversation with Search and multiple file reads
export const WithSearchAndRead = {
    args: {
        messages: [
            {
                uuid: 'sr-1',
            ...
            },
            {
                ...
                message: {
                    role: 'assistant',
                    content: 'Sure, let me search for all files that use useState in the project.',
                },
            },
            {
                uuid: 'sr-3',
                ...
                type: 'tool_call',
                toolCall: createToolCall('search-1', 'grep', 'useState', 'completed', [
                    {
                        type: 'content',
                        content: {
                            type: 'text',
...
Would you like me to look at any specific file in detail?`,
            ...
            },
            {
                ...
                type: 'tool_call',
                toolCall: createToolCall('read-2', 'read', 'src/components/Counter.tsx', 'completed', [
                    {
                        type: 'content',
                        content: {
                            type: 'text',
...
Would you like me to optimize this component?`,
    ...
    parameters: {
        docs: {
            description: {
                story: 'Demonstrates Search (grep) and Read tool calls in a code exploration conversation.',
            },
        },
    },
};
// Conversation with Todo/Plan updates
export const WithPlanUpdates = {
    args: {
        messages: [
            {
                uuid: 'plan-1',
            ...
            },
            {
                ...
                message: {
                    role: 'assistant',
                    content: 'Sure, this is a complex task. Let me first create a plan to track progress.',
                },
            },
            {
                uuid: 'plan-3',
                ...
                type: 'tool_call',
                toolCall: createToolCall('todo-1', 'todowrite', 'Create refactoring plan', 'completed', [
                    {
                        type: 'content',
                        content: {
                            type: 'text',
            ...
            },
            {
                ...
                message: {
                    role: 'assistant',
                    content: 'I have created the refactoring plan. Now let me analyze the existing auth code.',
                },
            },
            {
                uuid: 'plan-5',
                ...
                type: 'tool_call',
                toolCall: createToolCall('search-2', 'glob', '**/auth/**', 'completed', undefined, [
            ...
            },
            {
                ...
                type: 'tool_call',
                toolCall: createToolCall('read-3', 'read', 'src/auth/index.ts', 'completed', [
                    {
                        type: 'content',
                        content: {
                            type: 'text',
...
Should I continue with the implementation?`,
    ...
    parameters: {
        docs: {
            description: {
                story: 'Shows a complex refactoring task with Todo/Plan updates, file search, and code analysis.',
            },
        },
    },
};
export const LightTheme = {
    args: {
        messages: [
            createMessage('1', 'user', 'Show me how to use the light theme.', '2026-01-19T10:00:00.000Z'),
            createMessage('2', 'assistant', 'The ChatViewer supports light, dark, and auto themes. Set `theme="light"` for light mode styling.', '2026-01-19T10:00:05.000Z', 'coder-model'),
        ],
        theme: 'light',
    },
    decorators: [
...
export const AutoScrollDisabled = {
    args: {
        messages: [
            createMessage('1', 'user', 'This story has auto-scroll disabled.', '2026-01-19T10:00:00.000Z'),
            createMessage('2', 'assistant', 'When `autoScroll={false}`, the viewer will not automatically scroll to the bottom when new messages arrive. This is useful when you want users to manually control the scroll position.', '2026-01-19T10:00:05.000Z', 'coder-model'),
        ],
        autoScroll: false,
    },
};
export const EmptyWithoutIcon = {
    args: {
        messages: [],
...
const WithRefControlTemplate = () => {
    ...
    const messages = Array.from({ length: 20 }, (_, i) => createMessage(String(i + 1), i % 2 === 0 ? 'user' : 'assistant', i % 2 === 0
        ? `Question ${Math.floor(i / 2) + 1}: How does feature ${Math.floor(i / 2) + 1} work?`
        : `This is the answer to question ${Math.floor(i / 2) + 1}. The feature works by processing data through multiple stages and returning the result to the caller.`, new Date(2026, 0, 19, 10, i).toISOString(), i % 2 === 1 ? 'coder-model' : undefined));
    return (_jsxs("div", { style: {
            display: 'flex',
            flexDirection: 'column',
            height: '500px',
            gap: '10px',
        }, children: [_jsxs("div", { style: { display: 'flex', gap: '10px' }, children: [_jsx("button", { onClick: () => chatRef.current?.scrollToTop('smooth'), style: { padding: '8px 16px', cursor: 'pointer' }, children: "Scroll to Top" }), _jsx("button", { onClick: () => chatRef.current?.scrollToBottom('smooth'), style: { padding: '8px 16px', cursor: 'pointer' }, children: "Scroll to Bottom" })] }), _jsx("div", { style: { flex: 1 }, children: _jsx(ChatViewer, { ref: chatRef, messages: messages, autoScroll: false }) })] }));
};
export const WithRefControl = {
    render: () => _jsx(WithRefControlTemplate, {}),
    parameters: {
        docs: {
            description: {
                story: 'Demonstrates programmatic scroll control using the `ref` prop. The `ChatViewerHandle` provides `scrollToTop()`, `scrollToBottom()`, and `getScrollContainer()` methods.',
            },
        },
    },
};
...
const PlaygroundTemplate = () => {
    ...
    const parseAndRender = useCallback((input) => {
        try {
    ...
    return (_jsxs("div", { style: {
            ...
            fontFamily: 'system-ui, sans-serif',
                    ...
                    minWidth: 0,
                            ...
                            alignItems: 'center',
                            gap: '8px',
                        }, children: [_jsx("h3", { style: { margin: 0, fontSize: '14px', fontWeight: 600 }, children: "JSON Input (Messages Array)" }), _jsxs("div", { style: { display: 'flex', alignItems: 'center', gap: '12px' }, children: [_jsxs("label", { style: {
                                            display: 'flex',
                                            alignItems: 'center',
                                            gap: '4px',
                                            fontSize: '12px',
                                            ...
                                            cursor: 'pointer',
                                        }, children: [_jsx("input", { type: "checkbox", checked: autoRender, onChange: (e) => setAutoRender(e.target.checked), style: { cursor: 'pointer' } }), "Auto Render"] }), !autoRender && (_jsx("button", { onClick: () => parseAndRender(jsonInput), style: {
                                            padding: '6px 12px',
                                            background: '#3b82f6',
                                            color: 'white',
                                            border: 'none',
                                            ...
                                            fontSize: '13px',
                                            fontWeight: 500,
                                        }, children: "Render" }))] })] }), _jsx("textarea", { value: jsonInput, onChange: (e) => setJsonInput(e.target.value), style: {
                            flex: 1,
                            padding: '12px',
                            ...
                            resize: 'none',
                            outline: 'none',
                        }, placeholder: "Paste your JSON messages array here..." }), error && (_jsxs("div", { style: {
                            padding: '8px 12px',
                            ...
                            color: '#ef4444',
                            fontSize: '13px',
                        }, children: ["Error: ", error] })), _jsxs("div", { style: {
                            fontSize: '11px',
                            color: 'var(--app-secondary-foreground, #a1a1aa)',
                            lineHeight: 1.5,
                        }, children: [_jsx("strong", { children: "Supported message types:" }), _jsx("br", {}), "\u2022 ", _jsx("code", { children: "user" }), " - User messages with", ' ', _jsx("code", { children: "message.parts[].text" }), " or ", _jsx("code", { children: "message.content" }), _jsx("br", {}), "\u2022 ", _jsx("code", { children: "assistant" }), " - AI responses", _jsx("br", {}), "\u2022 ", _jsx("code", { children: "tool_call" }), " - Tool calls with", ' ', _jsx("code", { children: "toolCall.kind" }), " (read, write, edit, bash, grep, etc.)"] })] }), _jsxs("div", { style: {
                    display: 'flex',
                    flexDirection: 'column',
                    gap: '8px',
                    minWidth: 0,
                }, children: [_jsx("h3", { style: { margin: 0, fontSize: '14px', fontWeight: 600 }, children: "ChatViewer Preview" }), _jsx("div", { style: {
                            flex: 1,
                            border: '1px solid var(--app-border, #3f3f46)',
                            borderRadius: '6px',
                            overflow: 'hidden',
                        }, children: _jsx(ChatViewer, { messages: messages, emptyMessage: "Paste JSON to preview" }) })] })] }));
};
export const Playground = {
    render: () => _jsx(PlaygroundTemplate, {}),
    parameters: {
        layout: 'fullscreen',
        docs: {
            description: {
...
//# sourceMappingURL=ChatViewer.stories.js.map