 ...
 */
export const ExecuteWithDescription = {
    args: {
        toolCall: {
 ...
 */
export const ExecuteLongOutput = {
    args: {
        toolCall: {
...
//# sourceMappingURL=ShellToolCall.stories.js.map