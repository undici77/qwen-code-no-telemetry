...
describe('GenericToolCall collapsible output', () => {
    ...
    const renderOutput = (output) => {
        act(() => {
            root?.render(_jsx(GenericToolCall, { toolCall: {
    ...
    it('preserves and collapses output longer than 400 characters', () => {
        ...
        expect(container?.querySelector('button[aria-label="Expand output"]')).not.toBeNull();
    });
...
//# sourceMappingURL=GenericToolCall.test.js.map