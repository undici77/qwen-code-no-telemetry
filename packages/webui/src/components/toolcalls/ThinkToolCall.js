...
import { CollapsibleOutput, ToolCallContainer, ToolCallCard, ToolCallRow, groupContent, } from './shared/index.js';
/**
...
export const ThinkToolCall = ({ toolCall, isFirst, isLast, }) => {
    ...
    if (textOutputs.length > 0) {
        ...
        if (isLong) {
            ...
            return (_jsx(ToolCallCard, { icon: "\uD83D\uDCAD", children: _jsx(ToolCallRow, { label: "Think", children: isCollapsible ? (_jsx(CollapsibleOutput, { isCollapsible: true, className: "italic opacity-90 leading-relaxed", children: thoughts })) : (_jsx("div", { className: "italic opacity-90 leading-relaxed", children: thoughts })) }) }));
        }
