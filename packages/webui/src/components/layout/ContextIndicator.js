 ...
 * ```
 */
export const ContextIndicator = ({ contextUsage, }) => {
    if (!contextUsage) {
        return null;
    }
    ...
    const percentUsed = Math.max(0, Math.min(100, 100 - contextUsage.percentLeft));
    ...
    const tooltipContent = (_jsx("div", { className: "flex flex-col gap-1", children: _jsxs("div", { className: "font-medium", children: [percentFormatted, "% \u2022 ", formatNumber(contextUsage.usedTokens), " /", ' ', formatNumber(contextUsage.tokenLimit), " context used"] }) }));
    const ariaLabel = `${percentFormatted}% • ${formatNumber(contextUsage.usedTokens)} / ${formatNumber(contextUsage.tokenLimit)} context used`;
    return (_jsx(Tooltip, { content: tooltipContent, position: "top", children: _jsx("button", { type: "button", className: "btn-icon-compact", "aria-label": ariaLabel, children: _jsxs("svg", { viewBox: "0 0 24 24", "aria-hidden": "true", role: "presentation", children: [_jsx("circle", { className: "context-indicator__track", cx: "12", cy: "12", r: radius, fill: "none", stroke: "currentColor", opacity: "0.2" }), _jsx("circle", { className: "context-indicator__progress", cx: "12", cy: "12", r: radius, fill: "none", stroke: "currentColor", strokeWidth: "2", strokeDasharray: circumference, strokeDashoffset: dashOffset, style: {
