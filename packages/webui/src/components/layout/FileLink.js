 ...
 * ```
 */
export const FileLink = ({ path, line, column, showFullPath = false, className = '', disableClick = false, }) => {
    ...
    return (_jsxs("button", { type: "button", className: [
            ...
            .filter(Boolean)
            .join(' '), onClick: handleClick, onKeyDown: handleKeyDown, title: fullDisplayText, "aria-label": `Open file: ${fullDisplayText}`, "aria-disabled": isDisabled, disabled: isDisabled, children: [_jsx("span", { className: "file-link-path", children: displayPath }), line !== null && line !== undefined && (_jsxs("span", { className: "file-link-location opacity-70 text-[0.9em] font-normal dark:opacity-60", children: [":", line, column !== null && column !== undefined && _jsxs(_Fragment, { children: [":", column] })] }))] }));
};
