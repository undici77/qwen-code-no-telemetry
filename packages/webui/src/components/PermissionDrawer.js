...
export const PermissionDrawer = ({ isOpen, options, toolCall, onResponse, onClose, }) => {
    ...
    return (_jsx("div", { className: "fixed inset-x-0 bottom-0 z-[1000] p-2", children: _jsxs("div", { ref: containerRef, className: `relative flex flex-col rounded-large border p-2 outline-none animate-slide-up${planText ? ' max-h-[60vh]' : ''}`, style: {
