...
export const PermissionDrawer = ({ isOpen, options, toolCall, onResponse, onClose, }) => {
    ...
    return (_jsx("div", { className: "fixed inset-x-0 bottom-0 z-[1000] p-2", children: _jsxs("div", { ref: containerRef, className: `relative flex flex-col rounded-large border p-2 outline-none animate-slide-up${planText || editReviewText ? ' max-h-[60vh]' : ''}`, style: {
                ...
                borderColor: 'var(--app-input-border)',
                            ...
                            className: "text-[13px] font-normal text-[var(--app-secondary-foreground)] opacity-90 font-mono whitespace-normal break-words q-line-clamp-3 mb-2", style: {
                                ...
                                marginBottom: '6px',
                            }, title: toolCall.title, children: toolCall.title }))] }), planText && (_jsx("div", { className: "relative z-[1] overflow-y-auto mb-2 rounded-[4px] max-h-[40vh] py-2 px-3 text-[13px] leading-normal bg-[var(--app-primary-background)] border border-[var(--app-input-border)] [scrollbar-width:thin] [&::-webkit-scrollbar]:w-1.5 [&::-webkit-scrollbar-track]:bg-transparent [&::-webkit-scrollbar-thumb]:rounded-full [&::-webkit-scrollbar-thumb]:bg-[var(--app-foreground-muted)]/30", children: _jsx(MarkdownRenderer, { content: planText }) })), editReviewText && (_jsx("pre", { className: "relative z-[1] overflow-y-auto mb-2 rounded-[4px] max-h-[40vh] py-2 px-3 text-[13px] leading-normal whitespace-pre-wrap break-words bg-[var(--app-primary-background)] border border-[var(--app-input-border)] [scrollbar-width:thin] [&::-webkit-scrollbar]:w-1.5 [&::-webkit-scrollbar-track]:bg-transparent [&::-webkit-scrollbar-thumb]:rounded-full [&::-webkit-scrollbar-thumb]:bg-[var(--app-foreground-muted)]/30", children: editReviewText })), _jsx("div", { className: "relative z-[1] flex flex-col gap-1 pb-1", children: options.map((option, index) => {
