...
#   .\install.ps1 v0.24.1-no-telemetry -Source github
#
# One-liner:
#   iwr https://undici77.it/install.ps1 -OutFile install.ps1; .\install.ps1 v0.24.1-no-telemetry
...
function Show-Usage {
    ...
    Write-Host ""
    Write-Host "Examples:"
    Write-Host "  .\install.ps1 v0.24.1-no-telemetry"
    Write-Host "  .\install.ps1 v0.24.1-no-telemetry -Source github"
    Write-Host ""
}
