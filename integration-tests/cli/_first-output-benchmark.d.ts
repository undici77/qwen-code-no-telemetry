...
export type BenchmarkDecision =
  ...
  | 'inconclusive'
  | 'invalid';
export declare function parseBenchmarkPostSessionDwell(
  configuredValue?: string,
): 0 | 100 | 500;
export declare function measuredPairCountForDwell(
...
export declare function classifyFirstOutputEvent(
  event: BenchmarkDaemonEvent,
  promptId: string,
...
export declare function percentiles(
  values: readonly number[],
): PercentileSummary | null;
export declare function nullablePercentiles(
...
export declare function pairedCandidateControlStats(
  samples: readonly PairedMetricSample[],
  options: PairedStatsOptions,
): PairedCandidateControlStats;
export declare const FIRST_OUTPUT_FAILURE_CODES: readonly [
...
export declare function validatePromptAcceptance(
  value: unknown,
): PromptAcceptanceValidation;
export declare function validateExpectedFinalText(
  actual: string | null,
  expected: string,
...
export declare function evaluateSingleBundlePrototypeGate(
...
export declare function computeFirstOutputSessionTimings(
  timestamps: FirstOutputSessionTimestamps,
  processStartedAtMs: number,
  daemonPromptQueueWaitMs: number | null,
): FirstOutputSessionTimings;
export declare function findInvalidTimings(
...
export declare function renderFirstOutputBenchmarkMarkdown(
