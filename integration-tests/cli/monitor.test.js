...
describe('monitor-tool', () => {
    ...
    it('should have monitor tool registered', async () => {
        ...
        const result = await rig.run('Do you have access to a tool called "monitor"? Reply with just "yes" or "no".');
    ...
    it('should call monitor tool when asked to watch a command', async () => {
        ...
        const resultPromise = rig.run('Use the monitor tool to watch this command: for i in 1 2 3; do echo "EVENT_$i"; sleep 0.3; done. ' +
