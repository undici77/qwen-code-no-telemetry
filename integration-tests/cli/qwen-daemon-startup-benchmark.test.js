...
(SKIP ? describe.skip : describe)(
  ...
  () => {
    ...
    afterAll(() => {
      ...
      console.log(
        `  External command -> listening: ${formatPercentiles(snapshot.externalCommandToListening)}`,
      );
      console.log(
        `  process -> listening:          ${formatPercentiles(snapshot.processToListen)}`,
      );
      console.log(
        `  runQwenServe -> listening:     ${formatPercentiles(snapshot.runQwenServeToListen)}`,
      );
