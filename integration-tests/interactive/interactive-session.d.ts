...
export declare class InteractiveSession {
     ...
     * ```
     */
    static start(options?: InteractiveSessionOptions): Promise<InteractiveSession>;
     ...
     */
    waitForScreen(predicate: (screen: string) => boolean, description: string, timeout?: number): Promise<string>;
