...
describe('Hooks System Integration', () => {
    ...
    describe('UserPromptSubmit Hooks', () => {
        describe('Allow Decision', () => {
            it('should allow prompt when hook returns allow decision', async () => {
                const hookScript = 'echo \'{"decision": "allow", "reason": "approved by hook"}\'';
            ...
            it('should allow tool execution with allow decision and verify tool was called', async () => {
                const hookScript = 'echo \'{"decision": "allow", "reason": "Tool execution approved"}\'';
        ...
        describe('Block Decision', () => {
            it('should block prompt when hook returns block decision', async () => {
                const blockScript = 'echo \'{"decision": "block", "reason": "Prompt blocked by security policy"}\'';
            ...
            it('should block tool execution when hook returns block and verify no tool was called', async () => {
                const blockScript = '(echo "hook_called" >> hook_invoke_count.txt &) ; echo \'{"decision": "block", "reason": "File writing blocked by security policy"}\'';
                ...
                // When UserPromptSubmit hook blocks, CLI exits with non-zero code
                await expect(rig.run('Create a file test.txt with "hello"')).rejects.toThrow(/block/i);
        ...
        describe('Modify Prompt', () => {
            it('should use modified prompt when hook provides modification', async () => {
                const modifyScript = 'echo \'{"decision": "allow", "hookSpecificOutput": {"hookEventName": "UserPromptSubmit", "modifiedPrompt": "Modified prompt content", "additionalContext": "Context added by hook"}}\'';
        ...
        describe('Additional Context', () => {
            it('should include additional context in response when hook provides it', async () => {
                const contextScript = 'echo \'{"decision": "allow", "hookSpecificOutput": {"additionalContext": "Extra context information from hook"}}\'';
        ...
        describe('Input Format Validation', () => {
            it('should receive properly formatted input when hook is called', async () => {
                const inputValidationScript = 'echo \'{"decision": "allow", "hookSpecificOutput": {"hookEventName": "UserPromptSubmit", "additionalContext": "Valid input format"}}\'';
        ...
        describe('System Message', () => {
            it('should include system message in response when hook provides it', async () => {
                const systemMsgScript = 'echo \'{"decision": "allow", "systemMessage": "This is a system message from hook"}\'';
        ...
        describe('Multiple UserPromptSubmit Hooks', () => {
            it('should block when one of multiple parallel hooks returns block', async () => {
                ...
                const blockScript = 'echo \'{"decision": "block", "reason": "Blocked by security policy"}\'';
            ...
            it('should block when first sequential hook returns block', async () => {
                ...
                const blockScript = 'echo \'{"decision": "block", "reason": "First hook blocks"}\'';
            ...
            it('should block when second sequential hook returns block', async () => {
                ...
                const allowScript = 'echo \'{"decision": "allow", "reason": "First allows"}\'';
                const blockScript = 'echo \'{"decision": "block", "reason": "Second hook blocks"}\'';
            ...
            it('should handle multiple hooks all returning allow', async () => {
                const allow1Script = 'echo \'{"decision": "allow", "reason": "First allows"}\'';
                const allow2Script = 'echo \'{"decision": "allow", "reason": "Second allows"}\'';
                const allow3Script = 'echo \'{"decision": "allow", "reason": "Third allows"}\'';
            ...
            it('should handle multiple hooks all returning block', async () => {
                const block1Script = 'echo \'{"decision": "block", "reason": "First blocks"}\'';
                const block2Script = 'echo \'{"decision": "block", "reason": "Second blocks"}\'';
            ...
            it('should concatenate additional context from multiple hooks', async () => {
                const context1Script = 'echo \'{"decision": "allow", "hookSpecificOutput": {"additionalContext": "context from hook 1"}}\'';
                const context2Script = 'echo \'{"decision": "allow", "hookSpecificOutput": {"additionalContext": "context from hook 2"}}\'';
            ...
            it('should handle hook timeout alongside blocking hook', async () => {
                const blockScript = 'echo \'{"decision": "block", "reason": "Blocked while other times out"}\'';
            ...
            it('should handle multiple hook groups with different configurations', async () => {
                const allow1Script = 'echo \'{"decision": "allow", "reason": "Group 1 allows"}\'';
                const allow2Script = 'echo \'{"decision": "allow", "reason": "Group 2 allows"}\'';
            ...
            it('should block when one group blocks in multiple hook groups', async () => {
                const allowScript = 'echo \'{"decision": "allow", "reason": "Group 1 allows"}\'';
                const blockScript = 'echo \'{"decision": "block", "reason": "Group 2 blocks"}\'';
            ...
            it('should handle modified prompt from multiple hooks', async () => {
                const modify1Script = 'echo \'{"decision": "allow", "hookSpecificOutput": {"modifiedPrompt": "Modified by hook 1"}}\'';
                const modify2Script = 'echo \'{"decision": "allow", "hookSpecificOutput": {"modifiedPrompt": "Modified by hook 2"}}\'';
            ...
            it('should handle system messages from multiple hooks', async () => {
                const msg1Script = 'echo \'{"decision": "allow", "systemMessage": "System message 1"}\'';
                const msg2Script = 'echo \'{"decision": "allow", "systemMessage": "System message 2"}\'';
    ...
    describe('Stop Hooks', () => {
        describe('Allow Decision', () => {
            it('should allow stopping when hook returns allow decision', async () => {
                const allowStopScript = 'echo \'{"decision": "allow", "reason": "Stop allowed"}\'';
            ...
            it('should allow stopping and verify final response is produced', async () => {
                const allowFinalScript = 'echo \'{"decision": "allow", "hookSpecificOutput": {"additionalContext": "Final context from stop hook"}}\'';
        ...
        describe('Block Decision', () => {
            it('should continue execution when hook returns block decision', async () => {
                ...
                const blockStopScript = '(echo "hook_called" >> hook_invoke_count.txt &) ; echo \'{"decision": "block", "reason": "Stop blocked by security policy"}\'';
            ...
            it('should continue execution with custom reason', async () => {
                // Stop hook's block decision means "block stopping" (i.e., force continuation)
                const blockReasonScript = '(echo "hook_called" >> hook_invoke_count.txt &) ; echo \'{"decision": "block", "reason": "Custom block reason: task incomplete"}\'';
        ...
        describe('Additional Context', () => {
            it('should include additional context in final response', async () => {
                const contextScript = 'echo \'{"decision": "allow", "hookSpecificOutput": {"additionalContext": "Final context from hook"}}\'';
            ...
            it('should concatenate multiple additionalContext from multiple hooks', async () => {
                const context1Script = 'echo \'{"decision": "allow", "hookSpecificOutput": {"additionalContext": "context1"}}\'';
                const context2Script = 'echo \'{"decision": "allow", "hookSpecificOutput": {"additionalContext": "context2"}}\'';
        ...
        describe('System Message', () => {
            it('should include system message in final response', async () => {
                const systemMsgScript = 'echo \'{"decision": "allow", "systemMessage": "Final system message from stop hook"}\'';
        ...
        describe('Multiple Stop Hooks', () => {
            it('should continue execution when one of multiple parallel stop hooks returns block', async () => {
                // Stop hook's block decision means "block stopping" (i.e., force continuation)
                const allowScript = 'echo \'{"decision": "allow", "reason": "Stop allowed"}\'';
                // Write to a file to count hook invocations, then echo the decision
                const blockScript = 'echo "hook_called" >> hook_invoke_count.txt; echo \'{"decision": "block", "reason": "Stop blocked by security policy"}\'';
                ...
                // When Stop hook blocks, agent continues execution normally (with max turns to prevent infinite loop)
                const result = await rig.run('Say multi stop', '--max-session-turns', '3');
                // Verify that execution completed successfully (not blocked by Stop hook)
                // This confirms: 1) Agent could execute after Stop hook blocked, 2) Session terminated normally
                const hookInvokeCount = rig
                    .readFile('hook_invoke_count.txt')
            ...
            it('should continue execution when first sequential stop hook returns block', async () => {
                // Stop hook's block decision means "block stopping" (i.e., force continuation)
                const blockScript = '(echo "hook_called" >> hook_invoke_count.txt &) ; echo \'{"decision": "block", "reason": "First hook blocks stop"}\'';
                const allowScript = '(echo "hook_called" >> hook_invoke_count.txt &) ; echo \'{"decision": "allow", "reason": "This should still run"}\'';
                ...
                // When Stop hook blocks, agent continues execution normally (with max turns to prevent infinite loop)
                const result = await rig.run('Say sequential stop', '--max-session-turns', '3');
                // Verify that execution completed successfully (not blocked by Stop hook)
                // This confirms: 1) Agent could execute after Stop hook blocked, 2) Session terminated normally
                const hookInvokeCount = rig
                    .readFile('hook_invoke_count.txt')
            ...
            it('should continue execution when second sequential stop hook returns block', async () => {
                // Stop hook's block decision means "block stopping" (i.e., force continuation)
                const allowScript = '(echo "hook_called" >> hook_invoke_count.txt &) ; echo \'{"decision": "allow", "reason": "First allows"}\'';
                const blockScript = '(echo "hook_called" >> hook_invoke_count.txt &) ; echo \'{"decision": "block", "reason": "Second hook blocks stop"}\'';
                ...
                // When Stop hook blocks, agent continues execution normally (with max turns to prevent infinite loop)
                const result = await rig.run('Say seq second blocks', '--max-session-turns', '3');
                // Verify that execution completed successfully (not blocked by Stop hook)
                // This confirms: 1) Agent could execute after Stop hook blocked, 2) Session terminated normally
                const hookInvokeCount = rig
                    .readFile('hook_invoke_count.txt')
            ...
            it('should handle multiple stop hooks all returning block', async () => {
                const block1Script = '(echo "hook_called" >> hook_invoke_count.txt &) ; echo \'{"decision": "block", "reason": "First blocks"}\'';
                const block2Script = '(echo "hook_called" >> hook_invoke_count.txt &) ; echo \'{"decision": "block", "reason": "Second blocks"}\'';
                ...
                const _result = await rig.run('Say all block', '--max-session-turns', '3');
                // Verify Stop hook was invoked multiple times (indicating multiple rounds)
                const hookInvokeCount = rig
                    .readFile('hook_invoke_count.txt')
                    .split('\n')
    ...
    describe('Multiple Hooks', () => {
        describe('Sequential Execution', () => {
            it('should execute hooks sequentially when sequential: true', async () => {
                const hook1Script = 'echo \'{"decision": "allow", "hookSpecificOutput": {"additionalContext": "first"}}\'';
                const hook2Script = 'echo \'{"decision": "allow", "hookSpecificOutput": {"additionalContext": "second"}}\'';
            ...
            it('should stop at first blocking hook and not execute subsequent', async () => {
                const blockScript = 'echo \'{"decision": "block", "reason": "Blocked by first hook"}\'';
                ...
                await expect(rig.run('Create a file')).rejects.toThrow(/blocked|Blocked by first hook/i);
            });
            it('should pass output from first hook to second hook input', async () => {
                const passScript1 = 'echo \'{"decision": "allow", "hookSpecificOutput": {"additionalContext": "from first", "passthrough": "data"}}\'';
                const passScript2 = 'echo \'{"decision": "allow", "hookSpecificOutput": {"additionalContext": "received passthrough"}}\'';
        ...
        describe('Parallel Execution', () => {
            ...
            it('should handle mixed success/failure results from parallel hooks', async () => {
                ...
                await expect(rig.run('Say mixed')).rejects.toThrow(/blocked|error|nonexistent/i);
            });
    ...
    describe('SessionStart Hooks', () => {
        describe('Single SessionStart Hook', () => {
            it('should execute SessionStart hook on session startup', async () => {
                const sessionStartScript = 'echo  \'{decision: "allow", hookSpecificOutput: {additionalContext: "Session started successfully"}}\'';
            ...
            it('should inject additional context from SessionStart hook', async () => {
                const contextScript = 'echo \'{"decision": "allow", "hookSpecificOutput": {"additionalContext": "Project context: TypeScript React app with strict linting rules"}}\'';
            ...
            it('should handle SessionStart hook with system message', async () => {
                const systemMsgScript = 'echo \'{"decision": "allow", "systemMessage": "Welcome! Session initialized with custom settings"}\'';
        ...
        describe('SessionStart Matcher Scenarios', () => {
            it('should match startup source with matcher', async () => {
                const startupScript = 'echo \'{"decision": "allow", "hookSpecificOutput": {"additionalContext": "Startup hook executed"}}\'';
                const otherScript = 'echo \'{"decision": "allow", "hookSpecificOutput": {"additionalContext": "Other hook executed"}}\'';
            ...
            it('should match multiple sources with regex matcher', async () => {
                const multiSourceScript = 'echo \'{"decision": "allow", "hookSpecificOutput": {"additionalContext": "Multi-source hook executed"}}\'';
            ...
            it('should match all sources with wildcard matcher', async () => {
                const wildcardScript = 'echo \'{"decision": "allow", "hookSpecificOutput": {"additionalContext": "Wildcard hook executed"}}\'';
            ...
            it('should not execute when matcher does not match', async () => {
                const noMatchScript = 'echo \'{"decision": "allow", "hookSpecificOutput": {"additionalContext": "Should not execute"}}\'';
            ...
            it('should match clear source with matcher', async () => {
                const clearScript = 'echo \'{"decision": "allow", "hookSpecificOutput": {"additionalContext": "Clear hook executed"}}\'';
            ...
            it('should match compact source with matcher', async () => {
                const compactScript = 'echo \'{"decision": "allow", "hookSpecificOutput": {"additionalContext": "Compact hook executed"}}\'';
            ...
            it('should match all four sources with regex matcher', async () => {
                const allSourcesScript = 'echo \'{"decision": "allow", "hookSpecificOutput": {"additionalContext": "All sources hook executed"}}\'';
            ...
            it('should match startup and resume but not clear or compact', async () => {
                const startupResumeScript = 'echo  \'{decision: "allow", hookSpecificOutput: {additionalContext: "Startup/Resume hook executed"}}\'';
                const clearCompactScript = 'echo \'{"decision": "allow", "hookSpecificOutput": {"additionalContext": "Clear/Compact hook executed"}}\'';
            ...
            it('should handle invalid regex in matcher gracefully', async () => {
                const invalidRegexScript = 'echo \'{"decision": "allow", "hookSpecificOutput": {"additionalContext": "Fallback to exact match"}}\'';
            ...
            it('should match all session start sources with individual hooks', async () => {
                const startupScript = 'echo \'{"decision": "allow", "hookSpecificOutput": {"additionalContext": "Startup triggered"}}\'';
                const resumeScript = 'echo \'{"decision": "allow", "hookSpecificOutput": {"additionalContext": "Resume triggered"}}\'';
                const clearScript = 'echo \'{"decision": "allow", "hookSpecificOutput": {"additionalContext": "Clear triggered"}}\'';
                const compactScript = 'echo \'{"decision": "allow", "hookSpecificOutput": {"additionalContext": "Compact triggered"}}\'';
        ...
        describe('Multiple SessionStart Hooks', () => {
            it('should execute multiple parallel SessionStart hooks', async () => {
                const script1 = 'echo \'{"decision": "allow", "hookSpecificOutput": {"additionalContext": "Parallel hook 1"}}\'';
                const script2 = 'echo \'{"decision": "allow", "hookSpecificOutput": {"additionalContext": "Parallel hook 2"}}\'';
                const script3 = 'echo \'{"decision": "allow", "hookSpecificOutput": {"additionalContext": "Parallel hook 3"}}\'';
            ...
            it('should execute sequential SessionStart hooks in order', async () => {
                const script1 = 'echo \'{"decision": "allow", "hookSpecificOutput": {"additionalContext": "Sequential hook 1"}}\'';
                const script2 = 'echo \'{"decision": "allow", "hookSpecificOutput": {"additionalContext": "Sequential hook 2"}}\'';
            ...
            it('should concatenate additional context from multiple hooks', async () => {
                const context1 = 'echo \'{"decision": "allow", "hookSpecificOutput": {"additionalContext": "Context from hook 1"}}\'';
                const context2 = 'echo \'{"decision": "allow", "hookSpecificOutput": {"additionalContext": "Context from hook 2"}}\'';
            ...
            it('should handle system messages from multiple hooks', async () => {
                const msg1 = 'echo  \'{"decision": "allow", "systemMessage": "System message 1"}\'';
                const msg2 = 'echo \'{"decision": "allow", "systemMessage": "System message 2"}\'';
    ...
    describe('SessionEnd Hooks', () => {
        describe('Single SessionEnd Hook', () => {
            ...
            it('should execute SessionEnd hook with cleanup tasks', async () => {
                const cleanupScript = 'echo {decision: "allow", hookSpecificOutput: {additionalContext: "Cleanup completed"}}';
        ...
        describe('SessionEnd Matcher Scenarios', () => {
            it('should match specific exit reason with matcher', async () => {
                const clearScript = 'echo \'{"decision": "allow", "hookSpecificOutput": {"additionalContext": "Clear hook executed"}}\'';
                const logoutScript = 'echo \'{"decision": "allow", "hookSpecificOutput": {"additionalContext": "Logout hook executed"}}\'';
            ...
            it('should match multiple exit reasons with regex matcher', async () => {
                const multiReasonScript = 'echo \'{"decision": "allow", "hookSpecificOutput": {"additionalContext": "Multi-reason hook executed"}}\'';
            ...
            it('should match all reasons with wildcard matcher', async () => {
                const wildcardScript = 'echo \'{"decision": "allow", "hookSpecificOutput": {"additionalContext": "Wildcard end hook executed"}}\'';
            ...
            it('should handle invalid regex in SessionEnd matcher gracefully', async () => {
                const invalidRegexScript = 'echo \'{"decision": "allow", "hookSpecificOutput": {"additionalContext": "SessionEnd fallback to exact match"}}\'';
            ...
            it('should match all SessionEnd reasons with individual hooks', async () => {
                const clearScript = 'echo \'{"decision": "allow", "hookSpecificOutput": {"additionalContext": "Clear reason triggered"}}\'';
                const logoutScript = 'echo \'{"decision": "allow", "hookSpecificOutput": {"additionalContext": "Logout reason triggered"}}\'';
                const promptExitScript = 'echo \'{"decision": "allow", "hookSpecificOutput": {"additionalContext": "PromptInputExit reason triggered"}}\'';
                const bypassDisabledScript = 'echo \'{"decision": "allow", "hookSpecificOutput": {"additionalContext": "Bypass permissions disabled triggered"}}\'';
                const otherScript = 'echo \'{"decision": "allow", "hookSpecificOutput": {"additionalContext": "Other reason triggered"}}\'';
        ...
        describe('Multiple SessionEnd Hooks', () => {
            it('should execute multiple parallel SessionEnd hooks', async () => {
                const script1 = 'echo \'{"decision": "allow", "hookSpecificOutput": {"additionalContext": "End hook 1"}}\'';
                const script2 = 'echo \'{"decision": "allow", "hookSpecificOutput": {"additionalContext": "End hook 2"}}\'';
            ...
            it('should execute sequential SessionEnd hooks in order', async () => {
                const script1 = 'echo \'{"decision": "allow", "hookSpecificOutput": {"additionalContext": "Sequential end hook 1"}}\'';
                const script2 = 'echo \'{"decision": "allow", "hookSpecificOutput": {"additionalContext": "Sequential end hook 2"}}\'';
            ...
            it('should concatenate additional context from multiple hooks', async () => {
                const context1 = 'echo \'{"decision": "allow", "hookSpecificOutput": {"additionalContext": "End context from hook 1"}}\'';
                const context2 = 'echo \'{"decision": "allow", "hookSpecificOutput": {"additionalContext": "End context from hook 2"}}\'';
        ...
        describe('SessionEnd Block Scenarios', () => {
            it('should block session end when hook returns block decision', async () => {
                const blockScript = 'echo  \'{"decision": "block", "reason": "Session end blocked by policy"}\'';
            ...
            it('should allow session end when hook returns allow decision', async () => {
                const allowScript = 'echo  \'{"decision": "allow", "reason": "Session end allowed"}\'';
            ...
            it('should block when first sequential hook returns block', async () => {
                const blockScript = 'echo \'{"decision": "block", "reason": "First hook blocks session end"}\'';
                const allowScript = 'echo \'{"decision": "allow"}\'';
            ...
            it('should handle block with reason in session end', async () => {
                const blockWithReasonScript = 'echo  \'{"decision": "block", "reason": "Critical operations pending - cannot end session"} \'';
        ...
        describe('Multiple SessionEnd Hooks', () => {
            ...
            it('should concatenate additional context from multiple hooks', async () => {
                const context1Script = 'echo {decision: "allow", hookSpecificOutput: {additionalContext: "context from session end hook 1"}}';
                const context2Script = 'echo {decision: "allow", hookSpecificOutput: {additionalContext: "context from session end hook 2"}}';
                await rig.setup('session-end-multi-context', {
                    settings: {
                        hooks: {
                            enabled: true,
            ...
            it('should handle system messages from multiple hooks', async () => {
                const msg1Script = 'echo  \'{"decision": "allow", "systemMessage": "System message 1 from SessionEnd"}\'';
                const msg2Script = 'echo \'{"decision": "allow", "systemMessage": "System message 2 from SessionEnd"}\'';
    ...
    describe('Hook Script File Tests', () => {
        it('should execute hook from script file', async () => {
            const scriptFileHook = 'echo  \'{"decision": "allow", "reason": "Approved by script file", "hookSpecificOutput": {"additionalContext": "Script file executed successfully"}}\'';
        ...
        it('should execute blocking hook from script file', async () => {
            const scriptBlockHook = 'echo \'{"decision": "block", "reason": "Blocked by security script"}\'';
    ...
    describe('PermissionRequest Hooks', () => {
        describe('Single PermissionRequest Hook - Allow Scenarios', () => {
            it('should allow tool execution when hook returns allow decision', async () => {
                const allowScript = 'echo \'{"decision": "allow", "hookSpecificOutput": {"additionalContext": "Tool access granted by permission hook"}}\'';
                ...
                const result = await rig.run('Create a file test.txt with content "hello"');
                expect(result).toBeDefined();
                const fileContent = rig.readFile('test.txt');
                expect(fileContent).toContain('hello');
            });
        ...
        describe('Single PermissionRequest Hook - Deny Scenarios', () => {
            it('should deny tool execution when hook returns deny decision', async () => {
                const denyScript = 'echo \'{"decision": "deny", "reason": "Tool execution denied by security hook", "hookSpecificOutput": {"additionalContext": "Security policy violation"}}\'';
                ...
                const result = await rig.run('Create a file denied.txt with content "should be blocked"');
                expect(result).toBeDefined();
        ...
        describe('Multiple PermissionRequest Hooks - Allow Scenarios', () => {
            it('should allow tool execution when all hooks return allow decision', async () => {
                const allowScript1 = 'echo \'{"decision": "allow", "hookSpecificOutput": {"additionalContext": "First permission check passed"}}\'';
                const allowScript2 = 'echo \'{"decision": "allow", "hookSpecificOutput": {"additionalContext": "Second permission check passed"}}\'';
                ...
                const result = await rig.run('Create a file multi-test.txt with content "multi allow"');
                expect(result).toBeDefined();
            ...
            it('should allow execution with sequential permission checks', async () => {
                const allowScript1 = 'echo \'{"decision": "allow", "hookSpecificOutput": {"additionalContext": "First sequential check passed"}}\'';
                const allowScript2 = 'echo \'{"decision": "allow", "hookSpecificOutput": {"additionalContext": "Second sequential check passed"}}\'';
        ...
        describe('Multiple PermissionRequest Hooks - Deny Scenarios', () => {
            it('should deny tool execution when one hook returns deny decision in parallel', async () => {
                const allowScript = 'echo \'{"decision": "allow"}\'';
                const denyScript = 'echo \'{"decision": "deny", "reason": "Denied by security policy"}\'';
                ...
                const result = await rig.run('Create a file blocked.txt with content "should not be created"');
                expect(result).toBeDefined();
            ...
            it('should deny execution when first sequential hook denies', async () => {
                const denyScript = 'echo \'{"decision": "deny", "reason": "First check denied execution"}\'';
                const allowScript = 'echo \'{"decision": "allow"}\'';
                ...
                const result = await rig.run('Try to write a file that should be blocked');
                expect(result).toBeDefined();
        ...
        describe('PermissionRequest Matcher Scenarios', () => {
            it('should match specific tools with regex matcher', async () => {
                const specificToolScript = 'echo \'{"decision": "allow", "hookSpecificOutput": {"additionalContext": "Specific tool matched and allowed"}}\'';
            ...
            it('should match all tools with wildcard matcher', async () => {
                const wildcardScript = 'echo \'{"decision": "allow", "hookSpecificOutput": {"additionalContext": "Wildcard matcher allowed all tools"}}\'';
    ...
    describe('SubagentStart Hooks', () => {
        describe('Single SubagentStart Hook', () => {
            it('should execute SubagentStart hook when a subagent is launched', async () => {
                const hookScript = 'echo \'{"hookSpecificOutput": {"additionalContext": "Subagent start approved"}}\'';
                ...
                const result = await rig.run('Use the Task tool to create a bash subagent that says "hello from subagent"');
                expect(result).toBeDefined();
            });
            it('should inject additional context from SubagentStart hook', async () => {
                const contextScript = 'echo \'{"hookSpecificOutput": {"additionalContext": "Security check passed for subagent"}}\'';
                ...
                const result = await rig.run('Use the Task tool to create a bash subagent that says "hello"');
                expect(result).toBeDefined();
            });
            it('should execute SubagentStart hook with additional context', async () => {
                const contextScript = 'echo \'{"hookSpecificOutput": {"additionalContext": "Audit log created"}}\'';
        ...
        describe('Multiple SubagentStart Hooks', () => {
            it('should execute multiple SubagentStart hooks in parallel', async () => {
                const hook1Script = '(echo "hook1_called" >> hook_invoke_count.txt &) ; echo \'{"hookSpecificOutput": {"additionalContext": "Hook1 executed"}}\'';
                const hook2Script = '(echo "hook2_called" >> hook_invoke_count.txt &) ; echo \'{"hookSpecificOutput": {"additionalContext": "Hook2 executed"}}\'';
        ...
        describe('SubagentStart Matcher Scenarios', () => {
            it('should match specific agent types with exact matcher', async () => {
                const specificAgentScript = 'echo \'{"hookSpecificOutput": {"additionalContext": "Specific agent type matched"}}\'';
            ...
            it('should match all agent types with wildcard matcher', async () => {
                const wildcardScript = 'echo \'{"hookSpecificOutput": {"additionalContext": "Wildcard matcher matched all agent types"}}\'';
    ...
    describe('SubagentStop Hooks', () => {
        describe('Single SubagentStop Hook', () => {
            it('should execute SubagentStop hook when a subagent finishes', async () => {
                const hookScript = 'echo \'{"decision": "allow", "hookSpecificOutput": {"additionalContext": "Subagent stop processed"}}\'';
            ...
            it('should allow subagent to continue when SubagentStop hook blocks and requires continuation', async () => {
                ...
                const blockOnceScript = 'if [ -f hook_stop_state.txt ]; then echo \'{"decision": "allow"}\'; else echo "blocked_once" > hook_stop_state.txt; echo \'{"decision": "block", "reason": "File writing blocked by security policy, retrying..."}\'; fi';
                ...
                const result = await rig.run('Use the Task tool to create a bash subagent to write a test file with "hello"');
                expect(result).toBeDefined();
        ...
        describe('Multiple SubagentStop Hooks', () => {
            it('should execute multiple SubagentStop hooks in parallel', async () => {
                const hook1Script = '(echo "hook1_called" >> hook_invoke_count.txt &) ; echo \'{"decision": "allow"}\'';
                const hook2Script = '(echo "hook2_called" >> hook_invoke_count.txt &) ; echo \'{"decision": "allow"}\'';
        ...
        describe('SubagentStop Matcher Scenarios', () => {
            it('should match specific agent types with exact matcher', async () => {
                const specificAgentScript = 'echo \'{"decision": "allow", "hookSpecificOutput": {"additionalContext": "Specific agent type matched and allowed at stop"}}\'';
            ...
            it('should match all agent types with wildcard matcher', async () => {
                const wildcardScript = 'echo \'{"decision": "allow", "hookSpecificOutput": {"additionalContext": "Wildcard matcher allowed all agent types at stop"}}\'';
    ...
    describe('Notification Hooks', () => {
        describe('Idle Prompt Notifications', () => {
            it('should handle idle prompt notifications correctly', async () => {
                const idlePromptScript = 'echo \'{"additionalContext": "Idle prompt notification processed"}\'';
            ...
            it('should process multiple idle prompt notifications', async () => {
                const idlePromptScript1 = 'echo \'{"additionalContext": "First idle prompt notification"}\'';
                const idlePromptScript2 = 'echo \'{"additionalContext": "Second idle prompt notification"}\'';
                ...
                const result = await rig.run('Say multiple idle prompt notification test');
                expect(result).toBeDefined();
            });
        });
        describe('Elicitation Dialog Notifications', () => {
            it('should handle elication dialog notifications correctly', async () => {
                const elicationDialogScript = 'echo \'{"additionalContext": "Elicitation dialog notification processed"}\'';
            ...
            it('should handle multiple elication dialog notifications', async () => {
                const elicationDialogScript1 = 'echo \'{"additionalContext": "First elication dialog notification"}\'';
                const elicationDialogScript2 = 'echo \'{"additionalContext": "Second elication dialog notification"}\'';
                ...
                const result = await rig.run('Say multiple elication dialog notification test');
                expect(result).toBeDefined();
            });
        ...
        describe('Multiple Notification Hooks', () => {
            it('should handle multiple different notification types correctly', async () => {
                const notificationScript1 = 'echo \'{"additionalContext": "Generic notification 1"}\'';
                const notificationScript2 = 'echo \'{"additionalContext": "Generic notification 2"}\'';
                ...
                const result = await rig.run('Say multiple different notification test');
                expect(result).toBeDefined();
            });
        });
    ...
    describe('PreToolUse Hooks', () => {
        describe('Allow Decision', () => {
            it('should allow tool execution when hook returns allow decision', async () => {
                const hookScript = 'echo \'{"hookSpecificOutput": {"hookEventName": "PreToolUse", "permissionDecision": "allow", "permissionDecisionReason": "Tool execution approved by pretooluse hook"}}\'';
            ...
            it('should allow tool execution with additional context from hook', async () => {
                const hookScript = 'echo \'{"hookSpecificOutput": {"hookEventName": "PreToolUse", "permissionDecision": "allow", "permissionDecisionReason": "Security check passed by pretooluse hook", "additionalContext": "Security check passed by pretooluse hook"}}\'';
        ...
        describe('Block Decision', () => {
            it('should block tool execution when hook returns block decision', async () => {
                const blockScript = 'echo \'{"hookSpecificOutput": {"hookEventName": "PreToolUse", "permissionDecision": "deny", "permissionDecisionReason": "Tool execution blocked by security policy in pretooluse"}}\'';
        ...
        describe('Matcher Scenarios', () => {
            it('should match specific tools with regex matcher', async () => {
                const specificToolScript = 'echo \'{"hookSpecificOutput": {"hookEventName": "PreToolUse", "permissionDecision": "allow", "permissionDecisionReason": "Specific tool matched and allowed by pretooluse", "additionalContext": "Specific tool matched and allowed by pretooluse"}}\'';
            ...
            it('should match all tools with wildcard matcher', async () => {
                const wildcardScript = 'echo \'{"hookSpecificOutput": {"hookEventName": "PreToolUse", "permissionDecision": "allow", "permissionDecisionReason": "Wildcard matcher allowed all tools in pretooluse", "additionalContext": "Wildcard matcher allowed all tools in pretooluse"}}\'';
            ...
            it('should not execute when matcher does not match', async () => {
                const noMatchScript = 'echo \'{"hookSpecificOutput": {"hookEventName": "PreToolUse", "permissionDecision": "allow", "permissionDecisionReason": "Should not execute in pretooluse", "additionalContext": "Should not execute in pretooluse"}}\'';
        ...
        describe('Multiple PreToolUse Hooks', () => {
            it('should execute multiple parallel PreToolUse hooks', async () => {
                const script1 = 'echo \'{"decision": "allow", "hookSpecificOutput": {"additionalContext": "Parallel pretooluse hook 1"}}\'';
                const script2 = 'echo \'{"decision": "allow", "hookSpecificOutput": {"additionalContext": "Parallel pretooluse hook 2"}}\'';
            ...
            it('should execute sequential PreToolUse hooks in order', async () => {
                const script1 = 'echo \'{"decision": "allow", "hookSpecificOutput": {"additionalContext": "Sequential pretooluse hook 1"}}\'';
                const script2 = 'echo \'{"decision": "allow", "hookSpecificOutput": {"additionalContext": "Sequential pretooluse hook 2"}}\'';
            ...
            it('should block when one of multiple parallel hooks returns block', async () => {
                const allowScript = 'echo \'{"decision": "allow"}\'';
                const blockScript = 'echo \'{"decision": "block", "reason": "Blocked by security policy in parallel pretooluse"}\'';
            ...
            it('should block when first sequential hook returns block', async () => {
                const blockScript = 'echo \'{"decision": "block", "reason": "First hook blocks in sequential pretooluse"}\'';
                const allowScript = 'echo \'{"decision": "allow"}\'';
            ...
            it('should concatenate additional context from multiple hooks', async () => {
                const context1 = 'echo \'{"decision": "allow", "hookSpecificOutput": {"additionalContext": "Context from pretooluse hook 1"}}\'';
                const context2 = 'echo \'{"decision": "allow", "hookSpecificOutput": {"additionalContext": "Context from pretooluse hook 2"}}\'';
    ...
    describe('PostToolUse Hooks', () => {
        describe('Basic Functionality', () => {
            it('should execute PostToolUse hook after successful tool execution', async () => {
                const hookScript = 'echo \'{"decision": "allow", "reason": "Tool execution logged by posttooluse hook", "hookSpecificOutput": {"hookEventName": "PostToolUse", "additionalContext": "Tool execution logged by posttooluse hook"}}\'';
        ...
        describe('Matcher Scenarios', () => {
            it('should match specific tools with regex matcher', async () => {
                const specificToolScript = 'echo \'{"decision": "allow", "reason": "Specific tool matched by posttooluse", "hookSpecificOutput": {"hookEventName": "PostToolUse", "additionalContext": "Specific tool matched by posttooluse"}}\'';
            ...
            it('should match all tools with wildcard matcher', async () => {
                const wildcardScript = 'echo \'{"decision": "allow", "reason": "Wildcard matcher processed all tools in posttooluse", "hookSpecificOutput": {"hookEventName": "PostToolUse", "additionalContext": "Wildcard matcher processed all tools in posttooluse"}}\'';
            ...
            it('should not execute when matcher does not match', async () => {
                const noMatchScript = 'echo \'{"decision": "allow", "reason": "Should not execute in posttooluse", "hookSpecificOutput": {"hookEventName": "PostToolUse", "additionalContext": "Should not execute in posttooluse"}}\'';
        ...
        describe('Multiple PostToolUse Hooks', () => {
            it('should execute multiple parallel PostToolUse hooks', async () => {
                const script1 = 'echo \'{"decision": "allow", "reason": "Parallel posttooluse hook 1", "hookSpecificOutput": {"hookEventName": "PostToolUse", "additionalContext": "Parallel posttooluse hook 1"}}\'';
                const script2 = 'echo \'{"decision": "allow", "reason": "Parallel posttooluse hook 2", "hookSpecificOutput": {"hookEventName": "PostToolUse", "additionalContext": "Parallel posttooluse hook 2"}}\'';
            ...
            it('should execute sequential PostToolUse hooks in order', async () => {
                const script1 = 'echo \'{"decision": "allow", "reason": "Sequential posttooluse hook 1", "hookSpecificOutput": {"hookEventName": "PostToolUse", "additionalContext": "Sequential posttooluse hook 1"}}\'';
                const script2 = 'echo \'{"decision": "allow", "reason": "Sequential posttooluse hook 2", "hookSpecificOutput": {"hookEventName": "PostToolUse", "additionalContext": "Sequential posttooluse hook 2"}}\'';
            ...
            it('should concatenate additional context from multiple hooks', async () => {
                const context1 = 'echo \'{"decision": "allow", "reason": "Context from posttooluse hook 1", "hookSpecificOutput": {"hookEventName": "PostToolUse", "additionalContext": "Context from posttooluse hook 1"}}\'';
                const context2 = 'echo \'{"decision": "allow", "reason": "Context from posttooluse hook 2", "hookSpecificOutput": {"hookEventName": "PostToolUse", "additionalContext": "Context from posttooluse hook 2"}}\'';
    ...
    describe('PostToolUseFailure Hooks', () => {
        describe('Basic Functionality', () => {
            it('should execute PostToolUseFailure hook after failed tool execution', async () => {
                const hookScript = 'echo \'{"hookSpecificOutput": {"additionalContext": "Tool failure logged by posttoolusefailure hook"}}\'';
    ...
    describe('PreCompact Hooks', () => {
        describe('Basic Functionality', () => {
            it('should execute PreCompact hook before conversation compaction', async () => {
                const hookScript = 'echo \'{"hookSpecificOutput": {"hookEventName": "PreCompact", "additionalContext": "Compaction approved by precompact hook"}}\'';
        ...
        describe('Context Scenarios', () => {
            it('should provide additional context when hook returns context', async () => {
                const contextScript = 'echo \'{"hookSpecificOutput": {"hookEventName": "PreCompact", "additionalContext": "Compaction context provided by precompact hook"}}\'';
        ...
        describe('Matcher Scenarios', () => {
            it('should match all compaction triggers with wildcard matcher', async () => {
                const wildcardScript = 'echo \'{"hookSpecificOutput": {"hookEventName": "PreCompact", "additionalContext": "Wildcard matcher allowed compaction in precompact"}}\'';
            ...
            it('should not execute when matcher does not match', async () => {
                const noMatchScript = 'echo \'{"hookSpecificOutput": {"hookEventName": "PreCompact", "additionalContext": "Should not execute in precompact"}}\'';
        ...
        describe('Multiple PreCompact Hooks', () => {
            it('should execute multiple parallel PreCompact hooks', async () => {
                const script1 = 'echo \'{"hookSpecificOutput": {"hookEventName": "PreCompact", "additionalContext": "Parallel precompact hook 1"}}\'';
                const script2 = 'echo \'{"hookSpecificOutput": {"hookEventName": "PreCompact", "additionalContext": "Parallel precompact hook 2"}}\'';
            ...
            it('should execute sequential PreCompact hooks in order', async () => {
                const script1 = 'echo \'{"hookSpecificOutput": {"hookEventName": "PreCompact", "additionalContext": "Sequential precompact hook 1"}}\'';
                const script2 = 'echo \'{"hookSpecificOutput": {"hookEventName": "PreCompact", "additionalContext": "Sequential precompact hook 2"}}\'';
            ...
            it('should concatenate additional context from multiple hooks', async () => {
                const context1 = 'echo \'{"hookSpecificOutput": {"hookEventName": "PreCompact", "additionalContext": "Context from precompact hook 1"}}\'';
                const context2 = 'echo \'{"hookSpecificOutput": {"hookEventName": "PreCompact", "additionalContext": "Context from precompact hook 2"}}\'';
