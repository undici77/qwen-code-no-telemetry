...
import { query, isSDKAssistantMessage, isSDKSystemMessage, isSDKResultMessage, isSDKPartialAssistantMessage, } from '@qwen-code/sdk';
    ...
    describe('Simple Text Queries', () => {
        ...
        it('should handle greeting and self-description', async () => {
            ...
            try {
                ...
                expect(assistantText.length).toBeGreaterThan(0);
                expect(assistantText.toLowerCase()).toMatch(/hello|hi|greetings|qwen code|assistant/);
