...
import { query, isSDKUserMessage, isSDKAssistantMessage, isSDKSystemMessage, isSDKResultMessage, isSDKPartialAssistantMessage, isControlRequest, isControlResponse, isControlCancel, } from '@qwen-code/sdk';
        ...
        it('should maintain session context across turns', async () => {
            ...
            async function* createContextualConversation() {
                ...
                yield {
                    ...
                    message: {
                        role: 'user',
                        content: 'Suppose we have 3 rabbits and 4 carrots. Identify: How many **animals** are there?',
                    },
                    parent_tool_use_id: null,
                };
                await resultWaiter.waitForResult(0);
